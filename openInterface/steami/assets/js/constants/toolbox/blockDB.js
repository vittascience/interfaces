/**
 * Database of defaut blocks in STM32 toolbox.
...
const TOOLBOXES_BLOCKS_CONTENT = {
    ...
    get: function () {
        return {
            ...
            /** steami default blocks */

            // display - steami
            "display_stm32_controlColorLed": this.Set.state(),
            "display_steami_addOledText": this.Set.number("X") + this.Set.number("Y") + this.Set.text("TEXT"),
            "display_steami_setOledPixel": this.Set.number("X") + this.Set.number("Y") + this.Set.state(),
            "display_steami_drawOledLine": this.Set.number("XA") + this.Set.number("YA", 32) + this.Set.number("XB", 128) + this.Set.number("YB", 32),
            // display - LCD
            ...
            "display_rgb_led_matrix_setColor": this.Set.colour_picker('#22b573') + '<mutation duration="false"></mutation>',
            // display - LED
            ...
            "display_setNumberGrove4Digit": this.Set.field("DIO", "'P3'") + this.Set.number("N", 1024),
            ...
            "io_getGroveThumbJoystick": this.Set.field("PIN_Y", "'P1'"),
            // io - pins
            ...
            // sensors
            "sensors_getGroveHighTemperature": this.Set.field("A1", "'P1'"),
            ...
            "communication_ble_STSensorApp_send": "<mutation items='1'></mutation>"
                + "<value name='ADD0'><block type='communication_ble_STSensorApp_service'><mutation isAcce='false'></mutation></block></value>",
            "communication_ble_STSensorApp_service": "<mutation isAcce='false'></mutation>",
            "communication_BLE_SendData": this.Set.text('DATA', "{hello}"),
            "communication_FizziqBT": this.Set.number('VALUE', 25),
            // communication - tracking modules
            "communication_stm32_RTC_setTime": this.Set.number("HOUR", 8) + this.Set.number("MIN", 40) + this.Set.number("SEC", 10),
            // communication - NFC
