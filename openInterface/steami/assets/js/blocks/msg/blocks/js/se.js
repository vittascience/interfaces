...
Blockly.Msg['DISPLAY_STEAMI_OLED_SETPIXEL_TOOLTIP'] = 'Gör det möjligt att styra varje pixel på STeaMi-kortets OLED-skärm (128x128).';
...
Blockly.Msg['DISPLAY_STEAMI_OLED_SETBACKGROUND_TITLE'] = '[Skärm] ställ in bakgrund till %1';
Blockly.Msg['DISPLAY_STEAMI_OLED_WHITE'] = 'vit';
Blockly.Msg['DISPLAY_STEAMI_OLED_BLACK'] = 'svart';
Blockly.Msg['DISPLAY_STEAMI_OLED_SETBACKGROUND_TOOLTIP'] = 'Växlar skärmens bakgrundsfärg.';
...
Blockly.Msg['DISPLAY_STEAMI_OLED_DRAWICON_TITLE'] = '[Skärm] visa ikon %1 på position x %2 y %3';
Blockly.Msg['DISPLAY_STEAMI_OLED_DRAWICON_TOOLTIP'] = 'Visar en ikon från STM32:s Image-bibliotek på (x,y) på grove OLED-skärmen. Anslut skärmen till en I2C-port.';
Blockly.Msg['IO_STEAMI_ONSWITCHBUTTONPRESSED_TITLE'] = 'om knapp %1 är %2 då';
Blockly.Msg['IO_STEAMI_ONSWITCHBUTTONPRESSED_TOOLTIP'] = 'Låter dig köra kod beroende på vilka knappar som trycks på STeaMi-kortet (A, B, Menu, Up, Down, Left, Right).';
Blockly.Msg["SENSORS_STEAMI_APDS9960_READ_DATA_TITLE"] = "[APDS9960] %1";
Blockly.Msg["SENSORS_STEAMI_APDS9960_READ_DATA_TOOLTIP"] = "Returnerar omgivande ljusnivå (i lux), uppmätt avstånd (max 100 mm), eller upptäckt gest (vänster, höger, upp, ner, nära, långt, eller 'okänd' om ingen gest upptäckts) från APDS9960-sensorn";
...
Blockly.Msg["SENSORS_STEAMI_VL53L1X_READ_TOOLTIP"] = "Returnerar avståndet som VL53L1X-sensorn mäter i millimeter, centimeter eller meter";
