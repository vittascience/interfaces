...
(function (root, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		// Node.js
		module.exports = factory(require('../../main/blockly/blockly_compressed.js'));
	} else {
		// Browser
	...
	Blockly.defineBlocksWithJsonArray([
		{ type: 'colour_picker', message0: '%1', args0: [{ type: 'field_colour', name: 'COLOUR', colour: '#9966ff' }], output: 'Colour', helpUrl: '%{BKY_COLOUR_PICKER_HELPURL}', style: 'colour_blocks', tooltip: '%{BKY_COLOUR_PICKER_TOOLTIP}', extensions: ['parent_tooltip_when_inline'] },
	...
	Blockly.defineBlocksWithJsonArray([
		{ type: 'controls_repeat_ext', message0: '%{BKY_CONTROLS_REPEAT_TITLE}', args0: [{ type: 'input_value', name: 'TIMES', check: 'Number' }], message1: '%{BKY_CONTROLS_REPEAT_INPUT_DO} %1', args1: [{ type: 'input_statement', name: 'DO' }], previousStatement: null, nextStatement: null, style: 'loops_blocks', tooltip: '%{BKY_CONTROLS_REPEAT_TOOLTIP}', helpUrl: '%{BKY_CONTROLS_REPEAT_HELPURL}' },
		{ type: 'controls_repeat', message0: '%{BKY_CONTROLS_REPEAT_TITLE}', args0: [{ type: 'field_number', name: 'TIMES', value: 10, min: 0, precision: 1 }], message1: '%{BKY_CONTROLS_REPEAT_INPUT_DO} %1', args1: [{ type: 'input_statement', name: 'DO' }], previousStatement: null, nextStatement: null, style: 'loops_blocks', tooltip: '%{BKY_CONTROLS_REPEAT_TOOLTIP}', helpUrl: '%{BKY_CONTROLS_REPEAT_HELPURL}' },
		{
		...
		},
		{
			...
			args0: [
				{ type: 'input_value', name: 'VAR', value:'var1' },
	...
	Blockly.defineBlocksWithJsonArray([
		...
		{ type: 'text_create_join_item', message0: '%{BKY_TEXT_CREATE_JOIN_ITEM_TITLE_ITEM}', previousStatement: null, nextStatement: null, style: 'text_blocks', tooltip: '%{BKY_TEXT_CREATE_JOIN_ITEM_TOOLTIP}', enableContextMenu: !1 },
		{
			...
			args0: [
				{ type: 'input_value', name: 'VAR', variable: 'var1', check: 'String' },
	...
	Blockly.Blocks.text_reverse = {
		init: function () {
			this.jsonInit({ message0: Blockly.Msg.TEXT_REVERSE_MESSAGE0, args0: [{ type: 'input_value', name: 'TEXT', check: 'String' }], output: 'String', inputsInline: !0, style: 'text_blocks', tooltip: Blockly.Msg.TEXT_REVERSE_TOOLTIP, helpUrl: Blockly.Msg.TEXT_REVERSE_HELPURL });
		},
	};
	...
	Blockly.Constants.VariablesDynamic.CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN = {
		customContextMenu: function (a) {
			if (!this.isInFlyout) {
				...
				a.push(e);
			} else if ('variables_get_dynamic' == this.type || 'variables_get_reporter_dynamic' == this.type) (b = { text: Blockly.Msg.RENAME_VARIABLE, enabled: !0, callback: Blockly.Constants.Variables.RENAME_OPTION_CALLBACK_FACTORY(this) }), (f = this.getField('VAR').getText()), (e = { text: Blockly.Msg.DELETE_VARIABLE.replace('%1', f), enabled: !0, callback: Blockly.Constants.Variables.DELETE_OPTION_CALLBACK_FACTORY(this) }), a.unshift(b), a.unshift(e);
		},
		onchange: function (a) {
