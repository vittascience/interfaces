...
Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] = "اللبنات المطوية تحتوي على تحذيرات.";
Blockly.Msg["COLLAPSE_ALL"] = "إخفاء القطعةs";
...
Blockly.Msg["CONTROLS_IF_MSG_ELSE"] = "وإﻻ إذا";
...
Blockly.Msg["CONTROLS_IF_TOOLTIP_4"] = "إذا كانت القيمة الأولى تساوي 'صحيح', إذن قم بتنفيذ القطعة الأولى من الأوامر. والا, إذا كانت القيمة الثانية تساوي 'صحيح', قم بتنفيذ القطعة الثانية من الأوامر. If none of the values are true, do the last block of statements.";
...
Blockly.Msg["DELETE_VARIABLE_CONFIRMATION"] = "حذف 1% استخدامات المتغير '2%'؟";
...
Blockly.Msg["LISTS_GET_SUBLIST_END_FROM_END"] = "to # من نهاية";
...
Blockly.Msg["LISTS_REPEAT_TITLE"] = "أتشئ قائمة مع item %1 repeated %2 times";
...
Blockly.Msg["LISTS_SORT_TYPE_IGNORECASE"] = "أبجديًا";
...
Blockly.Msg["LOGIC_COMPARE_TOOLTIP_GT"] = "يرجع صحيح إذا كانت كلا المدخلات غير مساوية لبعضها البعض.";
...
Blockly.Msg["MATH_ONLIST_TOOLTIP_RANDOM"] = "Returns a random element from the list.";
...
Blockly.Msg["MATH_RANDOM_FLOAT_TOOLTIP"] = "Returns a random fraction between 0.0 (inclusive) and 1.0 (exclusive).";
...
Blockly.Msg["PROCEDURES_DEFNORETURN_TITLE"] = "تعريف";
