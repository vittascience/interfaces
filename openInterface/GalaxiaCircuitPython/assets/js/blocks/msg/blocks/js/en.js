...
Blockly.Msg["DISPLAY_GALAXIA_PLOT_SET_Y_SCALE_TITLE"] = "[Plot] set y axis scale to min %1 max %2";
Blockly.Msg["DISPLAY_GALAXIA_PLOT_SET_Y_SCALE_TOOLTIP"] = "Set the scale of the y axis.";
Blockly.Msg["DISPLAY_GALAXIA_ANIMATE_FUNCTION_TITLE"] = "[Plot] compute new point every %1 second.s";
Blockly.Msg["DISPLAY_GALAXIA_ANIMATE_FUNCTION_NEW_POINT"] = "add result %1 to plot";
...
Blockly.Msg["DISPLAY_OLED_DRAWICON_TOOLTIP"] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + "Enable show Galaxia icon from Image library. Connect the OLED display on I2C port.";
// Display - LED modules
...
Blockly.Msg["DISPLAY_4DIGIT_SETCLOCK_TOOLTIP"] = IMG_MODULE_4DIGITDISPLAY + Blockly.Tooltip.SEP + "Enable to show clock on grove 4-digit display (TM1637) on digital pins. Warning, getting real clock is possible only if Galaxia stay in power on mode.";
...
Blockly.Msg["DISPLAY_MORPION_NEWGAME_TOOLTIP"] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + "Enable to start new game of Tic Tac Toe on OLED display. Connect the OLED display on I2C port. Warning, the game uses all Galaxia memory, you cannot connect any other device during playing Tic Tac Toe.";
Blockly.Msg["DISPLAY_MORPION_MOVECURSOR_TITLE"] = "[OLED display] Tic Tac Toe - move cursor";
Blockly.Msg["DISPLAY_MORPION_MOVECURSOR_TOOLTIP"] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + "Enable to move cursor of Tic Tac Toe grid on OLED display. The cursor goes through the grid box by box. Connect the OLED display on I2C port. Warning, the game uses all Galaxia memory, you cannot connect any other device during playing Tic Tac Toe.";
...
Blockly.Msg["DISPLAY_MORPION_ISENDGAME_TOOLTIP"] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + "Enable to return Tic Tac Toe game curent state. Connect the OLED display on I2C port. Warning, the game uses all Galaxia memory, you cannot connect any other device during playing Tic Tac Toe.";
...
Blockly.Msg["IO_ONPINTOUCHED_TOOLTIP"] = "Execute instructions if Galaxia logo or the pin P0, P1 or P2 is touched (or pressed).";
Blockly.Msg["IO_ISPINTOUCHED_TITLE"] = "%1 is touched";
Blockly.Msg["IO_ISPINTOUCHED_TOOLTIP"] = "Returns 'True' if Galaxia logo or pin P0, P1 or P2 is touched (or pressed), else return 'False'.";
// IO - External modules
Blockly.Msg["IO_GROVEKEYPAD_GETNUMBER_TITLE"] = "[Numeric Touch Keypad] get number on pins RX %1 TX %2";
Blockly.Msg["IO_GROVEKEYPAD_GETNUMBER_TOOLTIP"] = IMG_MODULE_KEYPAD + Blockly.Tooltip.SEP + "Enable to get touched number from keypad grove module on pins RX & TX. When you connect device, make sure you “cross” the wires. Galaxia TX pin needs to be connected with device's RX pin, and the RX pin with the device's TX pin.";
Blockly.Msg["IO_GROVEJOYSTICK_GETAXIS_TITLE"] = "[Joystick Module] joystick axis %1 value on pins A0 %2 A1 %3";
Blockly.Msg["IO_GROVEJOYSTICK_GETAXIS_TOOLTIP"] = IMG_MODULE_JOYSTICK + Blockly.Tooltip.SEP + "Returns grove joystick axis value (from O à 65535) on analog pins.";
...
Blockly.Msg["IO_GETGROVEROTARYANGLE_TOOLTIP"] = IMG_MODULE_ROTARY_ANGLE + Blockly.Tooltip.SEP + "Returns grove rotary angle position (from O à 65535) on analog pins.";
Blockly.Msg["IO_GETGROVESLIDEPOTENTIOMETER_TITLE"] = "[Slide Potentiometer] position value on pin %1";
Blockly.Msg["IO_GETGROVESLIDEPOTENTIOMETER_TOOLTIP"] = IMG_MODULE_SLIDE_POT + Blockly.Tooltip.SEP + "Returns grove slide potentiometer position value (from O à 65535) on analog pins.";
...
Blockly.Msg["IO_READANALOGPIN_TOOLTIP"] = "Enable to read the analog value of pins (0-65535).";
Blockly.Msg["IO_WRITEPWMPIN_TITLE"] = "write value %1 on PWM pin %2";
Blockly.Msg["IO_WRITEPWMPIN_TOOLTIP"] = "Enable to apply PWM signal with fixed 10kHz-frequency. You can change value from 0 to 65535. 32768 will be 50% of duty cycle, as around 1.66V.";
Blockly.Msg["IO_SETPWM_TITLE"] = "apply a square signal of %1 (Hz) frequency on pin %2";
Blockly.Msg["IO_SETPWM_TOOLTIP"] = "Enable to apply a PWM square signal with 50% (as 32768) of duty cycle. You can change frequency of the signal from 0 to 4.29 GHz.";
...
Blockly.Msg["IO_PREPARE_PULSE_IN_TITLE"] = "prepare pulse measurement on pin %1";
Blockly.Msg["IO_PREPARE_PULSE_IN_TOOLTIP"] = "Prepares the spindle for measuring a pulse.";
...
Blockly.Msg["COMMUNICATION_SERIAL_INIT_TOOLTIP"] = "Enable to redirect serial connection with RX & TX. When you connect device, make sure you “cross” the wires. Galaxia TX pin needs to be connected with device's RX pin, and the RX pin with the device's TX pin.";
...
Blockly.Msg["COMMUNICATION_GPS_GGA_GETINFORMATIONS_TITLE"] = "[GPS] get %1 with datas %2";
Blockly.Msg["COMMUNICATION_GPS_GGA_GETINFORMATIONS_TOOLTIP"] = IMG_MODULE_GPS + Blockly.Tooltip.SEP + "Returns analyzed datas from gps grove module choosen in ('clock','latitude,'longitude')";
...
Blockly.Msg["SENSORS_BME280_GETDATA_TOOLTIP"] = IMG_MODULE_ENVIRO_BIT + Blockly.Tooltip.SEP + "Returns the ambient temperature in Celius degree (°C), Fahrenheit (°F) or Kelvin (K), pressure (in Pa), humidity (in %) or altitude (in m) from BME280 sensor on Enviro:bit shield.";
...
Blockly.Msg["SENSORS_O2_GAS_READDATA_TOOLTIP"] = IMG_MODULE_O2 + Blockly.Tooltip.SEP + "Returns O2 concentration (in %) from the grove O2 sensor on analog pins.";
...
Blockly.Msg["SENSORS_SCD30_FORCED_CALIBRATION_TOOLTIP"] = IMG_MODULE_SCD30 + Blockly.Tooltip.SEP + "Force the calibration of the SCD30 sensor to the given value (in ppm). Go outside (where the concentration is around approximately 420 ppm, i.e. clean air), reset the board, then wait 2 minutes. Tip: Use button A or B on the BBC Galaxia board to control the start of calibration. Otherwise, by reconnecting the board, the program launches and performs a calibration again that is not necessarily desired.";
Blockly.Msg["SENSORS_AIR_QUALITY_GETVALUE_TITLE"] = "[Air Quality Sensor] value on pin %1";
Blockly.Msg["SENSORS_AIR_QUALITY_GETVALUE_TOOLTIP"] = IMG_MODULE_AIR_QUALITY + Blockly.Tooltip.SEP + "Returns value of air quality (from O à 65535) on analog pins.";
...
Blockly.Msg["SENSORS_GETGROVEMOISTURE_TOOLTIP"] = IMG_MODULE_MOISTURE + Blockly.Tooltip.SEP + "Returns moisture measurement (from O à 65535) from the grove moisture sensor on analog pins.";
Blockly.Msg["SENSORS_GETGROVETEMPERATURE_TITLE"] = "[Temperature Sensor] temperature in %1 on pin %2";
Blockly.Msg["SENSORS_GETGROVETEMPERATURE_TOOLTIP"] = IMG_MODULE_TEMPERATURE + Blockly.Tooltip.SEP + "Returns grove temperature sensor value in Celius degree (°C), Fahrenheit (°F) or Kelvin (K) on analog pins.";
Blockly.Msg["SENSORS_DHT_READDATA_TITLE"] = "[%1 Sensor] %2 on pin %3";
Blockly.Msg["SENSORS_DHT_READDATA_TOOLTIP"] = IMG_MODULE_DHT11 + Blockly.Tooltip.SEP + "Returns temperature in Celius degree (°C), Fahrenheit (°F) or Kelvin (K), or air humidity (in %) from DHT11 or DHT22 sensor on digital pins.";
...
Blockly.Msg["SENSORS_GETGROVEWATER_TOOLTIP"] = IMG_MODULE_WATER + Blockly.Tooltip.SEP + "Returns water amount (from 0 to 255) from the grove water sensor on analog pins.";
...
Blockly.Msg["SENSORS_GETGROVELIGHT_TOOLTIP"] = IMG_MODULE_LIGHT + Blockly.Tooltip.SEP + "Returns grove light sensor value (from O à 65535) on analog pins.";
...
Blockly.Msg["SENSORS_GETGROVESOUND_TOOLTIP"] = IMG_MODULE_SOUND_LOUDNESS + Blockly.Tooltip.SEP + "Returns grove sound sensor value (from O à 65535 converted in dB) on analog pins.";
...
Blockly.Msg["ACTUATORS_MOTOR_SETPOWER_TOOLTIP"] = IMG_MODULE_MOTOR + Blockly.Tooltip.SEP + "Enable to control DC motor power (from 0 to 1023) on digital pins. Warning, Galaxia has to be powered by external batterie in order to provide enough energy to DC motor.";
...
Blockly.Msg["ACTUATORS_MUSIC_PLAYMUSIC_TOOLTIP"] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + "Enable to play the choosen music on grove buzzer module on digital pins.";
...
Blockly.Msg["ROBOTS_MAQUEEN_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TOOLTIP"] = IMG_MODULE_CAR_MP3_GRAY_REMOTE_IR_RECEIVER + Blockly.Tooltip.SEP + "Allows you to execute instructions on command received by IR transmission from NEC Car mp3 gray remote control.";
...
// Network - Simple WiFi
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CONNECT_BASIC_TITLE"] = "connection to access point SSID %1 with password %2";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CONNECT_BASIC_TOOLTIP"] = "Allow you to connect the Galaxia card to the local WiFi network. SSID: Network identifier or name, Router password.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CONNECT_COMPLETE_TITLE"] = "connection to access point SSID %1 with password %2 with IP adress %3 on port %4";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CONNECT_COMPLETE_TOOLTIP"] = "Allow you to connect the Galaxia card to the local WiFi network. SSID: Network identifier or name, Router password, IP: static IP address of the Galaxia card, PORT: Server port.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CONNECT_TITLE"] = "connection to access point SSID %1 with password %2 with IP adress %3";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CONNECT_TOOLTIP"] = "Allow you to connect the Galaxia card to the local WiFi network. SSID: Network identifier or name, Router password, IP: static IP address of the Galaxia card";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CREATE_AP_TITLE"] = "create access point with SSID %1 and password %2";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_CREATE_AP_TOOLTIP"] = "Allow you to create an access point.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_GETLASTCONNECTEDIP_TITLE"] = "latest connected IP";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_GETLASTCONNECTEDIP_TOOLTIP"] = "Allow you to return the IP address of the last device connected to the card.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_GETMYIP_TITLE"] = "my IP address";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_GETMYIP_TOOLTIP"] = "Allow to return the IP address of the card.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_MESSAGE"] = "message";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_BASIC_TITLE"] = "wait for a message to be received in %1 then do";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_BASIC_TOOLTIP"] = "Receive block basic.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_COMPLETE_TITLE"] = "if a message is received in %3 via IP %1 within %2 second(s) then";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_COMPLETE_TOOLTIP"] = "Receive block complete; timeout, ip.";
...
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_DELIMITER_TITLE"] = "wait for a message ending with %2 to be received in %1 then do";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_DELIMITER_TOOLTIP"] = "Receive block with delimiter.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_TITLE"] = "wait for a message to be received in %2 from the IP %1 then do";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RECEIVE_TOOLTIP"] = "Receive block; ip.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_RESPONSE"] = "WiFiResponse";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_SEND_BASIC_TITLE"] = "send %1 to IP %2";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_SEND_BASIC_TOOLTIP"] = "Send block basic; data, ip.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_SEND_COMPLETE_TITLE"] = "send %1 to IP %2 via port %3";
Blockly.Msg["NETWORK_GALAXIA_SIMPLEWIFI_SEND_COMPLETE_TOOLTIP"] = "Send block complete; data, ip, port.";
// Network - HTTP
Blockly.Msg["NETWORK_GALAXIA_HTTP_ADD_BUTTON_TO_PAGE"] = "add button into web page with title %1 who send the request %2";
Blockly.Msg["NETWORK_GALAXIA_HTTP_ADD_BUTTON_TO_PAGE_TOOLTIP"] = "Add button to the web page served by the web server.";
Blockly.Msg["NETWORK_GALAXIA_HTTP_ADD_TO_PAGE"] = "add text %1 into web page";
Blockly.Msg["NETWORK_GALAXIA_HTTP_ADD_TO_PAGE_TOOLTIP"] = "Add text to the web page served by the web server.";
Blockly.Msg["NETWORK_GALAXIA_HTTP_GENERATE_PAGE"] = "generate new page every %1 seconds";
Blockly.Msg["NETWORK_GALAXIA_HTTP_GENERATE_PAGE_TOOLTIP"] = "Update the page served by the web server every x seconds.";
Blockly.Msg["NETWORK_GALAXIA_HTTP_RESPOND_BASIC_TITLE"] = "respond %1";
Blockly.Msg["NETWORK_GALAXIA_HTTP_RESPOND_BASIC_TOOLTIP"] = "Respond basic block.";
Blockly.Msg["NETWORK_GALAXIA_HTTP_RESPOND_COMPLETE_TITLE"] = "respond %1 code %2";
Blockly.Msg["NETWORK_GALAXIA_HTTP_RESPOND_COMPLETE_TOOLTIP"] = "Respond complete block.";
Blockly.Msg["NETWORK_GALAXIA_HTTP_RESPONSE"] = "request";
Blockly.Msg["NETWORK_GALAXIA_HTTP_WAIT_REQUEST_TITLE"] = "wait for a request to be received in %1 then do";
Blockly.Msg["NETWORK_GALAXIA_HTTP_WAIT_REQUEST_TOOLTIP"] = "Wait request block.";
// Network - MQTT
Blockly.Msg["NETWORK_GALAXIA_MQTT_PUBLISH"] = "publish %2 to topic %1";
Blockly.Msg["NETWORK_GALAXIA_MQTT_SUBSCRIBE"] = "subscribe to mqtt topic %1";
// Network - Simple MQTT
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_CONNECT_COMPLETE_TITLE"] = "connect to mqtt broker %1 on port %4 with username %2 and password %3";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_CONNECT_COMPLETE_TOOLTIP"] = "connect to an mqtt broker.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_MESSAGE"] = "message";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_ON_CONNECT"] = "on mqtt connected to broker";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_ON_CONNECT_TOOLTIP"] = "Do something when the connection to the broker is established.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_ON_DISCONNECT"] = "on mqtt disconnected from broker";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_ON_DISCONNECT_TOOLTIP"] = "Do something when the connection to the broker is closed.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_PUBLISH_TOOLTIP"] = "publish a message to a topic.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_RECEIVE"] = "on mqtt %2 from %1";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_RECEIVE_TOOLTIP"] = "Do something when a new message is received on a topic.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_SUBSCRIBE_TOOLTIP"] = "subscribe to an mqtt topic.";
Blockly.Msg["NETWORK_GALAXIA_SIMPLE_MQTT_TOPIC"] = "topic";
// Network - Simple HTTP
Blockly.Msg["NETWORK_GALAXIA_SIMLPLE_HTPP_REQUEST_TITLE"] = "get URL of %1";
Blockly.Msg["NETWORK_GALAXIA_SIMLPLE_HTPP_REQUEST_TOOLTIP"] = "Get the URL of the given response.";
...
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Returns a boolean value (1 if there is data available to read, 0 otherwise).';
