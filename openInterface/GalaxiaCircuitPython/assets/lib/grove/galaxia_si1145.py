"""
CircuitPython driver for SI1145 light I2C sensor, low memory version :
...
SI1145_DEFAULT_I2C_ADDR = 0x60

class SI1145(object):

  def __init__(self, i2c, addr=SI1145_DEFAULT_I2C_ADDR):
    if i2c == None:
  ...
  def _load_calibration(self):
    ...
    self._i2c.writeto(self._addr, b'0x0F')
    self._i2c.writeto(self._addr, b'0x03')
