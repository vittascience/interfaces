...
_DS1307_DEFAULT_I2C_ADDR = const(0x29)
...
class TCS34725:
  def __init__(self, i2c, addr=_DS1307_DEFAULT_I2C_ADDR):
    if i2c == None:
  ...
  def _register16(self, register, value=None):
    ...
    if value is None:
      ...
      self._i2c.readfrom_into(self._addr, crc_result)
      return struct.unpack('<H', crc_result)[0]
  ...
  def read(self, raw=False):
    ...
    while not self._valid():
      time.sleep(int(self._integration_time + 0.9)/1000)
