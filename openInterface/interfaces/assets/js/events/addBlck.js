function sendAddBlock() {
    ...
    if (errors.length !== 0) {
        ...
        let interface = window.location.href.replace(/.+(arduinoq|arduino|microbit|GalaxiaCircuitPython|python|adacraft|wb55|l476|esp32|TI-83|galaxia|raspberrypi|niryo|nao|mBot|buddy|cyberpi|eliobot|letsstartcoding|pico|winky|sphero|lotibot|bluebot|spike|photon|codey|steami|alphai).+/, '$1')
