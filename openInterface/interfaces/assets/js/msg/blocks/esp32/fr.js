...
Blockly.Msg['NETWORK_SERVER_GET_CLIENT_DATA_TOOLTIP'] = 'Renvoie les données reçues du client. Par défaut, la connexion avec le client est fermée automatiquement à chaque tour de boucle du serveur. Pour garder la connexion ouverte, cliquer sur le bouton <b>⊕</b> et passer à <b>Faux</b>. La carte ' + Blockly.Msg.Esp32BoardName + ' doit être connectée à un réseau wifi.';
Blockly.Msg['NETWORK_SERVER_GET_CLIENT_DATA_CLOSING'] = 'fermer la connexion ?';
...
Blockly.Msg['NETWORK_SERVER_CLOSE_CLIENT_CONNECTION_TITLE'] = '[serveur] fermer la connexion avec le client';
Blockly.Msg['NETWORK_SERVER_CLOSE_CLIENT_CONNECTION_TOOLTIP'] = 'Permet de fermer la connexion avec le client. ' + Blockly.Msg.Esp32BoardName + ' doit être connectée à un réseau wifi.';
...
Blockly.Msg['NETWORK_THINGSPEAK_SEND_DATA_TOOLTIP'] = 'Ce bloc permet d\'envoyer des mesures de capteurs à l\'application ThingSpeakr grâce au WiFi intégré de l\'ESP32. Il peut être utilisé avec un ou plusieurs blocs "Field" et "Valeur" en appuyant sur le bouton <b>⊕</b>.';
