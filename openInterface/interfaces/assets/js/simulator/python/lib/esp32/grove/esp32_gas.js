// ESP32 - esp32_gas module

var $builtinmodule = function () {

    var esp32_gas = {};

    esp32_gas.MULTICHANNEL_GAS_I2C_ADDR = new Sk.builtin.int_(0x04);

    esp32_gas.GAS = new Sk.misceval.buildClass(esp32_gas, function ($gbl, $loc) {
        ...
        GAS__init__.$defaults = [Sk.builtin.none(), esp32_gas.MULTICHANNEL_GAS_I2C_ADDR];
