...
var $builtinmodule = function () {
	...
	esp32_hm330x.HM330_I2C_ADDR = new Sk.builtin.int_(0x40);

	esp32_hm330x.HM330X = new Sk.misceval.buildClass(esp32_hm330x, function ($gbl, $loc) {
		...
		HM330X__init__.$defaults = [Sk.builtin.none(), esp32_hm330x.HM330_I2C_ADDR];
