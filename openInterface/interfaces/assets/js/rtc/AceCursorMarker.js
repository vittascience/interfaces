...
/*  export */ class AceCursorMarker {
   ...
   */
   constructor(session, cursorId, label, color, position) {
    ...
    this._tooltipElement.style.width = "fit-content";
...
update(_, markerLayer, __, layerConfig) {
    ...
    this._tooltipElement.style.padding = "2px";
  this._tooltipElement.style.borderRadius = "5px";
    ...
    this._markerElement.style.height = '100%';
