...
// '': [0x06, 0x0E, 0x3E, 0x0E, 0x06], //0x1F down triangle
  ...
  '0': [0x3E, 0x51, 0x49, 0x45, 0x3E], //0x30 0
  '1': [0x00, 0x42, 0x7F, 0x40, 0x00], //0x31 1
  '2': [0x72, 0x49, 0x49, 0x49, 0x46], //0x32 2
  '3': [0x21, 0x41, 0x49, 0x4D, 0x33], //0x33 3
  '4': [0x18, 0x14, 0x12, 0x7F, 0x10], //0x34 4
  '5': [0x27, 0x45, 0x45, 0x45, 0x39], //0x35 5
  '6': [0x3C, 0x4A, 0x49, 0x49, 0x31], //0x36 6
  '7': [0x41, 0x21, 0x11, 0x09, 0x07], //0x37 7
  '8': [0x36, 0x49, 0x49, 0x49, 0x36], //0x38 8
  '9': [0x46, 0x49, 0x49, 0x29, 0x1E], //0x39 9
  ...
  'A': [0x7C, 0x12, 0x11, 0x12, 0x7C], //0x41 A
  'B': [0x7F, 0x49, 0x49, 0x49, 0x36], //0x42 B 
  'C': [0x3E, 0x41, 0x41, 0x41, 0x22], //0x43 C
  'D': [0x7F, 0x41, 0x41, 0x41, 0x3E], //0x44 D
  'E': [0x7F, 0x49, 0x49, 0x49, 0x41], //0x45 E
  'F': [0x7F, 0x09, 0x09, 0x09, 0x01], //0x46 F
  'G': [0x3E, 0x41, 0x41, 0x51, 0x73], //0x47 G
  'H': [0x7F, 0x08, 0x08, 0x08, 0x7F], //0x48 H
  'I': [0x00, 0x41, 0x7F, 0x41, 0x00], //0x49 I
  'J': [0x20, 0x40, 0x41, 0x3F, 0x01], //0x4A J
  'K': [0x7F, 0x08, 0x14, 0x22, 0x41], //0x4B K
  'L': [0x7F, 0x40, 0x40, 0x40, 0x40], //0x4C L
  'M': [0x7F, 0x02, 0x1C, 0x02, 0x7F], //0x4D M
  'N': [0x7F, 0x04, 0x08, 0x10, 0x7F], //0x4E N
  'O': [0x3E, 0x41, 0x41, 0x41, 0x3E], //0x4F O
  'P': [0x7F, 0x09, 0x09, 0x09, 0x06], //0x50 P
  'Q': [0x3E, 0x41, 0x51, 0x21, 0x5E], //0x51 Q
  'R': [0x7F, 0x09, 0x19, 0x29, 0x46], //0x52 R
  'S': [0x26, 0x49, 0x49, 0x49, 0x32], //0x53 S
  'T': [0x03, 0x01, 0x7F, 0x01, 0x03], //0x54 T
  'U': [0x3F, 0x40, 0x40, 0x40, 0x3F], //0x55 U
  'V': [0x1F, 0x20, 0x40, 0x20, 0x1F], //0x56 V
  'W': [0x3F, 0x40, 0x38, 0x40, 0x3F], //0x57 W
  'X': [0x63, 0x14, 0x08, 0x14, 0x63], //0x58 X
  'Y': [0x03, 0x04, 0x78, 0x04, 0x03], //0x59 Y
  'Z': [0x61, 0x59, 0x49, 0x4D, 0x43], //0x5A Z
  '[': [0x00, 0x7F, 0x41, 0x41, 0x41], //0x5B [
  '\\': [0x02, 0x04, 0x08, 0x10, 0x20], //0x5C '\'
  ']': [0x00, 0x41, 0x41, 0x41, 0x7F], //0x5D ]
  '^': [0x04, 0x02, 0x01, 0x02, 0x04], //0x5E ^
  '_': [0x40, 0x40, 0x40, 0x40, 0x40], //0x5F _
  '`': [0x00, 0x03, 0x07, 0x08, 0x00], //0x60 `
  'a': [0x20, 0x54, 0x54, 0x78, 0x40], //0x61 a
  'b': [0x7F, 0x28, 0x44, 0x44, 0x38], //0x62 b
  'c': [0x38, 0x44, 0x44, 0x44, 0x00], //0x63 c
  'd': [0x38, 0x44, 0x44, 0x28, 0x7F], //0x64 d
  'e': [0x38, 0x54, 0x54, 0x54, 0x18], //0x65 e
  'f': [0x00, 0x08, 0x7E, 0x09, 0x02], //0x66 f
  // 0x18, 0xA4, 0xA4, 0x9C, 0x78], //0x67 g (old)
  'g': [0x0C, 0x52, 0x52, 0x4E, 0x3C], //0x67 g 
  'h': [0x7F, 0x08, 0x04, 0x04, 0x78], //0x68 h
  'i': [0x00, 0x44, 0x7D, 0x40, 0x00], //0x69 i
  'j': [0x20, 0x40, 0x40, 0x3D, 0x00], //0x6A j
  'k': [0x7F, 0x10, 0x28, 0x44, 0x00], //0x6B k
  'l': [0x00, 0x41, 0x7F, 0x40, 0x00], //0x6C l
  'm': [0x7C, 0x04, 0x78, 0x04, 0x78], //0x6D m
  'n': [0x7C, 0x08, 0x04, 0x04, 0x78], //0x6E n
  'o': [0x38, 0x44, 0x44, 0x44, 0x38], //0x6F o
  'p': [0xFC, 0x18, 0x24, 0x24, 0x18], //0x70 p
  // 0x18, 0x24, 0x24, 0x18, 0xFC], //0x71 q (old)
  'q': [0x0C, 0x12, 0x12, 0x0C, 0x7E], //0x71 q
  'r': [0x7C, 0x08, 0x04, 0x04, 0x08], //0x72 r
  's': [0x48, 0x54, 0x54, 0x54, 0x24], //0x73 s
  't': [0x04, 0x04, 0x3F, 0x44, 0x24], //0x74 t
  'u': [0x3C, 0x40, 0x40, 0x20, 0x7C], //0x75 u
  'v': [0x1C, 0x20, 0x40, 0x20, 0x1C], //0x76 v
  'w': [0x3C, 0x40, 0x30, 0x40, 0x3C], //0x77 w
  'x': [0x44, 0x28, 0x10, 0x28, 0x44], //0x78 x
  'y': [0x0C, 0x10, 0x10, 0x50, 0x3C], //0x79 y
  'z': [0x44, 0x64, 0x54, 0x4C, 0x44], //0x7A z
  ...
  'ü': [0x3A, 0x40, 0x40, 0x20, 0x7A], //0x81 ü
  '': [0x38, 0x54, 0x54, 0x55, 0x59], //0x82
  '': [0x21, 0x55, 0x55, 0x79, 0x41], //0x83
  'ä': [0x21, 0x54, 0x54, 0x78, 0x41], //0x84 ä
  ...
  'Ä': [0xF0, 0x29, 0x24, 0x29, 0xF0], //0x8E Ä
  ...
  'ö': [0x32, 0x48, 0x48, 0x48, 0x32], //0x94 ö
  ...
  'Ö': [0x3D, 0x42, 0x42, 0x42, 0x3D], //0x99 Ö
  'Ü': [0x3D, 0x40, 0x40, 0x40, 0x3D], //0x9A Ü
  ...
  'ß': [0x7C, 0x2A, 0x2A, 0x3E, 0x14], //0xE1 beta / ß
