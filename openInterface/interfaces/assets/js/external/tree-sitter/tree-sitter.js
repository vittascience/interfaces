			...
			static init(moduleOptions) {
				return (
					...
					(initPromise = new Promise((resolveInitPromise) => {
						...
						assert(INITIAL_MEMORY >= 65536, 'INITIAL_MEMORY should be larger than STACK_SIZE, was ' + INITIAL_MEMORY + '! (STACK_SIZE=65536)'), (wasmMemory = Module.wasmMemory ? Module.wasmMemory : new WebAssembly.Memory({ initial: INITIAL_MEMORY / 65536, maximum: 32768 })), updateMemoryViews(), (INITIAL_MEMORY = wasmMemory.buffer.byteLength);
						var wasmTable = new WebAssembly.Table({ initial: 25, element: 'anyfunc' }),
							__ATPRERUN__ = [],
							__ATINIT__ = [],
							__ATMAIN__ = [],
							__ATPOSTRUN__ = [],
						...
						function instantiateAsync(e, t, r, _) {
							return e || 'function' != typeof WebAssembly.instantiateStreaming || isDataURI(t) || isFileURI(t) || ENVIRONMENT_IS_NODE || 'function' != typeof fetch
								? instantiateArrayBuffer(t, r, _)
								: fetch(t, { credentials: 'same-origin' }).then((e) =>
										WebAssembly.instantiateStreaming(e, r).then(_, function (e) {
											return err('wasm streaming compile failed: ' + e), err('falling back to ArrayBuffer instantiation'), instantiateArrayBuffer(t, r, _);
										})
								  );
						}
						function createWasm() {
							...
							function t(e, t) {
								...
								return _.neededDynlibs && (dynamicLibraries = _.neededDynlibs.concat(dynamicLibraries)), mergeLibSymbols(r, 'main'), (Module.asm = r), addOnInit(Module.asm.__wasm_call_ctors), __RELOC_FUNCS__.push(Module.asm.__wasm_apply_data_relocs), removeRunDependency('wasm-instantiate'), r;
							}
						...
						function UTF8ArrayToString(e, t, r) {
							...
							for (var n = ''; t < s; ) {
								...
								if (128 & a) {
									...
									if (192 != (224 & a)) {
										var l = 63 & e[t++];
										if ((a = 224 == (240 & a) ? ((15 & a) << 12) | (o << 6) | l : ((7 & a) << 18) | (o << 12) | (l << 6) | (63 & e[t++])) < 65536) n += String.fromCharCode(a);
										else {
											var i = a - 65536;
						...
						function getDylinkMetadata(e) {
							...
							if (e instanceof WebAssembly.Module) {
								...
								0 === o.length && ((a = 'dylink'), (o = WebAssembly.Module.customSections(e, a))), n(0 === o.length, 'need dylink section'), (r = (e = new Uint8Array(o[0])).length);
							} else {
								n(!(1836278016 == new Uint32Array(new Uint8Array(e.subarray(0, 24)).buffer)[0]), 'need to see wasm magic number'), n(0 !== e[8], 'need the dylink section to be first'), (t = 9);
								var l = _();
								(r = t + l), (a = s());
							}
							var i = { neededDynlibs: [], tlsExports: new Set(), weakImports: new Set() };
							if ('dylink' == a) {
								(i.memorySize = _()), (i.memoryAlign = _()), (i.tableSize = _()), (i.tableAlign = _());
								...
								for (; t < r; ) {
									var c = e[t++],
										p = _();
									if (1 === c) (i.memorySize = _()), (i.memoryAlign = _()), (i.tableSize = _()), (i.tableAlign = _());
									else if (2 === c) for (u = _(), d = 0; d < u; ++d) (m = s()), i.neededDynlibs.push(m);
									else if (3 === c)
										for (var h = _(); h--; ) {
											var f = s();
						...
						function newDSO(e, t, r) {
							...
							return (LDSO.loadedLibsByName[e] = _), null != t && (LDSO.loadedLibsByHandle[t] = _), _;
						}
						...
						function getFunctionAddress(e) {
							return functionsInTableMap || ((functionsInTableMap = new WeakMap()), updateTableMap(0, wasmTable.length)), functionsInTableMap.get(e) || 0;
						}
						...
						function updateGOT(e, t) {
							for (var r in e)
								if (!isInternalSym(r)) {
									var _ = e[r];
									r.startsWith('orig$') && ((r = r.split('$')[1]), (t = !0)), GOT[r] || (GOT[r] = new WebAssembly.Global({ value: 'i32', mutable: !0 })), (t || 0 == GOT[r].value) && ('function' == typeof _ ? (GOT[r].value = addFunction(_)) : 'number' == typeof _ ? (GOT[r].value = _) : err('unhandled export type for `' + r + '`: ' + typeof _));
								}
						}
						function relocateExports(e, t, r) {
							...
							for (var s in e) {
								var n = e[s];
								'object' == typeof n && (n = n.value), 'number' == typeof n && (n += t), (_[s] = n);
							}
						...
						function loadWebAssemblyModule(binary, flags, localScope, handle) {
							...
							function loadModule() {
								...
								if (firstLoad) {
									...
									handle && ((HEAP8[(handle + 8) | 0] = 1), (HEAPU32[(handle + 12) >> 2] = memoryBase), (HEAP32[(handle + 16) >> 2] = metadata.memorySize), (HEAPU32[(handle + 20) >> 2] = tableBase), (HEAP32[(handle + 24) >> 2] = metadata.tableSize));
								...
								if (flags.loadAsync) {
									...
									return WebAssembly.instantiate(binary, info).then((e) => postInstantiation(e.instance));
								}
						...
						function mergeLibSymbols(e, t) {
							for (var r in e) {
								...
								'main' == r && t(_), r == _ && t('main'), r.startsWith('dynCall_') && !Module.hasOwnProperty(r) && (Module[r] = e[r]);
							}
						}
						function asyncLoad(e, t, r, _) {
							...
							readAsync(
								e,
								(r) => {
									assert(r, 'Loading data file "' + e + '" failed (no arrayBuffer).'), t(new Uint8Array(r)), s && removeRunDependency(s);
								},
								(t) => {
						...
						function loadDynamicLibrary(e, t = { global: !0, nodelete: !0 }, r, _) {
							var s = LDSO.loadedLibsByName[e];
							if (s) return t.global && !s.global && ((s.global = !0), 'loading' !== s.exports && mergeLibSymbols(s.exports, e)), t.nodelete && s.refcount !== 1 / 0 && (s.refcount = 1 / 0), s.refcount++, _ && (LDSO.loadedLibsByHandle[_] = s), !t.loadAsync || Promise.resolve(!0);
							function n() {
								...
								if (!readBinary) throw new Error(_ + ': file not found, and synchronous loading of external files is not available');
								return readBinary(_);
							}
							function a() {
								...
								return t.loadAsync ? n().then((e) => loadWebAssemblyModule(e, t, r, _)) : loadWebAssemblyModule(n(), t, r, _);
							}
							function o(t) {
								s.global ? mergeLibSymbols(t, e) : r && Object.assign(r, t), (s.exports = t);
							}
							return ((s = newDSO(e, _, 'loading')).refcount = t.nodelete ? 1 / 0 : 1), (s.global = t.global), t.loadAsync ? a().then((e) => (o(e), !0)) : (o(a()), !0);
						}
						...
						function loadDylibs() {
							dynamicLibraries.length
								? (addRunDependency('loadDylibs'),
								  dynamicLibraries
										.reduce((e, t) => e.then(() => loadDynamicLibrary(t, { loadAsync: !0, global: !0, nodelete: !0, allowUndefined: !0 })), Promise.resolve())
										.then(() => {
						...
						function setValue(e, t, r = 'i8') {
							switch ((r.endsWith('*') && (r = '*'), r)) {
								...
								case 'i32':
									...
									break;
								case 'i64':
									(tempI64 = [t >>> 0, ((tempDouble = t), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0)]), (HEAP32[e >> 2] = tempI64[0]), (HEAP32[(e + 4) >> 2] = tempI64[1]);
									break;
								case 'float':
									HEAPF32[e >> 2] = t;
									break;
						...
						function emscripten_realloc_buffer(e) {
							...
							try {
								return wasmMemory.grow((e - t.byteLength + 65535) >>> 16), updateMemoryViews(), 1;
							} catch (e) {}
						}
						function _emscripten_resize_heap(e) {
							...
							for (var _ = 1; _ <= 4; _ *= 2) {
								var s = t * (1 + 0.2 / _);
								if (((s = Math.min(s, e + 100663296)), emscripten_realloc_buffer(Math.min(r, (n = Math.max(e, s)) + (((a = 65536) - (n % a)) % a))))) return !0;
							}
							var n, a;
							return !1;
						}
						...
						var SYSCALLS = {
							...
							doStat: function (e, t, r) {
								...
								(HEAP32[r >> 2] = _.dev),
									...
									(tempI64 = [_.size >>> 0, ((tempDouble = _.size), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0)]),
								...
								var s = _.atime.getTime(),
									...
									a = _.ctime.getTime();
								return (
									(tempI64 = [Math.floor(s / 1e3) >>> 0, ((tempDouble = Math.floor(s / 1e3)), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0)]),
									(HEAP32[(r + 56) >> 2] = tempI64[0]),
									(HEAP32[(r + 60) >> 2] = tempI64[1]),
									(HEAPU32[(r + 64) >> 2] = (s % 1e3) * 1e3),
									(tempI64 = [Math.floor(n / 1e3) >>> 0, ((tempDouble = Math.floor(n / 1e3)), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0)]),
									(HEAP32[(r + 72) >> 2] = tempI64[0]),
									(HEAP32[(r + 76) >> 2] = tempI64[1]),
									(HEAPU32[(r + 80) >> 2] = (n % 1e3) * 1e3),
									(tempI64 = [Math.floor(a / 1e3) >>> 0, ((tempDouble = Math.floor(a / 1e3)), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0)]),
									(HEAP32[(r + 88) >> 2] = tempI64[0]),
									(HEAP32[(r + 92) >> 2] = tempI64[1]),
									(HEAPU32[(r + 96) >> 2] = (a % 1e3) * 1e3),
									(tempI64 = [_.ino >>> 0, ((tempDouble = _.ino), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0)]),
						...
						function _fd_seek(e, t, r, _, s) {
							try {
								...
								return FS.llseek(a, n, _), (tempI64 = [a.position >>> 0, ((tempDouble = a.position), +Math.abs(tempDouble) >= 1 ? (tempDouble > 0 ? +Math.floor(tempDouble / 4294967296) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0) : 0)]), (HEAP32[s >> 2] = tempI64[0]), (HEAP32[(s + 4) >> 2] = tempI64[1]), a.getdents && 0 === n && 0 === _ && (a.getdents = null), 0;
							} catch (e) {
								if ('undefined' == typeof FS || 'ErrnoError' !== e.name) throw e;
								return e.errno;
							}
						...
						function _tree_sitter_parse_callback(e, t, r, _, s) {
							...
							'string' == typeof n ? (setValue(s, n.length, 'i32'), stringToUTF16(n, e, 10240)) : setValue(s, 0, 'i32');
						}
						...
						function stringToUTF16(e, t, r) {
							...
							for (var _ = t, s = (r -= 2) < 2 * e.length ? r / 2 : e.length, n = 0; n < s; ++n) {
						...
						(_fd_close.sig = 'ii'), (_fd_seek.sig = 'iijip'), (_fd_write.sig = 'iippp'), (_proc_exit.sig = 'vi');
						var wasmImports = {
							...
							_ts_language_state_count = (Module._ts_language_state_count = function () {
							...
							_ts_language_next_state = (Module._ts_language_next_state = function () {
							...
							_ts_lookahead_iterator_new = (Module._ts_lookahead_iterator_new = function () {
							...
							_ts_lookahead_iterator_delete = (Module._ts_lookahead_iterator_delete = function () {
							...
							_ts_lookahead_iterator_reset_state = (Module._ts_lookahead_iterator_reset_state = function () {
							...
							_ts_lookahead_iterator_reset = (Module._ts_lookahead_iterator_reset = function () {
							...
							_ts_lookahead_iterator_next = (Module._ts_lookahead_iterator_next = function () {
							...
							_ts_lookahead_iterator_current_symbol = (Module._ts_lookahead_iterator_current_symbol = function () {
							...
							_ts_parser_set_included_ranges = (Module._ts_parser_set_included_ranges = function () {
								return (_ts_parser_set_included_ranges = Module._ts_parser_set_included_ranges = Module.asm.ts_parser_set_included_ranges).apply(null, arguments);
							}),
							...
							_ts_parser_included_ranges_wasm = (Module._ts_parser_included_ranges_wasm = function () {
								return (_ts_parser_included_ranges_wasm = Module._ts_parser_included_ranges_wasm = Module.asm.ts_parser_included_ranges_wasm).apply(null, arguments);
							}),
							...
							_ts_tree_root_node_with_offset_wasm = (Module._ts_tree_root_node_with_offset_wasm = function () {
								return (_ts_tree_root_node_with_offset_wasm = Module._ts_tree_root_node_with_offset_wasm = Module.asm.ts_tree_root_node_with_offset_wasm).apply(null, arguments);
							}),
							...
							_ts_tree_included_ranges_wasm = (Module._ts_tree_included_ranges_wasm = function () {
								return (_ts_tree_included_ranges_wasm = Module._ts_tree_included_ranges_wasm = Module.asm.ts_tree_included_ranges_wasm).apply(null, arguments);
							}),
							...
							_ts_tree_cursor_reset_to_wasm = (Module._ts_tree_cursor_reset_to_wasm = function () {
							...
							_ts_tree_cursor_goto_first_child_for_index_wasm = (Module._ts_tree_cursor_goto_first_child_for_index_wasm = function () {
								return (_ts_tree_cursor_goto_first_child_for_index_wasm = Module._ts_tree_cursor_goto_first_child_for_index_wasm = Module.asm.ts_tree_cursor_goto_first_child_for_index_wasm).apply(null, arguments);
							}),
							_ts_tree_cursor_goto_first_child_for_position_wasm = (Module._ts_tree_cursor_goto_first_child_for_position_wasm = function () {
								return (_ts_tree_cursor_goto_first_child_for_position_wasm = Module._ts_tree_cursor_goto_first_child_for_position_wasm = Module.asm.ts_tree_cursor_goto_first_child_for_position_wasm).apply(null, arguments);
							}),
							...
							_ts_tree_cursor_goto_previous_sibling_wasm = (Module._ts_tree_cursor_goto_previous_sibling_wasm = function () {
							...
							_ts_tree_cursor_goto_descendant_wasm = (Module._ts_tree_cursor_goto_descendant_wasm = function () {
								return (_ts_tree_cursor_goto_descendant_wasm = Module._ts_tree_cursor_goto_descendant_wasm = Module.asm.ts_tree_cursor_goto_descendant_wasm).apply(null, arguments);
							}),
							...
							_ts_tree_cursor_current_node_state_id_wasm = (Module._ts_tree_cursor_current_node_state_id_wasm = function () {
							...
							_ts_tree_cursor_current_depth_wasm = (Module._ts_tree_cursor_current_depth_wasm = function () {
								return (_ts_tree_cursor_current_depth_wasm = Module._ts_tree_cursor_current_depth_wasm = Module.asm.ts_tree_cursor_current_depth_wasm).apply(null, arguments);
							}),
							_ts_tree_cursor_current_descendant_index_wasm = (Module._ts_tree_cursor_current_descendant_index_wasm = function () {
								return (_ts_tree_cursor_current_descendant_index_wasm = Module._ts_tree_cursor_current_descendant_index_wasm = Module.asm.ts_tree_cursor_current_descendant_index_wasm).apply(null, arguments);
							}),
							...
							_ts_node_field_name_for_child_wasm = (Module._ts_node_field_name_for_child_wasm = function () {
							...
							_ts_node_children_by_field_id_wasm = (Module._ts_node_children_by_field_id_wasm = function () {
								return (_ts_node_children_by_field_id_wasm = Module._ts_node_children_by_field_id_wasm = Module.asm.ts_node_children_by_field_id_wasm).apply(null, arguments);
							}),
							_ts_node_first_child_for_byte_wasm = (Module._ts_node_first_child_for_byte_wasm = function () {
								return (_ts_node_first_child_for_byte_wasm = Module._ts_node_first_child_for_byte_wasm = Module.asm.ts_node_first_child_for_byte_wasm).apply(null, arguments);
							}),
							_ts_node_first_named_child_for_byte_wasm = (Module._ts_node_first_named_child_for_byte_wasm = function () {
								return (_ts_node_first_named_child_for_byte_wasm = Module._ts_node_first_named_child_for_byte_wasm = Module.asm.ts_node_first_named_child_for_byte_wasm).apply(null, arguments);
							}),
							_ts_node_grammar_symbol_wasm = (Module._ts_node_grammar_symbol_wasm = function () {
							...
							_ts_node_descendant_count_wasm = (Module._ts_node_descendant_count_wasm = function () {
								return (_ts_node_descendant_count_wasm = Module._ts_node_descendant_count_wasm = Module.asm.ts_node_descendant_count_wasm).apply(null, arguments);
							}),
							...
							_ts_node_is_error_wasm = (Module._ts_node_is_error_wasm = function () {
							...
							_ts_node_is_extra_wasm = (Module._ts_node_is_extra_wasm = function () {
								return (_ts_node_is_extra_wasm = Module._ts_node_is_extra_wasm = Module.asm.ts_node_is_extra_wasm).apply(null, arguments);
							}),
							_ts_node_parse_state_wasm = (Module._ts_node_parse_state_wasm = function () {
							...
							_ts_node_next_parse_state_wasm = (Module._ts_node_next_parse_state_wasm = function () {
						...
						function run(e = arguments_) {
							...
							runDependencies > 0 ||
								(!dylibsLoaded && (loadDylibs(), (dylibsLoaded = !0), runDependencies > 0)) ||
								(preRun(),
								runDependencies > 0 ||
									(Module.setStatus
						...
						if ((LDSO.init(), Module.preInit)) for ('function' == typeof Module.preInit && (Module.preInit = [Module.preInit]); Module.preInit.length > 0; ) Module.preInit.pop()();
						var shouldRunNow = !0;
						...
						class ParserImpl {
							...
							parse(e, t, r) {
								...
								if (r && r.includedRanges) {
									(_ = r.includedRanges.length), (s = C._calloc(_, SIZE_OF_RANGE));
									let e = s;
									for (let t = 0; t < _; t++) marshalRange(e, r.includedRanges[t]), (e += SIZE_OF_RANGE);
								}
								const n = C._ts_parser_parse_wasm(this[0], this[1], t ? t[0] : 0, s, _);
								if (!n) throw ((currentParseCallback = null), (currentLogCallback = null), new Error('Parsing failed'));
								const a = new Tree(INTERNAL, n, this.language, currentParseCallback);
							...
							getIncludedRanges() {
								...
								if (e > 0) {
									let _ = t;
									for (let t = 0; t < e; t++) (r[t] = unmarshalRange(_)), (_ += SIZE_OF_RANGE);
									C._free(t);
								}
								return r;
							}
						...
						class Node {
							...
							childrenForFieldId(e) {
								...
								if (t > 0) {
									let e = r;
									for (let r = 0; r < t; r++) (_[r] = unmarshalNode(this.tree, e)), (e += SIZE_OF_NODE);
									C._free(r);
								}
								return _;
							}
							...
							descendantsOfType(e, t, r) {
								...
								for (let t = 0, r = s.length; t < r; t++) e.includes(s[t]) && _.push(t);
								const n = C._malloc(SIZE_OF_INT * _.length);
								for (let e = 0, t = _.length; e < t; e++) setValue(n + e * SIZE_OF_INT, _[e], 'i32');
								marshalNode(this), C._ts_node_descendants_of_type_wasm(this.tree[0], n, _.length, t.row, t.column, r.row, r.column);
						...
						class Language {
							...
							query(e) {
								...
								if (!_) {
									...
									switch (t) {
										...
										case 4:
											...
											break;
										case 5:
											(n = new TypeError(`Bad pattern structure at offset ${_}: '${s}'...`)), (a = '');
											break;
										default:
											(n = new SyntaxError(`Bad syntax at offset ${_}: '${s}'...`)), (a = '');
									}
								...
								const s = C._ts_query_string_count(_),
									...
									l = new Array(s);
								for (let e = 0; e < n; e++) {
									const t = C._ts_query_capture_name_for_id(_, e, TRANSFER_BUFFER),
										r = getValue(TRANSFER_BUFFER, 'i32');
									o[e] = UTF8ToString(t, r);
								}
								for (let e = 0; e < s; e++) {
									const t = C._ts_query_string_value_for_id(_, e, TRANSFER_BUFFER),
										r = getValue(TRANSFER_BUFFER, 'i32');
								...
								const i = new Array(a),
									...
									c = new Array(a);
								for (let e = 0; e < a; e++) {
									const t = C._ts_query_predicates_for_pattern(_, e, TRANSFER_BUFFER),
										r = getValue(TRANSFER_BUFFER, 'i32');
									(m[e] = []), (c[e] = []);
									const s = [];
									let n = t;
									for (let t = 0; t < r; t++) {
										...
										if (((n += SIZE_OF_INT), t === PREDICATE_STEP_TYPE_CAPTURE)) s.push({ type: 'capture', name: o[r] });
										else if (t === PREDICATE_STEP_TYPE_STRING) s.push({ type: 'string', value: l[r] });
										else if (s.length > 0) {
											...
											switch (t) {
												...
												case 'eq?':
													...
													if (((n = !t.startsWith('any-')), 'capture' === s[2].type)) {
														const t = s[1].name,
															r = s[2].name;
														c[e].push(function (e) {
															const s = [],
																a = [];
															for (const _ of e) _.name === t && s.push(_.node), _.name === r && a.push(_.node);
															const o = (e, t, r) => (r ? e.text === t.text : e.text !== t.text);
															return n ? s.every((e) => a.some((t) => o(e, t, _))) : s.some((e) => a.some((t) => o(e, t, _)));
														});
													} else {
														r = s[1].name;
														const t = s[2].value,
														...
														c[e].push(function (e) {
															const t = [];
															for (const _ of e) _.name === r && t.push(_.node);
															const s = _ ? a : o;
												...
												case 'match?':
													...
													(n = !t.startsWith('any-')),
														c[e].push(function (e) {
															const t = [];
															for (const _ of e) _.name === r && t.push(_.node.text);
															const s = (e, t) => (t ? a.test(e) : !a.test(e));
															return 0 === t.length ? !_ : n ? t.every((e) => s(e, _)) : t.some((e) => s(e, _));
														});
													break;
												case 'set!':
													...
													i[e] || (i[e] = {}), (i[e][s[1].value] = s[2] ? s[2].value : null);
													break;
												case 'is?':
												case 'is-not?':
												...
												case 'any-of?':
													...
													c[e].push(function (e) {
														const t = [];
														for (const _ of e) _.name === r && t.push(_.node.text);
														return 0 === t.length ? !_ : t.every((e) => l.includes(e)) === _;
													});
													break;
												default:
									...
									Object.freeze(i[e]), Object.freeze(u[e]), Object.freeze(d[e]);
								}
								return C._free(r), new Query(INTERNAL, _, o, c, m, Object.freeze(i), Object.freeze(u), Object.freeze(d));
							}
							static load(e) {
								let t;
						...
						class LookaheadIterable {
							...
							[Symbol.iterator]() {
								const e = this;
								return { next: () => (C._ts_lookahead_iterator_next(e[0]) ? { done: !1, value: e.currentType } : { done: !0, value: '' }) };
							}
						}
						class Query {
							constructor(e, t, r, _, s, n, a, o) {
								assertInternal(e), (this[0] = t), (this.captureNames = r), (this.textPredicates = _), (this.predicates = s), (this.setProperties = n), (this.assertedProperties = a), (this.refutedProperties = o), (this.exceededMatchLimit = !1);
							}
							delete() {
								C._ts_query_delete(this[0]), (this[0] = 0);
							}
							matches(e, { startPosition: t = ZERO_POINT, endPosition: r = ZERO_POINT, startIndex: _ = 0, endIndex: s = 0, matchLimit: n = 4294967295, maxStartDepth: a = 4294967295 } = {}) {
								if ('number' != typeof n) throw new Error('Arguments must be numbers');
								marshalNode(e), C._ts_query_matches_wasm(this[0], e.tree[0], t.row, t.column, r.row, r.column, _, s, n, a);
								...
								for (let t = 0; t < o; t++) {
									...
									m += SIZE_OF_INT;
									const _ = new Array(r);
									if (((m = unmarshalCaptures(this, e.tree, m, _)), this.textPredicates[t].every((e) => e(_)))) {
							...
							captures(e, { startPosition: t = ZERO_POINT, endPosition: r = ZERO_POINT, startIndex: _ = 0, endIndex: s = 0, matchLimit: n = 4294967295, maxStartDepth: a = 4294967295 } = {}) {
								if ('number' != typeof n) throw new Error('Arguments must be numbers');
								marshalNode(e), C._ts_query_captures_wasm(this[0], e.tree[0], t.row, t.column, r.row, r.column, _, s, n, a);
								const o = getValue(TRANSFER_BUFFER, 'i32'),
									l = getValue(TRANSFER_BUFFER + SIZE_OF_INT, 'i32'),
									i = getValue(TRANSFER_BUFFER + 2 * SIZE_OF_INT, 'i32'),
									u = [];
								...
								for (let t = 0; t < o; t++) {
									...
									if (((m += SIZE_OF_INT), (d.length = r), (m = unmarshalCaptures(this, e.tree, m, d)), this.textPredicates[t].every((e) => e(d)))) {
										const e = d[_],
						...
						function unmarshalCaptures(e, t, r, _) {
							for (let s = 0, n = _.length; s < n; s++) {
								...
								(r += SIZE_OF_NODE), (_[s] = { name: e.captureNames[n], node: a });
							}
							return r;
						}
						...
						function unmarshalNode(e, t = TRANSFER_BUFFER) {
							...
							return (o.id = r), (o.startIndex = _), (o.startPosition = { row: s, column: n }), (o[0] = a), o;
						}
