class HT16K33:
    ...
    def __init__(self, i2c, addr):
        assert 0x00 <= addr < 0x80, "ERROR - Invalid I2C address in HT16K33()"
        if i2c == None:
            raise ValueError("I2C object 'HT16K33' needed as argument!")
        self.i2c = i2c
        i2cModules = self.i2c.scan()
        if addr not in i2cModules:
            error = "Unable to find module 'HT16K33' at address " + str(hex(addr)) + ". Please check connections with the board.\n"
