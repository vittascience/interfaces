/**
 * Database of defaut blocks in Photon toolbox.
...
const TOOLBOXES_BLOCKS_CONTENT = {
    ...
    get: function () {
        return {
            /** Photon default blocks */

            // display
            'display_change_color_rgb': this.Set.number("R", 0) + this.Set.number("G", 255) + this.Set.number("B", 0),
            'display_change_color_rgb_palette': this.Set.colour_picker('#22b573', "COLOUR"),
            // io - time
            ...
            // actuators
            "actuators_go": this.Set.number("DISTANCE", 10) + this.Set.number("SPEED", 50),
            "actuators_go_infinity": this.Set.number("SPEED", 50),
            "actuators_rotate": this.Set.number("ANGLE", 90) + this.Set.number("SPEED", 50),
            "actuators_rotate_infinity": this.Set.number("SPEED", 50),
