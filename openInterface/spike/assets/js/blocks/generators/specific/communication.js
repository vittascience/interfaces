/**
 * @fileoverview Communication generators for Lego Spike.
 */

Blockly.Python.communication_speechSynthesisSay = function (block) {
    Blockly.Python.addImport('speech_synthesis', IMPORT_SPEECH_SYNTHESIS);
    const text = Blockly.Python.valueToCode(block, "TEXT", Blockly.Python.ORDER_NONE) || "''";
    const lang = block.getFieldValue("LANGUAGE");
    return `speech_synthesis.say(${text}, '${lang}')` + NEWLINE;
};
