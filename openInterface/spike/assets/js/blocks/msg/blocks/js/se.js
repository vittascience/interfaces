...
Blockly.Msg['DISPLAY_SHOW_LEDS_TOOLTIP'] = "Gör det möjligt att ändra färgen på LED:arna i 3x3-matrisen.";
Blockly.Msg['DISPLAY_SET_PIXEL_TITLE'] = "%1 styr LED x %2 y %3 %4";
Blockly.Msg['DISPLAY_SET_PIXEL_TOOLTIP'] = "Ändrar färgen på en LED i 3x3-matrisen.";
Blockly.Msg['DISPLAY_SET_INTENSITY_TITLE'] = "%1 sätt intensitet %2 %";
Blockly.Msg['DISPLAY_SET_INTENSITY_TOOLTIP'] = "Ändrar ljusstyrkan på LED:arna i 3x3-matrisen.";
Blockly.Msg['ACTUATORS_START_MOTOR_CONTINUOUS_TITLE'] = "%1 starta motor %2 hastighet %3 % kontinuerligt";
Blockly.Msg['ACTUATORS_START_MOTOR_CONTINUOUS_TOOLTIP'] = "Startar motorn i angiven riktning med given hastighet kontinuerligt.";
Blockly.Msg['ACTUATORS_START_MOTOR_FOR_TIME_TITLE'] = "%1 starta motor %2 hastighet %3 % i %4 sekunder";
Blockly.Msg['ACTUATORS_START_MOTOR_FOR_TIME_TOOLTIP'] = "Startar motorn i angiven riktning med given hastighet under angiven tid.";
Blockly.Msg['ACTUATORS_MOVE_MOTOR_TO_POSITION_TITLE'] = "%1 flytta motor till position %2 ° hastighet %3 %";
Blockly.Msg['ACTUATORS_MOVE_MOTOR_TO_POSITION_TOOLTIP'] = "Flyttar motorn till angiven position med given hastighet.";
Blockly.Msg['ACTUATORS_STOP_MOTOR_TITLE'] = "%1 stoppa motor";
Blockly.Msg['ACTUATORS_STOP_MOTOR_TOOLTIP'] = "Stoppar motorn.";
Blockly.Msg['ACTUATORS_MOVE_MOTORS_BY_DEGREES_TITLE'] = "%1 flytta motor %2 med %3 ° hastighet %4 %";
Blockly.Msg['ACTUATORS_MOVE_MOTORS_BY_DEGREES_TOOLTIP'] = "Flyttar motorn det angivna antalet grader i vald riktning med angiven hastighet.";
Blockly.Msg['COMMUNICATION_SPEECH_SYNTHESIS_SAY_TITLE'] = 'säg %1 på %2';
Blockly.Msg['COMMUNICATION_SPEECH_SYNTHESIS_SAY_TOOLTIP'] = 'Gör att enheten kan tala på det angivna språket.';
...
Blockly.Msg['COMMUNICATION_WRITEGRAPH_TOOLTIP'] = "Detta block låter dig skriva (numeriska) data som syns i plottern. Det kan användas med ett eller flera block i formatet \"Name\" och \"Data\". För att se grafer, klicka på ikonen \'Graph Mode\' i konsolen.";
Blockly.Msg['COMMUNICATION_DATA'] = 'Data';
Blockly.Msg['COMMUNICATION_PRINT_DATAS_TITLE'] = 'Namn %1 Värde %2';
Blockly.Msg['COMMUNICATION_PRINT_DATAS_TOOLTIP'] = "Detta block används med blocket \"Rita graf\". Det ska innehålla namnet på värdet som ska visas (text) och värdet självt (nummer).";
...
Blockly.Msg['IO_INITCHRONOMETER_TOOLTIP'] = 'Startar kronometern på 0 (i sekunder).';
...
Blockly.Msg['SENSORS_COLOR_TOOLTIP'] = 'Returnerar den upptäckta färgen som text (Svart, Violett, Lila, Blå, Azur, Turkos, Grön, Gul, Orange, Röd, Vit).';
Blockly.Msg['SENSORS_COLOR_DETECTION_TITLE'] = '%1 upptäckt färg är %2';
Blockly.Msg['SENSORS_COLOR_DETECTION_TOOLTIP'] = 'Returnerar true om den upptäckta färgen matchar den angivna.';
