function $builtinmodule(name) {
    ...
    return Sk.misceval.chain(
        Sk.importModule("ht16k33", false, true),
        (ht16k33_mod) => {
            import_modules.ht16k33 = ht16k33_mod.$d;
        },
        () => ht16k33matrix_mod(ht16k33matrix, import_modules)
    );
};

function ht16k33matrix_mod(ht16k33matrix, import_modules)  {
    ...
    ht16k33matrix.HT16K33Matrix = new Sk.misceval.buildClass(ht16k33matrix, HT16K33Matrix, "HT16K33Matrix", [import_modules.ht16k33.HT16K33]);
