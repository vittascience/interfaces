...
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED como (R,G,B) de 0 a 255 en el módulo Zip Halo LED de Kitronik.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TITLE'] = '[ZIP Halo HD] controlar el LED %1 con color %2';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED en el módulo Zip Halo LED de Kitronik. Usa la paleta para cambiar el color.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TITLE'] = '[ZIP Halo HD] controlar todas las LEDs en R %1 G %2 B %3';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permite controlar todas las LEDs en el módulo Zip Halo LED de Kitronik con el color elegido como (R,G,B) de 0 a 255.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TITLE'] = '[ZIP Halo HD] controlar todas las LEDs con color %1';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permite controlar todas las LEDs en el módulo Zip Halo LED de Kitronik con el color elegido. Usa la paleta para cambiar el color.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TITLE'] = '[ZIP Halo HD] Arcoíris';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Muestra el espectro de colores en las LEDs RGB del módulo Zip Halo LED de Kitronik.';
...
Blockly.Msg['IO_WRITEDIGITALPIN_TITLE'] = 'escribir estado %1 en el pin digital %2';
...
Blockly.Msg["IO_EXEC_TITLE"] = "ejecutar código Python %1";
Blockly.Msg["IO_EXEC_TOOLTIP"] = "Ejecuta código Python.";
Blockly.Msg["IO_EXEC_HELPURL"] = "https://docs.python.org/3/library/functions.html#exec";
// Micro:bit Logs
Blockly.Msg['COMMUNICATION_LOG_DELETE_TITLE'] = '[Log] borrar el registro en la micro:bit';
Blockly.Msg['COMMUNICATION_LOG_DELETE_TOOLTIP'] = 'Borra el registro (HTML) en la placa micro:bit.';
Blockly.Msg['COMMUNICATION_LOG_SERIAL_TITLE'] = '[Log] obtener comentarios en la consola';
Blockly.Msg['COMMUNICATION_LOG_SERIAL_TOOLTIP'] = 'Permite escribir datos del registro en la consola en tiempo real.';
Blockly.Msg['COMMUNICATION_LOG_SETLABEL_TITLE'] = '[Log] añadir una nueva etiqueta con un temporizador %1';
...
Blockly.Msg['COMMUNICATION_SERIAL_ONDATARECEIVED_TOOLTIP'] = 'Permite ejecutar instrucciones si se reciben datos a través del puerto serie en la variable \'serialData\'. Este último devuelve una matriz de bytes.';
...
Blockly.Msg['COMMUNICATION_RADIO_RECEIVE_FULL_TOOLTIP'] = 'Permite obtener los detalles del próximo mensaje a través de la radio del micro:bit. Devuelve -1 si no hay mensaje entrante.';
Blockly.Msg['COMMUNICATION_RADIO_NEXT_MESSAGE'] = 'próximo dato recibido';
Blockly.Msg['COMMUNICATION_RADIO_RSSI'] = 'fuerza de la señal recibida (RSSI)';
Blockly.Msg['COMMUNICATION_RADIO_TIMESTAMP'] = 'marca de tiempo del dato recibido';
...
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Devuelve un boolean (1 si hay datos para leer 0 si no)';
// Sensors - common msg
...
Blockly.Msg['SENSORS_MICRO_LOUD'] = 'fuerte';
Blockly.Msg['SENSORS_MICRO_QUIET'] = 'silencioso';
Blockly.Msg['SENSORS_MICRO_IS'] = 'es';
Blockly.Msg['SENSORS_MICRO_WAS'] = 'era';
Blockly.Msg['SENSORS_MICRO_ONSOUNDDETECTED_TITLE'] = '[Micro] si %1 sonido %2 detectado entonces';
Blockly.Msg['SENSORS_MICRO_ONSOUNDDETECTED_TOOLTIP'] = 'Ejecutar instrucciones si se detecta la condición de sonido (fuerte/silencioso). Opción \'era\': Ejecutar instrucciones si se ha producido un sonido (fuerte/silencioso) desde la última llamada a \'was_sound()\'';
Blockly.Msg['SENSORS_MICRO_GETCURRENTSOUND_TITLE'] = '[Micro] condición de sonido';
Blockly.Msg['SENSORS_MICRO_GETCURRENTSOUND_TOOLTIP'] = 'Devuelve la condición de sonido (fuerte/silencioso)';
Blockly.Msg['SENSORS_MICRO_WASSOUNDDETECTED_TITLE'] = '[Micro] %1 sonido fue detectado';
Blockly.Msg['SENSORS_MICRO_WASSOUNDDETECTED_TOOLTIP'] = 'Devuelve True si se ha producido un sonido (fuerte/silencioso) desde la última llamada a \'was_sound()\'';
Blockly.Msg['SENSORS_MICRO_GETSOUNDLEVEL_TITLE'] = '[Micro] nivel de sonido';
Blockly.Msg['SENSORS_MICRO_GETSOUNDLEVEL_TOOLTIP'] = 'Habilitar du obtener el nivel de sonido de 0 a 255';
Blockly.Msg['SENSORS_MICRO_GETHISTORYSOUND_TITLE'] = '[Micro] historial de sonidos';
Blockly.Msg['SENSORS_MICRO_GETHISTORYSOUND_TOOLTIP'] = 'Devuelve el historial de sonidos desde la última llamada a \'get_sounds()\'';
Blockly.Msg['SENSORS_MICRO_SETSOUNDTHRESHOLD_TITLE'] = '[Micro] establece %1 umbral de sonido a %2';
Blockly.Msg['SENSORS_MICRO_SETSOUNDTHRESHOLD_TOOLTIP'] = 'Habilitar para establecer el umbral de sonido alto/silencioso de 0 a 255';
Blockly.Msg['SENSORS_MICRO_SOUNDCONDITION_TITLE'] = '[Micro] %1';
Blockly.Msg['SENSORS_MICRO_SOUNDCONDITION_TOOLTIP'] = 'Habilitar para utilizar las constantes (LOUD/QUIET) del módulo de micrófono en la categoría \'Lógica\'';
// Sensors - Enviro:bit
...
Blockly.Msg['SENSORS_WEATHERBIT_ANEMOMETER_GET_SPEED_TOOLTIP'] = IMG_MODULE_WEATHER_BIT_KIT_MICROBIT + Blockly.Tooltip.SEP + 'Devuelve la velocidad del viento con el anemómetro en la unidad elegida (en m/s, km/s, inch/s o knots). El anemómetro está conectado al puerto RJ45 WIND del escudo Weather:bit';
...
Blockly.Msg['SENSORS_SUNLIGHT_GETDATA_TITLE'] = '[Sensor de luz %1] obtener luz %2';
...
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TITLE'] = '[Sensor de color v3] %1';
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TOOLTIP'] = IMG_MODULE_I2C_COLOR_V3 + Blockly.Tooltip.SEP + 'Permite leer el nivel de uno de los tres colores primarios (rojo, verde, azul), el brillo (~ de 0 a 10,000K) o la temperatura (~ de 0 a 100,000 Lux) con el sensor de color Grove v3. También permite leer el color en formato HSV (tono: 0 a 360°, saturación: 0 a 100%, valor: 0 a 100%) y recuperar el nombre del color asociado. Conecta el sensor a un puerto I2C.';
Blockly.Msg['COLOR_HUE'] = 'tono (°)';
Blockly.Msg['COLOR_SATURATION'] = 'saturación (%)';
Blockly.Msg['COLOR_VALUE'] = 'valor (%)';
Blockly.Msg['COLOR_LEVEL_WHITE'] = 'nivel de blanco';
Blockly.Msg['COLOR_LEVEL_TEMP'] = 'temperatura';
Blockly.Msg['COLOR_NAME'] = 'nombre del color';
...
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TITLE'] = '[Sensor de movimiento mini] estado en el pin %1';
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TOOLTIP'] = IMG_MODULE_MOTION_MINI + Blockly.Tooltip.SEP + 'Devuelve verdadero o falso según si el sensor Grove PIR Motion mini detecta movimiento en los pines digitales P0 a P20.';
...
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TITLE'] = '[Sensor de Frecuencia Cardíaca] bpm en el pin %1';
...
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TITLE'] = '[Motor paso a paso] inicializar motor  %1 en IN1 %2 IN2 %3 IN3 %4 IN4 %5';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Inicializa el motor paso a paso 28BYJ-48 con el controlador ULN2003 en los pines digitales P0 a P20.';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TITLE'] = '[Motor paso a paso] motor %1 girar %2 %3 dirección %4';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_STEPS'] = 'paso(s)';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_ROTATIONS'] = 'vuelta(s)';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Hace girar el motor paso a paso 28BYJ-48 un número de pasos o vueltas en sentido horario (↻) o antihorario (↺).';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TITLE'] = '[Motor paso a paso] motor %1 retraso entre cada paso %2 ms';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Permite ajustar la velocidad de rotación del motor paso a paso 28BYJ-48 modificando el retraso entre cada paso (en ms). Cuanto mayor sea el retraso, más lenta será la velocidad. El retraso por defecto es de 3 ms y no puede reducirse.';
// Actuadores - Kitronik
...
Blockly.Msg['ACTUATORS_KITRONIK_CONTROLMOTOR_TITLE'] = '[Kitronik Motors] controlar motor %1 dirección %2 velocidad %3';
...
Blockly.Msg['ACTUATORS_KITRONIK_STOPMOTOR_TITLE'] = '[Kitronik Motors] detener motor %1';
...
Blockly.Msg['ROBOTS_GO_FORWARD'] = 'hacia adelante';
Blockly.Msg['ROBOTS_GO_BACKWARD'] = 'hacia atrás';
Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'] = '\n.\nHaga clic en el botón 🞧 si desea bloquear o no el programa durante la ejecución del comando.';
// Robots - Maqueen
...
Blockly.Msg['ROBOTS_MAQUEEN_ULTRASONICRANGER_TITLE'] = '[Maqueen Lite] ultrasónico %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLLED_TITLE'] = '[Maqueen Lite] controla el LED rojo %1 al estado %2';
...
Blockly.Msg['ROBOTS_MAQUEEN_GO_TITLE'] = '[Maqueen Lite] %1 con velocidad %2';
...
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLMOTOR_TITLE'] = '[Maqueen Lite] controlar motor %1 dirección %2 velocidad %3';
...
Blockly.Msg['ROBOTS_MAQUEEN_ROTATE_TITLE'] = '[Maqueen Lite] rotar %1 velocidad %2';
...
Blockly.Msg['ROBOTS_MAQUEEN_STOPMOTORS_TITLE'] = '[Maqueen Lite] parar motor %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETSERVOANGLE_TITLE'] = '[Maqueen Lite] establece el servo %1 al ángulo %2 °';
...
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Maqueen Lite] mover un cuadrado hacia adelante';
...
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Maqueen Lite] retrocede una casilla';
...
Blockly.Msg['ROBOTS_MAQUEEN_BLINK_ROBOT_TITLE'] = '[Maqueen Lite] robot parpadeante';
Blockly.Msg['ROBOTS_MAQUEEN_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Blink the Maqueen robot.';
Blockly.Msg['ROBOTS_MAQUEEN_READPATROL_TITLE'] = '[Maqueen Lite] lee la línea de patrulla %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETNEOPIXEL_TITLE'] = '[Maqueen Lite] establece el color R %2 G %3 B %4 en el LED %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETPALETTECOLOR_TITLE'] = '[Maqueen Lite] establece el color %2 en el LED %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETBUZZER_TITLE'] = '[Maqueen Lite] establece el zumbido a la frecuencia %1 durante %2 (ms)';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLAYMUSIC_TITLE'] = '[Maqueen Lite] reproducir música %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_DECODEIRRECEIVER_TITLE'] = '[Maqueen Lite] decodifica el receptor de infrarrojos';
...
Blockly.Msg['ROBOTS_MAQUEEN_GETIRCODE_TITLE'] = '[Maqueen Lite] código del receptor de infrarrojos';
...
// Robots - MaqueenPlus - Detección
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ULTRASONICRANGER_TRIG_ECHO_TITLE'] = '[Maqueen Plus %1] %2 TRIG %3 ECHO %4';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ULTRASONICRANGER_TRIG_ECHO_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) o el tiempo de ida y vuelta (en μs) de la onda entre un objeto y el robot MaqueenPlus utilizando el sensor ultrasónico conectado a los pines digitales indicados.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V2_ULTRASONICRANGER_TITLE'] = '[Maqueen Plus v2] %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V2_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) o el tiempo de ida y vuelta (en μs) de la onda entre un objeto y el robot MaqueenPlus usando el sensor ultrasónico.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_READPATROL_TITLE'] = '[Maqueen Plus %1] Estado del sensor de línea';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Lee el estado de uno de los sensores de seguimiento de línea del robot MaqueenPlus. El bloque devuelve 1 si el sensor está por encima de la línea.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LEFT_REAR'] = "trasero izquierdo";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LEFT'] = "izquierdo";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_MIDDLE_LEFT'] = "izquierdo medio";
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READLIGHTINTENSITY_TITLE'] = '[Maqueen Plus v3] intensidad de luz a %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READLIGHTINTENSITY_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Devuelve la intensidad de luz de los sensores de luz izquierdo o derecho en la parte frontal del robot Maqueen Plus V3.';
// Robots - Maqueen Plus - En movimiento
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GO_TITLE'] = '[Maqueen Plus %1] %2 a velocidad %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GO_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permite controlar el movimiento (ADELANTE/ATRÁS) y la velocidad (de 0 a 255) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ROTATE_TITLE'] = '[Maqueen Plus %1] gira %2 a la velocidad %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ROTATE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permite controlar los motores derecho e izquierdo cambiando la dirección (↻: ADELANTE, ↺: ATRÁS) y la velocidad (de 0 a 255) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLMOTOR_TITLE'] = '[Maqueen Plus %1] control motor %2 dirección %3 velocidad %4';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permite controlar los motores derecho e izquierdo cambiando la dirección (↻: ADELANTE, ↺: ATRÁS) y la velocidad (de 0 a 255) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_STOPMOTORS_TITLE'] = '[Maqueen Plus %1] detener motor %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permite detener el motor derecho o izquierdo del robot MaqueenPlus.';
// Robots - Maqueen Plus - Control
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLLED_TITLE'] = '[Maqueen Plus %1] controla el LED rojo antes del estado %2 %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLLED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permite controlar el estado del LED izquierdo o derecho del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LED_LEFT'] = "izquierda";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LED_RIGHT'] = "derecha";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LED_LEFT&RIGHT'] = "izquierda y derecha";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETRGBLED_TITLE'] = '[Maqueen Plus v3] controla el LED RGB antes del %1 color %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETRGBLED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permite controlar el color del LED izquierdo o derecho del robot Maqueen Plus V3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETBUZZER_TITLE'] = '[Maqueen Plus %1] controla el zumbador a la frecuencia %2 durante %3 (ms)';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETBUZZER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permite establecer una frecuencia para el zumbador del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETSERVOANGLE_TITLE'] = '[Maqueen Plus %1] ajustar el servomotor %2 al ángulo %3°';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permite controlar los servomotores P0, P1 y P2 modificando el ángulo (de 0 a 180°) del robot MaqueenPlus V1.';
// Robots - Maqueen Plus (V2 y V3) - LED RGB
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_BLINK_ROBOT_TITLE'] = '[Maqueen Plus %1] hace parpadear el robot';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Hace parpadear el robot MaqueenPlus v2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETNEOPIXEL_TITLE'] = '[Maqueen Plus %1] controla el LED RGB debajo de %2 a R %3 G %4 B %5';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED RGB en el módulo neopixel del robot MaqueenPlus, de modo que los valores R, G y B estén entre 0 y 255.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETPALETTECOLOR_TITLE'] = '[Maqueen Plus %1] controla el LED RGB de %2 a %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED RGB en el módulo neopixel ubicado debajo del robot MaqueenPlus. Usa la paleta para cambiar el color.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETRAINBOW_TITLE'] = '[Maqueen Plus %1] Arcoíris';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Mostrar el espectro de color de los LED RGB.';
// Robots - Maqueen Plus - Control remoto
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_DECODEIRRECEIVER_TITLE'] = '[Maqueen Plus] decodifica el receptor de infrarrojos';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Lee el receptor de infrarrojos del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GETIRCODE_TITLE'] = '[Maqueen Plus] código recibido del receptor de infrarrojos';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GETIRCODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Devuelve el código hexadecimal recibido con el detector de infrarrojos del robot MaqueenPlus.';
// Robots - Maqueen Plus (V3) - Buscador de líneas
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLSPEED_TITLE'] = '[Maqueen Plus v3] cambiar la velocidad del rastreador a %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLSPEED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Controla la velocidad del rastreador de líneas del robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STRAIGHT'] = 'moverse recto';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_LEFT'] = 'girar a la izquierda';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_RIGHT'] = 'girar a la derecha';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STOP'] = 'detener';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETINTERSECTIONRUNMODE_TITLE'] = '[Maqueen Plus v3] en %1,';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETINTERSECTIONRUNMODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permite cambiar el comportamiento del robot Maqueen Plus V3 cuando se encuentra frente a una intersección o un cruce en T.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_T'] = 'intersecciones en T';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_CROSSROADS'] = 'cruce';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETLEFTORRIGHTINTERSECTIONRUNMODE_TITLE'] = '[Maqueen Plus v3] en intersecciones en %1,';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETLEFTORRIGHTINTERSECTIONRUNMODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permite cambiar el comportamiento del robot Maqueen Plus V3 cuando se encuentra frente a una intersección en T.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_LEFT'] = "izquierda";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_RIGHT'] = "derecha";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLLINGSTATE_TITLE'] = '[Maqueen Plus v3] %1 el seguidor de línea';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLLINGSTATE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permite iniciar o detener el seguimiento de línea con el robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_PATROL_ON'] = 'iniciar';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_PATROL_OFF'] = 'detener';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTED_TITLE'] = '[Maqueen Plus v3] intersección detectada';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Devuelve la intersección detectada (1: intersección, 2: intersección en T, 3: intersección izquierda, 4: intersección derecha) con el robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTEDIS_TITLE'] = '[Maqueen Plus v3] ¿La intersección detectada es %1?';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTEDIS_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Devuelve Verdadero si la intersección detectada se verifica (1: cruce, 2: intersección en T, 3: intersección izquierda, 4: intersección derecha) con el robot Maqueen Plus V3.';
// Robots - Maqueen Plus (V3) - PID
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_RUNDISTANCE_TITLE'] = '[Maqueen Plus v3] %1 de %2 %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_RUNDISTANCE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permite recorrer una distancia determinada (en cm) o (en pulgadas) hacia ADELANTE o HACIA ATRÁS usando el controlador PID del robot Maqueen Plus V3.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURNWITHANGLE_TITLE'] = '[Maqueen Plus v3] girar %1 %2°';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURNWITHANGLE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permite girar el robot Maqueen Plus V3 a la izquierda o a la derecha en un ángulo determinado (en °) usando el controlador PID.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_LEFT'] = 'izquierda';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READREALTIMESPEED_TITLE'] = '[Maqueen Plus v3] velocidad del motor %1 en %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READREALTIMESPEED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Devuelve la velocidad (en cm/s) o (en pulgadas/s) del robot Maqueen Plus V3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STOPPID_TITLE'] = '[Maqueen Plus v3] detener el control PID actual';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STOPPID_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permite detener el control actual del regulador PID en el robot Maqueen Plus V3. Esta función solo es válida si la ejecución de comandos PID no está pendiente.';
// Robots - Maqieen Plus (V3) - Lidar
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TITLE'] = '[LiDAR %1] tamaño de configuración: %2';
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Permite configurar el tamaño de la matriz (8x8 o 4x4) de las mediciones del sensor de distancia LiDAR DFRobot conectado al robot Maqieen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_CONFIG_8X8_MATRIX'] = 'Matriz 8x8';
Blockly.Msg['SENSORS_LIDAR_CONFIG_4X4_MATRIX'] = 'Matriz 4x4';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TITLE'] = '[LiDAR %1] lee %2';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Lee todos los datos medidos con el sensor de distancia LiDAR DFRobot conectado al robot Maqueen Plus V3';
Blockly.Msg['SENSORS_LIDAR_DATA_DISTANCES_MATRIX'] = 'Matriz de distancias (en mm)';
Blockly.Msg['SENSORS_LIDAR_DATA_RAW_LIST'] = 'Lista de datos sin procesar';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TITLE'] = '[LiDAR %1] distancia medida en el punto x %2 y %3';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Devuelve la distancia (en mm) a un punto específico de la matriz (4x4 u 8x8) medida con el sensor de distancia LiDAR DFRobot conectado al robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TITLE'] = '[LiDAR %1] configura la distancia de evasión en %2 (cm)';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Permite configurar la distancia de evasión de obstáculos de 10 a 50 cm con el sensor de distancia LiDAR DFRobot conectado al robot Maqueen Plus V3. El sensor activará la señal de emergencia y proporcionará la dirección para evitar el obstáculo en función de esta distancia.';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TITLE'] = '[LiDAR %1] ¿Señal de emergencia activada?';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Devuelve Verdadero si la señal de emergencia se ha activado con el sensor de distancia LiDAR DFRobot conectado al robot Maqueen Plus V3. La señal se activa cuando se supera la distancia de evasión.';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TITLE'] = '[LiDAR %1] dirección a seguir para evitar el obstáculo';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Devuelve la dirección a seguir para evitar el obstáculo con el sensor de distancia LiDAR DFRobot conectado al robot Maqueen Plus V3. Las direcciones sugeridas son 1 (izquierda), 2 (derecha) y 3 (recto).';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TITLE'] = '[LiDAR %1] dirección a seguir es %2';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Devuelve Verdadero si la dirección de evasión de obstáculos se verifica con el sensor de distancia LiDAR DFRobot conectado al robot Maqueen Plus V3';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_LEFT'] = 'izquierda';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_RIGHT'] = 'derecha';
Blockly.Msg['SENSORS_LIDAR_DIR_FORWARD'] = 'adelante';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TITLE'] = '[LiDAR %1] distancia (en cm) desde el obstáculo %2';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) a un obstáculo ubicado a la DERECHA, IZQUIERDA o CENTRO, medida con el sensor de distancia LiDAR DFRobot conectado al robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_DIR_LEFT'] = 'izquierda';
Blockly.Msg['SENSORS_LIDAR_DIR_MIDDLE'] = 'centro';
Blockly.Msg['SENSORS_LIDAR_DIR_RIGHT'] = 'derecha';
// Robots - Cutebot
...
Blockly.Msg['ROBOTS_CUTEBOT_GO_TITLE'] = '[Cutebot] %1 con velocidad %2 %';
...
// Robots - Codo
Blockly.Msg['ROBOTS_CODO_GO_TITLE'] = '[Codo] %1 con velocidad %2';
...
// Robots - Buggy
Blockly.Msg['ROBOTS_BUGGY_GO_TITLE'] = '[Buggy] %1 con velocidad %2';
...
Blockly.Msg['ROBOTS_BITBOT_GO_TITLE'] = '[Bit:Bot] %1 con velocidad %2';
...
Blockly.Msg['SENSORS_BAROMETER_READDATA_TOOLTIP'] = IMG_MODULE_HP206C + Blockly.Tooltip.SEP + 'Devuelve la temperatura en grados Celsius (°C), Fahrenheit (°F) o Kelvin (K), la presión (en hPa) o la altitud (en m) usando el barómetro. Conectar el sensor a un puerto I2C.';
...
Blockly.Msg['ACTUATORS_MUSIC_PLAY_FREQUENCY_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permite reproducir una frecuencia en el altavoz integrado de la micro:bit o con un módulo zumbador (o altavoz) en los pines digitales P0 a P20.';
Blockly.Msg['ACTUATORS_MUSIC_STOP_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permite detener la música en curso del altavoz integrado o del zumbador en los pines digitales P0 a P20.';
Blockly.Msg['ACTUATORS_MUSIC_SETVOLUME_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permite cambiar el volumen del altavoz integrado de la micro:bit de 0 a 255.';
Blockly.Msg['ACTUATORS_MUSIC_SETTEMPO_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permite definir el número de pulsos por compás y el tempo de la música reproducida por las funciones de la biblioteca music.';
Blockly.Msg['ACTUATORS_MUSIC_GETTEMPO_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permite obtener el tempo de la música en una tupla de enteros (ticks, bpm).';
Blockly.Msg['ACTUATORS_KITRONIK_PLAY_FREQUENCY_TOOLTIP'] = IMG_SHIELD_KITRONIK_ENV + Blockly.Tooltip.SEP + 'Permite reproducir una frecuencia en el altavoz integrado del escudo Kitronik ambiental.';
Blockly.Msg['ACTUATORS_SPEECH_SAYSOMETHING_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permite decir una frase con la tarjeta micro:bit. Es posible ajustar la velocidad y el tono de la voz (de 0 a 255).';
Blockly.Msg['ROBOTS_CUTEBOT_GETIRCODE_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Devuelve el código hexadecimal recibido con el detector infrarrojo (P16) del robot Cutebot.';
Blockly.Msg['ROBOTS_BITCAR_ULTRASONICRANGER_TITLE'] = '[BitCar] %1';
Blockly.Msg['ROBOTS_BITCAR_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) o la duración del viaje de ida y vuelta (en μs) de la onda entre un objeto y el robot BitCar gracias al sensor ultrasónico.';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TITLE'] = '[BitCar] estado del sensor de línea %1';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite leer el estado de uno de los sensores seguidor de línea del robot BitCar. El bloque devuelve 0 si el sensor está sobre la línea.';
Blockly.Msg['ROBOTS_BITCAR_GO_TITLE'] = '[BitCar] controlar el robot %1 velocidad %2 %';
Blockly.Msg['ROBOTS_BITCAR_GO_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite controlar el movimiento (DELANTE/ATRÁS) así como la velocidad (de 0 a 100) del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TITLE'] = '[BitCar] girar %1 velocidad %2 %';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite controlar los motores derecho e izquierdo cambiando la dirección (↻ : DELANTE, ↺ : ATRÁS) y la velocidad (de 0 a 100) del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TITLE'] = '[BitCar] controlar el motor %1 dirección %2 velocidad %3 %';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite controlar los motores derecho e izquierdo cambiando la dirección (↻ : DELANTE, ↺ : ATRÁS) y la velocidad (de 0 a 100) del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TITLE'] = '[BitCar] detener el motor %1';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite detener el motor derecho o izquierdo del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TITLE'] = '[BitCar] parpadear el robot';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Hace parpadear el robot Maqueen.';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TITLE'] = '[BitCar] controlar el LED RGB debajo %1 a R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED RGB del neopixel del robot BitCar de modo que los valores R, G, B estén entre 0 y 255.';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TITLE'] = '[BitCar] controlar el LED RGB debajo %1 a %2';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED RGB del módulo neopixel ubicado debajo del robot BitCar. Utilizar la paleta para cambiar el color.';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TITLE'] = '[BitCar] Arcoíris';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Mostrar el espectro de colores en los LED RGB.';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TITLE'] = '[BitCar] controlar el zumbador a la frecuencia %1 durante %2 (ms)';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permite definir una frecuencia en el zumbador del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TITLE'] = '[BitCar] decodificar el receptor infrarrojo';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Realiza una lectura del receptor infrarrojo del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TITLE'] = '[BitCar] código recibido del receptor infrarrojo';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Devuelve el código hexadecimal recibido con el detector infrarrojo del robot BitCar.';
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TITLE'] = '[BitPlayer] si el botón %1 está %2 entonces';
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'Ejecuta instrucciones si uno de los botones del control BitPlayer es utilizado. Un botón tiene dos estados: \'presionado\' o \'liberado\'.';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TITLE'] = '[BitPlayer] valor del eje %1';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'Devuelve el valor del eje X o Y del joystick del control BitPlayer. Joystick: 2 ejes analógicos (X: P1 Y: P2).';
Blockly.Msg['ROBOTS_MAQUEEN_MIDDLE'] = 'medio';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TITLE'] = '[Maqueen Lite v5] valor del sensor de línea %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permite leer el valor del sensor seguidor de línea izquierdo, medio o derecho del robot Maqueen Lite v5.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TITLE'] = '[Maqueen Lite v5] nivel de la batería (%) tipo %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Devuelve el nivel restante de la batería (en %) del robot Maqueen Lite v5 según sea alcalina o de litio.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TITLE'] = '[Maqueen Lite v5] patrullar %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permite patrullar con el robot Maqueen Lite v5, es decir, se desplazará por el espacio y esquivará automáticamente los obstáculos gracias al sensor ultrasónico de distancia.';
...
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TITLE'] = '[uHandbit - Sensor de color] %1';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permite leer las componentes RGB (de 0 a 255) del sensor de color uHandbit conectado al puerto 4.';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TITLE'] = '[uHandbit - Sensor de color] color detectado';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permite leer el color detectado por el sensor de color uHandbit conectado al puerto 4. El color se devuelve como una cadena entre las siguientes: RED, GREEN, BLUE, BLACK, WHITE o NONE.';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TITLE'] = '[uHandbit - Sensor ultrasónico] %1 en el puerto %2';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) medida por el sensor ultrasónico del uHandbit en el puerto 1 o 2.';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TITLE'] = '[uHandbit - Servomotores] controlar el servo %1 al ángulo %2 ° duración %3 ms';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permite controlar el ángulo de un servomotor (de 0 a 180) conectado al módulo uHandbit. La duración controla la velocidad de rotación del servomotor.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TITLE'] = '[uHandbit - Neopixel] controlar el LED %1 a  R %2 G %3 B %4';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED del neopixel del módulo uHandbit (P15) de modo que los valores (R, G, B) estén entre 0 y 255.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TITLE'] = '[uHandbit - Neopixel] controlar el LED %1 a %2';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED del neopixel del módulo uHandbit (P15). Usa la paleta para cambiar el color de las LED RGB.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TITLE'] = '[uHandbit - Neopixel] Arcoíris';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Muestra el espectro de colores en las LED RGB del módulo uHandbit (P15).';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TITLE'] = '[WuKong] aplicar el modo de luz a %1';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permite aplicar un modo de iluminación en la placa WuKong.';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_BREATH'] = 'BREATH';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_OFF'] = 'OFF';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TITLE'] = '[WuKong] controlar la intensidad de luz a %1 %';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permite controlar la intensidad de luz (de 0 a 100) en la placa WuKong.';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TITLE'] = 'Blockly.Msg[\'ROBOTS_WUKONG_CONTROLMOTOR_TITLE\'] = \'[WuKong] controlar los motores %1 dirección %2 velocidad %3 %\';';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permite controlar los motores M1 y M2 cambiando la dirección (↻ : ADELANTE, ↺ : ATRÁS) y la velocidad (de 0 a 100%) de la placa WuKong.';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TITLE'] = 'Blockly.Msg[\'ROBOTS_WUKONG_STOPMOTORS_TITLE\'] = \'[WuKong] detener los motores %1\';';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permite controlar los motores M1 y M2 cambiando la dirección (↻ : ADELANTE, ↺ : ATRÁS) y la velocidad (de 0 a 100%) de la placa WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TITLE'] = 'Blockly.Msg[\'ROBOTS_WUKONG_SETSERVOANGLE_TITLE\'] = \'[WuKong %1] posicionar los servomotores %2 al ángulo %3°\';';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permite controlar los servomotores de S1 a S7 cambiando el ángulo (de 0 a 360°) de la placa WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SERVO_ALL'] = 'todos';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TITLE'] = 'Blockly.Msg[\'ROBOTS_WUKONG_SETSERVOSPEED_TITLE\'] = \'[WuKong] controlar los servomotores %1 a la velocidad %2 %\';';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permite controlar los servomotores continuos de S1 a S7 cambiando la velocidad (de -100 a 100) de la placa WuKong.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TITLE'] = '[Building:bit] controlar el LED RGB debajo %1 a R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED RGB del neopixel del robot Building:bit (P12) de modo que los valores R,G,B estén entre 0 y 255. El neopixel está conectado al pin P12 del robot.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TITLE'] = '[Building:bit] controlar el LED RGB debajo %1 a %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permite controlar el color de cada LED RGB del módulo neopixel (P12) situado bajo el robot Building:bit. Usa la paleta para cambiar el color.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TITLE'] = '[Building:bit %1] posicionar el servomotor %2 al ángulo %3°';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permite controlar los servomotores de S1 a S8 cambiando el ángulo (de 0 a 360°) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TITLE'] = '[Building:bit] controlar el motor %1 dirección %2 velocidad %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permite controlar los motores M1, M2, M3 y M4 cambiando la dirección (↻ : ADELANTE, ↺ : ATRÁS) y la velocidad (de 0 a 255) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TITLE'] = '[Building:bit] detener el motor %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permite controlar los motores M1, M2, M3 y M4 cambiando la dirección (↻ : ADELANTE, ↺ : ATRÁS) y la velocidad (de 0 a 255) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TITLE'] = '[Building:bit] controlar el motor paso a paso %1 posición %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permite controlar los motores paso a paso B1 y B2 cambiando la posición (de 0 a 360) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TITLE'] = '[Sensor ultrasónico] distancia en los pines TRIG %1 ECHO %2 ';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TOOLTIP'] = IMG_YAHBOOM_ULTRASONIC + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) medida por el sensor ultrasónico Yahboom en los pines digitales.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TITLE'] = '[Potenciómetro] valor en el pin %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TOOLTIP'] = IMG_YAHBOOM_POTENTIOMETER + Blockly.Tooltip.SEP + 'Devuelve el valor del potenciómetro Yahboom en los pines analógicos (P0 a P4 o P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TITLE'] = '[Sensor de luz] valor en el pin %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TOOLTIP'] = IMG_YAHBOOM_LIGHT_SENSOR + Blockly.Tooltip.SEP + 'Devuelve la luminosidad ambiental gracias al sensor de luz Yahboom en los pines analógicos (P0 a P4 o P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TITLE'] = '[Detector IR] ¿obstáculo detectado en el pin %1?';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TOOLTIP'] = IMG_YAHBOOM_IR_DETECTOR + Blockly.Tooltip.SEP + 'Devuelve True si se detecta un obstáculo gracias al sensor infrarrojo Yahboom en los pines digitales.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TITLE'] = '[Sensor PIR] ¿movimiento detectado en el pin %1?';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TOOLTIP'] = IMG_YAHBOOM_PIR_MOTION_SENSOR + Blockly.Tooltip.SEP + 'Devuelve True si se detecta movimiento gracias al sensor PIR Yahboom en los pines digitales.';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TITLE'] = '[DHT11] %1 en el pin %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TOOLTIP'] = IMG_YAHBOOM_DHT11 + Blockly.Tooltip.SEP + 'Devuelve la temperatura en grados Celsius (°C), Fahrenheit (°F) o Kelvin (K), o la humedad (en %) gracias al sensor dht11 Yahboom en los pines digitales P0 a P20.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TITLE'] = '[Sensor de color] nivel de %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TOOLTIP'] = IMG_YAHBOOM_COLOR_SENSOR + Blockly.Tooltip.SEP + 'Devuelve una de las componentes del color (R, G o B) de 0 a 255 gracias al sensor de color I2C Yahboom. Conecta el sensor a un puerto I2C.';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TITLE'] = '[Joystick] si dirigido hacia %1 en los pines X %2 Y %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TOOLTIP'] = IMG_YAHBOOM_JOYSTICK + Blockly.Tooltip.SEP + 'Permite ejecutar instrucciones si se cumple la dirección del joystick. Conecta el módulo a los pines analógicos (P0 a P4 o P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_UP'] = 'arriba';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_DOWN'] = 'abajo';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_LEFT'] = 'izquierda';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TITLE'] = '[HuskyLens] tabla de datos %1 del ID nº%2';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permite obtener los datos devueltos relacionados con el ID indicado por la cámara HuskyLens. Los datos recibidos están en una tabla con la forma [x1, y1, ancho, alto, id]. ';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - cambiar el parámetro %1 a %2 en los pines TXD %3 RXD %4';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Permite cambiar los parámetros del módulo Bluetooth HM10 enviando un comando AT. Una vez cambiado, no es necesario volver a ese modo porque se guarda en la memoria del módulo.';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - valor del parámetro %1 en los pines TXD %2 RXD %3';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Permite obtener el valor de los parámetros del módulo Bluetooth HM10 enviando un comando AT.';
Blockly.Msg['COMMUNICATION_UART_READLINE_TITLE'] = '[uart] leer una línea de datos';
Blockly.Msg['COMMUNICATION_UART_READLINE_TOOLTIP'] = 'Permite leer datos desde el puerto uart definido hasta que se lea \'\\n\'.';
Blockly.Msg['COMMUNICATION_I2C_INIT_TITLE'] = 'Blockly.Msg[\'COMMUNICATION_I2C_INIT_TITLE\'] = \'[i2c] Inicializar frecuencia %1 Hz en pines SDA %2 SCL %3\';';
Blockly.Msg['COMMUNICATION_I2C_INIT_TOOLTIP'] = 'Permite reiniciar la comunicación I2C en pines específicos a la frecuencia deseada (100 kHz a 400 kHz).';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TITLE'] = '[i2c] Lista de dispositivos I2C detectados';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TOOLTIP'] = 'Devuelve los dispositivos I2C detectados en los pines I2C como una lista de direcciones.';
Blockly.Msg['COMMUNICATION_I2C_REPEAT'] = '¿Repetir?';
Blockly.Msg['COMMUNICATION_I2C_READ_TITLE'] = 'Blockly.Msg[\'COMMUNICATION_I2C_READ_TITLE\'] = \'[i2c] dirección %1 leer %2 bytes\';';
Blockly.Msg['COMMUNICATION_I2C_READ_TOOLTIP'] = 'Permite leer N bytes desde la dirección I2C especificada. Puedes escribir la dirección I2C en hexadecimal en el bloque; se convertirá a un entero (0-127). El botón + controla el envío del bit de parada.';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TITLE'] = 'Blockly.Msg[\'COMMUNICATION_I2C_WRITE_TITLE\'] = \'[i2c] dirección %1 escribir %2 bytes\';';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TOOLTIP'] = 'Permite escribir un arreglo de bytes en la dirección I2C especificada. Puedes escribir la dirección I2C en hexadecimal en el bloque; se convertirá a un entero (0-127). El botón + controla el envío del bit de parada.';
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nPor defecto, los pines SPI del micro:bit son SCK: P13, MISO: P14 y MOSI: P15.';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] ID de la tarjeta en el pin NSS %1';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_RC522 + Blockly.Tooltip.SEP + 'Permite obtener el UID como cadena de caracteres del módulo RFID Joy-It RC522 por SPI si se detecta en los pines digitales.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TITLE'] = 'Blockly.Msg[\'ACTUATORS_REKABIT_RUNMOTOR_TITLE\'] = \'[Reka:bit] mover el motor %1 en la dirección %2 a la velocidad %3\';';
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Permite poner en marcha el motor M1, M2 o ambos en la placa Reka:bit estableciendo la dirección y la velocidad.';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M1'] = 'M1';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M2'] = 'M2';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_ALL'] = 'ambos';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_FORWARD'] = 'adelante';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_BACKWARD'] = 'atrás';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TITLE'] = '[Reka:bit] ajustar servo %1 a %2°';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Permite ajustar el ángulo del servo S1, S2, S3, S4 o de todos los servos conectados a la placa Reka:bit.';
...
Blockly.Msg['ACTUATORS_REKABIT_SERVO_ALL'] = 'todos';
