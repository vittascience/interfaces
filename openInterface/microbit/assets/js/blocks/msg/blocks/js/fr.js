...
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED telle que (R,G,B) de 0 à 255 du module Zip Halo LED de Kitronik.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TITLE'] = '[ZIP Halo HD] contrôler la LED %1 à %2';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED du module Zip Halo LED de Kitronik. Utiliser la palette pour changer la couleur.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TITLE'] = '[ZIP Halo HD] contrôler toutes les LED à R %1 G %2 B %3';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permet de contrôler toutes les LED du module Zip Halo LED de Kitronik à la couleur choisie telle que (R,G,B) soit de 0 à 255.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TITLE'] = '[ZIP Halo HD] contrôler toutes les LED à %1';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permet de contrôler toutes les LED du module Zip Halo LED de Kitronik à la couleur choisie. Utiliser la palette pour changer la couleur.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TITLE'] = '[ZIP Halo HD] Arc-en-ciel';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Afficher le spectre des couleurs sur les LED RGB du module Zip Halo LED de Kitronik.';
...
Blockly.Msg["IO_EXEC_TITLE"] = "exécuter le code python %1";
Blockly.Msg["IO_EXEC_TOOLTIP"] = "Exécuter du code Python.";
Blockly.Msg["IO_EXEC_HELPURL"] = "https://docs.python.org/3/library/functions.html#exec";
// Communication - Micro:bit Logs
Blockly.Msg['COMMUNICATION_LOG_DELETE_TITLE'] = '[Log] effacer le log sur la micro:bit';
Blockly.Msg['COMMUNICATION_LOG_DELETE_TOOLTIP'] = 'Efface le log (html) sur la carte micro:bit.';
Blockly.Msg['COMMUNICATION_LOG_SERIAL_TITLE'] = '[Log] obtenir un retour dans la console';
Blockly.Msg['COMMUNICATION_LOG_SERIAL_TOOLTIP'] = 'Permet d\'écrire des données du log dans la console en temps réél.';
Blockly.Msg['COMMUNICATION_LOG_SETLABEL_TITLE'] = '[Log] ajouter un nouveau label avec un Timer %1';
...
Blockly.Msg['COMMUNICATION_SERIAL_ONDATARECEIVED_TOOLTIP'] = 'Permet d\'exécuter des instructions si une donnée est reçue par le port série dans la variable \'serialData\'. Cette dernière retourne un tableau d\'octets (bytes).';
...
Blockly.Msg['COMMUNICATION_RADIO_RECEIVE_FULL_TOOLTIP'] = 'Permet d\'obtenir les détails du prochain message via la radio de la carte micro:bit. Retourne -1 s\'il n\'y a pas de message entrant.';
Blockly.Msg['COMMUNICATION_RADIO_NEXT_MESSAGE'] = 'prochaine donnée reçue';
Blockly.Msg['COMMUNICATION_RADIO_RSSI'] = 'force du signal reçu (RSSI)';
Blockly.Msg['COMMUNICATION_RADIO_TIMESTAMP'] = 'horodatage de la donnée reçue';
...
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - changer le paramètre %1 en %2 sur les broches TXD %3 RXD %4';
...
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - valeur du paramètre %1 sur les broches TXD %2 RXD %3';
...
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SENDDATA_TITLE'] = '[HM10 BT] envoyer sur les broches TXD %1 RXD %2 message %3';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Permet d\'envoyer des données via le module série Bluetooth HM10 sur les broches digitales.';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_ONDATARECEIVED_TITLE'] = '[HM10 BT] si message reçu sur les broches TXD %1 RXD %2 dans %3 alors';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Permet d\'exécuter des instructions si une donnée est reçue par un module série Bluetooth HM10 dans la variable \'HM10Data\' sur les broches digitales. Par défaut, le module s\'appelle MLT-BT05.';
// Communication - Tracking modules
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nPar défaut, les broches SPI de la carte micro:bit sont sur SCK: P13, MISO: P14 et MOSI: P15.';
...
Blockly.Msg['COMMUNICATION_UART_READLINE_TITLE'] = '[uart] lire une ligne de données';
Blockly.Msg['COMMUNICATION_UART_READLINE_TOOLTIP'] = 'Permet de lire des données depuis le port UART jusqu\'à ce que \'\\n\' soit lu.';
// Communication - I2C
Blockly.Msg['COMMUNICATION_I2C_INIT_TITLE'] = '[i2c] initialiser fréquence %1 Hz sur les broches SDA %2 SCL %3';
Blockly.Msg['COMMUNICATION_I2C_INIT_TOOLTIP'] = 'Permet de réinitialiser la communication I2C sur des broches spécifiques et à la fréquence souhaitée (100 kHz à 400 kHz).';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TITLE'] = '[i2c] liste des périphériques I2C détectés';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TOOLTIP'] = 'Retourne les périphériques I2C détectés sur les broches I2C sous forme de liste des adresses.';
Blockly.Msg['COMMUNICATION_I2C_REPEAT'] = 'à répétition ?';
Blockly.Msg['COMMUNICATION_I2C_READ_TITLE'] = '[i2c] adresse %1 lire les données de taille %2';
Blockly.Msg['COMMUNICATION_I2C_READ_TOOLTIP'] = 'Permet de lire N octets à l\'adresse I2C renseignée. Vous pouvez écrire l\'adresse I2C hexadécimale dans le bloc, elle sera convertit en entier (0 - 127). Le bouton + contrôle l\'envoie du bit d\'arrêt.';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TITLE'] = '[i2c] adresse %1 écrire les données %2';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TOOLTIP'] = 'Permet d\'écrire un tableau d\'octets à l\'adresse I2C renseignée. Vous pouvez écrire l\'adresse I2C hexadécimale dans le bloc, elle sera convertit en entier (0 - 127). Le bouton + contrôle l\'envoie du bit d\'arrêt.';
...
Blockly.Msg['SENSORS_MICRO_LOUD'] = 'fort';
Blockly.Msg['SENSORS_MICRO_QUIET'] = 'faible';
Blockly.Msg['SENSORS_MICRO_IS'] = 'est';
Blockly.Msg['SENSORS_MICRO_WAS'] = 'a été';
Blockly.Msg['SENSORS_MICRO_ONSOUNDDETECTED_TITLE'] = '[Micro] si un son %1 %2 détecté alors';
Blockly.Msg['SENSORS_MICRO_ONSOUNDDETECTED_TOOLTIP'] = 'Exécute des instructions si u1023n son (fort/faible) est détecté. Option \'was: Exécute des instructions si un son (fort/faible) s\'est produit depuis le dernier appel de la fonction \'was_sound()\'.';
Blockly.Msg['SENSORS_MICRO_GETCURRENTSOUND_TITLE'] = '[Micro] état du son';
Blockly.Msg['SENSORS_MICRO_GETCURRENTSOUND_TOOLTIP'] = 'Renvoie l\'état du son (fort/faible).';
Blockly.Msg['SENSORS_MICRO_WASSOUNDDETECTED_TITLE'] = '[Micro] son %1 a été détecté';
Blockly.Msg['SENSORS_MICRO_WASSOUNDDETECTED_TOOLTIP'] = 'Retourne \'True\' si un son (fort/faible) s\'est produit depuis le dernier appel de la fonction \'was_sound()\'.';
Blockly.Msg['SENSORS_MICRO_GETSOUNDLEVEL_TITLE'] = '[Micro] intensité du son';
Blockly.Msg['SENSORS_MICRO_GETSOUNDLEVEL_TOOLTIP'] = 'Permet d\'obtenir l\'intensité du son.';
Blockly.Msg['SENSORS_MICRO_GETHISTORYSOUND_TITLE'] = '[Micro] historique des sons';
Blockly.Msg['SENSORS_MICRO_GETHISTORYSOUND_TOOLTIP'] = 'Renvoie l\'historique des sons depuis le dernier appel de la fonction \'get_sounds()\'.';
Blockly.Msg['SENSORS_MICRO_SETSOUNDTHRESHOLD_TITLE'] = '[Micro] définir le seuil des sons %1 à %2';
Blockly.Msg['SENSORS_MICRO_SETSOUNDTHRESHOLD_TOOLTIP'] = 'Permet de définir un seuil du niveau sonore des sons forts/faibles de 0 à 255.';
Blockly.Msg['SENSORS_MICRO_SOUNDCONDITION_TITLE'] = '[Micro] %1';
Blockly.Msg['SENSORS_MICRO_SOUNDCONDITION_TOOLTIP'] = 'Permet d\'utiliser les constantes (LOUD/QUIET) de la librairie microphone dans les blocs de la catégorie \'Logique\'';
// Sensors - Enviro:bit
...
Blockly.Msg['SENSORS_BAROMETER_READDATA_TOOLTIP'] = IMG_MODULE_HP206C + Blockly.Tooltip.SEP + 'Renvoie la température en degré Celsius (°C), Fahrenheit (°F) ou Kelvin (K), la pression (en hPa) ou l\'altitude (en m) grâce au baromètre. Brancher le capteur sur un port I2C.';
...
Blockly.Msg['SENSORS_SUNLIGHT_GETDATA_TOOLTIP'] = IMG_MODULE_SI1145 + Blockly.Tooltip.SEP + 'Renvoie l\'indice de lumière ultraviolette, la luminosité visible (en lumen) ou infrarouge (en lumen) grâce au capteur Grove Sunlight V1 (SI1145 - 0X60) ou V2 (SI1151 - 0X53), le capteur GY1145 ou le capteur SI1145 d\'Adafruit. Brancher le capteur sur un port I2C.';
...
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TITLE'] = '[Capteur de couleurs v3] %1';
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TOOLTIP'] = IMG_MODULE_I2C_COLOR_V3 + Blockly.Tooltip.SEP + 'Permet de lire le niveau d\'une des trois couleurs primaires (rouge, vert, bleu), de la luminosité (~ de 0 à 10 000K) ou de la température (~ de 0 à 100 000 Lux) avec le capteur de couleur Grove v3. Celui-ci permet aussi lire la couleur au format HSV (teinte : 0 à 360°, saturation 0 à 100%, valeur 0 à 100%) et de récupérer le nom de la couleur associée. Brancher le capteur sur un port I2C.';
Blockly.Msg['COLOR_HUE'] = 'teinte (°)';
Blockly.Msg['COLOR_SATURATION'] = 'saturation (%)';
Blockly.Msg['COLOR_VALUE'] = 'valeur (%)';
Blockly.Msg['COLOR_LEVEL_WHITE'] = 'niveau de blanc';
Blockly.Msg['COLOR_LEVEL_TEMP'] = 'température';
Blockly.Msg['COLOR_NAME'] = 'nom de la couleur';
...
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TITLE'] = '[Capteur de mouvement mini] état sur la broche %1';
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TOOLTIP'] = IMG_MODULE_MOTION_MINI + Blockly.Tooltip.SEP + 'Renvoie vrai ou faux selon si le capteur Grove PIR Motion mini détecte un mouvement sur les broches digitales P0 à P20.';
...
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TITLE'] = '[Moteur pas à pas] initialiser le moteur %1 sur IN1 %2 IN2 %3 IN3 %4 IN4 %5';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Initialise le moteur pas à pas 28BYJ-48 avec le driver ULN2003 sur les broches digitales P0 à P20.';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TITLE'] = '[Moteur pas à pas] moteur %1 tourner de %2 %3 direction %4';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_STEPS'] = 'pas';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_ROTATIONS'] = 'tour(s)';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Fait tourner le moteur pas à pas 28BYJ-48 d\'un nombre de pas ou de tours dans le sens horaire (↻) ou antihoraire (↺).';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TITLE'] = '[Moteur pas à pas] moteur %1 delai entre chaque pas à %2 ms';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Permet de régler la vitesse de rotation du moteur pas à pas 28BYJ-48 en modifiant le délai entre chaque pas (en ms). Plus le délai est grand, plus la vitesse est lente. Le délai par défaut est de 3 ms et ne peut pas être réduit.';
// actuators - Kitronik
...
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TITLE'] = '[Reka:Bit] faire tourner le moteur %1 direction %2 vitesse %3';
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Permet de faire tourner le moteur M1, M2 ou les deux sur le shield Reka:bit en définissant le sens et la vitesse.';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M1'] = 'M1';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M2'] = 'M2';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_ALL'] = 'les deux';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_FORWARD'] = 'avant';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_BACKWARD'] = 'arrière';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TITLE'] = '[Reka:Bit] positionner le servo %1 à %2 °';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Permet de définir l\'angle du servo S1, S2, S3, S4 ou de tous les servos connectés au shield Reka:bit.';
...
Blockly.Msg['ACTUATORS_REKABIT_SERVO_ALL'] = 'tous';
// actuators - music
...
Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'] = '\n.\nCliquer sur le bouton 🞧 si vous souhaitez bloquer ou non le programme durant l\'exécution de la commande.';
...
Blockly.Msg['ROBOTS_MAQUEEN_MIDDLE'] = 'millieu';
Blockly.Msg['ROBOTS_MAQUEEN_RIGHT&LEFT'] = 'droit & gauche';
Blockly.Msg['ROBOTS_MAQUEEN_ULTRASONICRANGER_TITLE'] = '[Maqueen Lite] %1';
Blockly.Msg['ROBOTS_MAQUEEN_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Renvoie la distance (en cm) ou la durée de l\'aller-retour (en μs) de l\'onde entre un object et le robot Maqueen Lite grâce au capteur à ultrasons.';
...
Blockly.Msg['ROBOTS_MAQUEEN_READPATROL_TITLE'] = '[Maqueen Lite] état du capteur de ligne %1';
Blockly.Msg['ROBOTS_MAQUEEN_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de lire l\'état du capteur suiveur de ligne gauche ou droit du robot Maqueen Lite. Le bloc renvoit 0 si le capteur se trouve au dessus de la ligne.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TITLE'] = '[Maqueen Lite v5] valeur du capteur de ligne %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de lire la valeur du capteur suiveur de ligne gauche, milieu ou droit du robot Maqueen Lite v5.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TITLE'] = '[Maqueen Lite v5] niveau de la batterie (%) type %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Retourne le niveau restant de la batterie (en %) du robot Maqueen Lite v5 selon qu\'elle soit Alkaline ou au Lithium.';
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLLED_TITLE'] = '[Maqueen Lite] contrôler la LED rouge avant %1 état %2';
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLLED_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de contrôler l\'état de la LED gauche (P8) ou droite (P12) du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_GO_TITLE'] = '[Maqueen Lite] %1 à la vitesse %2';
Blockly.Msg['ROBOTS_MAQUEEN_GO_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de contrôler la marche (AVANT/ARRIERE) ainsi que la vitesse (de 0 à 255) du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLMOTOR_TITLE'] = '[Maqueen Lite] contrôler le moteur %1 direction %2 vitesse %3';
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs droit (adresse I2C: 0x02) et gauche (adresse I2C: 0x00) en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 255) du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_ROTATE_TITLE'] = '[Maqueen Lite] pivoter %1 vitesse %2';
Blockly.Msg['ROBOTS_MAQUEEN_ROTATE_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs droit (adresse I2C: 0x02) et gauche (adresse I2C: 0x00) en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 255) du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_STOPMOTORS_TITLE'] = '[Maqueen Lite] arrêter le moteur %1';
Blockly.Msg['ROBOTS_MAQUEEN_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet d\'arrêter le moteur droit ou gauche du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_SETSERVOANGLE_TITLE'] = '[Maqueen Lite] positionner le servomoteur %1 à l\'angle %2 °';
Blockly.Msg['ROBOTS_MAQUEEN_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de contrôler les servomoteurs S1 (adresse I2C: 0x14) and S2 (adresse I2C: 0x15) en changeant l\'angle (de 0 à 180) du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_S1'] = 'S1';
Blockly.Msg['ROBOTS_MAQUEEN_S2'] = 'S2';
Blockly.Msg['ROBOTS_MAQUEEN_SERVO_BOTH'] = 'les deux';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TITLE'] = '[Maqueen Lite v5] patrouiller %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de patrouiller avec le robot Maqueen Lite v5, c\'est à dire qu\'il va se déplacer dans l\'espace et esquiver automatiquement les obstacles grâce au capteur de distance à ultrasons.';
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Maqueen Lite] avancer d\'une case';
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Avance le robot Maqueen Lite d\'une case.';
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Maqueen Lite] reculer d\'une case';
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Recule le robot Maqueen Lite d\'une case.';
Blockly.Msg['ROBOTS_MAQUEEN_TURN_LEFT_TITLE'] = '[Maqueen Lite] pivoter à gauche';
Blockly.Msg['ROBOTS_MAQUEEN_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Pivote le robot Maqueen Lite de 90° vers la gauche.';
Blockly.Msg['ROBOTS_MAQUEEN_TURN_RIGHT_TITLE'] = '[Maqueen Lite] pivoter à droite';
Blockly.Msg['ROBOTS_MAQUEEN_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Pivote le robot Maqueen Lite de 90° vers la droite.';
Blockly.Msg['ROBOTS_MAQUEEN_STOP_ROBOT_TITLE'] = '[Maqueen Lite] arrêter le robot';
Blockly.Msg['ROBOTS_MAQUEEN_STOP_ROBOT_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Arrête les moteurs du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_BLINK_ROBOT_TITLE'] = '[Maqueen Lite] clignoter le robot';
Blockly.Msg['ROBOTS_MAQUEEN_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Fait clignoter le robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_SETNEOPIXEL_TITLE'] = '[Maqueen Lite] contrôler la LED RGB en dessous %1 à R %2 G %3 B %4';
Blockly.Msg['ROBOTS_MAQUEEN_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED RGB du neopixel du robot Maqueen Lite (P15) tel que les valeurs R,G,B soient comprises entre 0 et 255. Le neopixel est connecté à la broche P15 sur le robot.';
Blockly.Msg['ROBOTS_MAQUEEN_SETPALETTECOLOR_TITLE'] = '[Maqueen Lite] contrôler la LED RGB en dessous %1 à %2';
Blockly.Msg['ROBOTS_MAQUEEN_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED RGB du module neopixel (P15) situé sous le robot Maqueen Lite. Utiliser la palette pour changer la couleur.';
Blockly.Msg['ROBOTS_MAQUEEN_SETRAINBOW_TITLE'] = '[Maqueen Lite] Arc-en-ciel';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETBUZZER_TITLE'] = '[Maqueen Lite] contrôler le buzzer à la fréquence %1 pendant %2 (ms)';
Blockly.Msg['ROBOTS_MAQUEEN_SETBUZZER_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de définir une fréquence sur le buzzer du robot Maqueen Lite (P0).';
Blockly.Msg['ROBOTS_MAQUEEN_PLAYMUSIC_TITLE'] = '[Maqueen Lite] jouer la musique %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLAYMUSIC_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Permet de jouer une musique avec le buzzer du robot Maqueen Lite connecté à la broche (P0).';
Blockly.Msg['ROBOTS_MAQUEEN_DECODEIRRECEIVER_TITLE'] = '[Maqueen Lite] decoder le récepteur infrarouge';
Blockly.Msg['ROBOTS_MAQUEEN_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Effectue une lecture du récepteur infrarouge (P16) du robot Maqueen Lite.';
Blockly.Msg['ROBOTS_MAQUEEN_GETIRCODE_TITLE'] = '[Maqueen Lite] code reçu du récepteur infrarouge';
Blockly.Msg['ROBOTS_MAQUEEN_GETIRCODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Renvoie le code hexadecimal reçu avec le détecteur infrarouge (P16) du robot Maqueen Lite.';
// Robots - Maqueen Plus - Detection
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ULTRASONICRANGER_TRIG_ECHO_TITLE'] = '[Maqueen Plus %1] %2 TRIG %3 ECHO %4';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ULTRASONICRANGER_TRIG_ECHO_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Renvoie la distance (en cm) ou la durée de l\'aller-retour (en μs) de l\'onde entre un object et le robot MaqueenPlus grâce au capteur à ultrasons branché sur les broches digitales indiquées.';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_READPATROL_TITLE'] = '[Maqueen Plus %1] état du capteur de ligne';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet de lire l\'état d\'un des capteurs suiveur de ligne du robot MaqueenPlus. Le bloc renvoit 1 si le capteur se trouve au dessus de la ligne.';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READLIGHTINTENSITY_TITLE'] = '[Maqueen Plus v3] intensité lumineuse à %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READLIGHTINTENSITY_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Retourne l\'intensité lumineuse des capteurs de lumière gauche ou droite à l\'avant du robot Maqueen Plus V3.';
// Robots - Maqueen Plus - Moving
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GO_TITLE'] = '[Maqueen Plus %1] %2 à la vitesse %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GO_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet de contrôler la marche (AVANT/ARRIERE) ainsi que la vitesse (de 0 à 255) du robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ROTATE_TITLE'] = '[Maqueen Plus %1] pivoter %2 vitesse %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ROTATE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs droit et gauche en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 255) du robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLMOTOR_TITLE'] = '[Maqueen Plus %1] contrôler le moteur %2 direction %3 vitesse %4';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs droit et gauche en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 255) du robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_STOPMOTORS_TITLE'] = '[Maqueen Plus %1] arrêter le moteur %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet d\'arrêter le moteur droit ou gauche du robot MaqueenPlus.';
// Robots - Maqueen Plus - Control
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLLED_TITLE'] = '[Maqueen Plus %1] contrôler la LED rouge avant %2 état %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLLED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet de contrôler l\'état de la LED gauche ou droite du robot MaqueenPlus.';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETRGBLED_TITLE'] = '[Maqueen Plus v3] contrôler la LED RGB avant %1 couleur %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETRGBLED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de la LED gauche ou droite du robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETBUZZER_TITLE'] = '[Maqueen Plus %1] contrôler le buzzer à la fréquence %2 pendant %3 (ms)';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETBUZZER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet de définir une fréquence sur le buzzer du robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETSERVOANGLE_TITLE'] = '[Maqueen Plus %1] positionner le servomoteur %2 à l\'angle %3 °';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Permet de contrôler les servomoteurs P0, P1, P2 en changeant l\'angle (de 0 à 180) du robot MaqueenPlus V1.';
// Robots - Maqueen Plus (V2 & V3) - LED RGB
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_BLINK_ROBOT_TITLE'] = '[Maqueen Plus %1] clignoter le robot';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETNEOPIXEL_TITLE'] = '[Maqueen Plus %1] contrôler la LED RGB en dessous %2 à R %3 G %4 B %5';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETPALETTECOLOR_TITLE'] = '[Maqueen Plus %1] contrôler la LED RGB en dessous %2 à %3';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETRAINBOW_TITLE'] = '[Maqueen Plus %1] Arc-en-ciel';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_DECODEIRRECEIVER_TITLE'] = '[Maqueen Plus] décoder le récepteur infrarouge';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Effectue une lecture du récepteur infrarouge du robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GETIRCODE_TITLE'] = '[Maqueen Plus] code reçu du récepteur infrarouge';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GETIRCODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V1 + Blockly.Tooltip.SEP + 'Renvoie le code hexadecimal reçu avec le détecteur infrarouge du robot MaqueenPlus.';
// Robots - Maqueen Plus (V3) - Line Finder
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLSPEED_TITLE'] = '[Maqueen Plus v3] changer la vitesse du suiveur à %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLSPEED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet de contrôler la vitesse du suiveur de ligne du robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STRAIGHT'] = 'avancer tout droit';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_LEFT'] = 'tourner à gauche';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_RIGHT'] = 'tourner à droite';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STOP'] = 's\'arrêter';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETINTERSECTIONRUNMODE_TITLE'] = '[Maqueen Plus v3] aux %1, ';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETINTERSECTIONRUNMODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet de changer le comportement du robot Maqueen Plus V3 lorsque celui-ci se trouve face à un carrefour ou à un croisement en T.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_T'] = 'intersections en T';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_CROSSROADS'] = 'carrefours';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETLEFTORRIGHTINTERSECTIONRUNMODE_TITLE'] = '[Maqueen Plus v3] aux intersections à %1, ';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETLEFTORRIGHTINTERSECTIONRUNMODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet de changer le comportement du robot Maqueen Plus V3 lorsque celui-ci se trouve face à une intersection en T.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_LEFT'] = "gauche";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTION_RIGHT'] = "droite";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLLINGSTATE_TITLE'] = '[Maqueen Plus v3] %1 le suiveur de ligne';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_SETPATROLLINGSTATE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet de démarrer ou arrêter le suivi de ligne avec le robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_PATROL_ON'] = 'démarrer';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_PATROL_OFF'] = 'arrêter';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTED_TITLE'] = '[Maqueen Plus v3] intersection détectée';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Retourne l\'intersection détectée (1: carrefours, 2: intersection en T, 3: intersection à gauche, 4: intersection à droite) avec le robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTEDIS_TITLE'] = '[Maqueen Plus v3] intersection détectée est %1 ?';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_INTERSECTIONDETECTEDIS_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Retourne \'True\' si l\'intersection détectée est vérifiée (1: carrefours, 2: intersection en T, 3: intersection à gauche, 4: intersection à droite) avec le robot Maqueen Plus V3.';
// Robots - Maqueen Plus (V3) - PID
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_RUNDISTANCE_TITLE'] = '[Maqueen Plus v3] %1 de %2 %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_RUNDISTANCE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet de parcourir une certaine distance (en cm) ou (en inch) en marche AVANT ou ARRIERE en utilisant le régulateur PID du robot Maqueen Plus V3.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURNWITHANGLE_TITLE'] = '[Maqueen Plus v3] tourner à %1 de %2 °';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURNWITHANGLE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet de tourner le robot Maqueen Plus V3 à gauche ou à droite d\'un certain angle (en °) en utilisant le régulateur PID.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_RIGHT'] = 'droite';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_TURN_LEFT'] = 'gauche';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READREALTIMESPEED_TITLE'] = '[Maqueen Plus v3] vitesse du moteur %1 en %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_READREALTIMESPEED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Retourne la vitesse (en cm/s) ou (en inch/s) du robot Maqueen Plus V3.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STOPPID_TITLE'] = '[Maqueen Plus v3] arrêter le contrôle PID en cours';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V3_STOPPID_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V3 + Blockly.Tooltip.SEP + 'Permet d\'arrêter le contrôle du régulateur PID en cours sur le robot Maqueen Plus V3. Cette fonction est valable seulement si l\'exécution des commandes PID n\'est pas en attente.';
// Robots - Maqieen Plus (V3) - Lidar
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TITLE'] = '[LiDAR %1] configurer la taille: %2';
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Permet de configurer la taille de la matrice (8x8 ou 4x4) des mesures du capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_CONFIG_8X8_MATRIX'] = 'Matrice 8x8';
Blockly.Msg['SENSORS_LIDAR_CONFIG_4X4_MATRIX'] = 'Matrice 4x4';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TITLE'] = '[LiDAR %1] lire la %2';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Permet de lire toutes les données mesurées avec le capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_DATA_DISTANCES_MATRIX'] = 'matrice des distances (en mm)';
Blockly.Msg['SENSORS_LIDAR_DATA_RAW_LIST'] = 'liste des données brutes';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TITLE'] = '[LiDAR %1] distance mesurée au point x %2 y %3';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Retourne la distance (en mm) en un point précis de la matrice (4x4 ou 8x8) mesurée avec le capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TITLE'] = '[LiDAR %1] configurer la distance d\'évitement à %2 (cm)';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Permet de configurer la distance d\'évitement de l\'obstacle de 10 à 50 cm avec le capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3. Le capteur activera le signal d\'urgence et fournira la direction à suivre pour éviter l\'obtsacle en se basant sur cette distance.';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TITLE'] = '[LiDAR %1] signal d\'urgence activé ?';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Retourne \'True\' si le signal d\'urgence a été activé avec le capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3. Le signal s\'active lorsque la distance d\'évitement a été dépassée.';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TITLE'] = '[LiDAR %1] direction à suivre pour éviter l\'obstacle';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Retourne la direction à suivre pour éviter l\'obstacle avec le capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3. Les directions suggérées correspondent à 1 (vers la gauche), 2 (vers la droite), 3 (tout droit).';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TITLE'] = '[LiDAR %1] direction à suivre est %2';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Retourne \'True\' si la direction à suivre pour éviter l\'obstacle est vérifiée avec le capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_LEFT'] = 'à gauche';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_RIGHT'] = 'à droite';
Blockly.Msg['SENSORS_LIDAR_DIR_FORWARD'] = 'tout droit';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TITLE'] = '[LiDAR %1] distance (en cm) de l\'obstacle %2';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Retourne la distance (en cm) par rapport à un obstacle situé à DROITE, à GAUCHE ou au MILIEU mesurée avec le capteur de distance LiDAR de DFRobot branché sur le robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_DIR_LEFT'] = 'à gauche';
Blockly.Msg['SENSORS_LIDAR_DIR_MIDDLE'] = 'au milieu';
Blockly.Msg['SENSORS_LIDAR_DIR_RIGHT'] = 'à droite';
// Robots - Cutebot
...
Blockly.Msg['ROBOTS_CUTEBOT_GO_TITLE'] = '[Cutebot] %1 à la vitesse %2 %';
...
Blockly.Msg['ROBOTS_CUTEBOTPRO_RUNDISTANCE_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Permet de parcourir une certaine distance (en cm) ou (en inch) en marche AVANT ou ARRIERE avec le robot Cutebot Pro.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
Blockly.Msg['ROBOTS_CUTEBOTPRO_TURNWITHANGLE_TITLE'] = '[Cutebot Pro] tourner à %1 de %2 °';
Blockly.Msg['ROBOTS_CUTEBOTPRO_TURNWITHANGLE_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Permet de tourner le robot Cutebot Pro à gauche ou à droite d\'un certain angle (en °).' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
...
Blockly.Msg['ROBOTS_CUTEBOTPRO_PLACEWITHANGLE_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Permet de tourner le robot Cutebot Pro à gauche ou à droite à une position angulaire (en °).' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
...
Blockly.Msg['ROBOTS_CUTEBOTPRO_TURNWHEEL_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Permet de tourner les roues droite et/ou gauche d\'un certain angle (en °) ou (en Tr) du robot Cutebot Pro. 1 Tr correspond à 360 °, soit un tour complet de la roue.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
...
Blockly.Msg['ROBOTS_KITROBOT_GO_TITLE'] = '[Kit:robot v2] %1 à la vitesse %2 %';
...
// Robots - Codo
Blockly.Msg['ROBOTS_CODO_GO_TITLE'] = '[Codo] %1 à la vitesse %2';
...
Blockly.Msg['ROBOTS_OOBYBOT_GO_TITLE'] = '[Oobybot] %1 à la vitesse %2%';
...
// Robots - Buggy
Blockly.Msg['ROBOTS_BUGGY_GO_TITLE'] = '[Buggy] %1 à la vitesse %2';
...
Blockly.Msg['ROBOTS_BITBOT_GO_TITLE'] = '[Bit:Bot] %1 à la vitesse %2';
...
Blockly.Msg['ROBOTS_BITCAR_GO_TITLE'] = '[BitCar] %1 à la vitesse %2 %';
...
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs droit et gauche en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 100) du robot BitCar.';
...
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Fait clignoter le robot BitCar.';
...
// Robots - uHandbit
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TITLE'] = '[uHandbit - Capteur de couleurs] %1';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permet de lire les composantes RGB (de 0 à 255) du capteur de couleur uHandbit connecté sur le port 4.';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TITLE'] = '[uHandbit - Capteur de couleurs] couleur détectée';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permet de lire la couleur détectée par le capteur de couleur uHandbit connecté sur le port 4. La couleur est retournée sous forme d\'une chaîne de caractères parmi les suivantes : RED, GREEN, BLUE, BLACK, WHITE ou NONE.';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TITLE'] = '[uHandbit - Capteur à ultrasons] %1 sur le port %2';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Renvoie la distance (en cm) mesurée grâce au capteur à ultrasons du uHandbit sur le port 1 ou 2.';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TITLE'] = '[uHandbit - Servomoteurs] contrôler le servo %1 à l\'angle à %2 ° durée %3 ms';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permet de contrôler l\'angle d\'un servomoteur (de 0 à 180) branché sur le module uHandbit. La durée permet de contrôler la vitesse de rotation du servomoteur.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TITLE'] = '[uHandbit - Neopixel] contrôler la LED %1 à  R %2 G %3 B %4';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED du neopixel du module uHandbit (P15) tel que les valeurs (R, G, B) soient comprises entre 0 et 255.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TITLE'] = '[uHandbit - Neopixel] contrôler la LED %1 à %2';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED du module neopixel du module uHandbit (P15). Utiliser la palette pour changer la couleur des LED RGB.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TITLE'] = '[uHandbit - Neopixel] Arc-en-ciel';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Afficher le spectre des couleurs sur les LED RGB du module uHandbit (P15).';
// Robots - WuKong
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TITLE'] = '[WuKong] appliquer le mode lumineux à %1';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permet d\'appliquer un mode lumineux sur la carte WuKong.';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_BREATH'] = 'BREATH';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_OFF'] = 'OFF';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TITLE'] = '[WuKong] contrôler l\'intensité lumineuse à %1 %';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permet de contrôler l\'intensité lumineuse (de 0 à 100) sur la carte WuKong.';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TITLE'] = '[WuKong] contrôler le.s moteur.s %1 direction %2 vitesse %3 %';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs M1 et M2 en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 100%) de la carte WuKong.';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TITLE'] = '[WuKong] arrêter le.s moteur.s %1';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs M1 et M2 en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 100%) de la carte WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TITLE'] = '[WuKong %1] positionner le.s servomoteur.s %2 à l\'angle %3°';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permet de contrôler les servomoteurs de S1 à S7 en changeant l\'angle (de 0 à 360°) de la carte WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SERVO_ALL'] = 'tous';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TITLE'] = '[WuKong] contrôler le.s servomoteur.s %1 à la vitesse %2 %';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Permet de contrôler les servomoteurs continus de S1 à S7 en changeant la vitesse (de -100 à 100) de la carte WuKong.';
// Robots - Building:bit - Basic
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TITLE'] = '[Building:bit] contrôler la LED RGB en dessous %1 à R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED RGB du neopixel du robot Building:bit (P12) tel que les valeurs R,G,B soient comprises entre 0 et 255. Le neopixel est connecté à la broche P12 sur le robot.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TITLE'] = '[Building:bit] contrôler la LED RGB en dessous %1 à %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permet de contrôler la couleur de chaque LED RGB du module neopixel (P12) situé sous le robot Building:bit. Utiliser la palette pour changer la couleur.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TITLE'] = '[Building:bit %1] positionner le servomoteur %2 à l\'angle %3°';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permet de contrôler les servomoteurs de S1 à S8 en changeant l\'angle (de 0 à 360°) du robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TITLE'] = '[Building:bit] contrôler le moteur %1 direction %2 vitesse %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs M1, M2, M3 et M4 en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 255) du robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TITLE'] = '[Building:bit] arrêter le moteur %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs M1, M2, M3 et M4 en changeant la direction (↻ : AVANT, ↺ : ARRIERE) et la vitesse (de 0 à 255) du robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TITLE'] = '[Building:bit] contrôler le moteur pas à pas %1 position %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Permet de contrôler les moteurs pas à pas B1 et B2 en changeant la position (de 0 à 360) du robot Building:bit.';
// Robots - Building:bit - Sensors
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TITLE'] = '[Cap. à ultrasons] distance sur les broches TRIG %1 ECHO %2 ';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TOOLTIP'] = IMG_YAHBOOM_ULTRASONIC + Blockly.Tooltip.SEP + 'Renvoie la distance (en cm) mesurée grâce au capteur à ultrasons Yahboom sur les broches digitales.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TITLE'] = '[Potentiomètre] valeur sur la broche %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TOOLTIP'] = IMG_YAHBOOM_POTENTIOMETER + Blockly.Tooltip.SEP + 'Renvoie la valeur du potentiomètre Yahboom sur les broches analogiques (P0 à P4 ou P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TITLE'] = '[Cap. de lumière] valeur sur la broche %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TOOLTIP'] = IMG_YAHBOOM_LIGHT_SENSOR + Blockly.Tooltip.SEP + 'Renvoie la luminosité ambiante grâce au capteur de lumière Yahboom sur les broches analogiques (P0 à P4 ou P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TITLE'] = '[Détecteur IR] obstacle détecté sur la broche %1 ?';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TOOLTIP'] = IMG_YAHBOOM_IR_DETECTOR + Blockly.Tooltip.SEP + 'Renvoie True si un obstacle est détecté grâce au capteur infrarouge Yahboom sur les broches digitales.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TITLE'] = '[Capteur PIR] mouvement détecté sur la broche %1 ?';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TOOLTIP'] = IMG_YAHBOOM_PIR_MOTION_SENSOR + Blockly.Tooltip.SEP + 'Renvoie True si un movement est détecté grâce au capteur PIR Yahboom sur les broches digitales.';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TITLE'] = '[DHT11] %1 sur la broche %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TOOLTIP'] = IMG_YAHBOOM_DHT11 + Blockly.Tooltip.SEP + 'Renvoie la température en degré Celsius (°C), Fahrenheit (°F) ou Kelvin (K), ou l\'humidité (en %) grâce au capteur dht11 Yahboom sur les broches digitales P0 à P20.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TITLE'] = '[Capteur de couleur] niveau de %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TOOLTIP'] = IMG_YAHBOOM_COLOR_SENSOR + Blockly.Tooltip.SEP + 'Renvoie l\'une des composantes de la couleur (R, G ou B) de 0 à 255 grâce au capteur de couleur I2C Yahboom. Brancher le capteur sur un port I2C.';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TITLE'] = '[Joystick] si dirigé vers %1 sur les broches X %2 Y %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TOOLTIP'] = IMG_YAHBOOM_JOYSTICK + Blockly.Tooltip.SEP + 'Permet d\'exécuter des instructions si la direction du joystick est vérifiée. Brancher le module sur les broches analogiques (P0 à P4 ou P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_UP'] = 'haut';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_DOWN'] = 'bas';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_RIGHT'] = 'droite';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_LEFT'] = 'gauche';
// Drone - Tello
