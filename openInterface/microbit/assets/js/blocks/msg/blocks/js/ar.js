...
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'يتيح التحكم في لون كل LED مثل (R,G,B) من 0 إلى 255 على وحدة Kitronik Zip Halo LED.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TITLE'] = '[ZIP Halo HD] التحكم في LED %1 باللون %2';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'يتيح التحكم في لون كل LED على وحدة Kitronik Zip Halo LED. استخدم لوحة الألوان لتغيير اللون.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TITLE'] = '[ZIP Halo HD] التحكم في جميع LED باللون R %1 G %2 B %3';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'يتيح التحكم في جميع LED على وحدة Kitronik Zip Halo LED باللون المختار مثل (R,G,B) من 0 إلى 255.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TITLE'] = '[ZIP Halo HD] التحكم في جميع LED باللون %1';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'يتيح التحكم في جميع LED على وحدة Kitronik Zip Halo LED باللون المختار. استخدم لوحة الألوان لتغيير اللون.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TITLE'] = '[ZIP Halo HD] قوس قزح';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'يعرض طيف الألوان على LED RGB لوحدة Kitronik Zip Halo LED.';
...
Blockly.Msg["IO_EXEC_TITLE"] = "تنفيذ كود بايثون %1";
Blockly.Msg["IO_EXEC_TOOLTIP"] = "يقوم بتنفيذ كود بايثون.";
...
Blockly.Msg['COMMUNICATION_RADIO_RECEIVE_FULL_TITLE'] = '[راديو] %1';
Blockly.Msg['COMMUNICATION_RADIO_RECEIVE_FULL_TOOLTIP'] = 'يتيح لك الحصول على تفاصيل الرسالة التالية عبر راديو micro:bit. يُرجع -1 إذا لم يكن هناك رسالة واردة.';
Blockly.Msg['COMMUNICATION_RADIO_NEXT_MESSAGE'] = 'البيانات المستلمة التالية';
Blockly.Msg['COMMUNICATION_RADIO_RSSI'] = 'قوة الإشارة المستلمة (RSSI)';
Blockly.Msg['COMMUNICATION_RADIO_TIMESTAMP'] = 'الطابع الزمني للبيانات المستلمة';
...
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TITLE'] = '[مستشعر الألوان v3] %1';
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TOOLTIP'] = IMG_MODULE_I2C_COLOR_V3 + Blockly.Tooltip.SEP + 'يتيح قراءة مستوى أحد الألوان الأساسية الثلاثة (أحمر، أخضر، أزرق)، السطوع (~ من 0 إلى 10000 كلفن) أو درجة الحرارة (~ من 0 إلى 100000 لوكس) باستخدام مستشعر الألوان Grove v3. كما يتيح قراءة اللون بتنسيق HSV (درجة اللون: 0 إلى 360°، التشبع: 0 إلى 100%، القيمة: 0 إلى 100%) واسترجاع اسم اللون المرتبط. قم بتوصيل المستشعر بمنفذ I2C.';
Blockly.Msg['COLOR_HUE'] = 'درجة اللون (°)';
Blockly.Msg['COLOR_SATURATION'] = 'التشبع (%)';
Blockly.Msg['COLOR_VALUE'] = 'القيمة (%)';
Blockly.Msg['COLOR_LEVEL_WHITE'] = 'مستوى اللون الأبيض';
Blockly.Msg['COLOR_LEVEL_TEMP'] = 'درجة الحرارة';
Blockly.Msg['COLOR_NAME'] = 'اسم اللون';
...
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TITLE'] = '[مستشعر الحركة الصغير] الحالة على المنفذ %1';
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TOOLTIP'] = IMG_MODULE_MOTION_MINI + Blockly.Tooltip.SEP + 'يعيد "صحيح" أو "خطأ" حسب ما إذا كان مستشعر Grove PIR Motion mini يكتشف حركة على المنافذ الرقمية من P0 إلى P20.';
...
Blockly.Msg['ROBOTS_GO_FORWARD'] = 'التقدم';
Blockly.Msg['ROBOTS_GO_BACKWARD'] = 'الرجوع';
...
Blockly.Msg['SENSORS_BAROMETER_READDATA_TOOLTIP'] = IMG_MODULE_HP206C + Blockly.Tooltip.SEP + 'يعيد درجة الحرارة بوحدة مئوية (°C)، فهرنهايت (°F) أو كلفن (K)، أو الضغط (بـ hPa)، أو الارتفاع (بالمتر) باستخدام مقياس الضغط. يجب توصيل المستشعر بمنفذ I2C.';
...
Blockly.Msg['ROBOTS_KITROBOT_RIGHT'] = 'يمين';
Blockly.Msg['ROBOTS_KITROBOT_LEFT'] = 'يسار';
Blockly.Msg['ROBOTS_KITROBOT_RIGHT&LEFT'] = 'يمين & يسار';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONICRANGER_TITLE'] = '[Kit:robot v2] %1';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يرجع المسافة (بـ سم) أو مدة الذهاب والعودة (بـ ميكروثانية) للموجة بين جسم والروبوت Kit:robot v2 بفضل مستشعر الموجات فوق الصوتية.';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONIC_DISTANCE'] = 'المسافة (سم)';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONIC_DURATION'] = 'مدة الذهاب والعودة (ميكروثانية)';
Blockly.Msg['ROBOTS_KITROBOT_GO_TITLE'] = '[Kit:robot v2] التحكم في الروبوت %1 السرعة %2 %';
Blockly.Msg['ROBOTS_KITROBOT_GO_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بالتحكم في الحركة (أمام/خلف) وكذلك السرعة (من 0 إلى 100%) للروبوت Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_CONTROLMOTOR_TITLE'] = '[Kit:robot v2] التحكم في المحرك %1 الاتجاه %2 السرعة %3 %';
Blockly.Msg['ROBOTS_KITROBOT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بالتحكم في المحركات اليمنى واليسرى عن طريق تغيير الاتجاه (↻ : أمام، ↺ : خلف) والسرعة (من 0 إلى 100%) للروبوت Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_ROTATE_TITLE'] = '[Kit:robot v2] التدوير %1 السرعة %2 %';
Blockly.Msg['ROBOTS_KITROBOT_ROTATE_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بالتحكم في المحركات اليمنى واليسرى عن طريق تغيير الاتجاه (↻ : أمام، ↺ : خلف) والسرعة (من 0 إلى 100%) للروبوت Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_STOPMOTORS_TITLE'] = '[Kit:robot v2] إيقاف المحرك %1';
Blockly.Msg['ROBOTS_KITROBOT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بإيقاف المحرك الأيمن أو الأيسر للروبوت Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_SERVO_BOTH'] = 'كلاهما';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Kit:robot v2] التقدم بمربع واحد';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يدفع الروبوت Kit:robot v2 بمربع واحد.';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Kit:robot v2] الرجوع بمربع واحد';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يرجع الروبوت Kit:robot v2 بمربع واحد.';
Blockly.Msg['ROBOTS_KITROBOT_TURN_LEFT_TITLE'] = '[Kit:robot v2] التدوير لليسار';
Blockly.Msg['ROBOTS_KITROBOT_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يدور الروبوت Kit:robot v2 بزاوية 90° نحو اليسار.';
Blockly.Msg['ROBOTS_KITROBOT_TURN_RIGHT_TITLE'] = '[Kit:robot v2] التدوير لليمين';
Blockly.Msg['ROBOTS_KITROBOT_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يدور الروبوت Kit:robot v2 بزاوية 90° نحو اليمين.';
Blockly.Msg['ROBOTS_KITROBOT_STOP_ROBOT_TITLE'] = '[Kit:robot v2] إيقاف الروبوت';
Blockly.Msg['ROBOTS_KITROBOT_STOP_ROBOT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يوقف المحركات للروبوت Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_BLINK_ROBOT_TITLE'] = '[Kit:robot v2] وميض الروبوت';
Blockly.Msg['ROBOTS_KITROBOT_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يجعل الروبوت Kit:robot v2 يومض.';
Blockly.Msg['ROBOTS_KITROBOT_READPATROL_TITLE'] = '[Kit:robot v2] حالة مستشعر الخط %1';
Blockly.Msg['ROBOTS_KITROBOT_READPATROL_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بقراءة حالة مستشعر تتبع الخط الأيسر أو الأيمن للروبوت Kit:robot v2. الكتلة ترجع 0 أو 1 إذا كان المستشعر فوق الخط أو لا.';
Blockly.Msg['ROBOTS_KITROBOT_SETNEOPIXEL_TITLE'] = '[Kit:robot v2] التحكم في LED RGB في %1 عند R %2 G %3 B %4';
Blockly.Msg['ROBOTS_KITROBOT_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بالتحكم في لون كل LED RGB من النيوبيكسل للروبوت Kit:robot v2 بحيث تكون القيم R، G، B بين 0 و 255.';
Blockly.Msg['ROBOTS_KITROBOT_SETPALETTECOLOR_TITLE'] = '[Kit:robot v2] التحكم في LED RGB %1 إلى %2';
Blockly.Msg['ROBOTS_KITROBOT_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بالتحكم في لون كل LED RGB من وحدة النيوبيكسل الموجودة على الروبوت Kit:robot v2. استخدم اللوحة لتغيير اللون.';
Blockly.Msg['ROBOTS_KITROBOT_SETRAINBOW_TITLE'] = '[Kit:robot v2] قوس قزح';
Blockly.Msg['ROBOTS_KITROBOT_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'عرض طيف الألوان على LEDs RGB.';
Blockly.Msg['ROBOTS_KITROBOT_SETBUZZER_TITLE'] = '[Kit:robot v2] التحكم في الجرس بتردد %1 لمدة %2 (مللي ثانية)';
Blockly.Msg['ROBOTS_KITROBOT_SETBUZZER_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'يسمح بتحديد تردد على جرس الروبوت Kit:robot v2.';
Blockly.Msg['ROBOTS_BITCAR_ULTRASONICRANGER_TITLE'] = '[BitCar] %1';
Blockly.Msg['ROBOTS_BITCAR_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يرجع المسافة (بـ سم) أو مدة الذهاب والعودة (بـ ميكروثانية) للموجة بين جسم والروبوت BitCar بفضل مستشعر الموجات فوق الصوتية.';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TITLE'] = '[BitCar] حالة مستشعر الخط %1';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بقراءة حالة أحد مستشعرات تتبع الخط للروبوت BitCar. الكتلة ترجع 0 إذا كان المستشعر فوق الخط.';
Blockly.Msg['ROBOTS_BITCAR_GO_TITLE'] = '[BitCar] التحكم في الروبوت %1 السرعة %2 %';
Blockly.Msg['ROBOTS_BITCAR_GO_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بالتحكم في الحركة (أمام/خلف) وكذلك السرعة (من 0 إلى 100) للروبوت BitCar.';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TITLE'] = '[BitCar] التدوير %1 السرعة %2 %';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بالتحكم في المحركات اليمنى واليسرى عن طريق تغيير الاتجاه (↻ : أمام، ↺ : خلف) والسرعة (من 0 إلى 100) للروبوت BitCar.';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TITLE'] = '[BitCar] التحكم في المحرك %1 الاتجاه %2 السرعة %3 %';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بالتحكم في المحركات اليمنى واليسرى عن طريق تغيير الاتجاه (↻ : أمام، ↺ : خلف) والسرعة (من 0 إلى 100) للروبوت BitCar.';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TITLE'] = '[BitCar] إيقاف المحرك %1';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بإيقاف المحرك الأيمن أو الأيسر للروبوت BitCar.';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TITLE'] = '[BitCar] وميض الروبوت';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يجعل الروبوت Maqueen يومض.';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TITLE'] = '[BitCar] التحكم في LED RGB في الأسفل %1 عند R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بالتحكم في لون كل LED RGB من النيوبيكسل للروبوت BitCar بحيث تكون القيم R، G، B بين 0 و 255.';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TITLE'] = '[BitCar] التحكم في LED RGB في الأسفل %1 إلى %2';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بالتحكم في لون كل LED RGB من وحدة النيوبيكسل الموجودة تحت الروبوت BitCar. استخدم اللوحة لتغيير اللون.';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TITLE'] = '[BitCar] قوس قزح';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'عرض طيف الألوان على LEDs RGB.';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TITLE'] = '[BitCar] التحكم في الجرس بتردد %1 لمدة %2 (مللي ثانية)';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يسمح بتحديد تردد على جرس الروبوت BitCar.';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TITLE'] = '[BitCar] فك تشفير جهاز الاستقبال بالأشعة تحت الحمراء';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يجري قراءة لجهاز الاستقبال بالأشعة تحت الحمراء للروبوت BitCar.';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TITLE'] = '[BitCar] الكود المستلم من جهاز الاستقبال بالأشعة تحت الحمراء';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'يرجع الكود السداسي عشر المستلم مع كاشف الأشعة تحت الحمراء للروبوت BitCar.';
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TITLE'] = '[BitPlayer] إذا كان الزر %1 هو %2 إذن';
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'ينفذ التعليمات إذا تم استخدام أحد الأزرار في وحدة التحكم BitPlayer. الزر له حالتان: \'مضغوط\' أو \'محرر\'.';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TITLE'] = '[BitPlayer] قيمة المحور %1';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'يرجع قيمة المحور X أو Y من عصا التحكم في وحدة التحكم BitPlayer. عصا التحكم: محوران تناظريان (X : P1 Y : P2).';
Blockly.Msg['ROBOTS_MAQUEEN_MIDDLE'] = 'الوسط';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TITLE'] = '[Maqueen Lite v5] قيمة مستشعر تتبع الخط %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'يتيح قراءة قيمة مستشعر تتبع الخط الأيسر أو الأوسط أو الأيمن لروبوت Maqueen Lite v5.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TITLE'] = '[Maqueen Lite v5] مستوى البطارية (%) نوع %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'يعيد مستوى الشحن المتبقي للبطارية (٪) لروبوت Maqueen Lite v5 حسب ما إذا كانت البطارية من نوع القلوية (Alkaline) أو ليثيوم.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TITLE'] = '[Maqueen Lite v5] القيام بدورية %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'يتيح القيام بدوريات مع روبوت Maqueen Lite v5، أي أنه سيتحرك ويتجنب العقبات تلقائيًا بفضل مستشعر المسافة بالموجات فوق الصوتية.';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TITLE'] = '[Kitronik 16-Servos] ضبط السرفو %1 على الزاوية %2 °';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TOOLTIP'] = IMG_MODULE_KITRONIK_SHIELD_16_SERVOS + Blockly.Tooltip.SEP + 'يتيح ضبط زاوية محرك السرفو (من 0 إلى 180) الموصول بدرع Kitronik ذو 16 سرفو. انتبه: يجب تزويد الدائرة ببطارية لتوفير تيار كافٍ للسرفو.';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TITLE'] = '[uHandbit - حسّاس الألوان] %1';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'يقرأ مركبات RGB (من 0 إلى 255) من حسّاس الألوان uHandbit المتصل بالمنفذ 4.';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TITLE'] = '[uHandbit - حسّاس الألوان] اللون المكتشف';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'يقرأ اللون الذي كشفه حسّاس الألوان uHandbit المتصل بالمنفذ 4. يُعاد اللون كسلسلة نصية من إحدى القيم التالية: RED, GREEN, BLUE, BLACK, WHITE أو NONE.';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TITLE'] = '[uHandbit - حسّاس الموجات فوق الصوتية] %1 على المنفذ %2';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'يعيد المسافة (بالسم) المقاسة بواسطة حسّاس الموجات فوق الصوتية في uHandbit على المنفذ 1 أو 2.';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TITLE'] = '[uHandbit - محركات سيرفو] ضبط السرفو %1 إلى الزاوية %2 ° لمدة %3 مللي ثانية';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'يتيح ضبط زاوية محرك السرفو (من 0 إلى 180) الموصول بوحدة uHandbit. المدة تتحكم في سرعة دوران السرفو.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TITLE'] = '[uHandbit - Neopixel] ضبط LED %1 إلى R %2 G %3 B %4';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'يُمكّن من ضبط لون كل LED في وحدة neopixel الخاصة بـuHandbit (P15) بحيث تكون قيم (R, G, B) بين 0 و255.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TITLE'] = '[uHandbit - Neopixel] ضبط LED %1 إلى %2';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'يتيح ضبط لون كل LED في وحدة neopixel الخاصة بـuHandbit (P15). استخدم لوحة الألوان لتغيير لون LED RGB.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TITLE'] = '[uHandbit - Neopixel] قوس قزح';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'يعرض طيف الألوان على LED RGB في وحدة uHandbit (P15).';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TITLE'] = '[WuKong] تطبيق وضع الإضاءة على %1';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'يتيح تطبيق نمط إضاءة على لوحة WuKong.';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_BREATH'] = 'تنفس';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_OFF'] = 'إيقاف';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TITLE'] = '[WuKong] ضبط شدة الإضاءة إلى %1 %';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'يتيح ضبط شدة الإضاءة (من 0 إلى 100) على لوحة WuKong.';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TITLE'] = '[WuKong] التحكم بالمحرك/المحركات %1 اتجاه %2 سرعة %3 %';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'يتيح التحكم بالمحركين M1 وM2 بتغيير الاتجاه (↻: للأمام، ↺: للخلف) والسرعة (من 0 إلى 100%) على لوحة WuKong.';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TITLE'] = '[WuKong] إيقاف المحرك/المحركات %1';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'يتيح التحكم بالمحركين M1 وM2 بتغيير الاتجاه (↻: للأمام، ↺: للخلف) والسرعة (من 0 إلى 100%) على لوحة WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TITLE'] = '[WuKong %1] ضبط السرفو(ات) %2 إلى الزاوية %3°';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'يتيح التحكم بمحركات السرفو من S1 إلى S7 بتغيير الزاوية (من 0 إلى 360°) على لوحة WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SERVO_ALL'] = 'الكل';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TITLE'] = '[WuKong] ضبط السرفو/السرفوهات %1 بالسرعة %2 %';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'يتيح التحكم بالسرفوهات المستمرة من S1 إلى S7 بتغيير السرعة (من -100 إلى 100) على لوحة WuKong.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TITLE'] = '[Building:bit] ضبط LED RGB أسفل %1 إلى R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'يتيح ضبط لون كل LED RGB في وحدة neopixel لروبوت Building:bit (P12)، بحيث تكون قيم R,G,B بين 0 و255. وحدة neopixel متصلة بالدبوس P12 في الروبوت.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TITLE'] = '[Building:bit] ضبط LED RGB أسفل %1 إلى %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'يتيح ضبط لون كل LED RGB في وحدة neopixel (P12) تحت روبوت Building:bit. استخدم لوحة الألوان لتغيير اللون.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TITLE'] = '[Building:bit %1] ضبط السرفو %2 إلى الزاوية %3°';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'يتيح التحكم بالسرفوهات من S1 إلى S8 بتغيير الزاوية (من 0 إلى 360°) في روبوت Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TITLE'] = '[Building:bit] التحكم بالمحرك %1 اتجاه %2 سرعة %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'يتيح التحكم بالمحركات M1 وM2 وM3 وM4 بتغيير الاتجاه (↻: للأمام، ↺: للخلف) والسرعة (من 0 إلى 255) في روبوت Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TITLE'] = '[Building:bit] إيقاف المحرك %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'يتيح التحكم بالمحركات M1 وM2 وM3 وM4 بتغيير الاتجاه (↻: للأمام، ↺: للخلف) والسرعة (من 0 إلى 255) في روبوت Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TITLE'] = '[Building:bit] التحكم بمحرك الخطوة %1 الموضع %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'يتيح التحكم بمحركات خطوة B1 وB2 بتغيير الموضع (من 0 إلى 360) في روبوت Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TITLE'] = '[حساس الموجات فوق الصوتية] المسافة على الدبابيس TRIG %1 ECHO %2 ';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TOOLTIP'] = IMG_YAHBOOM_ULTRASONIC + Blockly.Tooltip.SEP + 'يعيد المسافة (بالسم) المقاسة بواسطة حسّاس الموجات فوق الصوتية Yahboom على الدبابيس الرقمية.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TITLE'] = '[المقاوم المتغير] القيمة على الدبوس %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TOOLTIP'] = IMG_YAHBOOM_POTENTIOMETER + Blockly.Tooltip.SEP + 'يعيد قيمة البوتنشيومتر Yahboom على الدبابيس التناظرية (P0 إلى P4 أو P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TITLE'] = '[حساس الضوء] القيمة على الدبوس %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TOOLTIP'] = IMG_YAHBOOM_LIGHT_SENSOR + Blockly.Tooltip.SEP + 'يعيد مستوى الإضاءة المحيطة باستخدام حساس الضوء Yahboom على الدبابيس التناظرية (P0 إلى P4 أو P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TITLE'] = '[كاشف IR] هل تم اكتشاف عقبة على الدبوس %1 ?';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TOOLTIP'] = IMG_YAHBOOM_IR_DETECTOR + Blockly.Tooltip.SEP + 'يعيد True إذا تم اكتشاف عقبة بواسطة كاشف الأشعة تحت الحمراء Yahboom على الدبابيس الرقمية.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TITLE'] = '[مستشعر PIR] هل تم اكتشاف حركة على الدبوس %1 ?';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TOOLTIP'] = IMG_YAHBOOM_PIR_MOTION_SENSOR + Blockly.Tooltip.SEP + 'يعيد True إذا تم اكتشاف حركة بواسطة مستشعر PIR Yahboom على الدبابيس الرقمية.';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TITLE'] = '[DHT11] %1 على الدبوس %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TOOLTIP'] = IMG_YAHBOOM_DHT11 + Blockly.Tooltip.SEP + 'يعيد درجة الحرارة بالدرجة المئوية (°C)، فهرنهايت (°F) أو كلفن (K)، أو الرطوبة (٪) باستخدام حساس DHT11 من Yahboom على الدبابيس الرقمية P0 إلى P20.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TITLE'] = '[حساس اللون] مستوى %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TOOLTIP'] = IMG_YAHBOOM_COLOR_SENSOR + Blockly.Tooltip.SEP + 'يعيد إحدى مركبات اللون (R أو G أو B) من 0 إلى 255 باستخدام حساس الألوان I2C من Yahboom. وصل الحساس بمنفذ I2C.';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TITLE'] = '[Joystick] إذا توجه إلى %1 على الدبابيس X %2 Y %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TOOLTIP'] = IMG_YAHBOOM_JOYSTICK + Blockly.Tooltip.SEP + 'يتيح تنفيذ تعليمات عند تحقق اتجاه الذراع. وصل الوحدة بالدبابيس التناظرية (P0 إلى P4 أو P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_UP'] = 'أعلى';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_DOWN'] = 'أسفل';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_RIGHT'] = 'يمين';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_LEFT'] = 'يسار';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TITLE'] = '[HuskyLens] مصفوفة البيانات %1 للمعرّف رقم %2';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يتيح الحصول على البيانات المرتبطة بالمعرّف المحدد من كاميرا HuskyLens. البيانات المستلمة تكون في مصفوفة بالشكل [x1, y1, العرض, الارتفاع, id]. ';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - تغيير المعامل %1 إلى %2 على دبابيس TXD %3 و RXD %4';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'يتيح تغيير معلمات وحدة Bluetooth HM10 بإرسال أمر AT. بعد تغيير المعامل، يُخزّن في ذاكرة الوحدة فلا حاجة للعودة إلى هذا الوضع.';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - قيمة المعامل %1 على دبابيس TXD %2 و RXD %3';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'يتيح استرجاع قيمة معلمات وحدة Bluetooth HM10 بواسطة أمر AT.';
Blockly.Msg['COMMUNICATION_UART_READLINE_TITLE'] = '[uart] قراءة سطر من البيانات';
Blockly.Msg['COMMUNICATION_UART_READLINE_TOOLTIP'] = 'يتيح قراءة البيانات من منفذ uart المحدد حتى يتم قراءة \'\\n\'.';
Blockly.Msg['COMMUNICATION_I2C_INIT_TITLE'] = '[i2c] تهيئة التردد %1 هرتز على دبابيس SDA %2 و SCL %3';
Blockly.Msg['COMMUNICATION_I2C_INIT_TOOLTIP'] = 'يتيح إعادة تهيئة اتصال I2C على دبابيس محددة بالتردد المطلوب (100 kHz إلى 400 kHz).';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TITLE'] = '[i2c] قائمة أجهزة I2C المكتشفة';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TOOLTIP'] = 'يعيد الأجهزة المكتشفة على دبابيس I2C على شكل قائمة من العناوين.';
Blockly.Msg['COMMUNICATION_I2C_REPEAT'] = 'تكرار؟';
Blockly.Msg['COMMUNICATION_I2C_READ_TITLE'] = '[i2c] العنوان %1 قراءة بيانات بحجم %2';
Blockly.Msg['COMMUNICATION_I2C_READ_TOOLTIP'] = 'يتيح قراءة N بايت من العنوان المحدد على I2C. يمكنك كتابة العنوان الست عشري في المربع؛ سيتم تحويله إلى عدد صحيح (0-127). زر + يتحكم في إرسال إشارة الإيقاف.';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TITLE'] = '[i2c] العنوان %1 اكتب البيانات %2';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TOOLTIP'] = 'يتيح كتابة مصفوفة بايتات إلى العنوان المحدد على I2C. يمكنك كتابة العنوان الست عشري في المربع؛ سيتم تحويله إلى عدد صحيح (0-127). زر + يتحكم في إرسال إشارة الإيقاف.';
Blockly.Msg['SENSORS_ENVIRO_BIT_WAIT_CLAP_TOOLTIP'] = IMG_MODULE_ENVIRO_BIT + Blockly.Tooltip.SEP + 'يقيس صوتًا عاليًا مرة أو مرتين في الثانية، ويُرجع True عند اكتشافه.';
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nبشكل افتراضي، دبابيس SPI على micro:bit هي SCK: P13، MISO: P14، وMOSI: P15.';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] معرف البطاقة على دبوس NSS %1';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID + Blockly.Tooltip.SEP + 'يتيح استرجاع مُعرّف UID كسلسلة نصية من وحدة قارئ RFID RC522 (SPI) من Joy-It عند اكتشافها على الدبابيس الرقمية.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TITLE'] = '[Reka:bit] شغّل المحرك %1 في الاتجاه %2 وبسرعة %3';
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'تمكّنك من تشغيل المحرك M1 أو M2 أو كلاهما على درع Reka:bit بتحديد الاتجاه والسرعة.';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M1'] = 'M1';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M2'] = 'M2';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_ALL'] = 'كلاهما';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_FORWARD'] = 'إلى الأمام';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_BACKWARD'] = 'إلى الخلف';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TITLE'] = '[Reka:bit] اضبط السرفو %1 إلى %2°';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'تمكّنك من ضبط زاوية السرفو S1 أو S2 أو S3 أو S4 أو جميعها المتصلة بدرع Reka:bit.';
...
Blockly.Msg['ACTUATORS_REKABIT_SERVO_ALL'] = 'جميعها';
