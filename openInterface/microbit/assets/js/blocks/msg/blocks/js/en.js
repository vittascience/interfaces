...
Blockly.Msg['PLOT_BAR_GRAPH_TITLE'] = 'plot the graph of %1';
Blockly.Msg['PLOT_BAR_GRAPH_TOOLTIP'] = 'Displays a vertical bar graph based on the "value" and "high" values. If "high" is 0, the graph adjusts automatically';
Blockly.Msg['PLOT_BAR_GRAPH_TO'] = 'to';
...
Blockly.Msg['GET_PIXEL_STATE_TITLE'] = 'LED state at x %1 y %2';
Blockly.Msg['GET_PIXEL_STATE_TOOLTIP'] = 'Allows checking the state (ON/OFF) of each LED on the micro:bit screen.';
Blockly.Msg['TOGGLE_PIXEL_STATE_TITLE'] = 'toggle LED state at x %1 y %2';
Blockly.Msg['TOGGLE_PIXEL_STATE_TOOLTIP'] = 'Allows toggling the state (ON/OFF) of each LED on the micro:bit screen.';
...
Blockly.Msg['SET_BRIGHTNESS_TITLE'] = 'set brightness %1';
Blockly.Msg['SET_BRIGHTNESS_TOOLTIP'] = 'Allows you to choose the brightness (from 0 to 9) of the micro:bit board’s LED display.';
...
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TITLE'] = '[ZIP Halo HD] control LED %1 at R %2 G %3 B %4';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Allows controlling the color of each LED as (R,G,B) from 0 to 255 on the Kitronik Zip Halo LED module.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TITLE'] = '[ZIP Halo HD] control LED %1 with color %2';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Allows controlling the color of each LED on the Kitronik Zip Halo LED module. Use the palette to change the color.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TITLE'] = '[ZIP Halo HD] control all LEDs at R %1 G %2 B %3';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Allows controlling all LEDs on the Kitronik Zip Halo LED module with the chosen color as (R,G,B) from 0 to 255.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TITLE'] = '[ZIP Halo HD] control all LEDs with color %1';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Allows controlling all LEDs on the Kitronik Zip Halo LED module with the chosen color. Use the palette to change the color.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TITLE'] = '[ZIP Halo HD] Rainbow';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Displays the color spectrum on the RGB LEDs of the Kitronik Zip Halo LED module.';
...
Blockly.Msg['DISPLAY_LAMPBIT_SETLED_TITLE'] = "[LAMP:BIT] set LED to state %1";
Blockly.Msg['DISPLAY_LAMPBIT_SETLED_TOOLTIP'] = IMG_MODULE_LAMPBIT + Blockly.Tooltip.SEP + "Controls streetlight LED";
...
Blockly.Msg['IO_GETMAGNETICSWITCH_TOOLTIP'] = IMG_MODULE_MAGNETIC_SWITCH + Blockly.Tooltip.SEP + 'Returns the value of the Grove magnetic switch (0 or 1) on digital pins P0 to P20.';
// Input/Output - Pins
...
Blockly.Msg["IO_EXEC_TITLE"] = "execute Python code %1";
Blockly.Msg["IO_EXEC_TOOLTIP"] = "Executes Python code.";
...
Blockly.Msg["COMMUNICATION_SERIAL_ONMESSAGERECEIVED_TITLE"] = "on serial message received in %1 then";
Blockly.Msg["COMMUNICATION_SERIAL_ONMESSAGERECEIVED_TOOLTIP"] = "Allows you to execute instructions if decoded data (as string UTF-8) is received by serial port in the 'messageData' variable. It returns a string.";
Blockly.Msg["COMMUNICATION_SERIAL_ONDATARECEIVED_TITLE"] = "on serial data received in %1 then";
Blockly.Msg["COMMUNICATION_SERIAL_ONDATARECEIVED_TOOLTIP"] = "Allows you to execute instructions if data is received by serial port in the 'serialData' variable. Its variable returns bytes array.";
...
Blockly.Msg['COMMUNICATION_RADIO_RECEIVE_FULL_TOOLTIP'] = 'Allows you to get the details of the next message via the micro:bit radio. Returns -1 if there is no incoming message.';
Blockly.Msg['COMMUNICATION_RADIO_NEXT_MESSAGE'] = 'next received data';
Blockly.Msg['COMMUNICATION_RADIO_RSSI'] = 'received signal strength (RSSI)';
Blockly.Msg['COMMUNICATION_RADIO_TIMESTAMP'] = 'timestamp of received data';
...
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - change parameter %1 to %2 on pins TXD %3 RXD %4';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Allows you to change the parameters of the HM10 Bluetooth module by sending an AT command. Once the parameter has been changed, it is no longer necessary to return to this mode because it is stored in the module\'s memory.';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - value of parameter %1 on pins TXD %2 RXD %3';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Allows you to retrieve the value of the HM10 bluetooth module parameters by sending an AT command.';
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_SENDDATA_TITLE"] = "[HM10 BT] send on pins TXD %1 RXD %2 message %3";
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_SENDDATA_TOOLTIP"] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + "Enable to send any data by serial HM10 bluetooth module on digital pins.";
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_ONDATARECEIVED_TITLE"] = "[HM10 BT] on message received on pins TXD %1 RXD %2 in %3 then";
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_ONDATARECEIVED_TOOLTIP"] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + "Allows you to execute instructions on data received by serial HM10 bluetooth module in the 'HM10Data' variable on digital pins. As default, the module name is MLT-BT05.";
// Communication - Tracking modules
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nBy default, the micro:bit SPI pins are on SCK: P13, MISO: P14, and MOSI: P15.';
...
Blockly.Msg["COMMUNICATION_UART_READ_TOOLTIP"] = "Read data from the defined uart port.";
Blockly.Msg['COMMUNICATION_UART_READLINE_TITLE'] = '[uart] read a line of data';
Blockly.Msg['COMMUNICATION_UART_READLINE_TOOLTIP'] = 'Allows reading data from the defined uart port until \'\\n\' is read.';
// Communication - I2C
Blockly.Msg['COMMUNICATION_I2C_INIT_TITLE'] = '[i2c] Initialize frequency %1 Hz on SDA pins %2 SCL %3';
Blockly.Msg['COMMUNICATION_I2C_INIT_TOOLTIP'] = 'Allows you to reset I2C communication on specific pins at the desired frequency (100 kHz to 400 kHz).';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TITLE'] = '[i2c] List of detected I2C devices';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TOOLTIP'] = 'Returns the detected I2C devices on the I2C pins as a list of addresses.';
Blockly.Msg['COMMUNICATION_I2C_REPEAT'] = 'Repeat?';
Blockly.Msg['COMMUNICATION_I2C_READ_TITLE'] = '[i2c] address %1 read data of size %2';
Blockly.Msg['COMMUNICATION_I2C_READ_TOOLTIP'] = 'Allows reading N bytes from the specified I2C address. You can write the hexadecimal I2C address in the block; it will be converted to an integer (0-127). The + button controls sending the stop bit.';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TITLE'] = '[i2c] address %1 write data %2';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TOOLTIP'] = 'Allows you to write an array of bytes to the specified I2C address. You can write the hexadecimal I2C address in the block; it will be converted to an integer (0-127). The + button controls the sending of the stop bit.';
...
Blockly.Msg['SENSORS_ENVIRO_BIT_WAIT_CLAP_TOOLTIP'] = IMG_MODULE_ENVIRO_BIT + Blockly.Tooltip.SEP + 'Measures a loud sound 1 or 2 times per second, returns True if detected.';
...
Blockly.Msg['SENSORS_BME280_GETDATA_TOOLTIP'] = IMG_MODULE_BME280 + Blockly.Tooltip.SEP + 'Returns the ambient temperature in degrees Celsius (°C) from -40 to 85 °C, Fahrenheit (°F) or Kelvin (K), humidity (in %), pressure (in Pascal) or altitude (in m) from the BME280 sensor. Connect sensor on I2C port.';
...
Blockly.Msg['SENSORS_BAROMETER_READDATA_TOOLTIP'] = IMG_MODULE_HP206C + Blockly.Tooltip.SEP + 'Returns temperature in Celsius (°C), Fahrenheit (°F), or Kelvin (K), pressure (in hPa), or altitude (in m) using the barometer. Connect the sensor to an I2C port.';
...
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TITLE'] = '[Color sensor v3] %1';
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TOOLTIP'] = IMG_MODULE_I2C_COLOR_V3 + Blockly.Tooltip.SEP + 'Allows reading the level of one of the three primary colors (red, green, blue), brightness (~ from 0 to 10,000K), or temperature (~ from 0 to 100,000 Lux) with the Grove v3 color sensor. It also allows reading the color in HSV format (hue: 0 to 360°, saturation: 0 to 100%, value: 0 to 100%) and retrieving the associated color name. Connect the sensor to an I2C port.';
Blockly.Msg['COLOR_HUE'] = 'hue (°)';
Blockly.Msg['COLOR_SATURATION'] = 'saturation (%)';
Blockly.Msg['COLOR_VALUE'] = 'value (%)';
Blockly.Msg['COLOR_LEVEL_WHITE'] = 'white level';
Blockly.Msg['COLOR_LEVEL_TEMP'] = 'temperature';
Blockly.Msg['COLOR_NAME'] = 'color name';
...
Blockly.Msg['SENSORS_VL53L0X_GETRANGEMILLIMETERS_TOOLTIP'] = IMG_MODULE_VL53L0X + Blockly.Tooltip.SEP + 'Returns distance measurements from the Time Of Flight sensor on the I2C port.';
...
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TITLE'] = '[Mini motion sensor] state on pin %1';
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TOOLTIP'] = IMG_MODULE_MOTION_MINI + Blockly.Tooltip.SEP + 'Returns true or false depending on whether the Grove PIR Motion mini sensor detects movement on digital pins P0 to P20.';
...
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TITLE'] = '[Stepper motor] initialize motor  %1 on IN1 %2 IN2 %3 IN3 %4 IN4 %5';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Initializes the 28BYJ-48 stepper motor with the ULN2003 driver on digital pins P0 to P20.';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TITLE'] = '[Stepper motor] motor %1 rotate %2 %3 direction %4';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_STEPS'] = 'step(s)';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_ROTATIONS'] = 'rotation(s)';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Rotates the 28BYJ-48 stepper motor by a number of steps or rotations in clockwise (↻) or counterclockwise (↺) direction.';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TITLE'] = '[Stepper motor] motor %1 delay between each step %2 ms';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Sets the rotation speed of the 28BYJ-48 stepper motor by adjusting the delay between each step (in ms). The larger the delay, the slower the speed. The default delay is 3 ms and cannot be reduced.';
// actuators - Kitronik
...
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TITLE'] = '[Kitronik 16-Servos] controls servo %1 at an angle of %2°';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TOOLTIP'] = IMG_MODULE_KITRONIK_SHIELD_16_SERVOS + Blockly.Tooltip.SEP + 'Allows you to control the angle of a servo motor (from 0 to 180°) connected to the Kitronik 16 Servo Shield. Note: the setup must be powered by a battery to provide sufficient current to the servo motor.';
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TITLE'] = '[Reka:bit] run motor %1 direction %2 speed %3';
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Allows you to run motor M1, M2, or both on the Reka:bit shield by setting the direction and speed.';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M1'] = 'M1';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M2'] = 'M2';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_ALL'] = 'both';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_FORWARD'] = 'forward';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_BACKWARD'] = 'backward';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TITLE'] = '[Reka:bit] set servo %1 to %2°';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Allows you to set the angle of servo S1, S2, S3, S4, or all servos connected to the Reka:bit shield.';
...
Blockly.Msg['ACTUATORS_REKABIT_SERVO_ALL'] = 'all';
// actuators - music
...
Blockly.Msg["ROBOTS_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_DETECTED_THEN"] = "received by NEC Car mp3 gray remote control then";
...
Blockly.Msg["ROBOTS_MAQUEEN_READPATROL_TITLE"] = "[Maqueen Lite] line patrol status on %1";
Blockly.Msg["ROBOTS_MAQUEEN_READPATROL_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to read state of line patrol sensor of Maqueen Lite robot. The block returns 0 if the sensor is above the line.";
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TITLE'] = '[Maqueen Lite v5] line sensor value on %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Allows reading the status of the left, middle, or right line follower sensor of the Maqueen Lite V5 robot.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TITLE'] = '[Maqueen Lite v5] battery level (%) type %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Returns the remaining battery level (in %) of the Maqueen Lite V5 robot, depending on whether it is Alkaline or Lithium.';
Blockly.Msg["ROBOTS_MAQUEEN_CONTROLLED_TITLE"] = "[Maqueen Lite] control red LED %1 to state %2";
Blockly.Msg["ROBOTS_MAQUEEN_CONTROLLED_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to control LED Right or Left state value of Maqueen Lite robot.";
Blockly.Msg["ROBOTS_MAQUEEN_GO_TITLE"] = "[Maqueen Lite] %1 at speed %2";
Blockly.Msg["ROBOTS_MAQUEEN_GO_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to control car running (FORWARD/BACKWARD) and speed (from 0 to 255) of Maqueen Lite robot.";
Blockly.Msg["ROBOTS_MAQUEEN_CONTROLMOTOR_TITLE"] = "[Maqueen Lite] control motor %1 direction %2 speed %3";
Blockly.Msg["ROBOTS_MAQUEEN_CONTROLMOTOR_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to control right motor (I2C address : 0x02) and left motor (I2C address : 0x00) changing direction (↻ : FOWARD, ↺ : REVERSE) or speed (from 0 to 255) of Maqueen Lite robot.";
Blockly.Msg["ROBOTS_MAQUEEN_ROTATE_TITLE"] = "[Maqueen Lite] rotate %1 speed %2";
Blockly.Msg["ROBOTS_MAQUEEN_ROTATE_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to control right motor (I2C address : 0x02) and left motor (I2C address : 0x00) changing direction (↻ : FOWARD, ↺ : REVERSE) or speed (from 0 to 255) of Maqueen Lite robot.";
Blockly.Msg["ROBOTS_MAQUEEN_STOPMOTORS_TITLE"] = "[Maqueen Lite] stop motor %1";
Blockly.Msg["ROBOTS_MAQUEEN_STOPMOTORS_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to stop right, left or both motors of Maqueen Lite robot.";
Blockly.Msg["ROBOTS_MAQUEEN_SETSERVOANGLE_TITLE"] = "[Maqueen Lite] set servo %1 to angle %2 °";
Blockly.Msg["ROBOTS_MAQUEEN_SETSERVOANGLE_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to control servomotor S1 (I2C address : 0x14) and S2 (I2C address : 0x15) by setting angle (from 0 to 180) of Maqueen Lite robot.";
Blockly.Msg["ROBOTS_MAQUEEN_S1"] = "S1";
Blockly.Msg["ROBOTS_MAQUEEN_S2"] = "S2";
Blockly.Msg["ROBOTS_MAQUEEN_SERVO_BOTH"] = "both";
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TITLE'] = '[Maqueen Lite v5] patrolling %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Allows you to patrol with the Maqueen Lite v5 robot, meaning it will move around and automatically avoid obstacles thanks to its ultrasonic distance sensor.';
...
Blockly.Msg["ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_BACKWARD_TITLE"] = "[Maqueen Lite] move one square backward";
...
Blockly.Msg["ROBOTS_MAQUEEN_DECODEIRRECEIVER_TOOLTIP"] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + "Enable to do a reading of infrared receiver connected to P16 of Maqueen Lite robot.";
...
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TITLE'] = '[LiDAR %1] configure size: %2';
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Allows you to configure the matrix size (8x8 or 4x4) of the measurements from the DFRobot LiDAR distance sensor connected to the Maqieen Plus V3 robot.';
Blockly.Msg['SENSORS_LIDAR_CONFIG_8X8_MATRIX'] = '8x8 Matrix';
Blockly.Msg['SENSORS_LIDAR_CONFIG_4X4_MATRIX'] = '4x4 Matrix';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TITLE'] = '[LiDAR %1] read %2';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Reads all data measured with the DFRobot LiDAR distance sensor connected to the Maqueen Plus V3 robot.';
Blockly.Msg['SENSORS_LIDAR_DATA_DISTANCES_MATRIX'] = 'Distance matrix (in mm)';
Blockly.Msg['SENSORS_LIDAR_DATA_RAW_LIST'] = 'raw data list';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TITLE'] = '[LiDAR %1] distance measured at point x %2 y %3';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Returns the distance (in mm) to a specific point in the matrix (4x4 or 8x8) measured with the DFRobot LiDAR distance sensor connected to the Maqueen Plus V3 robot.';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TITLE'] = '[LiDAR %1] configure avoidance distance to %2 (cm)';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Allows you to configure the obstacle avoidance distance from 10 to 50 cm with the DFRobot LiDAR distance sensor connected to the Maqueen Plus V3 robot. The sensor will activate the emergency signal and provide the direction to avoid the obstacle based on this distance.';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TITLE'] = '[LiDAR %1] emergency signal activated?';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Returns True if the emergency signal has been activated with the DFRobot LiDAR distance sensor connected to the Maqueen Plus V3 robot. The signal is activated when the avoidance distance has been exceeded.';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TITLE'] = '[LiDAR %1] direction to follow to avoid the obstacle';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Returns the direction to follow to avoid the obstacle with the DFRobot LiDAR distance sensor connected to the Maqueen Plus V3 robot. The suggested directions are 1 (left), 2 (right), and 3 (straight ahead).';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TITLE'] = '[LiDAR %1] direction to follow is %2';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Returns True if the obstacle avoidance direction is verified with the DFRobot LiDAR distance sensor connected to the Maqueen Plus V3 robot.';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_LEFT'] = 'left';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_RIGHT'] = 'right';
Blockly.Msg['SENSORS_LIDAR_DIR_FORWARD'] = 'forward';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TITLE'] = '[LiDAR %1] distance (in cm) from obstacle %2';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Returns the distance (in cm) to an obstacle located on the RIGHT, LEFT, or MIDDLE, measured with the DFRobot LiDAR distance sensor connected to the Maqueen Plus V3 robot.';
Blockly.Msg['SENSORS_LIDAR_DIR_LEFT'] = 'left';
Blockly.Msg['SENSORS_LIDAR_DIR_MIDDLE'] = 'middle';
Blockly.Msg['SENSORS_LIDAR_DIR_RIGHT'] = 'right';
// Robots - Cutebot
...
Blockly.Msg['ROBOTS_CUTEBOT_GO_TITLE'] = '[Cutebot] %1 at speed %2 %';
...
// Robots - Kit:robot v2
Blockly.Msg['ROBOTS_KITROBOT_RIGHT'] = 'right';
Blockly.Msg['ROBOTS_KITROBOT_LEFT'] = 'left';
Blockly.Msg['ROBOTS_KITROBOT_RIGHT&LEFT'] = 'right & left';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONICRANGER_TITLE'] = '[Kit:robot v2] %1';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Returns the distance (in cm) or the round-trip duration (in μs) of the wave between an object and the Kit:robot v2 robot using the ultrasonic sensor.';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONIC_DISTANCE'] = 'distance (cm)';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONIC_DURATION'] = 'round-trip duration (μs)';
Blockly.Msg['ROBOTS_KITROBOT_GO_TITLE'] = '[Kit:robot v2] %1 at speed %2 (%)';
Blockly.Msg['ROBOTS_KITROBOT_GO_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to control the movement (forward/reverse) and speed (from 0 to 100%) of the Kit:robot v2 robot.';
Blockly.Msg['ROBOTS_KITROBOT_CONTROLMOTOR_TITLE'] = '[Kit:robot v2] control motor %1 direction %2 speed %3 %';
Blockly.Msg['ROBOTS_KITROBOT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to control the right and left motors by changing the direction (↻: forward, ↺: reverse) and speed (from 0 to 100%) of the Kit:robot v2 robot.';
Blockly.Msg['ROBOTS_KITROBOT_ROTATE_TITLE'] = '[Kit:robot v2] rotate %1 speed %2 %';
Blockly.Msg['ROBOTS_KITROBOT_ROTATE_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to control the right and left motors by changing the direction (↻: forward, ↺: reverse) and speed (from 0 to 100%) of the Kit:robot v2 robot.';
Blockly.Msg['ROBOTS_KITROBOT_STOPMOTORS_TITLE'] = '[Kit:robot v2] stop motor %1';
Blockly.Msg['ROBOTS_KITROBOT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to stop the right or left motor of the Kit:robot v2 robot.';
Blockly.Msg['ROBOTS_KITROBOT_SERVO_BOTH'] = 'both';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Kit:robot v2] move one square forward';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Moves the Kit:robot v2 robot one square forward.';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Kit:robot v2] move one square backward';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Moves the Kit:robot v2 robot one square backward.';
Blockly.Msg['ROBOTS_KITROBOT_TURN_LEFT_TITLE'] = '[Kit:robot v2] turn left';
Blockly.Msg['ROBOTS_KITROBOT_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Turns the Kit:robot v2 robot 90° to the left.';
Blockly.Msg['ROBOTS_KITROBOT_TURN_RIGHT_TITLE'] = '[Kit:robot v2] turn right';
Blockly.Msg['ROBOTS_KITROBOT_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Turns the Kit:robot v2 robot 90° to the right.';
Blockly.Msg['ROBOTS_KITROBOT_STOP_ROBOT_TITLE'] = '[Kit:robot v2] stop the robot';
Blockly.Msg['ROBOTS_KITROBOT_STOP_ROBOT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Stops the motors of the Kit:robot v2 robot.';
Blockly.Msg['ROBOTS_KITROBOT_BLINK_ROBOT_TITLE'] = '[Kit:robot v2] blink the robot';
Blockly.Msg['ROBOTS_KITROBOT_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Blinks the Kit:robot v2 robot.';
Blockly.Msg['ROBOTS_KITROBOT_READPATROL_TITLE'] = '[Kit:robot v2] read line sensor %1';
Blockly.Msg['ROBOTS_KITROBOT_READPATROL_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to read the state of the left or right line follower sensor of the Kit:robot v2 robot. The block returns 0 or 1 if the sensor is above the line or not.';
Blockly.Msg['ROBOTS_KITROBOT_SETNEOPIXEL_TITLE'] = '[Kit:robot v2] control RGB LED %1 to R %2 G %3 B %4';
Blockly.Msg['ROBOTS_KITROBOT_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to control the color of each RGB LED of the neopixel module on the Kit:robot v2 robot, with R, G, B values ranging from 0 to 255.';
Blockly.Msg['ROBOTS_KITROBOT_SETPALETTECOLOR_TITLE'] = '[Kit:robot v2] control RGB LED %1 to %2';
Blockly.Msg['ROBOTS_KITROBOT_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to control the color of each RGB LED of the neopixel module on the Kit:robot v2 robot. Use the palette to change the color.';
Blockly.Msg['ROBOTS_KITROBOT_SETRAINBOW_TITLE'] = '[Kit:robot v2] rainbow';
Blockly.Msg['ROBOTS_KITROBOT_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Displays the spectrum of colors on the RGB LEDs.';
Blockly.Msg['ROBOTS_KITROBOT_SETBUZZER_TITLE'] = '[Kit:robot v2] control buzzer at frequency %1 for %2 (ms)';
Blockly.Msg['ROBOTS_KITROBOT_SETBUZZER_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Allows you to set a frequency on the buzzer of the Kit:robot v2 robot.';
// Robots - Codo
...
Blockly.Msg["ROBOTS_CODO_TURN_TITLE"] = "[Codo] turn %1 at speed %2";
...
Blockly.Msg['ROBOTS_BITCAR_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Returns the distance (in cm) or the round-trip time (in μs) of the wave between an object and the BitCar robot using the ultrasonic sensor.';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TITLE'] = '[BitCar] line follower sensor %1 state';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Reads the state of one of the line follower sensors of the BitCar robot. The block returns 0 if the sensor is above the line.';
Blockly.Msg['ROBOTS_BITCAR_GO_TITLE'] = '[BitCar] %1 at speed %2 %';
Blockly.Msg['ROBOTS_BITCAR_GO_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Controls the movement (FORWARD/BACKWARD) and speed (from 0 to 100) of the BitCar robot.';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TITLE'] = '[BitCar] rotate %1 speed %2 %';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Controls the right and left motors by changing the direction (↻: FORWARD, ↺: BACKWARD) and speed (from 0 to 100) of the BitCar robot.';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TITLE'] = '[BitCar] control motor %1 direction %2 speed %3 %';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Controls the right and left motors by changing the direction (↻: FORWARD, ↺: BACKWARD) and speed (from 0 to 100) of the BitCar robot.';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TITLE'] = '[BitCar] stop motor %1';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Stops the right or left motor of the BitCar robot.';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TITLE'] = '[BitCar] blink robot';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Makes the Maqueen robot blink.';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TITLE'] = '[BitCar] control RGB LED below %1 to R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Controls the color of each RGB LED of the neopixel of the BitCar robot such that the values of R, G, B are between 0 and 255.';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TITLE'] = '[BitCar] control RGB LED below %1 to %2';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Controls the color of each RGB LED of the neopixel module located under the BitCar robot. Use the palette to change the color.';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TITLE'] = '[BitCar] Rainbow';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Displays the spectrum of colors on the RGB LEDs.';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TITLE'] = '[BitCar] control buzzer frequency %1 for %2 (ms)';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Sets a frequency on the buzzer of the BitCar robot.';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TITLE'] = '[BitCar] decode infrared receiver';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Performs a read from the infrared receiver of the BitCar robot.';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TITLE'] = '[BitCar] code received from infrared receiver';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Returns the hexadecimal code received with the infrared detector of the BitCar robot.';
// Robots - Gamepad
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TITLE'] = '[BitPlayer] if button %1 is %2 then';
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'Executes instructions if one of the buttons on the BitPlayer is used. A button has two states: \'pressed\' or \'released\'.';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TITLE'] = '[BitPlayer] value of axis %1';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'Returns the value of the X or Y axis of the joystick on the BitPlayer. Joystick: 2 analog axes (X: P1 Y: P2).';
Blockly.Msg['ROBOTS_GAMEPAD_V4_ONBUTTONEVENT_TITLE'] = '[BitPlayer] if button %1 is %2 then';
Blockly.Msg['ROBOTS_GAMEPAD_V4_ONBUTTONEVENT_TOOLTIP'] = IMG_ROBOT_GAMEPAD_V4 + Blockly.Tooltip.SEP + 'Executes instructions if one of the buttons on the \'Micro:GamePad (V4.0) DFR0536\' is used. A button has two states: \'pressed\' or \'released\'. Keys: A(A), B(B), C(P13), D(P14), E(P15), F(P16), Z(P8).';
Blockly.Msg['ROBOTS_GAMEPAD_V4_LED_MOTOR_TITLE'] = '[Gamepad v4] LED and vibration motor in state %1';
Blockly.Msg['ROBOTS_GAMEPAD_V4_LED_MOTOR_TOOLTIP'] = IMG_ROBOT_GAMEPAD_V4 + Blockly.Tooltip.SEP + 'Allows controlling the state of the LED and vibration motor on the \'Micro:GamePad (V4.0) DFR0536\' (P16).';
Blockly.Msg['ROBOTS_GAMEPAD_V4_GETAXIS_TITLE'] = '[Gamepad v4] value of axis %1';
Blockly.Msg['ROBOTS_GAMEPAD_V4_GETAXIS_TOOLTIP'] = IMG_ROBOT_GAMEPAD_V4 + Blockly.Tooltip.SEP + 'Returns the value of the X or Y axis (from 0 to 1023) of the joystick on the \'Micro:GamePad (V4.0) DFR0536\'. Joystick: 2 analog axes (X: P1 Y: P2) 1 digital axis (Z: P8).';
...
// Robots - uHandbit
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TITLE'] = '[uHandbit - Color Sensor] %1';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Allows you to read the level of one of the three primary colors (red, green, blue) with the uHandbit color sensor. The color level is returned as a value between 0 and 255.';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TITLE'] = '[uHandbit - Color Sensor] detected color';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Allows you to read the color detected by the uHandbit color sensor. The color is returned as a string among the following: RED, GREEN, BLUE, BLACK, WHITE or NONE.';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TITLE'] = '[uHandbit - Ultrasonic Sensor] %1 on port %2';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Returns the distance (in cm) measured by the uHandbit ultrasonic sensor on port 1 or 2.';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TITLE'] = '[uHandbit - Servomotors] control servo %1 to angle %2° duration %3 ms';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Allows you to control the angle of a servo motor (from 0 to 180°) connected to the uHandbit. Note: the setup must be powered by a battery to provide sufficient current to the servo motor.';
Blockly.Msg["ROBOTS_UHANDBIT_SET_NEOPIXEL_TITLE"] = "[uHandbit - Neopixel] set color R %2 G %3 B %4 on LED %1";
Blockly.Msg["ROBOTS_UHANDBIT_SET_NEOPIXEL_TOOLTIP"] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + "Enable to control each LED color of uHandbit neopixel (P15) as (R,G,B) from 0 to 255.";
Blockly.Msg["ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TITLE"] = "[uHandbit - Neopixel] set color %2 on LED %1";
Blockly.Msg["ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TOOLTIP"] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + "Enable to control each LED color of uHandbit neopixel (P15). Choice color in the palette.";
Blockly.Msg["ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TITLE"] = "[uHandbit - Neopixel] rainbow";
Blockly.Msg["ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TOOLTIP"] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + "Enable to show a rainbow on uHandbit RGB LED (P15).";
// Robots - WuKong
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TITLE'] = '[WuKong] apply light mode to %1';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Allows you to apply a light mode to the WuKong board.';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_BREATH'] = 'BREATH';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_OFF'] = 'OFF';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TITLE'] = '[WuKong] controls light intensity to %1%';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Allows control of the light intensity (from 0 to 100%) on the WuKong board.';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TITLE'] = '[WuKong] control motor(s) %1 direction %2 speed %3 %';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Allows control of motors M1 and M2 by changing the direction (↻: FORWARD, ↺: BACKWARD) and speed (from 0 to 100%) of the WuKong board.';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TITLE'] = '[WuKong] stop motor(s) %1';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Allows stop the motor M1 or M2 of the WuKong board.';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TITLE'] = '[WuKong %1] set servomotor(s) %2 position at angle %3°';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Allows control of servomotors S1 to S7 by changing the angle (from 0 to 180°) of the WuKong board.';
...
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Allows continuous control of servomotors from S1 to S7 by changing the speed (from -100 to 100) of the WuKong board.';
// Robots - Building:bit - Basic
Blockly.Msg["ROBOTS_BUILDINGBIT_SETNEOPIXEL_TITLE"] = "[Building:bit] set color R %2 G %3 B %4 on LED %1";
Blockly.Msg["ROBOTS_BUILDINGBIT_SETNEOPIXEL_TOOLTIP"] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + "Enable to control each LED color ([R,G,B] from 0 to 255) of Building:bit neopixel (P12).";
Blockly.Msg["ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TITLE"] = "[Building:bit] set color %2 on LED %1";
Blockly.Msg["ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TOOLTIP"] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + "Enable to control each LED color of Building:bit neopixel (P12). Choice color in the palette.";
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TITLE'] = '[Building:bit %1] set the servomotor %2 position at angle %3°';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Allows control of servo motors S1 to S8 by changing the angle (from 0 to 360°) of the Building:bit robot.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TITLE'] = '[Building:bit] control the motor %1 direction %2 speed %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Allows control of motors M1, M2, M3, and M4 by changing the direction (↻: FORWARD, ↺: BACKWARD) and speed (from 0 to 255) of the Building:bit robot.';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TITLE'] = '[Building:bit] stop motor %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Allows stop the motor M1, M2, M3 or M4 of the Building:bit robot.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TITLE'] = '[Building:bit] Control stepper motor %1 position %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Allows control of stepper motors B1 and B2 by changing the position (from 0 to 360) of the Building:bit robot.';
...
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TOOLTIP'] = IMG_YAHBOOM_ULTRASONIC + Blockly.Tooltip.SEP + 'Returns the distance (in cm) measured by the Yahboom ultrasonic sensor on the digital pins.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TITLE'] = '[Potentiometer] value on pin %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TOOLTIP'] = IMG_YAHBOOM_POTENTIOMETER + Blockly.Tooltip.SEP + 'Returns the Yahboom potentiometer value on the analog pins (P0 to P4 or P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TITLE'] = '[Light Cap.] value on pin %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TOOLTIP'] = IMG_YAHBOOM_LIGHT_SENSOR + Blockly.Tooltip.SEP + 'Returns the ambient light level from the Yahboom light sensor on the analog pins (P0 to P4 or P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TITLE'] = '[IR Detector] obstacle detected on pin %1?';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TOOLTIP'] = IMG_YAHBOOM_IR_DETECTOR + Blockly.Tooltip.SEP + 'Returns True if an obstacle is detected by the Yahboom infrared sensor on the digital pins.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TITLE'] = '[PIR Sensor] motion detected on pin %1?';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TOOLTIP'] = IMG_YAHBOOM_PIR_MOTION_SENSOR + Blockly.Tooltip.SEP + 'Returns True if movement is detected by the Yahboom PIR sensor on the digital pins.';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TITLE'] = '[DHT11] %1 on pin %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TOOLTIP'] = IMG_YAHBOOM_DHT11 + Blockly.Tooltip.SEP + 'Returns the temperature in degrees Celsius (°C), Fahrenheit (°F), or Kelvin (K), or the humidity (in %) using the Yahboom DHT11 sensor on digital pins P0 to P20.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TITLE'] = '[Color sensor] level of %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TOOLTIP'] = IMG_YAHBOOM_COLOR_SENSOR + Blockly.Tooltip.SEP + 'Returns one of the color components (R, G, or B) from 0 to 255 using the Yahboom I2C color sensor. Connect the sensor to an I2C port.';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TITLE'] = '[Joystick] if pointed towards %1 on pins X %2 Y %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TOOLTIP'] = IMG_YAHBOOM_JOYSTICK + Blockly.Tooltip.SEP + 'Allows instructions to be executed if the joystick direction is checked. Connect the module to the analog pins (P0 to P4 or P10).';
...
Blockly.Msg['VITTAIA_LOAD_CLOUD_MODEL_TITLE'] = '%1 load model from URL %2';
Blockly.Msg['VITTAIA_LOAD_CLOUD_MODEL_TOOLTIP'] = 'Allows loading an AI model stored in the cloud.';
Blockly.Msg['VITTAIA_MAKE_PREDICTION_TITLE'] = '%1 run prediction';
Blockly.Msg['VITTAIA_MAKE_PREDICTION_TIME_WINDOW'] = 'window';
Blockly.Msg['VITTAIA_MAKE_PREDICTION_TOOLTIP'] = 'Allows running a prediction from a sensor. Adjust the time window to get a prediction if needed.';
Blockly.Msg['VITTAIA_SENSOR_ACC'] = 'accelerometer';
Blockly.Msg['VITTAIA_DETECT_CLASS_TITLE'] = '%1 if class %2 %3 detected then';
...
Blockly.Msg['VITTAIA_GET_HIGHEST_PROBABILITY_CLASS_TOOLTIP'] = 'Allows retrieving the class with the highest probability.';
// IA - Cameras
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TITLE'] = '[HuskyLens] activate mode %1';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows choosing the detection mode on the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_FACE_RECOGNITION'] = 'face detection';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_TRACKING'] = 'object tracking';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_RECOGNITION'] = 'object detection';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_LINE_TRACKING'] = 'line tracking';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_COLOR_RECOGNITION'] = 'color detection';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TAG_RECOGNITION'] = 'AprilTag detection';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_CLASSIFICATION'] = 'object classification';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_TEXT_TITLE'] = '[HuskyLens] display text %1 at position (%2,%3)';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_TEXT_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Displays text at the position (x,y) on the HuskyLens camera\'s screen.';
Blockly.Msg['CAMERAS_HUSKYLENS_CLEAR_SCREEN_TITLE'] = '[HuskyLens] clear screen';
Blockly.Msg['CAMERAS_HUSKYLENS_CLEAR_SCREEN_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Clears all displayed text from the HuskyLens camera\'s screen.';
Blockly.Msg['CAMERAS_HUSKYLENS_LEARN_ID_TITLE'] = '[HuskyLens] learn ID No. %1 automatically';
Blockly.Msg['CAMERAS_HUSKYLENS_LEARN_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Learns to automatically recognize an ID with the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_FORGET_IDS_TITLE'] = '[HuskyLens] forget all IDs';
Blockly.Msg['CAMERAS_HUSKYLENS_FORGET_IDS_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Erases all recorded IDs from the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_TITLE'] = '[HuskyLens] retrieve %1 data';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows to obtain the data returned by the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS'] = 'blocks';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS'] = 'arrows';
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TITLE'] = '[HuskyLens] associate name %1 with ID No. %2';
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows associating a name with an already registered ID.';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TITLE'] = '[HuskyLens] get %1 of detected blocks';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows to obtain detection information from the HuskyLens camera. Each identified element is stored in an array in the form [x1, y1, width, height, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ID'] = 'IDs';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X'] = 'X coordinates';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y'] = 'Y coordinates';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X1'] = 'X coordinates (origin)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y1'] = 'Y coordinates (origin)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X2'] = 'X coordinates (end)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y2'] = 'Y coordinates (end)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_WIDTH'] = 'widths';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_HEIGHT'] = 'heights';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ALL'] = 'all data';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_X'] = 'X coordinate';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_Y'] = 'Y coordinate';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_WIDTH'] = 'width';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_HEIGHT'] = 'height';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_XY_TITLE'] = '[HuskyLens] get %1 of the detected block';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_XY_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows retrieving the X or Y coordinates of the block detected by the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TITLE'] = '[HuskyLens] get %1 of detected arrows';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows to obtain detection information from the HuskyLens camera. Each identified element is stored in an array in the form [x1, y1, x2, y2, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TITLE'] = '[HuskyLens] tab of data %1 from ID #%2';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows you to obtain the returned data related to the ID entered with the HuskyLens camera. The received data is in an array in the form [x1, y1, width, height, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_DETECTED_ELEMENTS_TITLE'] = '[HuskyLens] get the number of %1 elements detected';
Blockly.Msg['CAMERAS_HUSKYLENS_DETECTED_ELEMENTS_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Allows to obtain the number of elements detected by the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_CHECK_ID_TITLE'] = '[HuskyLens] %2 check if ID No. %1 is detected';
Blockly.Msg['CAMERAS_HUSKYLENS_CHECK_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Returns True or False if the ID is detected by the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_LINE_DIRECTION_TITLE'] = '[HuskyLens] if line ID No. %1 %2';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_STRAIGHT'] = 'is straight';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_LEFT'] = 'turns left';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_RIGHT'] = 'turns right';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_LINE_DIRECTION_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Detects the direction of the line using the HuskyLens camera.';
Blockly.Msg['CAMERAS_HUSKYLENS_SAVE_MODEL_TITLE'] = '[HuskyLens] save as model No. %1';
Blockly.Msg['CAMERAS_HUSKYLENS_SAVE_MODEL_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Saves the model on the HuskyLens camera\'s SD card.';
Blockly.Msg['CAMERAS_HUSKYLENS_LOAD_MODEL_TITLE'] = '[HuskyLens] load model No. %1';
Blockly.Msg['CAMERAS_HUSKYLENS_LOAD_MODEL_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Loads the model from the HuskyLens camera\'s SD card.';
Blockly.Msg['SENSORS_VL53L0X_GETRANGEMILLIMETERS_TITLE'] = '[Time-of-Flight] distance in %1';
