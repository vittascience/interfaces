/**
 * @fileoverview Italian messages for Micro:bit. (IT)
 */
'use strict';
...
Blockly.Msg['PLOT_BAR_GRAPH_TITLE'] = 'traccia il grafico di %1';
Blockly.Msg['PLOT_BAR_GRAPH_TOOLTIP'] = 'Visualizza un grafico a barre verticali basato sui valori "value" e "high". Se "high" è uguale a 0, il grafico si regola automaticamente';
...
Blockly.Msg['GET_PIXEL_STATE_TITLE'] = 'stato del LED a x %1 y %2';
Blockly.Msg['GET_PIXEL_STATE_TOOLTIP'] = 'Permette di verificare lo stato (ON/OFF) di ciascun LED sullo schermo della scheda micro:bit.';
Blockly.Msg['TOGGLE_PIXEL_STATE_TITLE'] = 'invertire lo stato del LED a x %1 y %2';
Blockly.Msg['TOGGLE_PIXEL_STATE_TOOLTIP'] = 'Permette di invertire lo stato (ON/OFF) di ciascun LED sullo schermo della scheda micro:bit.';
...
Blockly.Msg['SET_BRIGHTNESS_TITLE'] = 'imposta luminosità %1';
Blockly.Msg['SET_BRIGHTNESS_TOOLTIP'] = 'Consente di scegliere la luminosità (da 0 a 9) del display LED della scheda micro:bit.';
...
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TITLE'] = '[ZIP Halo HD] controllare il LED %1 a R %2 G %3 B %4';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED come (R,G,B) da 0 a 255 sul modulo Zip Halo LED di Kitronik.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TITLE'] = '[ZIP Halo HD] controllare il LED %1 con colore %2';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED sul modulo Zip Halo LED di Kitronik. Usa la tavolozza per cambiare il colore.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TITLE'] = '[ZIP Halo HD] controllare tutte le LED a R %1 G %2 B %3';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permette di controllare tutte le LED sul modulo Zip Halo LED di Kitronik con il colore scelto come (R,G,B) da 0 a 255.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TITLE'] = '[ZIP Halo HD] controllare tutte le LED con colore %1';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Permette di controllare tutte le LED sul modulo Zip Halo LED di Kitronik con il colore scelto. Usa la tavolozza per cambiare il colore.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TITLE'] = '[ZIP Halo HD] Arcobaleno';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TOOLTIP'] = IMG_MODULE_KITRONIK_ZIP_HALO_HD + Blockly.Tooltip.SEP + 'Mostra lo spettro dei colori sui LED RGB del modulo Zip Halo LED di Kitronik.';
...
Blockly.Msg['DISPLAY_MY9221_REVERSE_TITLE'] = '[Module LED Bar] invert display %1 DI pins %2 DCKI %3';
...
Blockly.Msg['DISPLAY_LAMPBIT_SETLED_TITLE'] = "[LAMP:BIT] impostare il LED su %1";
Blockly.Msg['DISPLAY_LAMPBIT_SETLED_TOOLTIP'] = IMG_MODULE_LAMPBIT + Blockly.Tooltip.SEP + "Controlla il LED del lampione";
...
Blockly.Msg['IO_RUN_EVERY_TITLE'] = 'ripeti ogni %1 ora %2 minuti %3 secondi %4 millisecondi';
Blockly.Msg['IO_RUN_EVERY_TOOLTIP'] = 'Esegue ripetutamente una funzione. Ogni argomento è una diversa unità di tempo e si sommano. Ad esempio, run_every(min=2, s=30) pianifica il promemoria ogni due minuti e mezzo Nota che questa funzione è disponibile solo con micro:bit V2.';
Blockly.Msg['IO_MICROBIT_RESET_TITLE'] = '[Micro:bit] reset scheda';
Blockly.Msg['IO_MICROBIT_RESET_TOOLTIP'] = 'Riavvia la scheda micro:bit. Può essere utile per ripristinare lo stato della scheda o riavviare il programma in esecuzione.';
...
Blockly.Msg['IO_SET_PULL_TITLE'] = 'imposta il pin %1 allo stato di pull %2';
Blockly.Msg['IO_SET_PULL_TOOLTIP'] = 'Configura il pin per essere in modalità di lettura digitale con la modalità di pull data.';
Blockly.Msg['IO_SET_PULL_UP'] = 'alto';
Blockly.Msg['IO_SET_PULL_DOWN'] = 'basso';
Blockly.Msg['IO_SET_NO_PULL'] = 'nessuno';
Blockly.Msg["IO_EXEC_TITLE"] = "eseguire il codice Python %1";
Blockly.Msg["IO_EXEC_TOOLTIP"] = "Esegue il codice Python.";
Blockly.Msg["IO_EXEC_HELPURL"] = "https://docs.python.org/3/library/functions.html#exec";
// Micro:bit Logs
Blockly.Msg['COMMUNICATION_LOG_DELETE_TITLE'] = '[Log] clear log on micro:bit';
Blockly.Msg['COMMUNICATION_LOG_DELETE_TOOLTIP'] = 'Clears the log (HTML) on the micro:bit board.';
Blockly.Msg['COMMUNICATION_LOG_SERIAL_TITLE'] = '[Log] get console feedback';
Blockly.Msg['COMMUNICATION_LOG_SERIAL_TOOLTIP'] = 'Allows writing log data to the console in real-time.';
Blockly.Msg['COMMUNICATION_LOG_SETLABEL_TITLE'] = '[Log] add a new label with Timer %1';
...
Blockly.Msg['COMMUNICATION_LOG_ADDDATA_TITLE'] = '[Log] add data to label';
...
Blockly.Msg['COMMUNICATION_SERIAL_ONMESSAGERECEIVED_TITLE'] = 'se un messaggio viene ricevuto dalla porta seriale in %1, allora';
Blockly.Msg['COMMUNICATION_SERIAL_ONMESSAGERECEIVED_TOOLTIP'] = 'Consente di eseguire istruzioni se i dati decodificati (stringa UTF-8) vengono ricevuti tramite la porta seriale nella variabile \'messageData\'. Questa variabile restituisce una stringa (str).';
Blockly.Msg['COMMUNICATION_SERIAL_ONDATARECEIVED_TITLE'] = 'se i dati vengono ricevuti dalla porta seriale in %1, allora';
Blockly.Msg['COMMUNICATION_SERIAL_ONDATARECEIVED_TOOLTIP'] = 'Consente di eseguire istruzioni se i dati vengono ricevuti tramite la porta seriale nella variabile \'serialData\'. Quest\'ultimo restituisce un array di byte.';
...
Blockly.Msg['COMMUNICATION_RADIO_RECEIVE_FULL_TOOLTIP'] = 'Consente di ottenere i dettagli del prossimo messaggio tramite la radio della micro:bit. Restituisce -1 se non ci sono messaggi in arrivo.';
Blockly.Msg['COMMUNICATION_RADIO_NEXT_MESSAGE'] = 'prossimo dato ricevuto';
Blockly.Msg['COMMUNICATION_RADIO_RSSI'] = 'potenza del segnale ricevuto (RSSI)';
Blockly.Msg['COMMUNICATION_RADIO_TIMESTAMP'] = 'timestamp del dato ricevuto';
...
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Returns a boolean (1 if there\'s data to read 0 else).';
// Sensors - common msg
...
Blockly.Msg['SENSORS_MICRO_LOUD'] = 'loud';
Blockly.Msg['SENSORS_MICRO_QUIET'] = 'quiet';
Blockly.Msg['SENSORS_MICRO_IS'] = 'is';
Blockly.Msg['SENSORS_MICRO_WAS'] = 'was';
Blockly.Msg['SENSORS_MICRO_ONSOUNDDETECTED_TITLE'] = '[Micro] if %1 sound %2 detected then';
Blockly.Msg['SENSORS_MICRO_ONSOUNDDETECTED_TOOLTIP'] = 'Execute instructions if sound condition (loud/quiet) is detected. \'was\' option: Execute instructions if a (loud/quiet) sound occured since the last call to \'was_sound()\'.';
Blockly.Msg['SENSORS_MICRO_GETCURRENTSOUND_TITLE'] = '[Micro] sound condition';
Blockly.Msg['SENSORS_MICRO_GETCURRENTSOUND_TOOLTIP'] = 'Returns the sound condition (loud/quiet).';
Blockly.Msg['SENSORS_MICRO_WASSOUNDDETECTED_TITLE'] = '[Micro] %1 sound was detected';
Blockly.Msg['SENSORS_MICRO_WASSOUNDDETECTED_TOOLTIP'] = 'Returns True if a (loud/quiet) sound occured since the last call to \'was_sound()\'.';
Blockly.Msg['SENSORS_MICRO_GETSOUNDLEVEL_TITLE'] = '[Micro] sound level';
Blockly.Msg['SENSORS_MICRO_GETSOUNDLEVEL_TOOLTIP'] = 'Enable du get sound level from 0 to 255.';
Blockly.Msg['SENSORS_MICRO_GETHISTORYSOUND_TITLE'] = '[Micro] history of sounds';
Blockly.Msg['SENSORS_MICRO_GETHISTORYSOUND_TOOLTIP'] = 'Returns history of sounds since last call to \'get_sounds()\'.';
Blockly.Msg['SENSORS_MICRO_SETSOUNDTHRESHOLD_TITLE'] = '[Micro] set %1 sound threshold to %2';
Blockly.Msg['SENSORS_MICRO_SETSOUNDTHRESHOLD_TOOLTIP'] = 'Enable to set sound level threshold loud/quiet from 0 to 255.';
Blockly.Msg['SENSORS_MICRO_SOUNDCONDITION_TITLE'] = '[Micro] %1';
Blockly.Msg['SENSORS_MICRO_SOUNDCONDITION_TOOLTIP'] = 'Enable to use (LOUD/QUIET) constants from microphone module in \'Logic\' category.';
// Sensors - Enviro:bit
...
Blockly.Msg['SENSORS_KITRONIK_BME280_GETDATA_TOOLTIP'] = IMG_SHIELD_KITRONIK_ENV + Blockly.Tooltip.SEP + 'Restituisce la temperatura ambiente in gradi Celsius (°C) da -40 a 85°C, Fahrenheit (°F) o Kelvin (K), l\'umidità (in %), la pressione (in Pascal) o l\'altitudine (in m) grazie al sensore BME280 dello scudo Kitronik.';
Blockly.Msg['SENSORS_KITRONIK_KLIMATE_BME280_GETDATA_TITLE'] = '[Kitronik Klimate - BME280] %1';
Blockly.Msg['SENSORS_KITRONIK_KLIMATE_BME280_GETDATA_TOOLTIP'] = IMG_SHIELD_KITRONIK_KLIMATE + Blockly.Tooltip.SEP + 'Restituisce la temperatura ambiente in gradi Celsius (°C) da -40 a 85°C, Fahrenheit (°F) o Kelvin (K), l\'umidità (in %), la pressione (in Pascal) o l\'altitudine (in m) grazie al sensore BME280 dello scudo Kitronik.';
// Sensors - Kitronik Traffic
Blockly.Msg['SENSORS_LAMPBIT_GETLUMINOSITY_TITLE'] = "[LAMP:BIT] luminosità";
Blockly.Msg['SENSORS_LAMPBIT_GETLUMINOSITY_TOOLTIP'] = IMG_MODULE_LAMPBIT + Blockly.Tooltip.SEP + "Recupera la luminosità del fototransistor del lampione";
// Sensors - Gas
...
Blockly.Msg['SENSORS_GETGROVECAPACITIVEMOISTURE_TITLE'] = '[Sensore di umidità capacitivo] umidità del suolo %1';
Blockly.Msg['SENSORS_GETGROVECAPACITIVEMOISTURE_TOOLTIP'] = IMG_MODULE_CAPACITIVE_MOISTURE + Blockly.Tooltip.SEP + 'Restituisce l\'umidità (da 0 a 1023) misurata dal sensore di umidità capacitivo Grove sui pin P0/P14, P1/P15 o P2/P16.';
...
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TITLE'] = '[Sensore di colore v3] %1';
Blockly.Msg['SENSORS_GROVECOLORV3_GETDATA_TOOLTIP'] = IMG_MODULE_I2C_COLOR_V3 + Blockly.Tooltip.SEP + 'Permette di leggere il livello di uno dei tre colori primari (rosso, verde, blu), la luminosità (~ da 0 a 10.000K) o la temperatura (~ da 0 a 100.000 Lux) con il sensore di colore Grove v3. Permette anche di leggere il colore nel formato HSV (tonalità: 0 a 360°, saturazione: 0 a 100%, valore: 0 a 100%) e di recuperare il nome del colore associato. Collegare il sensore a una porta I2C.';
Blockly.Msg['COLOR_HUE'] = 'tonalità (°)';
Blockly.Msg['COLOR_SATURATION'] = 'saturazione (%)';
Blockly.Msg['COLOR_VALUE'] = 'valore (%)';
Blockly.Msg['COLOR_LEVEL_WHITE'] = 'livello di bianco';
Blockly.Msg['COLOR_LEVEL_TEMP'] = 'temperatura';
Blockly.Msg['COLOR_NAME'] = 'nome del colore';
...
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TITLE'] = '[Sensore di movimento mini] stato sul pin %1';
Blockly.Msg['SENSORS_GET_MINIPIR_GROVEMOTION_TOOLTIP'] = IMG_MODULE_MOTION_MINI + Blockly.Tooltip.SEP + 'Restituisce vero o falso a seconda che il sensore Grove PIR Motion mini rilevi un movimento sui pin digitali da P0 a P20.';
...
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TITLE'] = '[Sensore di frequenza cardiaca] bpm sul pin %1';
Blockly.Msg['SENSORS_GET_EAR-CLIP_HEART_RATE_TOOLTIP'] = IMG_MODULE_EAR_CLIP + Blockly.Tooltip.SEP + 'Restituisce il numero di battiti per minuto (bpm) misurati dal sensore cardiaco Grove.';
Blockly.Msg['SENSORS_GET_WATER_LEVEL_TITLE'] = '[Livello dell\'acqua] valore';
Blockly.Msg['SENSORS_GET_WATER_LEVEL_TOOLTIP'] = IMG_MODULE_WATER_I2C + Blockly.Tooltip.SEP + 'Misura il livello dell\'acqua in percentuale (da 0 a 100%) sulla porta I2C.';
// Attuatori
Blockly.Msg['ACTUATORS_SERVO_SETANGLE_TITLE'] = '[Servo Motore] imposta l\'angolo a %1 ° sul pin %2';
Blockly.Msg['ACTUATORS_SERVO_SETANGLE_TOOLTIP'] = IMG_MODULE_SERVO + Blockly.Tooltip.SEP + 'Permette di controllare l\'angolo di un servomotore (da 0 a 180) sui pin digitali da P0 a P20. Nota: l\'alimentazione deve essere fornita da una batteria per garantire una corrente sufficiente al servomotore.';
Blockly.Msg['ACTUATORS_CONTINUOUS_SERVO_SETSPEED_TITLE'] = '[Servo Continuo] imposta la velocità a %1 (%) direzione %2 sul pin %3';
...
Blockly.Msg['ACTUATORS_MOTOR_SETPOWER_TITLE'] = '[Motore] imposta la potenza a %1 sul pin %2';
Blockly.Msg['ACTUATORS_MOTOR_SETPOWER_TOOLTIP'] = IMG_MODULE_MOTOR + Blockly.Tooltip.SEP + 'Permette di controllare la potenza di un motore (da 0 a 1023) sui pin digitali da P0 a P20. Nota: l\'alimentazione deve essere fornita da una batteria per garantire una corrente sufficiente al motore.';
Blockly.Msg["ACTUATORS_FAN_SETPOWER_TITLE"] = "[Ventola] imposta la potenza a %1 sul pin %2";
Blockly.Msg["ACTUATORS_FAN_SETPOWER_TOOLTIP"] = IMG_MODULE_FAN + Blockly.Tooltip.SEP + "Permette di controllare la potenza di una mini ventola (da 0 a 1023) sui pin digitali da P0 a P20.";
Blockly.Msg['ACTUATORS_GROVERELAY_CONTROL_TITLE'] = '[Modulo Relè] imposta lo stato del relè a %1 sul pin %2';
Blockly.Msg['ACTUATORS_GROVERELAY_CONTROL_TOOLTIP'] = IMG_MODULE_RELAY + Blockly.Tooltip.SEP + 'Permette di controllare lo stato del relè (0 o 1) sui pin digitali da P0 a P20.';
...
Blockly.Msg['ACTUATORS_GROVEVIBRATIONMOTOR_CONTROL_TITLE'] = '[Motore a Vibrazione] controlla il motore a stato %1 sul pin %2';
Blockly.Msg['ACTUATORS_GROVEVIBRATIONMOTOR_CONTROL_TOOLTIP'] = IMG_MODULE_VIBRATION_MOTOR + Blockly.Tooltip.SEP + 'Permette di attivare o disattivare il motore a vibrazione Grove (0 o 1) sui pin digitali da P0 a P20.';
Blockly.Msg['ACTUATORS_GROVEELECTROMAGNET_CONTROL_TITLE'] = '[Elettromagnete] controlla lo stato %1 sul pin %2';
Blockly.Msg['ACTUATORS_GROVEELECTROMAGNET_CONTROL_TOOLTIP'] = IMG_MODULE_ELECTROMAGNET + Blockly.Tooltip.SEP + 'Permette di attivare o disattivare l\'elettromagnete (HIGH o LOW) sui pin digitali.';
Blockly.Msg['ACTUATORS_GROVEWATERATOMIZATION_CONTROL_TITLE'] = '[Atomizzatore d\'Acqua] controlla lo stato %1 sul pin %2';
Blockly.Msg['ACTUATORS_GROVEWATERATOMIZATION_CONTROL_TOOLTIP'] = IMG_MODULE_WATER_ATOMIZER + Blockly.Tooltip.SEP + 'Permette di attivare o disattivare l\'atomizzatore d\'acqua (HIGH o LOW) sui pin digitali.';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TITLE'] = '[Motore passo-passo] inizializza motore %1 su IN1 %2 IN2 %3 IN3 %4 IN4 %5';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_INIT_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Inizializza il motore passo-passo 28BYJ-48 con il driver ULN2003 sui pin digitali da P0 a P20.';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TITLE'] = '[Motore passo-passo] motore %1 ruotare di %2 %3 direzione %4';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_STEPS'] = 'passo/i';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_ROTATIONS'] = 'giro/i';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_MOVE_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Fa ruotare il motore passo-passo 28BYJ-48 di un certo numero di passi o giri in senso orario (↻) o antiorario (↺).';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TITLE'] = '[Motore passo-passo] motore %1 ritardo tra ogni passo %2 ms';
Blockly.Msg['ACTUATORS_STEPPERMOTOR_ULN2003_SET_DELAY_TOOLTIP'] = IMG_MODULE_STEPPER_ULN2003 + Blockly.Tooltip.SEP + 'Permette di regolare la velocità di rotazione del motore passo-passo 28BYJ-48 modificando il ritardo tra ogni passo (in ms). Maggiore è il ritardo, più lenta sarà la velocità. Il ritardo predefinito è di 3 ms e non può essere ridotto.';
// Attuatori - Kitronik
Blockly.Msg['ACTUATORS_ACCESSBIT_CONTROLBARRIER_TITLE'] = "[ACCESS:BIT] %1 la barriera";
Blockly.Msg['ACTUATORS_ACCESSBIT_CONTROLBARRIER_RAISE'] = "alza";
Blockly.Msg['ACTUATORS_ACCESSBIT_CONTROLBARRIER_LOWER'] = "abbassa";
Blockly.Msg['ACTUATORS_ACCESSBIT_CONTROLBARRIER_TOOLTIP'] = IMG_MODULE_ACCESSBIT + Blockly.Tooltip.SEP + "Controlla la posizione della barriera";
Blockly.Msg['ACTUATORS_ACCESSBIT_CONTROLBUZZER_TITLE'] = "[ACCESS:BIT] Buzzer attivo per %1 ms";
Blockly.Msg['ACTUATORS_ACCESSBIT_CONTROLBUZZER_TOOLTIP'] = IMG_MODULE_ACCESSBIT + Blockly.Tooltip.SEP + "Attiva il buzzer per il tempo impostato";
Blockly.Msg['ACTUATORS_KITRONIK_CONTROLMOTOR_TITLE'] = '[Kitronik Motores] controlla il motore %1 direzione %2 velocità %3';
Blockly.Msg['ACTUATORS_KITRONIK_CONTROLMOTOR_TOOLTIP'] = IMG_SHIELD_KITRONIK + Blockly.Tooltip.SEP + 'Permette di controllare MOTOR1, MOTOR2 o entrambi, modificando la direzione (↻: AVANTI, ↺: INDIETRO) o la velocità (da 0 a 100%) con lo shield Kitronik per BBC micro:bit. L\'alimentazione dello shield deve essere tra 3V e 10V.';
Blockly.Msg['ACTUATORS_KITRONIK_STOPMOTOR_TITLE'] = '[Kitronik Motores] ferma il motore %1';
Blockly.Msg['ACTUATORS_KITRONIK_STOPMOTOR_TOOLTIP'] = IMG_SHIELD_KITRONIK + Blockly.Tooltip.SEP + 'Permette di fermare MOTOR1, MOTOR2 o entrambi con lo shield Kitronik per BBC micro:bit. L\'alimentazione dello shield deve essere tra 3V e 10V.';
Blockly.Msg['ACTUATORS_KITRONIK_MOTOR_BOTH'] = 'entrambi';
// Attuatori - musica
Blockly.Msg['ACTUATORS_MUSIC_PLAYMUSIC_TITLE'] = '[Musica] riproduci musica %1 su %2';
Blockly.Msg['ACTUATORS_MUSIC_PLAYMUSIC_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di riprodurre musica con il modulo buzzer o altoparlante Grove sui pin digitali da P0 a P20.';
Blockly.Msg['ACTUATORS_MUSIC_PLAYSONG_TITLE'] = '[Musica] riproduci melodia %1 %2 su %3';
Blockly.Msg['ACTUATORS_MUSIC_PLAYSONG_ONCE'] = 'una volta';
Blockly.Msg['ACTUATORS_MUSIC_PLAYSONG_LOOP'] = 'in loop';
Blockly.Msg['ACTUATORS_MUSIC_PLAYSONG_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di riprodurre una melodia con un buzzer o un modulo altoparlante sui pin digitali da P0 a P20.';
Blockly.Msg['ACTUATORS_MUSIC_PLAY_NOTES_TITLE'] = '[Musica] riproduci note su';
Blockly.Msg['ACTUATORS_MUSIC_PLAY_NOTES_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di riprodurre note con un buzzer o un modulo altoparlante sui pin digitali da P0 a P20.';
Blockly.Msg['ACTUATORS_MUSIC_NOTE_TITLE'] = 'nota %1 all\'ottava %2 durata %3';
Blockly.Msg['ACTUATORS_MUSIC_NOTE_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di definire una nota con la sua ottava e durata.';
Blockly.Msg['MUSIC_SILENCE'] = 'Silenzio';
Blockly.Msg['ACTUATORS_MUSIC_PLAY_FREQUENCY_TITLE'] = '[Musica] riproduci frequenza %1 per %2 (ms) su %3';
Blockly.Msg['ACTUATORS_MUSIC_PLAY_FREQUENCY_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di riprodurre una frequenza sul micro:bit o con un modulo buzzer o altoparlante sui pin digitali da P0 a P20.';
Blockly.Msg['ACTUATORS_MUSIC_STOP_TITLE'] = '[Musica] ferma la musica su %1';
Blockly.Msg['ACTUATORS_MUSIC_STOP_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di fermare la musica attualmente in riproduzione sul micro:bit o sul buzzer sui pin digitali da P0 a P20.';
Blockly.Msg['ACTUATORS_MUSIC_SETVOLUME_TITLE'] = '[Musica] imposta volume a %1';
Blockly.Msg['ACTUATORS_MUSIC_SETVOLUME_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di modificare il volume dell’altoparlante integrato del micro:bit da 0 a 255.';
Blockly.Msg['ACTUATORS_MUSIC_SETTEMPO_TITLE'] = '[Musica] imposta battiti per misura %1 e tempo %2';
Blockly.Msg['ACTUATORS_MUSIC_SETTEMPO_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di impostare il numero di battiti per misura e il tempo della musica riprodotta dalle funzioni della libreria musicale.';
Blockly.Msg['ACTUATORS_MUSIC_GETTEMPO_TITLE'] = '[Musica] tempo musicale';
Blockly.Msg['ACTUATORS_MUSIC_GETTEMPO_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di ottenere il tempo della musica come una tupla di numeri interi (ticks, bpm).';
Blockly.Msg['ACTUATORS_KITRONIK_PLAY_FREQUENCY_TITLE'] = '[Kitronik Env. Shield] riproduci frequenza %1 per %2 ms';
Blockly.Msg['ACTUATORS_KITRONIK_PLAY_FREQUENCY_TOOLTIP'] = IMG_SHIELD_KITRONIK_ENV + Blockly.Tooltip.SEP + 'Permette di riprodurre una frequenza sull’altoparlante integrato dello shield ambientale Kitronik.';
Blockly.Msg['ACTUATORS_SPEECH_SAYSOMETHING_TITLE'] = '[Voce] pronuncia %1 velocità %2 intonazione %3';
Blockly.Msg['ACTUATORS_SPEECH_SAYSOMETHING_TOOLTIP'] = IMG_MODULE_BUZZER_SPEAKER + Blockly.Tooltip.SEP + 'Permette di pronunciare una frase con il micro:bit. È possibile regolare la velocità e l’intonazione della voce (da 0 a 255).';
// Notes
...
Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'] = '\n.\nClick the 🞧 button if you want to block or not the program during the execution of the command.';
...
Blockly.Msg['ROBOTS_MAQUEEN_ULTRASONICRANGER_TITLE'] = '[Maqueen Lite] ultrasonic %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLLED_TITLE'] = '[Maqueen Lite] control red LED %1 to state %2';
...
Blockly.Msg['ROBOTS_MAQUEEN_GO_TITLE'] = '[Maqueen Lite] %1 at speed %2';
...
Blockly.Msg['ROBOTS_MAQUEEN_CONTROLMOTOR_TITLE'] = '[Maqueen Lite] control motor %1 direction %2 speed %3';
...
Blockly.Msg['ROBOTS_MAQUEEN_ROTATE_TITLE'] = '[Maqueen Lite] rotate %1 speed %2';
...
Blockly.Msg['ROBOTS_MAQUEEN_STOPMOTORS_TITLE'] = '[Maqueen Lite] stop motor %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETSERVOANGLE_TITLE'] = '[Maqueen Lite] set servo %1 to angle %2 °';
...
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Maqueen Lite] move one square forward';
...
Blockly.Msg['ROBOTS_MAQUEEN_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Maqueen Lite] move back one square';
...
Blockly.Msg['ROBOTS_MAQUEEN_READPATROL_TITLE'] = '[Maqueen Lite] read line patrol %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETNEOPIXEL_TITLE'] = '[Maqueen Lite] set color R %2 G %3 B %4 on LED %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETPALETTECOLOR_TITLE'] = '[Maqueen Lite] set color %2 on LED %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETRAINBOW_TITLE'] = '[Maqueen Lite] Rainbow';
...
Blockly.Msg['ROBOTS_MAQUEEN_SETBUZZER_TITLE'] = '[Maqueen Lite] set buzzer at frequency %1 during %2 (ms)';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLAYMUSIC_TITLE'] = '[Maqueen Lite] play music %1';
...
Blockly.Msg['ROBOTS_MAQUEEN_DECODEIRRECEIVER_TITLE'] = '[Maqueen Lite] decode the infrared receiver';
...
Blockly.Msg['ROBOTS_MAQUEEN_GETIRCODE_TITLE'] = '[Maqueen Lite] code from infrared receiver';
...
// Robot - Maqieen Plus (V3) - Lidar
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TITLE'] = '[LiDAR %1] dimensione configurazione: %2';
Blockly.Msg['SENSORS_LIDAR_CONFIGMATRIX_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Consente di configurare la dimensione della matrice (8x8 o 4x4) delle misurazioni provenienti dal sensore di distanza LiDAR DFRobot collegato al robot Maqieen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_CONFIG_8X8_MATRIX'] = 'Matrice 8x8';
Blockly.Msg['SENSORS_LIDAR_CONFIG_4X4_MATRIX'] = 'Matrice 4x4';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TITLE'] = '[LiDAR %1] lettura %2';
Blockly.Msg['SENSORS_LIDAR_GETDATA_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Legge tutti i dati misurati con il sensore di distanza LiDAR DFRobot collegato al robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_DATA_DISTANCES_MATRIX'] = 'Matrice di distanza (in mm)';
Blockly.Msg['SENSORS_LIDAR_DATA_RAW_LIST'] = 'elenco dati grezzi';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TITLE'] = '[LiDAR %1] distanza misurata nel punto x %2 y %3';
Blockly.Msg['SENSORS_LIDAR_GETFIXEDPOINT_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Restituisce la distanza (in mm) da un punto specifico nella matrice (4x4 o 8x8) misurata con il sensore di distanza LiDAR DFRobot collegato al robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TITLE'] = '[LiDAR %1] configura la distanza di evitamento da %2 (cm)';
Blockly.Msg['SENSORS_LIDAR_CONFIGAVOIDANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Consente di configurare la distanza di evitamento degli ostacoli da 10 a 50 cm con il sensore di distanza LiDAR DFRobot collegato al robot Maqueen Plus V3. Il sensore attiverà il segnale di emergenza e fornirà la direzione per evitare l\'ostacolo in base a questa distanza.';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TITLE'] = '[LiDAR %1] Segnale di emergenza attivato?';
Blockly.Msg['SENSORS_LIDAR_ISSIGNALACTIVATED_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Restituisce True se il segnale di emergenza è stato attivato con il sensore di distanza LiDAR DFRobot collegato al robot Maqueen Plus V3. Il segnale viene attivato quando la distanza di evitamento è stata superata.';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TITLE'] = '[LiDAR %1] direzione da seguire per evitare l\'ostacolo';
Blockly.Msg['SENSORS_LIDAR_DIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Restituisce la direzione da seguire per evitare l\'ostacolo con il sensore di distanza LiDAR DFRobot collegato al robot Maqueen Plus V3. Le direzioni suggerite sono 1 (sinistra), 2 (destra) e 3 (dritto).';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TITLE'] = '[LiDAR %1] direzione da seguire è %2';
Blockly.Msg['SENSORS_LIDAR_ISDIRTOFOLLOW_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Restituisce True se la direzione di evitamento degli ostacoli è verificata con il sensore di distanza LiDAR DFRobot collegato al robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_LEFT'] = 'sinistra';
Blockly.Msg['SENSORS_LIDAR_DIR_TO_RIGHT'] = 'destra';
Blockly.Msg['SENSORS_LIDAR_DIR_FORWARD'] = 'avanti';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TITLE'] = '[LiDAR %1] distanza (in cm) dall\'ostacolo %2';
Blockly.Msg['SENSORS_LIDAR_GETOBSTACLEDISTANCE_TOOLTIP'] = IMG_ROBOT_DFROBOT_LIDAR + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) da un ostacolo situato a DESTRA, SINISTRA o AL CENTRO, misurata con il sensore di distanza LiDAR DFRobot collegato al robot Maqueen Plus V3.';
Blockly.Msg['SENSORS_LIDAR_DIR_LEFT'] = 'sinistra';
Blockly.Msg['SENSORS_LIDAR_DIR_MIDDLE'] = 'centrale';
Blockly.Msg['SENSORS_LIDAR_DIR_RIGHT'] = 'destra';
// Robots - Cutebot
Blockly.Msg['ROBOTS_CUTEBOT_ULTRASONICRANGER_TITLE'] = '[Cutebot] %1';
Blockly.Msg['ROBOTS_CUTEBOT_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) o la durata andata e ritorno (in μs) dell\'onda tra un oggetto e il robot Cutebot utilizzando il sensore ad ultrasuoni.';
Blockly.Msg['ROBOTS_CUTEBOT_ULTRASONIC_DISTANCE'] = 'distanza (cm)';
Blockly.Msg['ROBOTS_CUTEBOT_ULTRASONIC_DURATION'] = 'durata andata e ritorno (μs)';
Blockly.Msg['ROBOTS_CUTEBOT_BLINK_ROBOT_TITLE'] = '[Cutebot] lampeggia il robot';
Blockly.Msg['ROBOTS_CUTEBOT_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Fa lampeggiare il robot Cutebot.';
Blockly.Msg['ROBOTS_CUTEBOT_READPATROL_TITLE'] = '[Cutebot] stato del sensore di linea %1';
Blockly.Msg['ROBOTS_CUTEBOT_RIGHT'] = 'destro';
Blockly.Msg['ROBOTS_CUTEBOT_LEFT'] = 'sinistro';
Blockly.Msg['ROBOTS_CUTEBOT_READPATROL_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Legge lo stato del sensore segui-linea sinistro o destro del robot Cutebot. Il blocco restituisce 1 se il sensore è sopra la linea.';
Blockly.Msg['ROBOTS_CUTEBOT_CONTROLLED_TITLE'] = '[Cutebot] controlla LED RGB %1 %2';
Blockly.Msg['ROBOTS_CUTEBOT_CONTROLLED_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED RGB del robot Cutebot selezionando un colore dalla palette disponibile.';
Blockly.Msg['ROBOTS_CUTEBOT_CONTROL_RGB_LED_TITLE'] = '[Cutebot] controlla LED RGB %1 R %2 G %3 B %4';
Blockly.Msg['ROBOTS_CUTEBOT_CONTROL_RGB_LED_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED RGB del robot Cutebot, con valori R, G e B compresi tra 0 e 255.';
Blockly.Msg['ROBOTS_CUTEBOT_SETNEOPIXEL_TITLE'] = '[Cutebot] controlla LED RGB sotto in %1 R %2 G %3 B %4';
Blockly.Msg['ROBOTS_CUTEBOT_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED RGB del neopixel sotto il robot Cutebot (P15), con valori R, G e B compresi tra 0 e 255. Il neopixel è collegato al pin P15 del robot.';
Blockly.Msg['ROBOTS_CUTEBOT_SETPALETTECOLOR_TITLE'] = '[Cutebot] controlla LED RGB sotto in %1 %2';
Blockly.Msg['ROBOTS_CUTEBOT_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED RGB del modulo neopixel (P15) posizionato sotto il robot Maqueen. Utilizza la palette per cambiare il colore.';
Blockly.Msg['ROBOTS_CUTEBOT_GO_TITLE'] = '[Cutebot] controlla robot %1 velocità %2 %';
Blockly.Msg['ROBOTS_CUTEBOT_GO_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare i motori del robot Cutebot per farlo muovere in avanti o indietro a una velocità compresa tra 0 e 100%.';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_TITLE'] = '[Cutebot] ruota a %1 velocità %2 %';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare i motori del robot Cutebot per farlo ruotare (a destra o a sinistra) a una velocità compresa tra 0 e 100%.';
Blockly.Msg['ROBOTS_CUTEBOT_STOP_TITLE'] = '[Cutebot] ferma il robot';
Blockly.Msg['ROBOTS_CUTEBOT_STOP_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di fermare i motori del robot Cutebot.';
Blockly.Msg['ROBOTS_CUTEBOT_CONTROLMOTOR_TITLE'] = '[Cutebot] controlla motore %1 direzione %2 velocità %3 %';
Blockly.Msg['ROBOTS_CUTEBOT_MOTOR_RIGHT'] = 'destro';
Blockly.Msg['ROBOTS_CUTEBOT_MOTOR_LEFT'] = 'sinistro';
Blockly.Msg['ROBOTS_CUTEBOT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare i motori destro e sinistro modificando la direzione (↻: AVANTI, ↺: INDIETRO) e la velocità (da 0 a 100%) del robot Cutebot.';
Blockly.Msg['ROBOTS_CUTEBOT_SETSERVOANGLE_TITLE'] = '[Cutebot] imposta servo %1 a un angolo di %2°';
Blockly.Msg['ROBOTS_CUTEBOT_S1'] = 'S1';
Blockly.Msg['ROBOTS_CUTEBOT_S2'] = 'S2';
Blockly.Msg['ROBOTS_CUTEBOT_SERVO_BOTH'] = 'S1 e S2';
Blockly.Msg['ROBOTS_CUTEBOT_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di controllare i servomotori S1 e S2 modificando l\'angolo (da 0 a 180°) del robot Cutebot.';
Blockly.Msg['ROBOTS_CUTEBOT_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Cutebot] muovi di una casella in avanti';
Blockly.Msg['ROBOTS_CUTEBOT_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Sposta il robot Cutebot di una casella in avanti.';
Blockly.Msg['ROBOTS_CUTEBOT_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Cutebot] muovi di una casella indietro';
Blockly.Msg['ROBOTS_CUTEBOT_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Sposta il robot Cutebot di una casella indietro.';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_LEFT_TITLE'] = '[Cutebot] ruota a sinistra';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Ruota il robot Cutebot di 90° verso sinistra.';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_RIGHT_TITLE'] = '[Cutebot] ruota a destra';
Blockly.Msg['ROBOTS_CUTEBOT_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Ruota il robot Cutebot di 90° verso destra.';
Blockly.Msg['ROBOTS_CUTEBOT_SETBUZZER_TITLE'] = '[Cutebot] controllare il buzzer alla frequenza %1 per %2 (ms)';
Blockly.Msg['ROBOTS_CUTEBOT_SETBUZZER_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di impostare una frequenza sul buzzer del robot Cutebot (P0).';
Blockly.Msg['ROBOTS_CUTEBOT_PLAYMUSIC_TITLE'] = '[Cutebot] riprodurre musica %1';
Blockly.Msg['ROBOTS_CUTEBOT_PLAYMUSIC_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Permette di riprodurre musica con il buzzer del robot Cutebot collegato al pin (P0).';
Blockly.Msg['ROBOTS_CUTEBOT_DECODEIRRECEIVER_TITLE'] = '[Cutebot] decodifica ricevitore infrarosso';
Blockly.Msg['ROBOTS_CUTEBOT_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Effettua una lettura del ricevitore infrarosso (P16) del robot Cutebot.';
Blockly.Msg['ROBOTS_CUTEBOT_GETIRCODE_TITLE'] = '[Cutebot] codice ricevuto dal ricevitore infrarosso';
Blockly.Msg['ROBOTS_CUTEBOT_GETIRCODE_TOOLTIP'] = IMG_ROBOT_CUTEBOT + Blockly.Tooltip.SEP + 'Restituisce il codice esadecimale ricevuto con il rilevatore infrarosso (P16) del robot Cutebot.';
...
Blockly.Msg['ROBOTS_CUTEBOTPRO_RUNDISTANCE_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Allows you to travel a certain distance (in cm) or (in inches) FORWARD or BACKWARD with the Cutebot Pro robot.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
Blockly.Msg['ROBOTS_CUTEBOTPRO_TURNWITHANGLE_TITLE'] = '[Cutebot Pro] turn %1 by %2 °';
Blockly.Msg['ROBOTS_CUTEBOTPRO_TURNWITHANGLE_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Allows you to turn the Cutebot Pro robot left or right by a certain angle (in °).' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
...
Blockly.Msg['ROBOTS_CUTEBOTPRO_PLACEWITHANGLE_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Allows you to rotate the Cutebot Pro robot left or right at an angular position (in °).' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
...
Blockly.Msg['ROBOTS_CUTEBOTPRO_TURNWHEEL_TOOLTIP'] = IMG_ROBOT_CUTEBOT_PRO + Blockly.Tooltip.SEP + 'Allows you to turn the right and/or left wheels by a certain angle (in °) or (in Tr) of the Cutebot Pro robot. 1 Tr corresponds to 360 °, or one complete turn of the wheel.' + Blockly.Msg['ROBOTS_WAITING_BUTTON_TOOLTIP'];
...
// Robots - Kitrobot
Blockly.Msg['ROBOTS_KITROBOT_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_KITROBOT_LEFT'] = 'izquierda';
Blockly.Msg['ROBOTS_KITROBOT_RIGHT&LEFT'] = 'derecha & izquierda';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONICRANGER_TITLE'] = '[Kit:robot v2] %1';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) o la duración del viaje de ida y vuelta (en μs) de la onda entre un objeto y el Kit:robot v2 utilizando el sensor ultrasónico.';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONIC_DISTANCE'] = 'distancia (cm)';
Blockly.Msg['ROBOTS_KITROBOT_ULTRASONIC_DURATION'] = 'duración del viaje de ida y vuelta (μs)';
Blockly.Msg['ROBOTS_KITROBOT_GO_TITLE'] = '[Kit:robot v2] controlar el robot %1 velocidad %2 %';
Blockly.Msg['ROBOTS_KITROBOT_GO_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Permite controlar el caminar (ADELANTE/ATRÁS) así como la velocidad (del 0 al 100%) del Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_CONTROLMOTOR_TITLE'] = '[Kit:robot v2] controlar el motor %1 dirección %2 velocidad %3 %';
Blockly.Msg['ROBOTS_KITROBOT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Permite controlar los motores derecho e izquierdo cambiando la dirección (↻: ADELANTE, ↺: ATRÁS) y la velocidad (del 0 al 100%) del Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_ROTATE_TITLE'] = '[Kit:robot v2] rotar %1 velocidad %2 %';
Blockly.Msg['ROBOTS_KITROBOT_ROTATE_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Permite controlar los motores derecho e izquierdo cambiando la dirección (↻: ADELANTE, ↺: ATRÁS) y la velocidad (del 0 al 100%) del Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_STOPMOTORS_TITLE'] = '[Kit:robot v2] detener el motor %1';
Blockly.Msg['ROBOTS_KITROBOT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Permite detener el motor derecho o izquierdo del Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_SERVO_BOTH'] = 'ambos';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Kit:robot v2] mover una cuadricula hacia adelante';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Mueve el Kit:robot v2 una cuadricula hacia adelante.';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Kit:robot v2] mover una cuadricula hacia atrás';
Blockly.Msg['ROBOTS_KITROBOT_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Mueve el Kit:robot v2 una cuadricula hacia atrás.';
Blockly.Msg['ROBOTS_KITROBOT_TURN_LEFT_TITLE'] = '[Kit:robot v2] girar a la izquierda';
Blockly.Msg['ROBOTS_KITROBOT_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Gira el Kit:robot v2 90° a la izquierda.';
Blockly.Msg['ROBOTS_KITROBOT_TURN_RIGHT_TITLE'] = '[Kit:robot v2] girar a la derecha';
Blockly.Msg['ROBOTS_KITROBOT_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Gira el Kit:robot v2 90° a la derecha.';
Blockly.Msg['ROBOTS_KITROBOT_STOP_ROBOT_TITLE'] = '[Kit:robot v2] detener el robot';
Blockly.Msg['ROBOTS_KITROBOT_STOP_ROBOT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Detiene los motores del Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_BLINK_ROBOT_TITLE'] = '[Kit:robot v2] hacer parpadear al robot';
Blockly.Msg['ROBOTS_KITROBOT_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Hace parpadear el Kit:robot v2.';
Blockly.Msg['ROBOTS_KITROBOT_READPATROL_TITLE'] = '[Kit:robot v2] estado del sensor de línea %1';
Blockly.Msg['ROBOTS_KITROBOT_READPATROL_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Permite leer el estado del sensor de seguimiento de línea izquierda o derecha del Kit:robot v2. El bloque devuelve 0 o 1 dependiendo de si el sensor está sobre la línea o no.';
Blockly.Msg['ROBOTS_KITROBOT_SETNEOPIXEL_TITLE'] = '[Kit:robot v2] controlla il LED RGB in %1 a R %2 G %3 B %4';
...
Blockly.Msg['ROBOTS_KITROBOT_SETRAINBOW_TITLE'] = '[Kit:robot v2] arcobaleno';
Blockly.Msg['ROBOTS_KITROBOT_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Mostra lo spettro dei colori sui LED RGB.';
Blockly.Msg['ROBOTS_KITROBOT_SETBUZZER_TITLE'] = '[Kit:robot v2] controlla il cicalino alla frequenza %1 per %2 (ms)';
Blockly.Msg['ROBOTS_KITROBOT_SETBUZZER_TOOLTIP'] = IMG_ROBOT_KITROBOT + Blockly.Tooltip.SEP + 'Permette di configurare una frequenza nel cicalino del Kit:robot v2.';
// Robots - Codo
Blockly.Msg['ROBOTS_CODO_GO_TITLE'] = '[Codo] %1 at speed %2';
...
Blockly.Msg['ROBOTS_OOBYBOT_GO_TITLE'] = '[Oobybot] %1 at speed %2%';
...
// Robots - Buggy
Blockly.Msg['ROBOTS_BUGGY_GO_TITLE'] = '[Buggy] %1 at speed %2';
...
Blockly.Msg['ROBOTS_BITBOT_GO_TITLE'] = '[Bit:Bot] %1 at speed %2';
...
// Robots - Gamepad
Blockly.Msg['ROBOTS_GAMEPAD_V4_ONBUTTONEVENT_TITLE'] = '[Gamepad v4] se il pulsante %1 è %2 allora';
Blockly.Msg['ROBOTS_GAMEPAD_V4_ONBUTTONEVENT_TOOLTIP'] = IMG_ROBOT_GAMEPAD_V4 + Blockly.Tooltip.SEP + 'Esegue istruzioni se uno dei pulsanti del \'Micro:GamePad (V4.0) DFR0536\' viene utilizzato. Un pulsante ha due stati: \'premuto\' o \'rilasciato\'. Tasti: A(A), B(B), C(P13), D(P14), E(P15), F(P16), Z(P8).';
Blockly.Msg['ROBOTS_GAMEPAD_V4_LED_MOTOR_TITLE'] = '[Gamepad v4] LED e motore di vibrazione in stato %1';
Blockly.Msg['ROBOTS_GAMEPAD_V4_LED_MOTOR_TOOLTIP'] = IMG_ROBOT_GAMEPAD_V4 + Blockly.Tooltip.SEP + 'Permette di controllare lo stato del LED e del motore di vibrazione sul \'Micro:GamePad (V4.0) DFR0536\' (P16).';
Blockly.Msg['ROBOTS_GAMEPAD_V4_GETAXIS_TITLE'] = '[Gamepad v4] valore dell\'asse %1';
Blockly.Msg['ROBOTS_GAMEPAD_V4_GETAXIS_TOOLTIP'] = IMG_ROBOT_GAMEPAD_V4 + Blockly.Tooltip.SEP + 'Restituisce il valore dell\'asse X o Y (da 0 a 1023) del joystick del \'Micro:GamePad (V4.0) DFR0536\'. Joystick: 2 assi analogici (X: P1 Y: P2) 1 asse digitale (Z: P8).';
...
//Camere
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TITLE'] = '[HuskyLens] attivare la modalità %1';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di selezionare la modalità di rilevamento sulla fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_FACE_RECOGNITION'] = 'rilevamento del volto';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_TRACKING'] = 'tracciamento oggetto';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_RECOGNITION'] = 'rilevamento oggetto';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_LINE_TRACKING'] = 'tracciamento linea';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_COLOR_RECOGNITION'] = 'rilevamento colore';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TAG_RECOGNITION'] = 'rilevamento AprilTag';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_CLASSIFICATION'] = 'classificazione oggetto';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_TEXT_TITLE'] = '[HuskyLens] mostra il testo %1 alla posizione (%2,%3)';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_TEXT_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Mostra un testo alla posizione (x,y) sullo schermo della fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_CLEAR_SCREEN_TITLE'] = '[HuskyLens] cancellare lo schermo';
...
Blockly.Msg['CAMERAS_HUSKYLENS_LEARN_ID_TITLE'] = '[HuskyLens] apprendere automaticamente l\'ID n°%1';
Blockly.Msg['CAMERAS_HUSKYLENS_LEARN_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di riconoscere automaticamente un ID con la fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_FORGET_IDS_TITLE'] = '[HuskyLens] dimenticare tutti gli ID';
...
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_TITLE'] = '[HuskyLens] recuperare i dati %1';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di ottenere i dati restituiti dalla fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS'] = 'blocchi';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS'] = 'frecce';
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TITLE'] = '[HuskyLens] associare il nome %1 all\'ID n°%2';
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di associare un nome a un ID già registrato (modalità riconoscimento volti).';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TITLE'] = '[HuskyLens] ottenere %1 dei blocchi rilevati';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di ottenere le informazioni di rilevamento dalla fotocamera HuskyLens. Ogni elemento identificato è memorizzato in un array nel formato [x1, y1, larghezza, altezza, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ID'] = 'gli ID';
...
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X2'] = 'le coordinate X (destinazione)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y2'] = 'le coordinate Y (destinazione)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_X'] = 'coordinata X';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_Y'] = 'coordinata Y';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_WIDTH'] = 'larghezza';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_SINGLE_HEIGHT'] = 'altezza';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_WIDTH'] = 'le larghezze';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_HEIGHT'] = 'le altezze';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ALL'] = 'tutti i dati';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_XY_TITLE'] = '[HuskyLens] ottieni %1 del blocco rilevato';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_XY_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di recuperare le coordinate X o Y del blocco rilevato dalla fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TITLE'] = '[HuskyLens] ottieni %1 delle frecce rilevate';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di ottenere le informazioni di rilevamento dalla fotocamera HuskyLens. Ogni elemento identificato viene memorizzato in un array con la forma [x1, y1, x2, y2, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_DETECTED_ELEMENTS_TITLE'] = '[HuskyLens] ottieni il numero di elementi %1 rilevati';
Blockly.Msg['CAMERAS_HUSKYLENS_DETECTED_ELEMENTS_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permette di ottenere il numero di elementi rilevati dalla fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_CHECK_ID_TITLE'] = '[HuskyLens] %2 verifica se l’ID n° %1 è rilevato';
Blockly.Msg['CAMERAS_HUSKYLENS_CHECK_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Restituisce True o False se l’ID è rilevato dalla fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_LINE_DIRECTION_TITLE'] = '[HuskyLens] se la linea ID n° %1 %2';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_STRAIGHT'] = 'è dritta';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_LEFT'] = 'gira a sinistra';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_RIGHT'] = 'gira a destra';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_LINE_DIRECTION_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Rileva la direzione della linea utilizzando la fotocamera HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_SAVE_MODEL_TITLE'] = '[HuskyLens] salva come modello n° %1';
...
Blockly.Msg['CAMERAS_HUSKYLENS_LOAD_MODEL_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Carica il modello dalla scheda SD della fotocamera HuskyLens.';

Blockly.Msg['IO_GETMAGNETICSWITCH_TITLE'] = '[Modulo interruttore magnetico] stato sul pin %1';
Blockly.Msg['IO_GETMAGNETICSWITCH_TOOLTIP'] = IMG_MODULE_MAGNETIC_SWITCH + Blockly.Tooltip.SEP + 'Restituisce il valore dell\'interruttore magnetico Grove (0 o 1) sui pin digitali da P0 a P20.';
Blockly.Msg['SENSORS_BAROMETER_READDATA_TITLE'] = '[Barometro] %1';
Blockly.Msg['SENSORS_BAROMETER_READDATA_TOOLTIP'] = IMG_MODULE_HP206C + Blockly.Tooltip.SEP + 'Restituisce la temperatura in gradi Celsius (°C), Fahrenheit (°F) o Kelvin (K), la pressione (in hPa) o l\'altitudine (in m) utilizzando il barometro. Collegare il sensore a una porta I2C.';
Blockly.Msg['SENSORS_SHT35_READDATA_TITLE'] = '[Sensore SHT35] %1';
Blockly.Msg['SENSORS_SHT35_READDATA_TOOLTIP'] = IMG_MODULE_SHT35 + Blockly.Tooltip.SEP + 'Restituisce la temperatura in gradi Celsius (°C), Fahrenheit (°F) o Kelvin (K), o l\'umidità (in %) utilizzando il sensore SHT35. Collegare il sensore a una porta I2C.';
Blockly.Msg['SENSORS_FSR402_GETFORCE_TITLE'] = '[Sensore di forza] valore sul pin %1';
Blockly.Msg['SENSORS_FSR402_GETFORCE_TOOLTIP'] = IMG_MODULE_FORCE + Blockly.Tooltip.SEP + 'Restituisce la forza applicata al sensore rotondo utilizzando il sensore FSR402 sui pin analogici (P0 a P4 o P10).';
Blockly.Msg['SENSORS_EMG_DETECTOR_TITLE'] = '[Rilevatore EMG] valore sul pin %1';
Blockly.Msg['SENSORS_EMG_DETECTOR_TOOLTIP'] = IMG_MODULE_EMG_DETECTOR + Blockly.Tooltip.SEP + 'Misura le correnti elettriche che accompagnano l\'attività muscolare sui pin analogici (P0 a P4 o P10).';
Blockly.Msg['ACTUATORS_GROVEELECTROMAGNET_CONTROL_TITLE'] = '[Elettromagnete] controlla a stato %1 sul pin %2';
Blockly.Msg['ACTUATORS_GROVEELECTROMAGNET_CONTROL_TOOLTIP'] = IMG_MODULE_ELECTROMAGNET + Blockly.Tooltip.SEP + 'Consente di attivare o disattivare l\'elettromagnete (ALTO o BASSO) sui pin digitali.';
Blockly.Msg['ACTUATORS_GROVEWATERATOMIZATION_CONTROL_TITLE'] = '[Atomizzatore d\'acqua] controlla a stato %1 sul pin %2';
Blockly.Msg['ACTUATORS_GROVEWATERATOMIZATION_CONTROL_TOOLTIP'] = IMG_MODULE_WATER_ATOMIZER + Blockly.Tooltip.SEP + 'Consente di attivare o disattivare l\'atomizzatore d\'acqua (ALTO o BASSO) sui pin digitali.';
...
Blockly.Msg['ROBOTS_BITCAR_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) o la durata del viaggio di andata e ritorno (in μs) dell\'onda tra un oggetto e il robot BitCar grazie al sensore ad ultrasuoni.';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TITLE'] = '[BitCar]  stato del sensore di linea %1';
Blockly.Msg['ROBOTS_BITCAR_READPATROL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di leggere lo stato di uno dei sensori seguire linea del robot BitCar. Il blocco restituisce 0 se il sensore si trova sopra la linea.';
Blockly.Msg['ROBOTS_BITCAR_GO_TITLE'] = '[BitCar] controllare il robot %1 velocità %2 %';
Blockly.Msg['ROBOTS_BITCAR_GO_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di controllare il movimento (AVANTI/INDIETRO) e la velocità (da 0 a 100) del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TITLE'] = '[BitCar] ruotare %1 velocità %2 %';
Blockly.Msg['ROBOTS_BITCAR_ROTATE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di controllare i motori destro e sinistro cambiando la direzione (↻ : AVANTI, ↺ : INDIETRO) e la velocità (da 0 a 100) del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TITLE'] = '[BitCar] controllare il motore %1 direzione %2 velocità %3 %';
Blockly.Msg['ROBOTS_BITCAR_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di controllare i motori destro e sinistro cambiando la direzione (↻ : AVANTI, ↺ : INDIETRO) e la velocità (da 0 a 100) del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TITLE'] = '[BitCar] fermare il motore %1';
Blockly.Msg['ROBOTS_BITCAR_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di fermare il motore destro o sinistro del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TITLE'] = '[BitCar] lampeggiare il robot';
Blockly.Msg['ROBOTS_BITCAR_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Fa lampeggiare il robot Maqueen.';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TITLE'] = '[BitCar] controllare il LED RGB sotto %1 a R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BITCAR_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED RGB del neopixel del robot BitCar affinché i valori R,G,B siano compresi tra 0 e 255.';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TITLE'] = '[BitCar] controllare il LED RGB sotto %1 a %2';
Blockly.Msg['ROBOTS_BITCAR_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di controllare il colore di ogni LED RGB del modulo neopixel situato sotto il robot BitCar. Utilizzare la palette per cambiare colore.';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TITLE'] = '[BitCar] Arcobaleno';
Blockly.Msg['ROBOTS_BITCAR_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Mostra lo spettro dei colori sui LED RGB.';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TITLE'] = '[BitCar] controllare il buzzer alla frequenza %1 per %2 (ms)';
Blockly.Msg['ROBOTS_BITCAR_SETBUZZER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Permette di impostare una frequenza sul buzzer del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TITLE'] = '[BitCar] decodificare il ricevitore infrarosso';
Blockly.Msg['ROBOTS_BITCAR_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Esegue una lettura del ricevitore infrarosso del robot BitCar.';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TITLE'] = '[BitCar] codice ricevuto dal ricevitore infrarosso';
Blockly.Msg['ROBOTS_BITCAR_GETIRCODE_TOOLTIP'] = IMG_ROBOT_BITCAR + Blockly.Tooltip.SEP + 'Restituisce il codice esadecimale ricevuto con il rilevatore infrarosso del robot BitCar.';
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TITLE'] = '[BitPlayer] se il pulsante %1 è %2 allora';
Blockly.Msg['ROBOTS_BITPLAYER_ONBUTTONEVENT_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'Esegue istruzioni se uno dei pulsanti del controller BitPlayer è utilizzato. Un pulsante ha due stati: \'premuto\' o \'rilasciato\'.';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TITLE'] = '[BitPlayer] valore dell\'asse %1';
Blockly.Msg['ROBOTS_BITPLAYER_GETAXIS_TOOLTIP'] = IMG_ROBOT_BITPLAYER + Blockly.Tooltip.SEP + 'Restituisce il valore dell\'asse X o Y del joystick del controller BitPlayer. Joystick: 2 assi analogici (X: P1 Y: P2).';
Blockly.Msg['ROBOTS_MAQUEEN_MIDDLE'] = 'Blockly.Msg[\'ROBOTS_MAQUEEN_MIDDLE\'] = \'centrale\';';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TITLE'] = '[Maqueen Lite v5] valore del sensore di linea %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Consente di leggere il valore del sensore di linea sinistro, centrale o destro del robot Maqueen Lite v5.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TITLE'] = '[Maqueen Lite v5] livello della batteria (%) tipo %1';
Blockly.Msg['ROBOTS_MAQUEEN_V5_BATTERY_LEVEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Restituisce il livello residuo della batteria (in %) del robot Maqueen Lite v5 a seconda che sia alcalina o al litio.';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TITLE'] = 'Blockly.Msg[\'ROBOTS_MAQUEEN_V5_PATROLLING_TITLE\'] = \'[Maqueen Lite v5] pattugliare %1\';';
Blockly.Msg['ROBOTS_MAQUEEN_V5_PATROLLING_TOOLTIP'] = IMG_ROBOT_MAQUEEN + Blockly.Tooltip.SEP + 'Consente al robot Maqueen Lite v5 di pattugliare: si muoverà nello spazio ed eviterà automaticamente gli ostacoli grazie al sensore di distanza a ultrasuoni.';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TITLE'] = '[Kitronik 16-Servos] impostare il servo %1 all\'angolo %2°';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TOOLTIP'] = IMG_MODULE_KITRONIK_SHIELD_16_SERVOS + Blockly.Tooltip.SEP + 'Consente di impostare l\'angolo di un servomotore (da 0 a 180) collegato allo shield Kitronik da 16 servos. Attenzione: l\'alimentazione deve provenire da una batteria per fornire corrente sufficiente al servomotore.';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TITLE'] = '[uHandbit - Sensore di colore] %1';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_READ_RGB_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Consente di leggere le componenti RGB (da 0 a 255) del sensore di colore uHandbit collegato alla porta 4.';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TITLE'] = '[uHandbit - Sensore di colore] colore rilevato';
Blockly.Msg['ROBOTS_UHANDBIT_COLOR_SENSOR_GET_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Consente di leggere il colore rilevato dal sensore di colore uHandbit collegato alla porta 4. Il colore viene restituito come stringa tra le seguenti: RED, GREEN, BLUE, BLACK, WHITE o NONE.';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TITLE'] = '[uHandbit - Sensore a ultrasuoni] %1 sulla porta %2';
Blockly.Msg['ROBOTS_UHANDBIT_ULTRASONIC_GET_DISTANCE_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) misurata dal sensore a ultrasuoni dell\'uHandbit sulla porta 1 o 2.';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TITLE'] = '[uHandbit - Servomotori] impostare il servo %1 all\'angolo %2° durata %3 ms';
Blockly.Msg['ROBOTS_UHANDBIT_CONTROL_SERVO_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Consente di impostare l\'angolo di un servomotore (da 0 a 180) collegato al modulo uHandbit. La durata serve a controllare la velocità di rotazione del servomotore.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TITLE'] = '[uHandbit - Neopixel] impostare il LED %1 a  R %2 G %3 B %4';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Consente di impostare il colore di ogni LED del neopixel del modulo uHandbit (P15) in modo che i valori (R, G, B) siano compresi tra 0 e 255.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TITLE'] = '[uHandbit - Neopixel] impostare il LED %1 a %2';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_PALETTE_COLOR_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Consente di impostare il colore di ogni LED del neopixel del modulo uHandbit (P15). Usa la palette per cambiare il colore dei LED RGB.';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TITLE'] = '[uHandbit - Neopixel] Arcobaleno';
Blockly.Msg['ROBOTS_UHANDBIT_SET_NEOPIXEL_RAINBOW_TOOLTIP'] = IMG_MODULE_UHANDBIT + Blockly.Tooltip.SEP + 'Mostra lo spettro dei colori sui LED RGB del modulo uHandbit (P15).';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TITLE'] = '[WuKong] applicare la modalità luminosa a %1';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTMODE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Consente di applicare una modalità luminosa sulla scheda WuKong.';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_BREATH'] = 'RESPIRAZIONE';
Blockly.Msg['ROBOTS_WUKONG_LIGHT_OFF'] = 'SPENTO';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TITLE'] = '[WuKong] impostare l\'intensità luminosa al %1 %';
Blockly.Msg['ROBOTS_WUKONG_SETLIGHTINTENSITY_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Consente di impostare l\'intensità luminosa (da 0 a 100) sulla scheda WuKong.';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TITLE'] = '[WuKong] controllare il/i motore/i %1 direzione %2 velocità %3 %';
Blockly.Msg['ROBOTS_WUKONG_CONTROLMOTOR_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Consente di controllare i motori M1 e M2 cambiando la direzione (↻ : AVANTI, ↺ : INDIETRO) e la velocità (da 0 a 100%) della scheda WuKong.';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TITLE'] = '[WuKong] fermare il/i motore/i %1';
Blockly.Msg['ROBOTS_WUKONG_STOPMOTORS_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Consente di controllare i motori M1 e M2 cambiando la direzione (↻ : AVANTI, ↺ : INDIETRO) e la velocità (da 0 a 100%) della scheda WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TITLE'] = '[WuKong %1] posizionare il/i servomotore/i %2 all\'angolo %3°';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOANGLE_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Consente di controllare i servomotori da S1 a S7 cambiando l\'angolo (da 0 a 360°) della scheda WuKong.';
Blockly.Msg['ROBOTS_WUKONG_SERVO_ALL'] = 'tutti';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TITLE'] = '[WuKong] controllare il/i servomotore/i %1 alla velocità %2 %';
Blockly.Msg['ROBOTS_WUKONG_SETSERVOSPEED_TOOLTIP'] = IMG_MICROBIT_WUKONG + Blockly.Tooltip.SEP + 'Consente di controllare i servomotori continui da S1 a S7 cambiando la velocità (da -100 a 100) della scheda WuKong.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TITLE'] = '[Building:bit] impostare il LED RGB sotto %1 a R %2 G %3 B %4';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Consente di impostare il colore di ogni LED RGB del neopixel del robot Building:bit (P12) in modo che i valori R,G,B siano compresi tra 0 e 255. Il neopixel è collegato al pin P12 del robot.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TITLE'] = '[Building:bit] impostare il LED RGB sotto %1 a %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Consente di impostare il colore di ogni LED RGB del modulo neopixel (P12) sotto il robot Building:bit. Usa la palette per cambiare il colore.';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TITLE'] = '[Building:bit %1] posizionare il servomotore %2 all\'angolo %3°';
Blockly.Msg['ROBOTS_BUILDINGBIT_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Consente di controllare i servomotori da S1 a S8 cambiando l\'angolo (da 0 a 360°) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TITLE'] = '[Building:bit] controllare il motore %1 direzione %2 velocità %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Consente di controllare i motori M1, M2, M3 e M4 cambiando la direzione (↻ : AVANTI, ↺ : INDIETRO) e la velocità (da 0 a 255) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TITLE'] = '[Building:bit] fermare il motore %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Consente di controllare i motori M1, M2, M3 e M4 cambiando la direzione (↻ : AVANTI, ↺ : INDIETRO) e la velocità (da 0 a 255) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TITLE'] = '[Building:bit] controllare il motore passo-passo %1 posizione %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_CONTROLSTEPPERMOTOR_TOOLTIP'] = IMG_ROBOT_BUILDINGBIT + Blockly.Tooltip.SEP + 'Consente di controllare i motori passo-passo B1 e B2 cambiando la posizione (da 0 a 360) del robot Building:bit.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TITLE'] = '[Sensore a ultrasuoni] distanza sui pin TRIG %1 ECHO %2 ';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETULTRASONICDISTANCE_TOOLTIP'] = IMG_YAHBOOM_ULTRASONIC + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) misurata dal sensore a ultrasuoni Yahboom sui pin digitali.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TITLE'] = '[Potenziometro] valore sul pin %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPOTENTIOMETERVALUE_TOOLTIP'] = IMG_YAHBOOM_POTENTIOMETER + Blockly.Tooltip.SEP + 'Restituisce il valore del potenziometro Yahboom sui pin analogici (P0 a P4 o P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TITLE'] = '[Sensore di luce] valore sul pin %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETLIGHTLEVEL_TOOLTIP'] = IMG_YAHBOOM_LIGHT_SENSOR + Blockly.Tooltip.SEP + 'Restituisce la luminosità ambientale dal sensore di luce Yahboom sui pin analogici (P0 a P4 o P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TITLE'] = '[Rilevatore IR] ostacolo rilevato sul pin %1 ?';
Blockly.Msg['ROBOTS_BUILDINGBIT_ISOBSTACLEDETECTED_TOOLTIP'] = IMG_YAHBOOM_IR_DETECTOR + Blockly.Tooltip.SEP + 'Restituisce True se il sensore a infrarossi Yahboom sui pin digitali rileva un ostacolo.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TITLE'] = '[Sensore PIR] movimento rilevato sul pin %1 ?';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETPIRSTATE_TOOLTIP'] = IMG_YAHBOOM_PIR_MOTION_SENSOR + Blockly.Tooltip.SEP + 'Restituisce True se viene rilevato movimento dal sensore PIR Yahboom sui pin digitali.';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TITLE'] = '[DHT11] %1 sul pin %2';
Blockly.Msg['ROBOTS_BUILDINGBIT_DHT11_READDATA_TOOLTIP'] = IMG_YAHBOOM_DHT11 + Blockly.Tooltip.SEP + 'Restituisce la temperatura in gradi Celsius (°C), Fahrenheit (°F) o Kelvin (K), o l\'umidità (in %) dal sensore DHT11 Yahboom sui pin digitali P0 a P20.';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TITLE'] = '[Sensore di colore] valore di %1';
Blockly.Msg['ROBOTS_BUILDINGBIT_GETCOLOR_TOOLTIP'] = IMG_YAHBOOM_COLOR_SENSOR + Blockly.Tooltip.SEP + 'Restituisce una delle componenti del colore (R, G o B) da 0 a 255 grazie al sensore di colore I2C Yahboom. Collegare il sensore a una porta I2C.';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TITLE'] = '[Joystick] se diretto verso %1 sui pin X %2 Y %3';
Blockly.Msg['ROBOTS_BUILDINGBIT_ONJOYSTICKDIR_TOOLTIP'] = IMG_YAHBOOM_JOYSTICK + Blockly.Tooltip.SEP + 'Consente di eseguire istruzioni se la direzione del joystick corrisponde. Collegare il modulo ai pin analogici (P0 a P4 o P10).';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_UP'] = 'su';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_DOWN'] = 'giù';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_BUILDINGBIT_DIR_LEFT'] = 'sinistra';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TITLE'] = '[HuskyLens] array dei dati %1 dell\'ID n°%2';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Consente di ottenere i dati restituiti relativi all\'ID specificato con la camera HuskyLens. I dati ricevuti sono in un array della forma [x1, y1, larghezza, altezza, id]. ';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - modifica il parametro %1 in %2 sui pin TXD %3 RXD %4';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Permette di modificare i parametri del modulo Bluetooth HM10 inviando un comando AT. Una volta cambiato il parametro, non è più necessario tornare a questa modalità perché viene salvato nella memoria del modulo.';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - valore del parametro %1 sui pin TXD %2 RXD %3';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Permette di ottenere il valore di un parametro del modulo Bluetooth HM10 inviando un comando AT.';
Blockly.Msg['COMMUNICATION_UART_READLINE_TITLE'] = '[uart] leggi una riga di dati';
Blockly.Msg['COMMUNICATION_UART_READLINE_TOOLTIP'] = 'Permette di leggere i dati dalla porta uart definita fino a quando \'\\n\' non viene letto.';
Blockly.Msg['COMMUNICATION_I2C_INIT_TITLE'] = '[i2c] Inizializza la frequenza a %1 Hz sui pin SDA %2 SCL %3';
Blockly.Msg['COMMUNICATION_I2C_INIT_TOOLTIP'] = 'Permette di reimpostare la comunicazione I2C su pin specifici alla frequenza desiderata (100 kHz - 400 kHz).';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TITLE'] = '[i2c] Elenco dei dispositivi I2C rilevati';
Blockly.Msg['COMMUNICATION_I2C_SCAN_TOOLTIP'] = 'Restituisce i dispositivi I2C rilevati sui pin I2C come elenco di indirizzi.';
Blockly.Msg['COMMUNICATION_I2C_REPEAT'] = 'Ripetere?';
Blockly.Msg['COMMUNICATION_I2C_READ_TITLE'] = '[i2c] indirizzo %1 leggi dati di lunghezza %2';
Blockly.Msg['COMMUNICATION_I2C_READ_TOOLTIP'] = 'Permette di leggere N byte dall\'indirizzo I2C specificato. È possibile scrivere l\'indirizzo I2C esadecimale nel blocco; verrà convertito in un intero (0-127). Il pulsante + controlla l\'invio del bit di stop.';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TITLE'] = '[i2c] indirizzo %1 scrivi dati %2';
Blockly.Msg['COMMUNICATION_I2C_WRITE_TOOLTIP'] = 'Permette di scrivere un array di byte all\'indirizzo I2C specificato. È possibile scrivere l\'indirizzo I2C esadecimale nel blocco; verrà convertito in un intero (0-127). Il pulsante + controlla l\'invio del bit di stop.';
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nPer impostazione predefinita, i pin SPI del micro:bit sono SCK: P13, MISO: P14 e MOSI: P15.';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] ID del badge sul pin NSS %1';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_RC522 + Blockly.Tooltip.SEP + 'Consente di ottenere l\'UID come stringa del modulo RFID Joy-It RC522 via SPI, se il modulo è rilevato sui pin digitali.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TITLE'] = '[Reka:bit] aziona motore %1 direzione %2 velocità %3';
Blockly.Msg['ACTUATORS_REKABIT_RUNMOTOR_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Consente di far girare il motore M1, M2 o entrambi sullo shield Reka:bit impostando direzione e velocità.';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M1'] = 'M1';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_M2'] = 'M2';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_ALL'] = 'entrambi';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_FORWARD'] = 'avanti';
Blockly.Msg['ACTUATORS_REKABIT_MOTOR_BACKWARD'] = 'indietro';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TITLE'] = '[Reka:bit] imposta il servo %1 a %2°';
Blockly.Msg['ACTUATORS_REKABIT_SETSERVOPOSITION_TOOLTIP'] = IMG_MODULE_REKABIT + Blockly.Tooltip.SEP + 'Consente di impostare l\'angolo del servo S1, S2, S3, S4 o di tutti i servomotori collegati allo shield Reka:bit.';
...
Blockly.Msg['ACTUATORS_REKABIT_SERVO_ALL'] = 'tutti';
