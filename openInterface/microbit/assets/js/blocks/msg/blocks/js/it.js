...
Blockly.Msg['DISPLAY_ZIP_HALO_LED_LEDCONTROL_TOOLTIP'] = 'Permette di controllare il colore di ogni LED come (R,G,B) da 0 a 255 sul modulo Zip Halo LED di Kitronik.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TITLE'] = '[ZIP Halo HD] controllare il LED %1 con colore %2';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETPALETTECOLOR_TOOLTIP'] = 'Permette di controllare il colore di ogni LED sul modulo Zip Halo LED di Kitronik. Usa la tavolozza per cambiare il colore.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TITLE'] = '[ZIP Halo HD] controllare tutte le LED a R %1 G %2 B %3';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDRGB_TOOLTIP'] = 'Permette di controllare tutte le LED sul modulo Zip Halo LED di Kitronik con il colore scelto come (R,G,B) da 0 a 255.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TITLE'] = '[ZIP Halo HD] controllare tutte le LED con colore %1';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_SETALLLEDCOLOR_TOOLTIP'] = 'Permette di controllare tutte le LED sul modulo Zip Halo LED di Kitronik con il colore scelto. Usa la tavolozza per cambiare il colore.';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TITLE'] = '[ZIP Halo HD] Arcobaleno';
Blockly.Msg['DISPLAY_ZIP_HALO_LED_RAINBOW_TOOLTIP'] = 'Mostra lo spettro dei colori sui LED RGB del modulo Zip Halo LED di Kitronik.';
...
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V2_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) o il tempo di andata e ritorno (in μs) dell\'onda tra un oggetto e il robot MaqueenPlus usando il sensore ad ultrasuoni.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ULTRASONICRANGER_TRIG_ECHO_TITLE'] = '[MaqueenPlus %1] %2 TRIG %3 ECHO %4';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ULTRASONICRANGER_TRIG_ECHO_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) o la durata di andata e ritorno (in μs) dell\'onda tra un oggetto e il robot MaqueenPlus utilizzando il sensore ad ultrasuoni collegato ai pin digitali specificati.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V1_READPATROL_TITLE'] = '[MaqueenPlus v1] stato del sensore di linea %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V1_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Legge lo stato di uno dei sensori segui-linea del robot MaqueenPlus. Il blocco restituisce 0 se il sensore è sopra la linea.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V2_READPATROL_TITLE'] = '[MaqueenPlus v2] stato del sensore di linea %1';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V2_READPATROL_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Legge lo stato di uno dei sensori segui-linea del robot MaqueenPlus. Il blocco restituisce 0 se il sensore è sopra la linea.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LEFT_REAR'] = "posteriore sinistro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LEFT'] = "sinistro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_MIDDLE_LEFT'] = "medio sinistro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_MIDDLE'] = "medio";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_MIDDLE_RIGHT'] = "medio destro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_RIGHT'] = "destro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_RIGHT_REAR'] = "posteriore destro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLLED_TITLE'] = '[MaqueenPlus %1] controlla il LED rosso anteriore %2 stato %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLLED_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Controlla lo stato del LED sinistro o destro del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LED_LEFT'] = "sinistro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LED_RIGHT'] = "destro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_LED_LEFT&RIGHT'] = "sinistro & destro";
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GO_TITLE'] = '[MaqueenPlus %1] controlla il robot %2 velocità %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GO_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Controlla il movimento (AVANTI/INDIETRO) e la velocità (da 0 a 255) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ROTATE_TITLE'] = '[MaqueenPlus %1] ruota %2 velocità %3';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_ROTATE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Controlla i motori destro e sinistro cambiando la direzione (↻: AVANTI, ↺: INDIETRO) e la velocità (da 0 a 255) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLMOTOR_TITLE'] = '[MaqueenPlus %1] controlla il motore %2 direzione %3 velocità %4';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Controlla i motori destro e sinistro cambiando la direzione (↻: AVANTI, ↺: INDIETRO) e la velocità (da 0 a 255) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_STOPMOTORS_TITLE'] = '[MaqueenPlus %1] ferma il motore %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Ferma il motore destro o sinistro del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V1_SETSERVOANGLE_TITLE'] = '[MaqueenPlus v1] imposta l\'angolo del servo %1 a %2 °';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V1_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Controlla i servomotori P0, P1, P2 cambiando l\'angolo (da 0 a 180) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V2_SETSERVOANGLE_TITLE'] = '[MaqueenPlus v2] imposta l\'angolo del servo %1 a %2 °';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_V2_SETSERVOANGLE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Controlla i servomotori P0, P1, P2 cambiando l\'angolo (da 0 a 180) del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETNEOPIXEL_TITLE'] = '[MaqueenPlus v2] controlla il LED RGB sotto %1 R %2 G %3 B %4';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETNEOPIXEL_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Controlla il colore di ogni LED RGB del neopixel del robot MaqueenPlus dove i valori R,G,B variano da 0 a 255.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_BLINK_ROBOT_TITLE'] = '[MaqueenPlus v2] lampeggia il robot';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Fa lampeggiare il robot Maqueen.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETPALETTECOLOR_TITLE'] = '[MaqueenPlus v2] controlla il LED RGB sotto %1 a %2';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Controlla il colore di ogni LED RGB del modulo neopixel situato sotto il robot MaqueenPlus. Usa la palette per cambiare il colore.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETRAINBOW_TITLE'] = '[MaqueenPlus v2] Arcobaleno';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS_V2 + Blockly.Tooltip.SEP + 'Visualizza lo spettro dei colori sui LED RGB.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETBUZZER_TITLE'] = '[MaqueenPlus %1] controlla il buzzer alla frequenza %2 per %3 (ms)';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_SETBUZZER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Imposta una frequenza sul buzzer del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_DECODEIRRECEIVER_TITLE'] = '[MaqueenPlus] decodifica il ricevitore a infrarossi';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_DECODEIRRECEIVER_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Effettua una lettura del ricevitore a infrarossi del robot MaqueenPlus.';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GETIRCODE_TITLE'] = '[MaqueenPlus] codice ricevuto dal ricevitore a infrarossi';
Blockly.Msg['ROBOTS_MAQUEEN_PLUS_GETIRCODE_TOOLTIP'] = IMG_ROBOT_MAQUEEN_PLUS + Blockly.Tooltip.SEP + 'Restituisce il codice esadecimale ricevuto con il rilevatore a infrarossi del robot MaqueenPlus.';
// Robots - Cutebot
...
Blockly.Msg['ROBOTS_CUTEBOT_GO_FORWARD'] = 'avanti';
Blockly.Msg['ROBOTS_CUTEBOT_GO_BACKWARD'] = 'indietro';
...
Blockly.Msg['ROBOTS_KITROBOT_GO_FORWARD'] = 'ir adelante';
Blockly.Msg['ROBOTS_KITROBOT_GO_REVERSE'] = 'ir hacia atrás';
