...
Blockly.Msg['ROBOTS_ALPHABOT_GO_TITLE'] = '[Alphabot] %1 con velocidad %2 (%)';
...
Blockly.Msg['ROBOTS_DONUTBOT_TURN_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_DONUTBOT_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_DONUTBOT_LEFT'] = 'izquierda';
// Robots - Donutbot
Blockly.Msg['ROBOTS_DONUTBOT_ULTRASONICRANGER_TITLE'] = '[Donutbot – Sensor ultrasónico] distancia %1';
Blockly.Msg['ROBOTS_DONUTBOT_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Devuelve la distancia (en cm) entre un objeto y el robot Donutbot usando el sensor ultrasónico.';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_TITLE'] = '[Donutbot] estado del sensor de línea %1';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Devuelve el estado del sensor de línea (derecha/izquierda/centro) del robot Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_FUNCTION_TITLE'] = '[Donutbot] seguir la línea';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_FUNCTION_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Permite que el robot Donutbot siga una línea negra.';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_THRESHOLD_TITLE'] = '[Donutbot] umbral del sensor de línea %1';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_THRESHOLD_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Permite ajustar el umbral del sensor de línea (derecha/izquierda/centro) del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_TITLE'] = '[Donutbot] estado del sensor de color %1';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Devuelve el estado (color en formato (r,g,b)) del sensor de color (derecha/izquierda/centro) del robot Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_DETECTOR_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_DONUTBOT_DETECTOR_MIDDLE'] = 'centro';
Blockly.Msg['ROBOTS_DONUTBOT_DETECTOR_LEFT'] = 'izquierda';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_AVERAGE_TITLE'] = '[Donutbot] color promedio de los sensores de color';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_AVERAGE_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Devuelve el color promedio (r,g,b) de los sensores de color del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_NAME_TITLE'] = '[Donutbot] nombre del color bajo el sensor %1';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_NAME_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Devuelve el nombre del color ("blanco", "naranja", "morado", "rosa", "marrón", "amarillo", "verde", "azul", "rojo") detectado por el Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_DISTANCE_TITLE'] = '[Donutbot – ToF] distancia %1';
Blockly.Msg['ROBOTS_DONUTBOT_DISTANCE_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Devuelve medidas de distancia del sensor Time‑Of‑Flight VL53L0X en el puerto I2C.';
Blockly.Msg['ROBOTS_DONUTBOT_GO_TITLE'] = '[Donutbot] %1 con velocidad %2 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_GO_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controla el movimiento (ADELANTE/ATRÁS) y la velocidad (0 a 100 %) del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_TITLE'] = '[Donutbot] girar hacia la %1 velocidad %2 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Permite que el Donutbot gire a la derecha o izquierda a una velocidad específica (0 a 100 %).';
Blockly.Msg['ROBOTS_DONUTBOT_CONTROLMOTOR_TITLE'] = '[Donutbot] controlar motor %1 dirección %2 velocidad %3 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controla los motores derecho e izquierdo cambiando dirección (↻: ADELANTE, ↺: ATRÁS) y velocidad (0 a 100 %) del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Donutbot] avanzar una casilla';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Mueve el robot Donutbot una casilla hacia adelante.';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Donutbot] retroceder una casilla';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Mueve el Donutbot una casilla hacia atrás.';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_LEFT_TITLE'] = '[Donutbot] girar a la izquierda';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Rota el robot Donutbot 90° a la izquierda.';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_RIGHT_TITLE'] = '[Donutbot] girar a la derecha';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Rota el robot Donutbot 90° a la derecha.';
Blockly.Msg['ROBOTS_DONUTBOT_STOPMOTORS_TITLE'] = '[Donutbot] detener motor %1';
Blockly.Msg['ROBOTS_DONUTBOT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Detiene el motor derecho o izquierdo del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_RELEASEMOTORS_TITLE'] = '[Donutbot] liberar motor %1';
Blockly.Msg['ROBOTS_DONUTBOT_RELEASEMOTORS_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Detiene y libera el motor derecho o izquierdo del Donutbot. Una vez desactivado, el motor queda libre y puede moverse sin restricciones.';
Blockly.Msg['ROBOTS_DONUTBOT_RIGHT&LEFT'] = 'derecha y izquierda';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETCOLOR_TITLE'] = '[Donutbot] controlar LED %1 con R %2 G %3 B %4';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETCOLOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controla el color de cada LED del neopixel del Donutbot (pin15) con valores R, G, B entre 0 y 255.';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETPALETTECOLOR_TITLE'] = '[Donutbot] controlar LED %1 a %2';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controla el color de cada LED usando una paleta.';
Blockly.Msg['ROBOTS_DONUTBOT_BLINK_ROBOT_TITLE'] = '[Donutbot] parpadear robot en %1';
Blockly.Msg['ROBOTS_DONUTBOT_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Hace que el robot Donutbot parpadee.';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETRAINBOW_TITLE'] = '[Donutbot] arco iris';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Muestra el espectro de colores en los LEDs RGB (pin15).';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_ONPRESSED_TITLE'] = '[Donutbot] botón %1 está %2';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_ONPRESSED_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Ejecuta instrucciones si se pulsa un botón del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_PRESSED'] = 'pulsado';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_RELEASED'] = 'soltado';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_FRONT'] = 'frontal';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_LEFT'] = 'izquierda';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_BACK'] = 'trasero';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_CENTER'] = 'centro';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_SEND_DATA_TITLE'] = '[Donutbot] enviar datos %1';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_SEND_DATA_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Envía datos vía Bluetooth (BLE).';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_READ_DATA_TITLE'] = '[Donutbot] si mensaje recibido en %1 entonces';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_READ_DATA_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Ejecuta instrucciones si se reciben datos por Bluetooth (BLE).';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_ANGLE_TITLE'] = '[Donutbot] girar hacia la %1 en %2 ° velocidad %3 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_ANGLE_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controla los motores para rotar el Donutbot un cierto ángulo.';
Blockly.Msg['WIO_MAKE_PREDICTION_TITLE'] = '[Wio lite] hacer una predicción';
Blockly.Msg['WIO_MAKE_PREDICTION_TOOLTIP'] = IMG_WIO_LITE_AI + Blockly.Tooltip.SEP + 'Realiza una predicción usando la imagen de la cámara del Wio lite.';
Blockly.Msg['WIO_GET_DATA_TITLE'] = '[Wio lite] obtener todos los datos';
Blockly.Msg['WIO_GET_DATA_TOOLTIP'] = IMG_WIO_LITE_AI + Blockly.Tooltip.SEP + 'Devuelve todos los datos del Wio lite (probabilidades asociadas a las clases del modelo).';
Blockly.Msg['WIO_GET_CLASS_DATA_BY_ID_TITLE'] = '[Wio lite] probabilidad de la clase n°%1';
Blockly.Msg['WIO_GET_CLASS_DATA_BY_ID_TOOLTIP'] = IMG_WIO_LITE_AI + Blockly.Tooltip.SEP + 'Devuelve la probabilidad asociada a la clase con el id indicado.';
Blockly.Msg['WIO_GET_CLASS_MAX_ID_TITLE'] = '[Wio lite] id de la clase detectada';
Blockly.Msg['WIO_GET_CLASS_MAX_ID_TOOLTIP'] = IMG_WIO_LITE_AI + Blockly.Tooltip.SEP + 'Devuelve el id de la clase detectada (la que tiene la probabilidad más alta).';
...
Blockly.Msg['WIO_GET_STATUS_TOOLTIP'] = IMG_WIO_LITE_AI + Blockly.Tooltip.SEP + 'Devuelve la versión o el estado del Wio lite (0: ocupado, 1: listo, 2: resultado disponible).';
