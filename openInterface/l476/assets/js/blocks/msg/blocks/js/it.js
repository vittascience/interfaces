...
'use strict';
// Display - L476
Blockly.Msg['DISPLAY_L476_CONTROL_COLOR_LED_TITLE'] = 'controlla il LED (verde) allo stato %1';
Blockly.Msg['DISPLAY_L476_CONTROL_COLOR_LED_TOOLTIP'] = 'Controlla lo stato dei LED verde della scheda L476.';
Blockly.Msg['DISPLAY_L476_TOGGLE_LED_STATE_TITLE'] = 'inverti lo stato del LED (verde)';
Blockly.Msg['DISPLAY_L476_TOGGLE_LED_STATE_TOOLTIP'] = 'Inverti lo stato dei LED colorati della scheda L476.';
...
Blockly.Msg['DISPLAY_OLED_DRAWICON_TOOLTIP'] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + 'Permette di visualizzare un\'icona della libreria Immagini di L476 nella posizione (x,y) sul display grove OLED. Collegare il display a una porta I2C.';
...
Blockly.Msg['IO_L476_GETSWITCHSTATE_TITLE'] = 'leggi lo stato del pulsante (B1)';
Blockly.Msg['IO_L476_GETSWITCHSTATE_TOOLTIP'] = 'Permette di leggere lo stato dei pulsanti integrati nella scheda L476 (SW1, SW2, SW3).';
Blockly.Msg['IO_L476_ONSWITCHBUTTONPRESSED_TITLE'] = 'se il pulsante (B1) è %1 allora';
Blockly.Msg['IO_L476_ONSWITCHBUTTONPRESSED_TOOLTIP'] = 'Permette di eseguire alcune istruzione a seconda dello stato dei pulsanti integrati nella scheda L476 (SW1, SW2, SW3).';
Blockly.Msg['IO_L476_PRESSED'] = 'premuto';
Blockly.Msg['IO_L476_RELEASED'] = 'rilasciato';
...
Blockly.Msg['COMMUNICATION_SERIAL_INIT_TITLE'] = 'reindirizza il collegamento seriale verso RX %2 TX %3 Baud rate %1';
Blockly.Msg['COMMUNICATION_SERIAL_INIT_TOOLTIP'] = 'Permette di reindirizzare il collegamento seriale della scheda L476. Quando colleghi il modulo, assicurati che i pin siano "incrociati": RX della scheda con TX del modulo e viceversa.';
Blockly.Msg['COMMUNICATION_SERIAL_REDIRECTTOUSB_TITLE'] = 'reindirizza il collegamento seriale verso USB';
Blockly.Msg['COMMUNICATION_SERIAL_REDIRECTTOUSB_TOOLTIP'] = 'Permette di reindirizzare il collegamento seriale verso l\'USB (computer). Può essere utilizzato per far funzionare più moduli UART contemporaneamente.';
Blockly.Msg['COMMUNICATION_SERIAL_ONDATARECEIVED_TITLE then'] = 'quando ricevi dati seriali in %1 allora';
...
// Communication - L476
Blockly.Msg['COMMUNICATION_L476_RTC_SETTIME_TITLE'] = '[Orologio RTC] inizializza a %1 data %2 ora %3 minuto %4 secondo %5';
Blockly.Msg['COMMUNICATION_L476_RTC_SETTIME_TOOLTIP'] = 'Permette di inizializzare il modulo orologio RTC integrato nella scheda L476 per poter leggere la data e l\'ora precisa con il blocco "Leggi il modulo orologio". Inserire nel blocco "All\'avvio".';
Blockly.Msg['COMMUNICATION_L476_RTC_READTIME_TITLE'] = '[Orologio RTC] leggi %1';
Blockly.Msg['COMMUNICATION_L476_RTC_READTIME_TOOLTIP'] = 'Permette di leggere la data e l\'ora del modulo orologio RTC integrato nella scheda L476. Per un risultato corretto, utilizzare prima i due blocchi "Inizializza il modulo orologio".';
Blockly.Msg['CLOCK_ALL_DATA'] = 'orario';
...
// Communication - LoRa
Blockly.Msg['COMMUNICATION_LORA_INIT_TITLE'] = '[LoRa] inizializzare il modulo con la appEui %1 con la appKey %2';
...
Blockly.Msg['COMMUNICATION_LORA_SEND_TITLE'] = '[LoRa] inviare il dati ';
...
Blockly.Msg['COMMUNICATION_LORA_RECEIVE_TITLE'] = '[LoRa] ricevere un messaggio';
...
Blockly.Msg['SENSORS_MAGNETOSCOPE_INTEGRATED_LIS2MDL_TITLE'] = '[Magnetometro LIS2MDL] campo magnetico lungo %1';
...
Blockly.Msg['SENSORS_THERMOMETER_INTEGRATED_STTS751_TITLE'] = '[Termometro STTS751] temperatura';
Blockly.Msg['SENSORS_THERMOMETER_INTEGRATED_STTS751_TOOLTIP'] = IMG_X_NUCLEO_IKS01A3 + Blockly.Tooltip.SEP + 'Restituisce la temperatura (in °C)';
Blockly.Msg['SENSORS_HYGROMETER_INTEGRATED_HTS221_TITLE'] = '[Igrometro HTS221] umidità relativa';
Blockly.Msg['SENSORS_HYGROMETER_INTEGRATED_HTS221_TOOLTIP'] = IMG_X_NUCLEO_IKS01A3 + Blockly.Tooltip.SEP + 'Restituisce l\'umidità.';
Blockly.Msg['SENSORS_BAROMETER_INTEGRATED_LPS22_TITLE'] = '[Barometer LPS22] pressione atmosferica';
Blockly.Msg['SENSORS_BAROMETER_INTEGRATED_LPS22_TOOLTIP'] = IMG_X_NUCLEO_IKS01A3 + Blockly.Tooltip.SEP + 'Restituisce la pressione atmosferica. (260 à 1260 hPa)';
// Sensors - Gas
...
Blockly.Msg['SENSORS_SCD30_FORCED_CALIBRATION_TOOLTIP'] = IMG_MODULE_SCD30 + Blockly.Tooltip.SEP + 'Forza la calibrazione del sensore SCD30 al valore dato (in ppm). Andare all\'esterno (dove la concentrazione è di circa 420 ppm, cioè aria pulita), riavviare la scheda, quindi attendere 2 minuti. Consiglio: Utilizzare i pulsanti SW1, SW2 o SW3 della scheda L476 NUCLEO per controllare l\'avvio della calibrazione. In caso contrario, ricollegando la scheda, il programma si avvia ed esegue nuovamente una calibrazione non necessariamente voluta.';
Blockly.Msg['SENSORS_AIR_QUALITY_GETVALUE_TITLE'] = '[Sensore di qualità dell\'aria] valore sul pin %1';
Blockly.Msg['SENSORS_AIR_QUALITY_GETVALUE_TOOLTIP'] = IMG_MODULE_AIR_QUALITY + Blockly.Tooltip.SEP + 'Restituisce il valore della qualità dell\'aria (da 0 a 4095) sui pin analogici p34 a p36, o p39 (A2 a A4 su shield Grove).';
Blockly.Msg['SENSORS_HM330X_GETPARTICULE_TITLE'] = '[Sensore HM330X] concentrazione di particolato fine %1 (µg/m3)';
Blockly.Msg['SENSORS_HM330X_GETPARTICULE_TOOLTIP'] = IMG_MODULE_HM330X + Blockly.Tooltip.SEP + 'Rileva la densità di particolato nell\'aria con il sensore HM330X. Collega il sensore a una porta I2C.';
...
Blockly.Msg['SENSORS_BMP280_TEMP'] = 'la temperatura';
...
Blockly.Msg['SENSORS_GETGROVELINEFINDER_TOOLTIP'] = IMG_MODULE_LINE_FINDER + Blockly.Tooltip.SEP + 'Restituisce lo stato del sensore rilevatore di linea Grove (0 o 1) sui pin digitali.';
...
// Robots - DonutBot
Blockly.Msg['ROBOTS_DONUTBOT_TURN_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_DONUTBOT_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_DONUTBOT_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_DONUTBOT_ULTRASONICRANGER_TITLE'] = '[Donutbot – Sensore ad ultrasuoni] distanza %1';
Blockly.Msg['ROBOTS_DONUTBOT_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Restituisce la distanza (in cm) tra un oggetto e il robot Donutbot usando il sensore a ultrasuoni.';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_TITLE'] = '[Donutbot] stato del sensore di linea %1';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Restituisce lo stato del sensore di linea (destra/sinistra/centro) del robot Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_FUNCTION_TITLE'] = '[Donutbot] segui la linea';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_FUNCTION_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Permette al robot Donutbot di seguire una linea nera.';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_THRESHOLD_TITLE'] = '[Donutbot] soglia del sensore di linea %1';
Blockly.Msg['ROBOTS_DONUTBOT_LINE_DETECTOR_THRESHOLD_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Permette di impostare la soglia per il sensore di linea (destra/sinistra/centro) del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_TITLE'] = '[Donutbot] stato del sensore di colore %1';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Restituisce lo stato (colore in formato (r,g,b)) del sensore di colore (destra/sinistra/centro) del robot Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_DETECTOR_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_DONUTBOT_DETECTOR_MIDDLE'] = 'centro';
Blockly.Msg['ROBOTS_DONUTBOT_DETECTOR_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_AVERAGE_TITLE'] = '[Donutbot] colore medio dai sensori di colore';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_AVERAGE_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Restituisce il colore medio (r,g,b) dai sensori di colore del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_NAME_TITLE'] = '[Donutbot] nome del colore rilevato dal sensore %1';
Blockly.Msg['ROBOTS_DONUTBOT_COLOR_DETECTOR_NAME_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Restituisce il nome del colore ("bianco", "arancione", "viola", "rosa", "marrone", "giallo", "verde", "blu", "rosso") rilevato dal Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_DISTANCE_TITLE'] = '[Donutbot – ToF] distanza %1';
Blockly.Msg['ROBOTS_DONUTBOT_DISTANCE_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Restituisce le misure di distanza dal sensore Time‑Of‑Flight VL53L0X su porta I2C.';
Blockly.Msg['ROBOTS_DONUTBOT_GO_TITLE'] = '[Donutbot] controlla robot %1 velocità %2 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_GO_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controlla il movimento (AVANTI/INDIETRO) e la velocità (0–100 %) del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_TITLE'] = '[Donutbot] gira verso %1 velocità %2 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Permette al Donutbot di girare a destra o sinistra a una velocità specifica (0–100 %).';
Blockly.Msg['ROBOTS_DONUTBOT_CONTROLMOTOR_TITLE'] = '[Donutbot] controlla motore %1 direzione %2 velocità %3 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_CONTROLMOTOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controlla i motori destro e sinistro cambiando la direzione (↻: AVANTI, ↺: INDIETRO) e la velocità (0–100 %).';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Donutbot] muovi avanti di una casella';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Muove il robot Donutbot in avanti di una casella.';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Donutbot] muovi indietro di una casella';
Blockly.Msg['ROBOTS_DONUTBOT_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Muove il Donutbot indietro di una casella.';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_LEFT_TITLE'] = '[Donutbot] gira a sinistra';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Ruota il robot Donutbot di 90° a sinistra.';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_RIGHT_TITLE'] = '[Donutbot] gira a destra';
Blockly.Msg['ROBOTS_DONUTBOT_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Ruota il robot Donutbot di 90° a destra.';
Blockly.Msg['ROBOTS_DONUTBOT_STOPMOTORS_TITLE'] = '[Donutbot] ferma motore %1';
Blockly.Msg['ROBOTS_DONUTBOT_STOPMOTORS_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Ferma il motore destro o sinistro del Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_RELEASEMOTORS_TITLE'] = '[Donutbot] rilascia motore %1';
Blockly.Msg['ROBOTS_DONUTBOT_RELEASEMOTORS_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Ferma e rilascia il motore destro o sinistro del Donutbot. Una volta disattivato, il motore è libero di muoversi senza vincoli.';
Blockly.Msg['ROBOTS_DONUTBOT_RIGHT&LEFT'] = 'destra e sinistra';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETCOLOR_TITLE'] = '[Donutbot] controlla LED %1 con R %2 G %3 B %4';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETCOLOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controlla il colore di ogni LED del neopixel (pin15) con valori R, G, B compresi tra 0 e 255.';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETPALETTECOLOR_TITLE'] = '[Donutbot] controlla LED %1 su %2';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETPALETTECOLOR_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controlla il colore di ogni LED usando la palette.';
Blockly.Msg['ROBOTS_DONUTBOT_BLINK_ROBOT_TITLE'] = '[Donutbot] lampeggia il robot in %1';
Blockly.Msg['ROBOTS_DONUTBOT_BLINK_ROBOT_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Fa lampeggiare il robot Donutbot.';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETRAINBOW_TITLE'] = '[Donutbot] arcobaleno';
Blockly.Msg['ROBOTS_DONUTBOT_NEOPIXEL_SETRAINBOW_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Mostra lo spettro di colori sui LED RGB (pin15).';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_ONPRESSED_TITLE'] = '[Donutbot] pulsante %1 è %2';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_ONPRESSED_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Esegue istruzioni se un pulsante del Donutbot viene premuto.';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_PRESSED'] = 'premuto';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTONS_RELEASED'] = 'rilasciato';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_FRONT'] = 'anteriore';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_BACK'] = 'posteriore';
Blockly.Msg['ROBOTS_DONUTBOT_BUTTON_CENTER'] = 'centro';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_SEND_DATA_TITLE'] = '[Donutbot] invia dati %1';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_SEND_DATA_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Invia dati via Bluetooth (BLE).';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_READ_DATA_TITLE'] = '[Donutbot] se messaggio ricevuto su %1 allora';
Blockly.Msg['ROBOTS_DONUTBOT_BLE_READ_DATA_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Esegue istruzioni se vengono ricevuti dati via Bluetooth (BLE).';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_ANGLE_TITLE'] = '[Donutbot] gira verso %1 di %2 ° velocità %3 (%)';
Blockly.Msg['ROBOTS_DONUTBOT_TURNTO_ANGLE_TOOLTIP'] = IMG_ROBOT_DONUTBOT + Blockly.Tooltip.SEP + 'Controlla i motori per ruotare il Donutbot di un angolo specifico.';
Blockly.Msg['WIO_MAKE_PREDICTION_TITLE'] = '[Wio lite] eseguire una previsione';
Blockly.Msg['WIO_MAKE_PREDICTION_TOOLTIP'] = IMG_WIO_LITE_AI + Blockly.Tooltip.SEP + 'Esegue una previsione usando l\'immagine della fotocamera di Wio lite.';
...
Blockly.Msg['WIO_GET_CLASS_DATA_BY_ID_TOOLTIP'] = IMG_WIO_LITE_AI + Blockly.Tooltip.SEP + 'Restituisce la probabilità associata alla classe con l\'id indicato.';
...
Blockly.Msg['WIO_GET_STATUS_TITLE'] = '[Wio lite] ottieni %1';
