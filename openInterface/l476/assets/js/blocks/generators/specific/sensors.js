...
Blockly.Python.sensors_DHT11ReadData = function (block) {
    ...
    Blockly.Python.addFunction('dht_getMeasure', FUNCTIONS_L476.DEF_DHT_GET_MEASURE);
...
Blockly.Python.sensors_getO2gas = function (block) {
    ...
    Blockly.Python.addImport('pyb', IMPORT_PYB);
    Blockly.Python.addFunction('getAnalogMean', FUNCTIONS_L476.DEF_GET_ANALOG_MEAN);
    Blockly.Python.addFunction('readO2', FUNCTIONS_L476.DEF_O2SENSOR_READ);
...
Blockly.Python.sensors_getGroveTemperature = function (block) {
    ...
    Blockly.Python.addImport('pyb', IMPORT_PYB);
    Blockly.Python.addFunction('getGroveTemperature', FUNCTIONS_L476.DEF_GROVE_GET_TEMP);
    let code;
    switch (block.getFieldValue("UNIT")) {
        case "CELSIUS":
...
Blockly.Python.sensors_getGroveHighTemperature = function (block) {
    ...
    Blockly.Python.addImport('pyb', IMPORT_PYB);
    Blockly.Python.addImport('math', IMPORT_MATH);
    Blockly.Python.addConstant('thmc_table', FUNCTIONS_L476.DEF_GROVE_HIGHTEMP_THMC_TABLE);
    Blockly.Python.addFunction('getAnalogMean', FUNCTIONS_L476.DEF_GET_ANALOG_MEAN);
    Blockly.Python.addFunction('K_VtoT', FUNCTIONS_L476.DEF_GROVE_HIGHTEMP_KVTOT);
    Blockly.Python.addFunction('getRoomTemp', FUNCTIONS_L476.DEF_GROVE_HIGHTEMP_GET_ROOM_TEMP);
    Blockly.Python.addFunction('getThmcTemp', FUNCTIONS_L476.DEF_GROVE_HIGHTEMP_GET_THMC_TEMP);
...
Blockly.Python.sensors_getUVindex = function (block) {
    ...
    Blockly.Python.addImport('pyb', IMPORT_PYB);
    Blockly.Python.addImport('utime', IMPORT_UTIME);
    Blockly.Python.addFunction("getUVindex", FUNCTIONS_L476.DEF_GROVE_GET_UV_INDEX);
...
Blockly.Python.sensors_SCD30_readData = function (block) {
    ...
    Blockly.Python.addFunction('scd30_read', FUNCTIONS_L476.DEF_SCD30_READ);
...
Blockly.Python.sensors_SCD30_forcedCalibration = function (block) {
    ...
    Blockly.Python.addImport('utime', IMPORT_UTIME);
    Blockly.Python.addImport('stm32_scd30', IMPORT_STM32_SCD30);
    Blockly.Python.addFunction('scd30_calibrateSensor', FUNCTIONS_L476.DEF_SCD30_CALIBRATE);
    Blockly.Python.addInit('scd30', "scd30 = SCD30(i2c=machine.I2C(1))");
...
Blockly.Python.sensors_DS18B20_getTemperature = function (block) {
    ...
    Blockly.Python.addFunction('ds18x20_measure', FUNCTIONS_L476.DEF_DS18B20_MEASURE);
...
Blockly.Python.sensors_getGroveUltrasonicRanger = function (block) {
    ...
    switch (block.getFieldValue("SENSOR")) {
        case "GROVE":
            ...
            Blockly.Python.addFunction('grove_getUltrasonicData', FUNCTIONS_L476.DEF_GROVE_ULTRASONIC);
        ...
        case "HC-SR04":
            ...
            Blockly.Python.addInit('hcsr04_' + pinTRIG + '_codeFlag', '# Ultrasonic TRIG/ECHO on ' + pinName_TRIG + '/' + pinName_ECHO);
            Blockly.Python.addFunction('hcsr04_getUltrasonicData', FUNCTIONS_L476.DEF_HCSR04_ULTRASONIC);
...
Blockly.Python.sensors_inclinometerIntegrated_LIS2DW12 = function (block) {
    ...
    Blockly.Python.addFunction('internal_tilt_measure', FUNCTIONS_L476.DEF_INCLINOMETER_INTEGRATED_LIS2DW12);
    const axis = block.getFieldValue("AXIS");
...
Blockly.Python.sensors_thermometerIntegrated_STTS751 = function (block) {
    Blockly.Python.addImport('machine', IMPORT_MACHINE);
    Blockly.Python.addImport('STTS751', IMPORT_STTS751);
    Blockly.Python.addInit('internal_i2c', 'i2c = machine.I2C(1)');
    Blockly.Python.addInit('thermometer', 'thermometer = STTS751.STTS751(i2c)');
    return ["thermometer.temperature()", Blockly.Python.ORDER_ATOMIC];
}

Blockly.Python.sensors_hygrometerIntegrated_HTS221 = function (block) {
    Blockly.Python.addImport('machine', IMPORT_MACHINE);
    Blockly.Python.addImport('HTS221', IMPORT_HTS221);
    Blockly.Python.addInit('internal_i2c', 'i2c = machine.I2C(1)');
    Blockly.Python.addInit('hygrometer', 'hygrometer = HTS221.HTS221(i2c)');
    return ["hygrometer.humidity()", Blockly.Python.ORDER_ATOMIC];
}

Blockly.Python.sensors_barometerIntegrated_LPS22 = function (block) {
    Blockly.Python.addImport('machine', IMPORT_MACHINE);
    Blockly.Python.addImport('LPS22', IMPORT_LPS22);
    Blockly.Python.addInit('internal_i2c', 'i2c = machine.I2C(1)');
    Blockly.Python.addInit('barometer', 'barometer = LPS22.LPS22(i2c)');
    return ["barometer.pressure()", Blockly.Python.ORDER_ATOMIC];
}