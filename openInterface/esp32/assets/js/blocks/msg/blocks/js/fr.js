...
Blockly.Msg['IO_WRITEPWMPIN_TOOLTIP'] = 'Permet d\'appliquer un signal PWM  d\'une fréquence fixée à 5kHz et en changeant le cycle de 0 à 1023. La valeur 512 correspondra à 50% du cycle, donc environ 1.66V.';
...
Blockly.Msg['COMMUNICATION_START_BT_TOOLTIP'] = 'Permet d\'intialiser le service Bluetooth Low Energy de l\'ESP32 avec un nom attribué.';
...
Blockly.Msg['COMMUNICATION_FIZZIQ_BT_TOOLTIP'] = IMG_MODULE_FIZZIQ + Blockly.Tooltip.SEP + 'Envoyer des données (Température, Humidité, etc) via Bluetooth à Fizziq App. Dans l\'onglet "Mesures" de Fizziq, cliquer sur "Capteurs externes", puis Connecter l\'App à l\'appareil nommé "ESP32_Vittascience".';
...
Blockly.Msg['COMMUNICATION_FS_SAVE_DATA_TITLE'] = '[ESP32] enregistrer les données %1 dans le fichier %2';
...
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nPar défaut, les broches SPI 2 de la carte ESP32 sont sur SCK: Pin(18) [D13], MISO: Pin(19) [D12] et MOSI: Pin(23) [D11] et les broches de SPI 1 sont sur SCK: Pin(14) [D7], MISO: Pin(12) [D8] et MOSI: Pin(13) [D9].';
...
Blockly.Msg['ROBOTS_ILO_SET_LED_ANIM_TITLE'] = '[Ilo] animation des LEDs %1 nombre de répétitions %2';
...
Blockly.Msg['ROBOTS_ILO_GET_COLOR_RAW_TITLE'] = '[Ilo] valeur brute du capteur de couleur %1';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_RAW_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Renvoie la valeur brute (de 0 à 255) du capteur de couleur (centre) du robot Ilo.';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_CARD_TITLE'] = '[Ilo] couleur de la carte détectée %1';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_CARD_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Renvoie la couleur détectée par le capteur de couleur (centre) du robot Ilo au format RGB ou son nom (white, orange, purple, light_blue, yellow, green, blue, red)';
Blockly.Msg['ROBOTS_ILO_COLOR_LABEL'] = 'nom';
Blockly.Msg['ROBOTS_ILO_COLOR_RGB'] = 'rgb';
Blockly.Msg['ROBOTS_ILO_COLOR_RED'] = 'intensité de rouge';
Blockly.Msg['ROBOTS_ILO_COLOR_GREEN'] = 'intensité de vert';
Blockly.Msg['ROBOTS_ILO_COLOR_BLUE'] = 'intensité de bleu';
Blockly.Msg['ROBOTS_ILO_COLOR_SENSOR_RIGHT'] = 'droit';
...
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TITLE'] = '[Ilo] %1 l\'animation des LEDs pendant les déplacements';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Permet d\'activer ou de désactiver l\'affichage des animations des LEDs pendant les déplacements du robot Ilo.';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_ENABLE'] = 'activer';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_DISABLE'] = 'désactiver';
// Robots - Alvik
// Distances units
...
Blockly.Msg['ROBOTS_REVOLUTIONS'] = 'tours';
...
Blockly.Msg['ROBOTS_REV_PER_S'] = 'tours/s';
// MOTORS
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TITLE'] = 'pivoter de %1 %2';
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TOOLTIP'] = 'Faire tourner le robot d\'un angle spécifié';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TITLE'] = 'avancer de %1 %2';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TOOLTIP'] = 'Déplacer le robot d\'une distance spécifiée';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TITLE'] = 'régler vitesse roues gauche %1 droite %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TOOLTIP'] = 'Définir la vitesse des roues gauche et droite indépendamment';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TITLE'] = 'régler position roues gauche %1 droite %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TOOLTIP'] = 'Définir la position angulaire des roues gauche et droite';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TITLE'] = 'conduire vitesse linéaire %1 %2 vitesse angulaire %3 %4';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TOOLTIP'] = 'Contrôler le mouvement avec vitesse linéaire et angulaire';
Blockly.Msg['ROBOTS_ALVIK_STOP_TITLE'] = 'arrêter les moteurs';
Blockly.Msg['ROBOTS_ALVIK_STOP_TOOLTIP'] = 'Arrêter les moteurs immédiatement';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TITLE'] = 'freiner les moteurs';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TOOLTIP'] = 'Freiner activement les moteurs';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TITLE'] = 'vitesse des roues en %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TOOLTIP'] = 'Obtenir la vitesse actuelle des roues';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TITLE'] = 'position des roues en %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TOOLTIP'] = 'Obtenir la position angulaire actuelle des roues';
Blockly.Msg['ROBOTS_ALVIK_GET_DRIVE_SPEED_TITLE'] = 'vitesse de conduite linéaire %1 angulaire %2';
Blockly.Msg['ROBOTS_ALVIK_GET_DRIVE_SPEED_TOOLTIP'] = 'Obtenir les vitesses de conduite actuelles';
// SERVOS
...
Blockly.Msg['ROBOTS_ALVIK_SET_ILLUMINATOR_TOOLTIP'] = 'Activer ou désactiver la LED d\'éclairage du capteur de couleur';
// SENSORS
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TITLE'] = 'distance en %1 capteur %2';
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TOOLTIP'] = 'Obtenir la distance mesurée par le capteur ToF';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TITLE'] = 'capteur de ligne %1';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TOOLTIP'] = 'Obtenir la valeur du capteur de ligne';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TITLE'] = 'orientation %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TOOLTIP'] = 'Obtenir l\'orientation du robot (roulis, tangage, lacet)';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TITLE'] = 'accélération axe %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TOOLTIP'] = 'Obtenir l\'accélération selon l\'axe spécifié';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TITLE'] = 'gyroscope axe %1';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TOOLTIP'] = 'Obtenir la valeur du gyroscope selon l\'axe spécifié';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TITLE'] = 'niveau batterie';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TOOLTIP'] = 'Obtenir le niveau de charge de la batterie';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TITLE'] = 'bouton tactile %1 pressé';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TOOLTIP'] = 'Vérifier si un bouton tactile est pressé';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TITLE'] = 'couleur en format %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TOOLTIP'] = 'Obtenir la couleur détectée au format RGB ou HSV';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TITLE'] = 'valeur brute couleur %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TOOLTIP'] = 'Obtenir la valeur brute d\'une composante de couleur';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TITLE'] = 'étiquette couleur';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TOOLTIP'] = 'Obtenir le nom de la couleur détectée';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TITLE'] = 'calibrer couleur sur fond %1';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TOOLTIP'] = 'Calibrer le capteur de couleur sur fond noir ou blanc';
// COLORS
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TITLE'] = 'convertir R %1 G %2 B %3 vers HSV';
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TOOLTIP'] = 'Convertir les valeurs RGB en valeurs HSV.';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TITLE'] = 'convertir H %1 S %2 V %3 vers étiquette';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TOOLTIP'] = 'Convertir les valeurs HSV en nom de couleur. Couleurs disponibles : BLACK, GREY, LIGHT GREY, WHITE, YELLOW, LIGHT GREEN, GREEN, LIGHT BLUE, BLUE, VIOLET, BROWN, ORANGE, RED and BLACK.';
Blockly.Msg['ROBOTS_LEFT_TOF'] = 'gauche';
Blockly.Msg['ROBOTS_CENTER_LEFT_TOF'] = 'centre-gauche';
Blockly.Msg['ROBOTS_CENTER_TOF'] = 'centre';
Blockly.Msg['ROBOTS_CENTER_RIGHT_TOF'] = 'centre-droit';
Blockly.Msg['ROBOTS_RIGHT_TOF'] = 'droit';
Blockly.Msg['ROBOTS_LEFT'] = 'gauche';
Blockly.Msg['ROBOTS_CENTER'] = 'centre';
Blockly.Msg['ROBOTS_RIGHT'] = 'droit';
Blockly.Msg['ROBOTS_ROLL'] = 'roulis';
Blockly.Msg['ROBOTS_PITCH'] = 'tangage';
Blockly.Msg['ROBOTS_YAW'] = 'lacet';
Blockly.Msg['ROBOTS_AXIS_X'] = 'X';
Blockly.Msg['ROBOTS_AXIS_Y'] = 'Y';
Blockly.Msg['ROBOTS_AXIS_Z'] = 'Z';
Blockly.Msg['ROBOTS_UP'] = 'haut';
Blockly.Msg['ROBOTS_DOWN'] = 'bas';
Blockly.Msg['ROBOTS_LEFT'] = 'gauche';
Blockly.Msg['ROBOTS_RIGHT'] = 'droit';
Blockly.Msg['ROBOTS_OK'] = 'OK';
Blockly.Msg['ROBOTS_CANCEL'] = 'annuler';
Blockly.Msg['ROBOTS_CENTER'] = 'centre';
Blockly.Msg['ROBOTS_ANY'] = 'n\'importe lequel';
Blockly.Msg['ROBOTS_COLOR_RGB'] = 'RGB';
Blockly.Msg['ROBOTS_COLOR_HSV'] = 'HSV';
Blockly.Msg['ROBOTS_COLOR_RED'] = 'rouge';
Blockly.Msg['ROBOTS_COLOR_GREEN'] = 'vert';
Blockly.Msg['ROBOTS_COLOR_BLUE'] = 'bleu';
Blockly.Msg['ROBOTS_COLOR_BLACK'] = 'noir';
Blockly.Msg['ROBOTS_COLOR_WHITE'] = 'blanc';