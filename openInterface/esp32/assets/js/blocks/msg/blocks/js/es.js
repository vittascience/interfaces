...
Blockly.Msg['IO_WRITEPWMPIN_TOOLTIP'] = 'Permite aplicar una señal PWM con una frecuencia fija de 5kHz y cambiando el ciclo de 0 a 1023. El valor 512 corresponderá al 50% del ciclo, es decir, a unos 1,66V';
...
Blockly.Msg['COMMUNICATION_START_BT_TITLE'] = '[BLE incorporado] inicializar bluetooth %1';
...
Blockly.Msg['COMMUNICATION_FIZZIQ_BT_TOOLTIP'] = IMG_MODULE_FIZZIQ + Blockly.Tooltip.SEP + 'Enviar datos (Temperatura, Humedad, etc) vía Bluetooth a la aplicación Fizziq. En la pestaña "Mediciones" de Fizziq, haga clic en "Sensores externos", luego conecte la aplicación al dispositivo llamado "ESP32_Vittascience".';
...
Blockly.Msg['COMMUNICATION_FS_SAVE_DATA_TITLE'] = '[ESP32] guardar datos %1 en el archivo %2';
Blockly.Msg['COMMUNICATION_FS_SAVE_DATA_TOOLTIP'] = 'Le permite guardar datos en un archivo de texto en el sistema de archivos ESP32. Si utiliza el mismo nombre de archivo, los datos se agregarán al final del archivo. También puedes presionar el botón + para cambiar la extensión del archivo.';
...
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Permite ejecutar instrucciones si se reciben datos por un módulo Bluetooth HC05 en la variable \'HC05Data\' en los pines RX/TX';
...
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Devuelve el tamaño de los datos disponibles en el puerto UART (1 o 2). Por defecto, los pines son: UART 1 (tx=10, rx=9) y UART 2 (tx=17, rx=16). De lo contrario, utilice el bloque \'Establecer conexión serie a la velocidad en baudios de RX/TX...\'.';
...
Blockly.Msg['ROBOTS_ILO_SET_LED_ANIM_TITLE'] = '[Ilo] animación de LEDs %1 duración %2';
...
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TITLE'] = '[Ilo] %1 animación de los LEDs durante los desplazamientos';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Permite activar o desactivar la visualización de las animaciones de los LEDs durante los desplazamientos del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_ENABLE'] = 'activar';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_DISABLE'] = 'desactivar';
Blockly.Msg['ROBOTS_CENTIMETERS'] = 'cm';
Blockly.Msg['ROBOTS_MILLIMETERS'] = 'mm';
Blockly.Msg['ROBOTS_METERS'] = 'm';
Blockly.Msg['ROBOTS_INCHES'] = 'pulgada';
Blockly.Msg['ROBOTS_DEGREES'] = '°';
Blockly.Msg['ROBOTS_RADIANS'] = 'rad';
Blockly.Msg['ROBOTS_REVOLUTIONS'] = 'vueltas';
...
Blockly.Msg['ROBOTS_INCH_PER_S'] = 'pulgada/s';
Blockly.Msg['ROBOTS_RPM'] = 'rpm';
Blockly.Msg['ROBOTS_DEG_PER_S'] = '°/s';
Blockly.Msg['ROBOTS_RAD_PER_S'] = 'rad/s';
Blockly.Msg['ROBOTS_REV_PER_S'] = 'vueltas/s';
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TITLE'] = 'girar %1 %2';
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TOOLTIP'] = 'Hacer girar el robot un ángulo especificado';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TITLE'] = 'avanzar %1 %2';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TOOLTIP'] = 'Mover el robot una distancia especificada';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TITLE'] = 'ajustar velocidad ruedas izquierda %1 derecha %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TOOLTIP'] = 'Definir la velocidad de las ruedas izquierda y derecha de forma independiente';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TITLE'] = 'ajustar posición ruedas izquierda %1 derecha %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TOOLTIP'] = 'Definir la posición angular de las ruedas izquierda y derecha';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TITLE'] = 'mover velocidad lineal %1 %2 velocidad angular %3 %4';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TOOLTIP'] = 'Controlar el movimiento con velocidad lineal y angular';
Blockly.Msg['ROBOTS_ALVIK_STOP_TITLE'] = 'detener los motores';
Blockly.Msg['ROBOTS_ALVIK_STOP_TOOLTIP'] = 'Detener los motores inmediatamente';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TITLE'] = 'frenar los motores';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TOOLTIP'] = 'Frenar activamente los motores';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TITLE'] = 'velocidad de las ruedas en %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TOOLTIP'] = 'Obtener la velocidad actual de las ruedas';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TITLE'] = 'posición de las ruedas en %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TOOLTIP'] = 'Obtener la posición angular actual de las ruedas';
Blockly.Msg['ROBOTS_ALVIK_GET_DRIVE_SPEED_TITLE'] = 'velocidad de conducción lineal %1 angular %2';
Blockly.Msg['ROBOTS_ALVIK_GET_DRIVE_SPEED_TOOLTIP'] = 'Obtener las velocidades de conducción actuales';
Blockly.Msg['ROBOTS_ALVIK_SET_SERVO_POSITIONS_TITLE'] = 'posición servos A %1 B %2 °';
Blockly.Msg['ROBOTS_ALVIK_SET_SERVO_POSITIONS_TOOLTIP'] = 'Definir las posiciones de los servomotores A y B';
Blockly.Msg['ROBOTS_ALVIK_SET_COLOR_TITLE'] = 'LED %1 color %2';
Blockly.Msg['ROBOTS_ALVIK_SET_COLOR_TOOLTIP'] = 'Cambia el color del LED integrado (izquierdo o derecho) del robot Alvik.';
Blockly.Msg['ROBOTS_ALVIK_LED_LEFT'] = 'izquierda';
Blockly.Msg['ROBOTS_ALVIK_LED_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_ALVIK_COLOR_RED'] = 'rojo';
Blockly.Msg['ROBOTS_ALVIK_COLOR_GREEN'] = 'verde';
Blockly.Msg['ROBOTS_ALVIK_COLOR_BLUE'] = 'azul';
Blockly.Msg['ROBOTS_ALVIK_COLOR_OFF'] = 'apagado';
Blockly.Msg['ROBOTS_ALVIK_COLOR_WHITE'] = 'blanco';
Blockly.Msg['ROBOTS_ALVIK_COLOR_YELLOW'] = 'amarillo';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CYAN'] = 'cian';
Blockly.Msg['ROBOTS_ALVIK_COLOR_MAGENTA'] = 'magenta';
Blockly.Msg['ROBOTS_ALVIK_SET_BUILTIN_LED_TITLE'] = 'estado del LED integrado %1';
Blockly.Msg['ROBOTS_ALVIK_SET_BUILTIN_LED_TOOLTIP'] = 'Encender o apagar el LED integrado';
Blockly.Msg['ROBOTS_ALVIK_SET_ILLUMINATOR_TITLE'] = 'estado LED del sensor de color %1';
Blockly.Msg['ROBOTS_ALVIK_SET_ILLUMINATOR_TOOLTIP'] = 'Activar o desactivar la LED de iluminación del sensor de color';
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TITLE'] = 'distancia en %1 sensor %2';
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TOOLTIP'] = 'Obtener la distancia medida por el sensor ToF';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TITLE'] = 'sensor de línea %1';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TOOLTIP'] = 'Obtener el valor del sensor de línea';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TITLE'] = 'orientación %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TOOLTIP'] = 'Obtener la orientación del robot (balanceo, cabeceo, guiñada)';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TITLE'] = 'aceleración eje %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TOOLTIP'] = 'Obtener la aceleración según el eje especificado';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TITLE'] = 'giroscopio eje %1';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TOOLTIP'] = 'Obtener el valor del giroscopio según el eje especificado';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TITLE'] = 'nivel de batería';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TOOLTIP'] = 'Obtener el nivel de carga de la batería';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TITLE'] = 'botón táctil %1 presionado';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TOOLTIP'] = 'Comprobar si un botón táctil está presionado';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TITLE'] = 'color en formato %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TOOLTIP'] = 'Obtener el color detectado en formato RGB o HSV';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TITLE'] = 'valor bruto del color %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TOOLTIP'] = 'Obtener el valor bruto de una componente de color';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TITLE'] = 'etiqueta de color';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TOOLTIP'] = 'Obtener el nombre del color detectado';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TITLE'] = 'calibrar color sobre fondo %1';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TOOLTIP'] = 'Calibrar el sensor de color con fondo negro o blanco';
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TITLE'] = 'convertir R %1 G %2 B %3 a HSV';
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TOOLTIP'] = 'Convertir los valores RGB a HSV.';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TITLE'] = 'convertir H %1 S %2 V %3 a etiqueta';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TOOLTIP'] = 'Convertir los valores HSV a nombre de color. Colores disponibles: BLACK, GREY, LIGHT GREY, WHITE, YELLOW, LIGHT GREEN, GREEN, LIGHT BLUE, BLUE, VIOLET, BROWN, ORANGE, RED y BLACK.';
Blockly.Msg['ROBOTS_LEFT_TOF'] = 'izquierda';
Blockly.Msg['ROBOTS_CENTER_LEFT_TOF'] = 'centro-izquierda';
Blockly.Msg['ROBOTS_CENTER_TOF'] = 'centro';
Blockly.Msg['ROBOTS_CENTER_RIGHT_TOF'] = 'centro-derecha';
Blockly.Msg['ROBOTS_RIGHT_TOF'] = 'derecha';
Blockly.Msg['ROBOTS_LEFT'] = 'izquierda';
Blockly.Msg['ROBOTS_CENTER'] = 'centro';
Blockly.Msg['ROBOTS_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_ROLL'] = 'alabeo';
Blockly.Msg['ROBOTS_PITCH'] = 'cabeceo';
Blockly.Msg['ROBOTS_YAW'] = 'guiñada';
Blockly.Msg['ROBOTS_AXIS_X'] = 'X';
Blockly.Msg['ROBOTS_AXIS_Y'] = 'Y';
Blockly.Msg['ROBOTS_AXIS_Z'] = 'Z';
Blockly.Msg['ROBOTS_UP'] = 'arriba';
Blockly.Msg['ROBOTS_DOWN'] = 'abajo';
Blockly.Msg['ROBOTS_OK'] = 'Aceptar';
Blockly.Msg['ROBOTS_CANCEL'] = 'Cancelar';
Blockly.Msg['ROBOTS_ANY'] = 'cualquiera';
Blockly.Msg['ROBOTS_COLOR_RGB'] = 'RGB';
Blockly.Msg['ROBOTS_COLOR_HSV'] = 'HSV';
Blockly.Msg['ROBOTS_COLOR_RED'] = 'rojo';
Blockly.Msg['ROBOTS_COLOR_GREEN'] = 'verde';
Blockly.Msg['ROBOTS_COLOR_BLUE'] = 'azul';
Blockly.Msg['ROBOTS_COLOR_BLACK'] = 'negro';
Blockly.Msg['ROBOTS_COLOR_WHITE'] = 'blanco';
Blockly.Msg['DISPLAY_LED_MATRIX_TITLE'] = '[Matriz de LED] mostrar %1 %2';
...
Blockly.Msg['DISPLAY_LED_MATRIX_CLEAR_TITLE'] = '[Matriz de LED] borrar la matriz';
...
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + 'Permite obtener el identificador UID como cadena de caracteres del módulo Grove RFID 125 kHz si está disponible en los pines digitales.\n\nLos datos recibidos del módulo vienen en forma de un arreglo de bytes. Para convertirlos, utiliza el bloque "[RFID] convertir los datos ... en INT".';
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TITLE"] = "[RFID - 125kHz] convertir los datos %1 a %2";
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TOOLTIP"] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + "Permite obtener los datos recibidos desde un arreglo de 'bytes' en forma de hexadecimal, entero (int) o lista de enteros.";
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nPor defecto, los pines SPI 2 de la placa ESP32 están en SCK: Pin(18) [D13], MISO: Pin(19) [D12] y MOSI: Pin(23) [D11] y los pines de SPI 1 están en SCK: Pin(14) [D7], MISO: Pin(12) [D8] y MOSI: Pin(13) [D9].';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] SPI %1 ID de la tarjeta en el pin NSS %2';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_RC522 + Blockly.Tooltip.SEP + 'Permite obtener el identificador UID como cadena de caracteres del módulo RFID RC522 en SPI de Joy-It si está detectado en los pines digitales.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
...
Blockly.Msg["ACTUATORS_MOSFET_SETPERCENTVALUE_TITLE"] = "[MOSFET] ajustar la potencia a %1 (%) en el pin %2";
...
Blockly.Msg["ACTUATORS_MOSFET_SETFREQUENCY_TITLE"] = "[MOSFET] ajustar la frecuencia a %1 (Hz) en el pin %2";
Blockly.Msg["ACTUATORS_MOSFET_SETFREQUENCY_TOOLTIP"] = IMG_MODULE_MOSFET + Blockly.Tooltip.SEP + "Permite controlar la frecuencia de ciclo (Hz) del transistor MOSFET en un pin PWM.";
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TITLE'] = '[Sensor IR MLX90621] temperatura (°C) tipo %1';
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'Devuelve la temperatura en grados Celsius (°C) medida con el sensor infrarrojo MLX90621. Conecta el sensor a un puerto I2C.';
Blockly.Msg['SENSORS_MLX90621_INT_TYPE'] = 'entero';
Blockly.Msg['SENSORS_MLX90621_FLOAT_TYPE'] = 'decimal';
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TITLE'] = '[Sensor IR MLX90621] temperatura (°C) %1';
Blockly.Msg['SENSORS_MLX90621_TEMP_MIN'] = 'mínimo';
Blockly.Msg['SENSORS_MLX90621_TEMP_MAX'] = 'máximo';
Blockly.Msg['SENSORS_MLX90621_TEMP_AVG'] = 'promedio';
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'Devuelve la temperatura del objeto (mínima, máxima o promedio) en grados Celsius (°C) usando el sensor infrarrojo MLX90621. Conecta el sensor a un puerto I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMFREQUENCY_TITLE'] = '[PCA9685] establecer la frecuencia de la señal PWM a %1 (Hz)';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMFREQUENCY_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'Permite configurar la frecuencia de la señal PWM (en Hz) para todos los canales del módulo PCA9685. Conecta el módulo a un puerto I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEPERCENT_TITLE'] = '[PCA9685] establecer la potencia de salida a %1 (%) en el canal %2';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEPERCENT_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'Permite controlar la potencia de salida PWM (de 0 a 100%) en un canal del módulo PCA9685. Conecta el módulo a un puerto I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEONTIME_TITLE'] = '[PCA9685] establecer tiempo de encendido a %1 (ms) en el canal %2';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEONTIME_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'Permite controlar el tiempo de encendido de la señal PWM (en ms) en un canal del módulo PCA9685. Conecta el módulo a un puerto I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLE_TITLE'] = '[PCA9685] flanco de subida %1 flanco de bajada %2 en el canal %3';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLE_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'Permite controlar la señal PWM estableciendo los contadores de flanco de subida y de bajada (0 a 4095) en un canal del módulo PCA9685. Conecta el módulo a un puerto I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLE_TITLE'] = '[PCA9685] establecer el ángulo del servomotor a %1 en el canal %2';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLE_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'Permite controlar el ángulo de un servomotor (de 0 a 180) en un canal del módulo PCA9685. Conecta el módulo a un puerto I2C. Atención: el montaje debe alimentarse con una batería para suministrar la corriente necesaria al servomotor.';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLECUSTOM_TITLE'] = '[PCA9685] establecer el ángulo del servomotor a %1 en el canal %2 con pulso mínimo %3 (ms) y pulso máximo %4 (ms)';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLECUSTOM_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'Permite controlar el ángulo de un servomotor (de 0 a 180) en un canal del módulo PCA9685 definiendo las anchuras de pulso en ms para los ángulos 0° y 180°. Conecta el módulo a un puerto I2C. Atención: el montaje debe alimentarse con una batería para suministrar la corriente necesaria al servomotor.';
