/**
 * @fileoverview Arabic messages for ESP32. (AR)
 * Not translated yet.
 */
...
Blockly.Msg['COMMUNICATION_START_BT_TITLE'] = '[Built-in BLE] initialize bluetooth %1';
Blockly.Msg['COMMUNICATION_START_BT_TOOLTIP'] = 'Initialize Bluetooth service on the ESP32 with given name.';
Blockly.Msg['COMMUNICATION_SEND_BT_TITLE'] = '[Built-in BLE] send data %1';
Blockly.Msg['COMMUNICATION_SEND_BT_TOOLTIP'] = 'Send data via the ESP32\'s Bluetooth service.';
Blockly.Msg['COMMUNICATION_BLE_READ_DATA_TITLE'] = '[Built-in BLE] on data reception in %1 then ';
...
Blockly.Msg['COMMUNICATION_FIZZIQ_BT_TITLE'] = '[Built-in BLE - Fizziq App] send %1 %2';
Blockly.Msg['COMMUNICATION_FIZZIQ_BT_TOOLTIP'] = IMG_MODULE_FIZZIQ + Blockly.Tooltip.SEP + 'Send data via the ESP32\'s Bluetooth service to Fizziq App. In the "Measurements" tab of Fizziq, click on "External Sensors", then Connect the App to the device named "ESP32_Vittascience".';
...
Blockly.Msg['COMMUNICATION_FS_SAVE_DATA_TITLE'] = '[ESP32] save data %1 in file %2';
Blockly.Msg['COMMUNICATION_FS_SAVE_DATA_TOOLTIP'] = 'Allows you to save data to a text file in the ESP32 file system. If you use the same file name, the data will be appended to the end of the file. You can also press the + button to change the file extension.';
...
Blockly.Msg['SENSORS_PRESSURE'] = 'الضغط';
Blockly.Msg['SENSORS_ALTITUDE'] = 'الارتفاع';
// Sensors - ESP32
...
Blockly.Msg['SENSORS_GY521_GETDATA_TITLE'] = '[مستشعر الحركة GY-521] %1';
Blockly.Msg['SENSORS_GY521_GETDATA_TOOLTIP'] = 'يعيد قيمة التسارع أو السرعة الزاوية أو درجة الحرارة باستخدام مستشعر GY-521 المتصل بمنفذ I2C.';
Blockly.Msg['SENSORS_GY521_ACC'] = 'التسارع';
Blockly.Msg['SENSORS_GY521_GYR'] = 'الجيروسكوب';
Blockly.Msg['SENSORS_GY521_TEMP'] = 'درجة الحرارة';
Blockly.Msg['SENSORS_GY521_AXIS'] = 'المحور';
// Other sensors
...
Blockly.Msg['SENSORS_GET_WATER_LEVEL_TITLE'] = '[مستوى الماء] القيمة';
Blockly.Msg['SENSORS_GET_WATER_LEVEL_TOOLTIP'] = IMG_MODULE_WATER_I2C + Blockly.Tooltip.SEP + 'يقيس مستوى الماء كنسبة مئوية (من 0 إلى 100%) على منفذ I2C.';
Blockly.Msg['SENSORS_VOLTAGE_DIVIDER_GETDATA_TITLE'] = '[مقسم الجهد] قسّم الجهد على %1 على الدبوس %2';
Blockly.Msg['SENSORS_VOLTAGE_DIVIDER_GETDATA_TOOLTIP'] = IMG_MODULE_VOLTAGE_DIVDER + Blockly.Tooltip.SEP + 'يُرجع قيمة الجهد على الدبابيس التناظرية (A0 إلى A5). يتيح لك المُحدد تحديد نطاق القياس: 3 لجهد بين 0.3 فولت و12.9 فولت، 10 لجهد بين 1 فولت و43 فولت.';
// Actuators - Motors
...
Blockly.Msg['ROBOTS_ILO_SET_LED_ANIM_TITLE'] = '[Ilo] LED animation %1 number of cycles %2';
...
Blockly.Msg['ROBOTS_ILO_GET_COLOR_RAW_TITLE'] = '[Ilo] raw color sensor value %1';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_RAW_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Returns the raw value (from 0 to 255) of the color sensor (center) of the Ilo robot.';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_CARD_TITLE'] = '[Ilo] detected card color %1';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_CARD_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Returns the color detected (white, orange, purple, light_blue, yellow, green, blue, red) by the color sensor (center) of the Ilo robot.';
Blockly.Msg['ROBOTS_ILO_COLOR_LABEL'] = 'name';
Blockly.Msg['ROBOTS_ILO_COLOR_RGB'] = 'rgb';
Blockly.Msg['ROBOTS_ILO_COLOR_RED'] = 'red';
Blockly.Msg['ROBOTS_ILO_COLOR_GREEN'] = 'green';
Blockly.Msg['ROBOTS_ILO_COLOR_BLUE'] = 'blue';
...
Blockly.Msg['ROBOTS_ILO_SET_ACC_TITLE'] = '[Ilo] ضبط التسارع إلى %1';
Blockly.Msg['ROBOTS_ILO_SET_ACC_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'يضبط تسارع روبوت Ilo.';
Blockly.Msg['ROBOTS_ILO_SET_TEMPO_TITLE'] = '[Ilo] التأخير بين الحركات %1 (مللي ثانية)';
Blockly.Msg['ROBOTS_ILO_SET_TEMPO_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'يضبط التأخير بين حركات روبوت Ilo.';
Blockly.Msg['ROBOTS_ILO_GET_LUMINOSITY_TITLE'] = '[Ilo] شدة الإضاءة تحت المستشعر %1';
Blockly.Msg['ROBOTS_ILO_GET_LUMINOSITY_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'يعرض قيمة الإضاءة التي يقيسها مستشعر روبوت Ilo.';
Blockly.Msg['ROBOTS_ILO_LINE_DETECTOR_ALL'] = 'الكل';
Blockly.Msg['ROBOTS_ILO_FINISH_STATE'] = 'هل تنتظر نهاية الحركة؟';
Blockly.Msg['ROBOTS_ILO_FINISH_STATE_YES'] = 'نعم';
Blockly.Msg['ROBOTS_ILO_FINISH_STATE_NO'] = 'لا';

Blockly.Msg['IO_GETMAGNETICSWITCH_TITLE'] = '[وحدة المفتاح المغناطيسي] الحالة على الطرف %1';
Blockly.Msg['IO_GETMAGNETICSWITCH_TOOLTIP'] = IMG_MODULE_MAGNETIC_SWITCH + Blockly.Tooltip.SEP + 'يعيد قيمة المفتاح المغناطيسي من نوع Grove (0 أو 1) على الأطراف الرقمية.';
...
Blockly.Msg['SENSORS_FSR402_GETFORCE_TOOLTIP'] = IMG_MODULE_FORCE + Blockly.Tooltip.SEP + 'يعيد القوة المطبقة على المستشعر الدائري باستخدام مستشعر FSR402 على الأطراف التناظرية.';
Blockly.Msg['SENSORS_EMG_DETECTOR_TITLE'] = '[كاشف EMG] القيمة على الطرف %1';
Blockly.Msg['SENSORS_EMG_DETECTOR_TOOLTIP'] = IMG_MODULE_EMG_DETECTOR + Blockly.Tooltip.SEP + 'يقيس التيارات الكهربائية التي تصاحب النشاط العضلي على الأطراف التناظرية.';
Blockly.Msg['SENSORS_GET_DISSOLVED_OXYGEN_PROBE_TITLE'] = '[مسبار الأكسجين المذاب] القيمة على الطرف %1';
Blockly.Msg['SENSORS_GET_DISSOLVED_OXYGEN_PROBE_TOOLTIP'] = 'يقيس الأكسجين المذاب في الماء على الأطراف التناظرية.';
Blockly.Msg['ACTUATORS_GROVEELECTROMAGNET_CONTROL_TITLE'] = '[المغناطيس الكهربائي] التحكم في الحالة %1 على الطرف %2';
...
Blockly.Msg['ACTUATORS_GROVEWATERATOMIZATION_CONTROL_TITLE'] = '[مرذاذ الماء] التحكم في الحالة %1 على الطرف %2';
...
Blockly.Msg['ROBOTS_ILO_COLOR_SENSOR_RIGHT'] = 'يمين';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TITLE'] = '[Ilo] %1 عرض تأثيرات مصابيح LED أثناء الحركة';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'يتيح تفعيل أو تعطيل عرض تأثيرات مصابيح LED أثناء تحرك روبوت Ilo.';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_ENABLE'] = 'تفعيل';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_DISABLE'] = 'تعطيل';
Blockly.Msg['ROBOTS_CENTIMETERS'] = 'سم';
Blockly.Msg['ROBOTS_MILLIMETERS'] = 'مم';
Blockly.Msg['ROBOTS_METERS'] = 'م';
Blockly.Msg['ROBOTS_INCHES'] = 'بوصة';
Blockly.Msg['ROBOTS_DEGREES'] = '°';
Blockly.Msg['ROBOTS_RADIANS'] = 'راديان';
Blockly.Msg['ROBOTS_REVOLUTIONS'] = 'دورات';
Blockly.Msg['ROBOTS_PERCENTAGE'] = '%';
Blockly.Msg['ROBOTS_CM_PER_S'] = 'سم/ث';
Blockly.Msg['ROBOTS_MM_PER_S'] = 'مم/ث';
Blockly.Msg['ROBOTS_M_PER_S'] = 'م/ث';
Blockly.Msg['ROBOTS_INCH_PER_S'] = 'بوصة/ث';
Blockly.Msg['ROBOTS_RPM'] = 'دورة/دقيقة';
Blockly.Msg['ROBOTS_DEG_PER_S'] = '°/ث';
Blockly.Msg['ROBOTS_RAD_PER_S'] = 'راديان/ث';
Blockly.Msg['ROBOTS_REV_PER_S'] = 'دورات/ث';
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TITLE'] = 'استدارة بمقدار %1 %2';
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TOOLTIP'] = 'تدوير الروبوت بزاوية محددة';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TITLE'] = 'التقدم بمقدار %1 %2';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TOOLTIP'] = 'تحريك الروبوت بمسافة محددة';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TITLE'] = 'تعيين سرعة العجلة اليسرى %1 واليمينية %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TOOLTIP'] = 'تعيين سرعات العجلتين اليسرى واليمنى بشكل مستقل';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TITLE'] = 'ضبط موضع العجلة اليسرى %1 واليمنى %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TOOLTIP'] = 'تعيين الموضع الزاوي للعجلتين اليسرى واليمنى';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TITLE'] = 'تحريك بسرعة خطية %1 %2 وسرعة زاوية %3 %4';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TOOLTIP'] = 'Blockly.Msg[\'ROBOTS_ALVIK_DRIVE_TOOLTIP\'] = \'التحكم في الحركة باستخدام سرعة خطية وسرعة زاوية\';';
Blockly.Msg['ROBOTS_ALVIK_STOP_TITLE'] = 'إيقاف المحركات';
Blockly.Msg['ROBOTS_ALVIK_STOP_TOOLTIP'] = 'إيقاف المحركات فوراً';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TITLE'] = 'فرملة المحركات';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TOOLTIP'] = 'تطبيق فرملة نشطة على المحركات';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TITLE'] = 'سرعة العجلات بوحدة %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TOOLTIP'] = 'الحصول على السرعة الحالية للعجلات';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TITLE'] = 'موضع العجلات بوحدة %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TOOLTIP'] = 'الحصول على الموضع الزاوي الحالي للعجلات';
Blockly.Msg['ROBOTS_ALVIK_GET_DRIVE_SPEED_TITLE'] = 'Blockly.Msg[\'ROBOTS_ALVIK_GET_DRIVE_SPEED_TITLE\'] = \'سرعة القيادة: خطية %1، سرعة زاوية %2\';';
Blockly.Msg['ROBOTS_ALVIK_GET_DRIVE_SPEED_TOOLTIP'] = 'الحصول على سرعات القيادة الحالية';
Blockly.Msg['ROBOTS_ALVIK_SET_SERVO_POSITIONS_TITLE'] = 'موضع السيرفو A %1 B %2 °';
Blockly.Msg['ROBOTS_ALVIK_SET_SERVO_POSITIONS_TOOLTIP'] = 'تعيين مواضع محركات السيرفو A وB';
Blockly.Msg['ROBOTS_ALVIK_SET_COLOR_TITLE'] = 'LED %1 لون %2';
Blockly.Msg['ROBOTS_ALVIK_SET_COLOR_TOOLTIP'] = 'تغيير لون LED المدمج (الأيسر أو الأيمن) في روبوت Alvik.';
Blockly.Msg['ROBOTS_ALVIK_LED_LEFT'] = 'يسار';
Blockly.Msg['ROBOTS_ALVIK_LED_RIGHT'] = 'يمين';
Blockly.Msg['ROBOTS_ALVIK_COLOR_RED'] = 'أحمر';
Blockly.Msg['ROBOTS_ALVIK_COLOR_GREEN'] = 'أخضر';
Blockly.Msg['ROBOTS_ALVIK_COLOR_BLUE'] = 'أزرق';
Blockly.Msg['ROBOTS_ALVIK_COLOR_OFF'] = 'مطفأ';
Blockly.Msg['ROBOTS_ALVIK_COLOR_WHITE'] = 'أبيض';
Blockly.Msg['ROBOTS_ALVIK_COLOR_YELLOW'] = 'أصفر';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CYAN'] = 'سماوي';
Blockly.Msg['ROBOTS_ALVIK_COLOR_MAGENTA'] = 'أرجواني';
Blockly.Msg['ROBOTS_ALVIK_SET_BUILTIN_LED_TITLE'] = 'حالة LED المدمجة %1';
Blockly.Msg['ROBOTS_ALVIK_SET_BUILTIN_LED_TOOLTIP'] = 'تشغيل أو إطفاء LED المدمج';
Blockly.Msg['ROBOTS_ALVIK_SET_ILLUMINATOR_TITLE'] = 'حالة LED لمستشعر اللون %1';
Blockly.Msg['ROBOTS_ALVIK_SET_ILLUMINATOR_TOOLTIP'] = 'تفعيل أو تعطيل إضاءة LED لمستشعر اللون';
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TITLE'] = 'المسافة بوحدة %1 للمستشعر %2';
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TOOLTIP'] = 'الحصول على المسافة المقاسة بواسطة مستشعر ToF';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TITLE'] = 'مستشعر الخط %1';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TOOLTIP'] = 'الحصول على قيمة مستشعر الخط';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TITLE'] = 'الاتجاه %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TOOLTIP'] = 'الحصول على اتجاه الروبوت (الدحرجة، الإمالة، الانحراف)';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TITLE'] = 'التسارع على المحور %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TOOLTIP'] = 'الحصول على التسارع على المحور المحدد';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TITLE'] = 'جيروسكوب المحور %1';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TOOLTIP'] = 'الحصول على قراءة الجيروسكوب للمحور المحدد';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TITLE'] = 'مستوى البطارية';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TOOLTIP'] = 'الحصول على مستوى شحن البطارية';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TITLE'] = 'الزر اللمسي %1 مضغوط';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TOOLTIP'] = 'التحقق مما إذا كان زر اللمس مضغوطاً';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TITLE'] = 'اللون بصيغة %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TOOLTIP'] = 'الحصول على اللون المكتشف بصيغة RGB أو HSV';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TITLE'] = 'القيمة الخام للون %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TOOLTIP'] = 'الحصول على القيمة الخام لمكوّن لوني';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TITLE'] = 'تسمية اللون';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TOOLTIP'] = 'الحصول على اسم اللون المكتشف';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TITLE'] = 'معايرة حساس اللون على خلفية %1';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TOOLTIP'] = 'معايرة مستشعر اللون لخلفية سوداء أو بيضاء';
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TITLE'] = 'تحويل R %1 G %2 B %3 إلى HSV';
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TOOLTIP'] = 'تحويل قيم RGB إلى HSV.';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TITLE'] = 'تحويل H %1 S %2 V %3 إلى تسمية';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TOOLTIP'] = 'تحويل قيم HSV إلى اسم لون. الألوان المتاحة: أسود، رمادي، رمادي فاتح، أبيض، أصفر، أخضر فاتح، أخضر، أزرق فاتح، أزرق، بنفسجي، بني، برتقالي، أحمر، وأسود.';
Blockly.Msg['ROBOTS_LEFT_TOF'] = 'يسار';
Blockly.Msg['ROBOTS_CENTER_LEFT_TOF'] = 'وسط-يسار';
Blockly.Msg['ROBOTS_CENTER_TOF'] = 'وسط';
Blockly.Msg['ROBOTS_CENTER_RIGHT_TOF'] = 'وسط-يمين';
Blockly.Msg['ROBOTS_RIGHT_TOF'] = 'يمين';
Blockly.Msg['ROBOTS_LEFT'] = 'يسار';
Blockly.Msg['ROBOTS_CENTER'] = 'مركز';
Blockly.Msg['ROBOTS_RIGHT'] = 'يمين';
Blockly.Msg['ROBOTS_ROLL'] = 'دوران';
Blockly.Msg['ROBOTS_PITCH'] = 'ميل';
Blockly.Msg['ROBOTS_YAW'] = 'انحراف';
Blockly.Msg['ROBOTS_AXIS_X'] = 'X';
Blockly.Msg['ROBOTS_AXIS_Y'] = 'Y';
Blockly.Msg['ROBOTS_AXIS_Z'] = 'Z';
Blockly.Msg['ROBOTS_UP'] = 'أعلى';
Blockly.Msg['ROBOTS_DOWN'] = 'أسفل';
Blockly.Msg['ROBOTS_OK'] = 'موافق';
Blockly.Msg['ROBOTS_CANCEL'] = 'إلغاء';
Blockly.Msg['ROBOTS_ANY'] = 'أياً كان';
Blockly.Msg['ROBOTS_COLOR_RGB'] = 'RGB';
Blockly.Msg['ROBOTS_COLOR_HSV'] = 'HSV';
Blockly.Msg['ROBOTS_COLOR_RED'] = 'أحمر';
Blockly.Msg['ROBOTS_COLOR_GREEN'] = 'أخضر';
Blockly.Msg['ROBOTS_COLOR_BLUE'] = 'أزرق';
Blockly.Msg['ROBOTS_COLOR_BLACK'] = 'أسود';
Blockly.Msg['ROBOTS_COLOR_WHITE'] = 'أبيض';
Blockly.Msg['DISPLAY_LED_MATRIX_TITLE'] = '[مصفوفة LED] عرض %1 %2';
Blockly.Msg['DISPLAY_LED_MATRIX_TOOLTIP'] = IMG_MODULE_LED_MATRIX_8_8 + Blockly.Tooltip.SEP + 'يتيح عرض رسم على مصفوفة LED أحادية اللون 8x8.';
Blockly.Msg['DISPLAY_LED_MATRIX_CLEAR_TITLE'] = '[مصفوفة LED] مسح المصفوفة';
Blockly.Msg['DISPLAY_LED_MATRIX_CLEAR_TOOLTIP'] = IMG_MODULE_LED_MATRIX_8_8 + Blockly.Tooltip.SEP + 'يطفئ كل مصابيح LED في المصفوفة';
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TITLE'] = '[RFID - 125kHz] معرّف البطاقة على دبابيس RX %1 TX %2';
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + 'يتيح استرداد معرّف UID كسلسلة أحرف من وحدة Grove RFID 125 kHz إذا كانت متاحة على الدبابيس الرقمية.\n\nالبيانات المستلمة من الوحدة تكون على شكل مصفوفة بايت. لتحويلها، استخدم الكتلة "[RFID] تحويل البيانات ... إلى INT".';
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TITLE"] = "[RFID - 125kHz] تحويل البيانات %1 إلى %2";
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TOOLTIP"] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + "يتيح الحصول على البيانات الواردة من مصفوفة بايت على شكل قيمة hex أو int أو قائمة أعداد صحيحة.";
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nبشكل افتراضي، دبابيس SPI 2 في لوحة ESP32 هي SCK: Pin(18) [D13], MISO: Pin(19) [D12] و MOSI: Pin(23) [D11] و دبابيس SPI 1 هي SCK: Pin(14) [D7], MISO: Pin(12) [D8] و MOSI: Pin(13) [D9].';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] SPI %1 معرّف البطاقة على دبوس NSS %2';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_RC522 + Blockly.Tooltip.SEP + 'يتيح استرداد معرّف الـUID كسلسلة أحرف من وحدة RFID RC522 بتوصيل SPI من Joy-It إذا تم اكتشافها على الدبابيس الرقمية.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
Blockly.Msg["SENSORS_ULTRASONIC_1PIN"] = "على الدبوس";
Blockly.Msg["SENSORS_ULTRASONIC_2PINS"] = "على الدبابيس ";
Blockly.Msg["ACTUATORS_MOSFET_SETSTATE_TITLE"] = "[MOSFET] ضبط الحالة إلى %1 على الدبوس %2";
Blockly.Msg["ACTUATORS_MOSFET_SETSTATE_TOOLTIP"] = IMG_MODULE_MOSFET + Blockly.Tooltip.SEP + "يتيح لك التحكم في حالة ترانزستور MOSFET (0 أو 1) على دبوس PWM.";
Blockly.Msg["ACTUATORS_MOSFET_SETPERCENTVALUE_TITLE"] = "[MOSFET] ضبط القدرة إلى %1 (%) على الدبوس %2";
Blockly.Msg["ACTUATORS_MOSFET_SETPERCENTVALUE_TOOLTIP"] = IMG_MODULE_MOSFET + Blockly.Tooltip.SEP + "يتيح لك التحكم في قدرة خرج ترانزستور MOSFET (من 0 إلى 100%) على دبوس PWM.";
Blockly.Msg["ACTUATORS_MOSFET_SETFREQUENCY_TITLE"] = "[MOSFET] ضبط التردد إلى %1 (Hz) على الدبوس %2";
Blockly.Msg["ACTUATORS_MOSFET_SETFREQUENCY_TOOLTIP"] = IMG_MODULE_MOSFET + Blockly.Tooltip.SEP + "يتيح لك التحكم في تردد الدورة (Hz) لترانزستور MOSFET على دبوس PWM.";
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TITLE'] = '[مستشعر حرارة بالأشعة تحت الحمراء MLX90621] درجة الحرارة (°C) النوع %1';
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'يعيد درجة الحرارة بالدرجات المئوية (°C) باستخدام مستشعر الأشعة تحت الحمراء MLX90621. قم بتوصيل المستشعر بمنفذ I2C.';
Blockly.Msg['SENSORS_MLX90621_INT_TYPE'] = 'عدد صحيح';
Blockly.Msg['SENSORS_MLX90621_FLOAT_TYPE'] = 'عشري';
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TITLE'] = '[مستشعر حرارة بالأشعة تحت الحمراء MLX90621] درجة الحرارة (°C) %1';
Blockly.Msg['SENSORS_MLX90621_TEMP_MIN'] = 'الحد الأدنى';
Blockly.Msg['SENSORS_MLX90621_TEMP_MAX'] = 'الحد الأقصى';
Blockly.Msg['SENSORS_MLX90621_TEMP_AVG'] = 'المتوسط';
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'يعيد الحد الأدنى أو الأقصى أو متوسط حرارة الجسم بالدرجات المئوية (°C) باستخدام مستشعر الأشعة تحت الحمراء MLX90621. قم بتوصيل المستشعر بمنفذ I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMFREQUENCY_TITLE'] = '[PCA9685] اضبط تردد إشارة PWM إلى %1 (Hz)';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMFREQUENCY_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'يتيح ضبط تردد إشارة PWM (بالهرتز) لجميع قنوات وحدة PCA9685. قم بتوصيل الوحدة بمنفذ I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEPERCENT_TITLE'] = '[PCA9685] اضبط طاقة الإخراج إلى %1 (%) على القناة %2';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEPERCENT_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'يتيح التحكم في طاقة خرج PWM (من 0 إلى 100%) على قناة واحدة من وحدة PCA9685. قم بتوصيل الوحدة بمنفذ I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEONTIME_TITLE'] = '[PCA9685] اضبط زمن التشغيل إلى %1 (ms) على القناة %2';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLEONTIME_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'يتيح التحكم في زمن تشغيل إشارة PWM (بالملي ثانية) على قناة واحدة من وحدة PCA9685. قم بتوصيل الوحدة بمنفذ I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLE_TITLE'] = '[PCA9685] الحافة الصاعدة %1 الحافة الهابطة %2 على القناة %3';
Blockly.Msg['ACTUATORS_PCA9685_SETPWMDUTYCYCLE_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'يتيح التحكم في إشارة PWM عن طريق ضبط قيم عدّاد الحافة الصاعدة والهابطة (من 0 إلى 4095) على قناة واحدة من وحدة PCA9685. قم بتوصيل الوحدة بمنفذ I2C.';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLE_TITLE'] = '[PCA9685] اضبط زاوية السيرفو إلى %1 على القناة %2';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLE_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'يتيح التحكم في زاوية محرك السيرفو (من 0 إلى 180) على قناة واحدة من وحدة PCA9685. قم بتوصيل الوحدة بمنفذ I2C. تحذير: يجب تشغيل الدائرة ببطارية لتوفير تيار كافٍ للمحرك.';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLECUSTOM_TITLE'] = '[PCA9685] اضبط زاوية السيرفو إلى %1 على القناة %2 مع مدة نبضة دنيا %3 (ms) ومدة نبضة قصوى %4 (ms)';
Blockly.Msg['ACTUATORS_PCA9685_SETSERVOANGLECUSTOM_TOOLTIP'] = IMG_MODULE_PCA9685 + Blockly.Tooltip.SEP + 'يتيح التحكم في زاوية محرك السيرفو (من 0 إلى 180) على قناة واحدة من وحدة PCA9685 عن طريق ضبط عرض النبضات بالملي ثانية لزاوية 0° و180°. قم بتوصيل الوحدة بمنفذ I2C. تحذير: يجب تشغيل الدائرة ببطارية لتوفير تيار كافٍ للمحرك.';
