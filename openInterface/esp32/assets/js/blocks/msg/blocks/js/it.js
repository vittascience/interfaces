/**
 * @fileoverview Italian messages for ESP32. (IT)
 * Not translated yet.
 */
...
Blockly.Msg['DISPLAY_OLED_DRAWICON_TOOLTIP'] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + 'Enable to display an icon from ESP32 Image library, at position (x,y) on the Grove OLED display. Connect the OLED display on I2C port.';
// Display - Neopixel
...
Blockly.Msg['DISPLAY_MY9221_REVERSE_TOOLTIP'] = IMG_MODULE_LED_BAR + Blockly.Tooltip.SEP + 'Allows to invert the 10 LEDs of the LED Bar module (MY9221) module with the digital pins P0 to P20.';
...
Blockly.Msg['SENSORS_GY521_GETDATA_TITLE'] = '[Sensore di movimento GY-521] %1';
Blockly.Msg['SENSORS_GY521_GETDATA_TOOLTIP'] = 'Restituisce il valore dell\'accelerazione, velocità angolare o temperatura utilizzando il sensore GY-521 collegato alla porta I2C.';
Blockly.Msg['SENSORS_GY521_ACC'] = 'accelerazione';
Blockly.Msg['SENSORS_GY521_GYR'] = 'giroscopio';
Blockly.Msg['SENSORS_GY521_TEMP'] = 'temperatura';
Blockly.Msg['SENSORS_GY521_AXIS'] = 'asse';
// Other sensors
...
Blockly.Msg['SENSORS_VOLTAGE_DIVIDER_GETDATA_TITLE'] = '[Divisore di tensione] dividi la tensione per %1 sul pin %2';
Blockly.Msg['SENSORS_VOLTAGE_DIVIDER_GETDATA_TOOLTIP'] = IMG_MODULE_VOLTAGE_DIVDER + Blockly.Tooltip.SEP + 'Restituisce il valore della tensione sui pin analogici. Il selettore consente di specificare l\'intervallo di misura: 3 per una tensione tra 0,3V e 12,9V, 10 per una tensione tra 1V e 43V.';
// Actuators
...
// Robot Ilo
Blockly.Msg['ROBOTS_ILO_SET_LED_COLOR_RGB_TITLE'] = '[Ilo] LED R %1 V %2 B %3';
Blockly.Msg['ROBOTS_ILO_SET_LED_COLOR_RGB_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Permette di controllare il colore dei LED del robot Ilo in formato RGB.';
Blockly.Msg['ROBOTS_ILO_SET_LED_COLOR_TITLE'] = '[Ilo] LED %1';
Blockly.Msg['ROBOTS_ILO_SET_LED_COLOR_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di controllare il colore dei LED del robot Ilo in formato RGB.';
Blockly.Msg['ROBOTS_ILO_SET_LED_SHAPE_TITLE'] = '[Ilo] LED mostra icona %1';
Blockly.Msg['ROBOTS_ILO_SET_LED_SHAPE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di controllare il colore dei LED del robot Ilo utilizzando una forma predefinita.';
Blockly.Msg['ROBOTS_ILO_SET_LED_ANIM_TITLE'] = '[Ilo] animazione LED %1 durata %2';
Blockly.Msg['ROBOTS_ILO_SET_LED_ANIM_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di controllare il colore dei LED del robot Ilo utilizzando un\'animazione predefinita.';
Blockly.Msg['ROBOTS_ILO_WAVE'] = 'onda';
Blockly.Msg['ROBOTS_ILO_SET_LED_SINGLE_TITLE'] = '[Ilo] LED n°%1 %2 in %3';
Blockly.Msg['ROBOTS_ILO_SET_LED_SINGLE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di controllare il colore dei LED del robot Ilo utilizzando un\'animazione predefinita.';
Blockly.Msg['ROBOTS_ILO_MATRIX'] = 'dalla matrice';
Blockly.Msg['ROBOTS_ILO_CIRCLE'] = 'dal cerchio';
Blockly.Msg['ROBOTS_ILO_MOVE_TITLE'] = '[Ilo] controlla il robot %1 velocità %2 %';
Blockly.Msg['ROBOTS_ILO_MOVE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di controllare la direzione e la velocità del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_MOVE_BY_STEPS_TITLE'] = '[Ilo] controlla il robot %1 di %2 unità';
Blockly.Msg['ROBOTS_ILO_MOVE_BY_STEPS_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di controllare la direzione e la distanza percorsa dal robot Ilo. 1 unità = 1 lunghezza del robot Ilo, ovvero 20 cm.';
Blockly.Msg['ROBOTS_ILO_MOVE_FRONT'] = 'avanti';
Blockly.Msg['ROBOTS_ILO_MOVE_BACK'] = 'indietro';
Blockly.Msg['ROBOTS_ILO_MOVE_RIGHT'] = 'a destra';
Blockly.Msg['ROBOTS_ILO_MOVE_LEFT'] = 'a sinistra';
Blockly.Msg['ROBOTS_ILO_MOVE_ROT_TRIGO'] = 'ruotare a sinistra';
Blockly.Msg['ROBOTS_ILO_MOVE_ROT_CLOCK'] = 'ruotare a destra';
Blockly.Msg['ROBOTS_ILO_MOVE_MOTOR_TITLE'] = '[Ilo] controlla il motore %1 direzione %2 velocità %3 %';
Blockly.Msg['ROBOTS_ILO_MOVE_MOTOR_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di controllare un motore specifico del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_FRONT_LEFT'] = 'anteriore sinistra';
Blockly.Msg['ROBOTS_ILO_FRONT_RIGHT'] = 'anteriore destra';
Blockly.Msg['ROBOTS_ILO_BACK_RIGHT'] = 'posteriore destra';
Blockly.Msg['ROBOTS_ILO_BACK_LEFT'] = 'posteriore sinistra';
Blockly.Msg['ROBOTS_ILO_ROTATE_TITLE'] = '[Ilo] ruotare il robot in direzione %1 di %2 °';
Blockly.Msg['ROBOTS_ILO_ROTATE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di ruotare il robot Ilo nella direzione e con l\'angolo desiderati (in gradi).';
Blockly.Msg['ROBOTS_ILO_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Ilo] muovere avanti di una casella';
Blockly.Msg['ROBOTS_ILO_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Muove il robot Ilo avanti di una casella.';
Blockly.Msg['ROBOTS_ILO_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Ilo] muovere indietro di una casella';
Blockly.Msg['ROBOTS_ILO_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Muove il robot Ilo indietro di una casella.';
Blockly.Msg['ROBOTS_ILO_TURN_LEFT_TITLE'] = '[Ilo] girare a sinistra';
Blockly.Msg['ROBOTS_ILO_TURN_LEFT_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Gira il robot Ilo di 90° a sinistra.';
Blockly.Msg['ROBOTS_ILO_TURN_RIGHT_TITLE'] = '[Ilo] girare a destra';
Blockly.Msg['ROBOTS_ILO_TURN_RIGHT_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Gira il robot Ilo di 90° a destra.';
Blockly.Msg['ROBOTS_ILO_STOP_ROBOT_TITLE'] = '[Ilo] fermare il robot';
Blockly.Msg['ROBOTS_ILO_STOP_ROBOT_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Ferma i motori del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_GET_DISTANCE_TITLE'] = '[Ilo] distanza sul sensore %1';
Blockly.Msg['ROBOTS_ILO_GET_DISTANCE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Restituisce la distanza (in mm) dall\'ostacolo più vicino nella direzione indicata.';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_RAW_TITLE'] = '[Ilo] valore grezzo sensore di colore %1';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_RAW_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Restituisce il valore grezzo (da 0 a 255) del sensore di colore (centrale) del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_CARD_TITLE'] = '[Ilo] colore carta rilevato %1';
Blockly.Msg['ROBOTS_ILO_GET_COLOR_CARD_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Restituisce il colore rilevato (bianco, arancione, viola, azzurro, giallo, verde, blu, rosso) dal sensore di colore (centrale) del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_COLOR_LABEL'] = 'nome';
Blockly.Msg['ROBOTS_ILO_COLOR_RGB'] = 'rgb';
Blockly.Msg['ROBOTS_ILO_COLOR_RED'] = 'rosso';
Blockly.Msg['ROBOTS_ILO_COLOR_GREEN'] = 'verde';
Blockly.Msg['ROBOTS_ILO_COLOR_BLUE'] = 'blu';
Blockly.Msg['ROBOTS_ILO_COLOR_SENSOR_RIGHT'] = 'destro';
Blockly.Msg['ROBOTS_ILO_FRONT'] = 'anteriore';
Blockly.Msg['ROBOTS_ILO_BACK'] = 'posteriore';
Blockly.Msg['ROBOTS_ILO_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_ILO_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_ILO_LINE_DETECTOR_TITLE'] = '[Ilo] stato del sensore di linea %1';
Blockly.Msg['ROBOTS_ILO_LINE_DETECTOR_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Restituisce lo stato del sensore di linea (destra/sinistra) del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_SET_LINE_DETECTOR_THRESHOLD_TITLE'] = '[Ilo] soglia del sensore di linea %1';
Blockly.Msg['ROBOTS_ILO_SET_LINE_DETECTOR_THRESHOLD_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Imposta la soglia per il sensore di linea (destra/sinistra) del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_LINE_DETECTOR_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_ILO_LINE_DETECTOR_MIDDLE'] = 'centrale';
Blockly.Msg['ROBOTS_ILO_LINE_DETECTOR_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_ILO_COLOR_DETECTOR_TITLE'] = '[Ilo] rileva il colore sotto il %1 sensore';
Blockly.Msg['ROBOTS_ILO_COLOR_DETECTOR_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Consente di rilevare quale colore si trova sotto il robot Ilo.';
Blockly.Msg['ROBOTS_ILO_COLOR_DETECTOR_RGB_TITLE'] = '[Ilo] rileva l\'intensità di %1 sotto il %2 sensore';
Blockly.Msg['ROBOTS_ILO_COLOR_DETECTOR_RGB_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Permette di rilevare quale colore si trova sotto il robot Ilo e restituisce l\'intensità di rosso, verde o blu.';
Blockly.Msg['ROBOTS_ILO_RED'] = 'rosso';
Blockly.Msg['ROBOTS_ILO_GREEN'] = 'verde';
Blockly.Msg['ROBOTS_ILO_BLUE'] = 'blu';
Blockly.Msg['ROBOTS_ILO_GET_INTERNAL_SENSORS_TITLE'] = '[Ilo] %1';
Blockly.Msg['ROBOTS_ILO_GET_INTERNAL_SENSORS_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Restituisce il valore del beccheggio, rollio o imbardata del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_PITCH'] = 'beccheggio';
Blockly.Msg['ROBOTS_ILO_ROLL'] = 'rollio';
Blockly.Msg['ROBOTS_ILO_YAW'] = 'imbardata';
Blockly.Msg['ROBOTS_ILO_SET_ACC_TITLE'] = '[Ilo] imposta accelerazione a %1';
Blockly.Msg['ROBOTS_ILO_SET_ACC_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + "Imposta l'accelerazione del robot Ilo.";
Blockly.Msg['ROBOTS_ILO_SET_TEMPO_TITLE'] = '[Ilo] ritardo tra i movimenti %1 (ms)';
Blockly.Msg['ROBOTS_ILO_SET_TEMPO_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Imposta il ritardo tra i movimenti del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_GET_LUMINOSITY_TITLE'] = '[Ilo] luminosità sotto il sensore %1';
Blockly.Msg['ROBOTS_ILO_GET_LUMINOSITY_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Restituisce il valore della luminosità misurata dal sensore del robot Ilo.';
Blockly.Msg['ROBOTS_ILO_LINE_DETECTOR_ALL'] = 'tutti';
Blockly.Msg['ROBOTS_ILO_FINISH_STATE'] = 'attendere la fine del movimento?';
Blockly.Msg['ROBOTS_ILO_FINISH_STATE_YES'] = 'sì';
Blockly.Msg['ROBOTS_ILO_FINISH_STATE_NO'] = 'no';

Blockly.Msg['SENSORS_PRESSURE'] = 'pressione';
Blockly.Msg['SENSORS_ALTITUDE'] = 'altitudine';
...
Blockly.Msg['SENSORS_BAROMETER_READDATA_TITLE'] = '[Barometro HP206C] %1';
Blockly.Msg['SENSORS_BAROMETER_READDATA_TOOLTIP'] = IMG_MODULE_HP206C + Blockly.Tooltip.SEP + 'Restituisce la temperatura in gradi Celsius (°C), Fahrenheit (°F) o Kelvin (K), la pressione (in hPa) o l\'altitudine (in m) utilizzando il barometro HP206C. Collegare il sensore a una porta I2C.';
Blockly.Msg['SENSORS_FSR402_GETFORCE_TITLE'] = '[Sensore di forza] valore sul pin %1';
Blockly.Msg['SENSORS_FSR402_GETFORCE_TOOLTIP'] = IMG_MODULE_FORCE + Blockly.Tooltip.SEP + 'Restituisce la forza applicata al sensore rotondo utilizzando il sensore FSR402 sui pin analogici.';
Blockly.Msg['SENSORS_EMG_DETECTOR_TITLE'] = '[Rilevatore EMG] valore sul pin %1';
Blockly.Msg['SENSORS_EMG_DETECTOR_TOOLTIP'] = IMG_MODULE_EMG_DETECTOR + Blockly.Tooltip.SEP + 'Misura le correnti elettriche che accompagnano l\'attività muscolare sui pin analogici.';
Blockly.Msg['SENSORS_GET_DISSOLVED_OXYGEN_PROBE_TITLE'] = '[Sonda ossigeno disciolto] valore sul pin %1';
Blockly.Msg['SENSORS_GET_DISSOLVED_OXYGEN_PROBE_TOOLTIP'] = 'Misura l\'ossigeno disciolto nell\'acqua sui pin analogici.';
Blockly.Msg['ACTUATORS_GROVEELECTROMAGNET_CONTROL_TITLE'] = '[Elettromagnete] controlla a stato %1 sul pin %2';
Blockly.Msg['ACTUATORS_GROVEELECTROMAGNET_CONTROL_TOOLTIP'] = IMG_MODULE_ELECTROMAGNET + Blockly.Tooltip.SEP + 'Consente di attivare o disattivare l\'elettromagnete.';
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TITLE'] = '[uart %1] dati disponibili';
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Restituisce la dimensione dei dati disponibili sulla porta UART (1 o 2). Per impostazione predefinita, i pin sono i seguenti: UART 1 (tx=10, rx=9) e UART 2 (tx=17, rx=16). In caso contrario, utilizzare il blocco \'Imposta la connessione seriale su RX TX Baudrate ...\'.';
Blockly.Msg['ACTUATORS_GROVEWATERATOMIZATION_CONTROL_TITLE'] = '[Atomizzatore d\'acqua] controllare allo stato %1 sul pin %2';
...
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TITLE'] = '[Ilo] %1 l\'animazione dei LED durante i movimenti';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_TOOLTIP'] = IMG_ROBOT_ILO + Blockly.Tooltip.SEP + 'Attiva o disattiva le animazioni dei LED mentre il robot Ilo si muove.';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_ENABLE'] = 'attiva';
Blockly.Msg['ROBOTS_ILO_DISPLAY_LED_ANIMATION_STATE_DISABLE'] = 'disattiva';
Blockly.Msg['ROBOTS_CENTIMETERS'] = 'cm';
Blockly.Msg['ROBOTS_MILLIMETERS'] = 'mm';
Blockly.Msg['ROBOTS_METERS'] = 'm';
Blockly.Msg['ROBOTS_INCHES'] = 'pollice';
Blockly.Msg['ROBOTS_DEGREES'] = '°';
Blockly.Msg['ROBOTS_RADIANS'] = 'rad';
Blockly.Msg['ROBOTS_REVOLUTIONS'] = 'giri';
...
Blockly.Msg['ROBOTS_INCH_PER_S'] = 'pollice/s';
Blockly.Msg['ROBOTS_RPM'] = 'rpm';
Blockly.Msg['ROBOTS_DEG_PER_S'] = '°/s';
Blockly.Msg['ROBOTS_RAD_PER_S'] = 'rad/s';
Blockly.Msg['ROBOTS_REV_PER_S'] = 'giri/s';
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TITLE'] = 'ruotare di %1 %2';
Blockly.Msg['ROBOTS_ALVIK_ROTATE_TOOLTIP'] = 'Far ruotare il robot di un angolo specificato';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TITLE'] = 'avanzare di %1 %2';
Blockly.Msg['ROBOTS_ALVIK_MOVE_TOOLTIP'] = 'Spostare il robot di una distanza specificata';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TITLE'] = 'impostare velocità ruota sinistra %1 destra %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_SPEED_TOOLTIP'] = 'Impostare separatamente la velocità delle ruote sinistra e destra';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TITLE'] = 'impostare posizione ruota sinistra %1 destra %2 %3';
Blockly.Msg['ROBOTS_ALVIK_SET_WHEELS_POSITION_TOOLTIP'] = 'Impostare la posizione angolare delle ruote sinistra e destra';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TITLE'] = 'Blockly.Msg[\'ROBOTS_ALVIK_DRIVE_TITLE\'] = \'muovi con velocità lineare %1 %2 e velocità angolare %3 %4\';';
Blockly.Msg['ROBOTS_ALVIK_DRIVE_TOOLTIP'] = 'Controllare il movimento con velocità lineare e angolare';
Blockly.Msg['ROBOTS_ALVIK_STOP_TITLE'] = 'Blockly.Msg[\'ROBOTS_ALVIK_STOP_TITLE\'] = \'fermare i motori\';';
Blockly.Msg['ROBOTS_ALVIK_STOP_TOOLTIP'] = 'Fermare immediatamente i motori';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TITLE'] = 'frenare i motori';
Blockly.Msg['ROBOTS_ALVIK_BRAKE_TOOLTIP'] = 'Frenare attivamente i motori';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TITLE'] = 'velocità delle ruote in %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_SPEED_TOOLTIP'] = 'Ottenere la velocità attuale delle ruote';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TITLE'] = 'posizione delle ruote in %1';
Blockly.Msg['ROBOTS_ALVIK_GET_WHEELS_POSITION_TOOLTIP'] = 'Ottenere la posizione angolare attuale delle ruote';
Blockly.Msg['ROBOTS_ALVIK_GET_DRIVE_SPEED_TITLE'] = 'velocità di guida lineare %1 angolare %2';
...
Blockly.Msg['ROBOTS_ALVIK_SET_ILLUMINATOR_TOOLTIP'] = 'Attivare o disattivare il LED di illuminazione del sensore di colore';
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TITLE'] = 'distanza in %1 sensore %2';
Blockly.Msg['ROBOTS_ALVIK_GET_DISTANCE_TOOLTIP'] = 'Ottenere la distanza misurata dal sensore ToF';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TITLE'] = 'sensore di linea %1';
Blockly.Msg['ROBOTS_ALVIK_GET_LINE_TOOLTIP'] = 'Ottenere il valore del sensore di linea';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TITLE'] = 'orientamento %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ORIENTATION_TOOLTIP'] = 'Ottenere l\'orientamento del robot (rollio, beccheggio, imbardata)';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TITLE'] = 'accelerazione asse %1';
Blockly.Msg['ROBOTS_ALVIK_GET_ACCELERATION_TOOLTIP'] = 'Ottenere l\'accelerazione lungo l\'asse specificato';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TITLE'] = 'giroscopio asse %1';
Blockly.Msg['ROBOTS_ALVIK_GET_GYROS_TOOLTIP'] = 'Ottenere il valore del giroscopio lungo l\'asse specificato';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TITLE'] = 'livello batteria';
Blockly.Msg['ROBOTS_ALVIK_GET_BATTERY_CHARGE_TOOLTIP'] = 'Ottenere il livello di carica della batteria';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TITLE'] = 'pulsante tattile %1 premuto';
Blockly.Msg['ROBOTS_ALVIK_GET_TOUCH_BUTTON_TOOLTIP'] = 'Verificare se un pulsante tattile è premuto';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TITLE'] = 'colore in formato %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_TOOLTIP'] = 'Ottenere il colore rilevato nei formati RGB o HSV';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TITLE'] = 'valore grezzo colore %1';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_RAW_TOOLTIP'] = 'Ottenere il valore grezzo di una componente del colore';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TITLE'] = 'etichetta colore';
Blockly.Msg['ROBOTS_ALVIK_GET_COLOR_LABEL_TOOLTIP'] = 'Ottenere il nome del colore rilevato';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TITLE'] = 'calibrare colore su sfondo %1';
Blockly.Msg['ROBOTS_ALVIK_COLOR_CALIBRATION_TOOLTIP'] = 'Calibrare il sensore di colore su sfondo nero o bianco';
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TITLE'] = 'convertire R %1 G %2 B %3 in HSV';
Blockly.Msg['ROBOTS_ALVIK_RGB2HSV_TOOLTIP'] = 'Convertire i valori RGB in valori HSV.';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TITLE'] = 'convertire H %1 S %2 V %3 in etichetta';
Blockly.Msg['ROBOTS_ALVIK_HSV2LABEL_TOOLTIP'] = 'Convertire i valori HSV nel nome del colore. Colori disponibili : BLACK, GREY, LIGHT GREY, WHITE, YELLOW, LIGHT GREEN, GREEN, LIGHT BLUE, BLUE, VIOLET, BROWN, ORANGE, RED and BLACK.';
Blockly.Msg['ROBOTS_LEFT_TOF'] = 'sinistra';
Blockly.Msg['ROBOTS_CENTER_LEFT_TOF'] = 'centro-sinistra';
Blockly.Msg['ROBOTS_CENTER_TOF'] = 'centro';
Blockly.Msg['ROBOTS_CENTER_RIGHT_TOF'] = 'centro-destro';
Blockly.Msg['ROBOTS_RIGHT_TOF'] = 'destra';
Blockly.Msg['ROBOTS_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_CENTER'] = 'centro';
Blockly.Msg['ROBOTS_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_ROLL'] = 'rollio';
Blockly.Msg['ROBOTS_PITCH'] = 'beccheggio';
Blockly.Msg['ROBOTS_YAW'] = 'imbardata';
Blockly.Msg['ROBOTS_AXIS_X'] = 'X';
Blockly.Msg['ROBOTS_AXIS_Y'] = 'Y';
Blockly.Msg['ROBOTS_AXIS_Z'] = 'Z';
Blockly.Msg['ROBOTS_UP'] = 'su';
Blockly.Msg['ROBOTS_DOWN'] = 'giù';
Blockly.Msg['ROBOTS_OK'] = 'OK';
Blockly.Msg['ROBOTS_CANCEL'] = 'annulla';
Blockly.Msg['ROBOTS_ANY'] = 'qualsiasi';
Blockly.Msg['ROBOTS_COLOR_RGB'] = 'RGB';
Blockly.Msg['ROBOTS_COLOR_HSV'] = 'HSV';
Blockly.Msg['ROBOTS_COLOR_RED'] = 'rosso';
Blockly.Msg['ROBOTS_COLOR_GREEN'] = 'verde';
Blockly.Msg['ROBOTS_COLOR_BLUE'] = 'blu';
Blockly.Msg['ROBOTS_COLOR_BLACK'] = 'nero';
Blockly.Msg['ROBOTS_COLOR_WHITE'] = 'bianco';
Blockly.Msg['DISPLAY_LED_MATRIX_TITLE'] = '[Matrice LED] mostra %1 %2';
Blockly.Msg['DISPLAY_LED_MATRIX_TOOLTIP'] = IMG_MODULE_LED_MATRIX_8_8 + Blockly.Tooltip.SEP + 'Consente di visualizzare un disegno sulla matrice LED monocromatica 8x8.';
Blockly.Msg['DISPLAY_LED_MATRIX_CLEAR_TITLE'] = '[Matrice LED] cancella la matrice';
...
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TITLE'] = '[RFID - 125kHz] ID del badge sui pin RX %1 TX %2';
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + 'Consente di recuperare l\'identificatore UID come stringa dal modulo Grove RFID 125 kHz se questo è disponibile sui pin digitali.\n\nI dati ricevuti dal modulo sono sotto forma di un array di byte. Per convertirli, usa il blocco "[RFID] convertire i dati ... in INT".';
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TITLE"] = "[RFID - 125kHz] convertire i dati %1 in %2";
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TOOLTIP"] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + "Consente di ottenere i dati ricevuti da un array di 'byte' come hex, int o lista di interi.";
