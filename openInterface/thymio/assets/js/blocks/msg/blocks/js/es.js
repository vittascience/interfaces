...
Blockly.Msg['MATH_THYMIO_RESULT_DEFAULT_NAME'] = 'resultado';
Blockly.Msg['VARIABLES_DEFAULT_NAME1'] = 'A';
Blockly.Msg['VARIABLES_DEFAULT_NAME2'] = 'B';
Blockly.Msg['MATH_THYMIO_COPY_TITLE'] = 'copiar %1 en %2';
Blockly.Msg['MATH_THYMIO_COPY_TOOLTIP'] = 'Copia el valor de "A" a "B".';
Blockly.Msg['MATH_THYMIO_ADD_TITLE'] = 'sumar %1 a %2 en %3';
Blockly.Msg['MATH_THYMIO_ADD_TOOLTIP'] = 'Suma el valor de "A" a "B" y almacena el resultado en "C".';
Blockly.Msg['MATH_THYMIO_SUBTRACT_TITLE'] = 'restar %1 a %2 en %3';
Blockly.Msg['MATH_THYMIO_SUBTRACT_TOOLTIP'] = 'Resta el valor de "A" a "B" y almacena el resultado en "C".';
Blockly.Msg['MATH_THYMIO_MULTIPLY_TITLE'] = 'multiplicar %1 por %2 en %3';
Blockly.Msg['MATH_THYMIO_MULTIPLY_TOOLTIP'] = 'Multiplica el valor de "A" por "B" y almacena el resultado en "C".';
Blockly.Msg['MATH_THYMIO_DIVIDE_TITLE'] = 'dividir %1 por %2 en %3';
Blockly.Msg['MATH_THYMIO_DIVIDE_TOOLTIP'] = 'División entera del valor de "A" por "B" y almacena el resultado en "C".';
Blockly.Msg['MATH_THYMIO_MIN_TITLE'] = 'mínimo de %1 y %2 en %3';
Blockly.Msg['MATH_THYMIO_MIN_TOOLTIP'] = 'Almacena el mínimo entre "A" y "B" en "C".';
Blockly.Msg['MATH_THYMIO_MAX_TITLE'] = 'máximo de %1 y %2 en %3';
Blockly.Msg['MATH_THYMIO_MAX_TOOLTIP'] = 'Almacena el máximo entre "A" y "B" en "C".';
Blockly.Msg['MATH_THYMIO_RANDOM_TITLE'] = 'número aleatorio en %1';
Blockly.Msg['MATH_THYMIO_RANDOM_TOOLTIP'] = 'Almacena un número aleatorio en "resultado".';
Blockly.Msg['MATH_THYMIO_SIN_TITLE'] = 'seno de %1 en %2';
Blockly.Msg['MATH_THYMIO_SIN_TOOLTIP'] = 'Almacena el valor del seno del ángulo "A" (en radianes) en "resultado".';
Blockly.Msg['MATH_THYMIO_COS_TITLE'] = 'coseno de %1 en %2';
Blockly.Msg['MATH_THYMIO_COS_TOOLTIP'] = 'Almacena el valor del coseno del ángulo "A" (en radianes) en "resultado".';
Blockly.Msg['MATH_THYMIO_SQRT_TITLE'] = 'raíz cuadrada de %1 en %2';
Blockly.Msg['MATH_THYMIO_SQRT_TOOLTIP'] = 'Almacena la raíz cuadrada de "A" en "resultado".';
