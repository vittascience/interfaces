...
Blockly.Msg['IO_ON_TIMER_EVENT_TITLE'] = 'when %1 timer is triggered';
Blockly.Msg['IO_ON_TIMER_EVENT_TOOLTIP'] = 'Create an event and execute the code when the timer is triggered.';
...
// Sensors - Proximity
Blockly.Msg['SENSORS_GET_PROXIMITY_TITLE'] = 'distance from proximity sensor %1';
Blockly.Msg['SENSORS_GET_PROXIMITY_TOOLTIP'] = 'Read the distance from the proximity sensor.';
...
Blockly.Msg['ROBOT_ROTATE_CLOCK_TITLE'] = 'control the robot to rotate %1 with speed %2';
...
Blockly.Msg['ROBOT_ROTATE_FOREVER_TITLE'] = 'control the robot to rotate %1 with speed %2';
...
Blockly.Msg['MATH_THYMIO_RESULT_DEFAULT_NAME'] = 'risultato';
Blockly.Msg['VARIABLES_DEFAULT_NAME1'] = 'A';
Blockly.Msg['VARIABLES_DEFAULT_NAME2'] = 'B';
Blockly.Msg['MATH_THYMIO_COPY_TITLE'] = 'copia %1 in %2';
Blockly.Msg['MATH_THYMIO_COPY_TOOLTIP'] = 'Copia il valore di "A" in "B".';
Blockly.Msg['MATH_THYMIO_ADD_TITLE'] = 'aggiungi %1 a %2 in %3';
Blockly.Msg['MATH_THYMIO_ADD_TOOLTIP'] = 'Aggiunge il valore di "A" a "B" e memorizza il risultato in "C".';
Blockly.Msg['MATH_THYMIO_SUBTRACT_TITLE'] = 'sottrai %1 a %2 in %3';
Blockly.Msg['MATH_THYMIO_SUBTRACT_TOOLTIP'] = 'Sottrae il valore di "A" a "B" e memorizza il risultato in "C".';
Blockly.Msg['MATH_THYMIO_MULTIPLY_TITLE'] = 'moltiplica %1 per %2 in %3';
Blockly.Msg['MATH_THYMIO_MULTIPLY_TOOLTIP'] = 'Moltiplica il valore di "A" per "B" e memorizza il risultato in "C".';
Blockly.Msg['MATH_THYMIO_DIVIDE_TITLE'] = 'dividi %1 per %2 in %3';
Blockly.Msg['MATH_THYMIO_DIVIDE_TOOLTIP'] = 'Divisione intera del valore di "A" per "B" e memorizza il risultato in "C".';
Blockly.Msg['MATH_THYMIO_MIN_TITLE'] = 'minimo di %1 e %2 in %3';
Blockly.Msg['MATH_THYMIO_MIN_TOOLTIP'] = 'Memorizza il minimo tra "A" e "B" in "C".';
Blockly.Msg['MATH_THYMIO_MAX_TITLE'] = 'massimo di %1 e %2 in %3';
Blockly.Msg['MATH_THYMIO_MAX_TOOLTIP'] = 'Memorizza il massimo tra "A" e "B" in "C".';
Blockly.Msg['MATH_THYMIO_RANDOM_TITLE'] = 'numero casuale in %1';
Blockly.Msg['MATH_THYMIO_RANDOM_TOOLTIP'] = 'Memorizza un numero casuale in "risultato".';
Blockly.Msg['MATH_THYMIO_SIN_TITLE'] = 'seno di %1 in %2';
Blockly.Msg['MATH_THYMIO_SIN_TOOLTIP'] = 'Memorizza il valore del seno dell\'angolo "A" (in radianti) in "risultato".';
Blockly.Msg['MATH_THYMIO_COS_TITLE'] = 'coseno di %1 in %2';
Blockly.Msg['MATH_THYMIO_COS_TOOLTIP'] = 'Memorizza il valore del coseno dell\'angolo "A" (in radianti) in "risultato".';
Blockly.Msg['MATH_THYMIO_SQRT_TITLE'] = 'radice quadrata di %1 in %2';
Blockly.Msg['MATH_THYMIO_SQRT_TOOLTIP'] = 'Memorizza la radice quadrata di "A" in "risultato".';
