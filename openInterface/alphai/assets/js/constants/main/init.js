...
const DEFAULT_CODE_START = 'while True:\n  pass';
//modes
...
//board
const BOARD_ALPHAI = "alphai";
const BOARD_DEFAULT = BOARD_ALPHAI;
//standalone_blocks
...
const SIMULATOR_DEFAULT_BOARD = {
    "link": "alphai-front.svg",
    "name": "AlphAI"
};
const SIMULATOR_DEFAULT_ROBOT = 'alphai';
