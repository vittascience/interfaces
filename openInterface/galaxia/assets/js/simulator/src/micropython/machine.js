...
var $builtinmodule = function (name) {
	...
	machine.Pin = new Sk.misceval.buildClass(machine, function ($gbl, $loc) {
		...
		// drive
		$loc.DRIVE_0 = new Sk.builtin.int_(0);
		$loc.DRIVE_1 = new Sk.builtin.int_(1);
		$loc.DRIVE_2 = new Sk.builtin.int_(2);
		$loc.DRIVE_3 = new Sk.builtin.int_(3);
		// grove pins
		$loc.GROVE_1_PRIM = new Sk.builtin.int_(13);
		$loc.GROVE_1_SEC = new Sk.builtin.int_(14);
		$loc.DRIVE_2_PRIM = new Sk.builtin.int_(7);
		$loc.GROVE_2_SEC = new Sk.builtin.int_(6);
		// pins
		$loc.P0 = new Sk.builtin.int_(3);
		$loc.P1 = new Sk.builtin.int_(2);
		$loc.P2 = new Sk.builtin.int_(1);
		$loc.P3 = new Sk.builtin.int_(16);
		$loc.P4 = new Sk.builtin.int_(18);
		$loc.P5 = new Sk.builtin.int_(45);
		$loc.P6 = new Sk.builtin.int_(6);
		$loc.P7 = new Sk.builtin.int_(7);
		$loc.P8 = new Sk.builtin.int_(21);
		$loc.P9 = new Sk.builtin.int_(42);
		$loc.P10 = new Sk.builtin.int_(17);
		$loc.P11 = new Sk.builtin.int_(43);
		$loc.P13 = new Sk.builtin.int_(34);
		$loc.P14 = new Sk.builtin.int_(35);
		$loc.P15 = new Sk.builtin.int_(36);
		$loc.P16 = new Sk.builtin.int_(15);
		$loc.P19 = new Sk.builtin.int_(13);
		$loc.P20 = new Sk.builtin.int_(14);
	...
	machine.ADC = new Sk.misceval.buildClass(machine, function ($gbl, $loc) {
		...
		$loc.WIDTH_13BIT = new Sk.builtin.int_(4);
	...
	machine.PWM = new Sk.misceval.buildClass(machine, function ($gbl, $loc) {
		...
		$loc.duty_u16 = $loc.duty;

		$loc.duty_ns = new Sk.builtin.func(function (self, duty) {
		});
	...
	machine.UART = new Sk.misceval.buildClass(machine, function ($gbl, $loc) {
		...
		UART__init__ = function (self, port, baudrate, bits, parity, stop, tx, rx, rts, cts, txbuf, rxbuf, timeout, timeout_char, irq) {
			...
			if (Sk.builtin.checkNone(tx)) {
				if (port.v == 0) tx = Sk.misceval.callsim(machine.Pin, new Sk.builtin.int_(1));
				else if (port.v == 1) tx = Sk.misceval.callsim(machine.Pin, new Sk.builtin.int_(10));
			}
			if (Sk.builtin.checkNone(rx)) {
				if (port.v == 0) rx = Sk.misceval.callsim(machine.Pin, new Sk.builtin.int_(3));
				else if (port.v == 1) rx = Sk.misceval.callsim(machine.Pin, new Sk.builtin.int_(9));
			}
