...
Blockly.Msg['DISPLAY_GALAXIA_SET_LED_COLORS_TOOLTIP'] = 'Allows you to adjust the color of each value RGB of the LED integrated in the Galaxia card, from 0 to 255.';
...
Blockly.Msg['COMMUNICATION_LOG_SET_LABEL_TITLE'] = '[Log] add a new label';
Blockly.Msg['COMMUNICATION_LOG_SET_LABEL_TOOLTIP'] = 'Allows adding a label to the logs of the Galaxia board.';
Blockly.Msg['COMMUNICATION_LOG_ADDDATA_TITLE'] = '[Log] add data to a label';
...
Blockly.Msg['COMMUNICATION_INFRARED_ONDATARECEIVED_TITLE'] = '[IR] إذا تم استلام %1 في %2 %3 دبوس %4 مع البروتوكول %5 إذن';
Blockly.Msg['COMMUNICATION_INFRARED_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_IR_RECEIVER + Blockly.Tooltip.SEP + 'يسمح بتنفيذ التعليمات إذا تم استلام بيانات بواسطة وحدة الأشعة تحت الحمراء في متغير على الدبوس الرقمي مع بروتوكول NEC_8 أو NEC_16.';
...
Blockly.Msg['SENSORS_BAROMETER_READDATA_TITLE'] = '[مقياس الضغط HP206C] %1';
...
Blockly.Msg["DISPLAY_GALAXIA_IMAGE_VITTABOT_HEY"] = "Vittabot 'مرحبًا'";
Blockly.Msg["DISPLAY_GALAXIA_IMAGE_VITTABOT_HAPPY"] = "Vittabot سعيد";
Blockly.Msg["DISPLAY_GALAXIA_IMAGE_VITTABOT_ANGRY"] = "Vittabot غاضب";
Blockly.Msg["DISPLAY_GALAXIA_IMAGE_VITTASCIENCE_LOGO"] = "شعار Vittascience";
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TITLE'] = '[RFID - 125kHz] معرف البطاقة على دبابيس RX %1 و TX %2';
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + 'يتيح استرجاع مُعرِّف UID كسلسلة محارف من وحدة Grove RFID 125 kHz إذا كانت متصلة على الدبابيس الرقمية.\n\nالبيانات المستلمة من الوحدة تكون في صورة مصفوفة بايتات. لتحويلها، استخدم الكتلة "[RFID] تحويل البيانات ... إلى INT".\n\nتنبيه: يعمل هذا الموديل RFID فقط على جهد 5V؛ استخدم مثلاً شيلد Bit:Maker لتشغيل هذا الموديل.';
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TITLE"] = "[RFID - 125kHz] تحويل البيانات %1 إلى %2";
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TOOLTIP"] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + "يتيح الحصول على البيانات المستلمة من مصفوفة بايتات بصيغة hex، int أو كقائمة أعداد صحيحة.";
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nافتراضياً، دبابيس SPI 2 في لوحة Thingz-Galaxia هي SCK: Pin(34) [P13]، MISO: Pin(35) [P14] و MOSI: Pin(36) [P15].';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] معرف البطاقة على دبوس NSS %1';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_RC522 + Blockly.Tooltip.SEP + 'يتيح استرجاع مُعرِّف UID كسلسلة نصية من وحدة RFID RC522 عبر SPI من Joy-It إذا تم اكتشافها على الدبابيس الرقمية.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
Blockly.Msg['ACTUATORS_KITRONIK_CONTROLMOTOR_TITLE'] = '[Kitronik Motors] التحكم بالمحرك %1 اتجاه %2 سرعة %3';
Blockly.Msg['ACTUATORS_KITRONIK_CONTROLMOTOR_TOOLTIP'] = IMG_SHIELD_KITRONIK + Blockly.Tooltip.SEP + 'يتيح التحكم بـ MOTOR1 أو MOTOR2 أو كلاهما بتغيير الاتجاه (↻: الدوران للأمام، ↺: الدوران للخلف) أو تغيير السرعة (من 0 إلى 100%) لشيلد محرك Kitronik لـ BBC:microbit. يجب أن يكون جهد تغذية الشيلد بين 3V و10V.';
Blockly.Msg['ACTUATORS_KITRONIK_STOPMOTOR_TITLE'] = '[Kitronik Motors] إيقاف المحرك %1';
Blockly.Msg['ACTUATORS_KITRONIK_STOPMOTOR_TOOLTIP'] = IMG_SHIELD_KITRONIK + Blockly.Tooltip.SEP + 'يتيح إيقاف MOTOR1 أو MOTOR2 أو كليهما على شيلد محرك Kitronik لـ BBC:microbit. يجب أن يكون جهد تغذية الشيلد بين 3V و10V. ';
Blockly.Msg['ACTUATORS_KITRONIK_MOTOR_BOTH'] = 'كلاهما';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TITLE'] = '[Kitronik 16-Servos] ضبط السيرفو %1 على زاوية %2 °';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TOOLTIP'] = IMG_MODULE_KITRONIK_SHIELD_16_SERVOS + Blockly.Tooltip.SEP + 'يتيح التحكم في زاوية سيرفو (من 0 إلى 180) موصَّل على شيلد Kitronik ذو 16 سيرفو. انتبه: يجب تغذية التركيب ببطارية لتوفير تيار كافٍ للسيرفو.';
Blockly.Msg["ACTUATORS_MOSFET_SETSTATE_TITLE"] = "[MOSFET] تعيين الحالة إلى %1 على الدبوس %2";
...
Blockly.Msg["ACTUATORS_MOSFET_SETPERCENTVALUE_TITLE"] = "[MOSFET] تعيين مستوى الطاقة إلى %1 (%) على الدبوس %2";
Blockly.Msg["ACTUATORS_MOSFET_SETPERCENTVALUE_TOOLTIP"] = IMG_MODULE_MOSFET + Blockly.Tooltip.SEP + "يتيح لك التحكم في طاقة إخراج ترانزستور MOSFET (من 0 إلى 100%) على دبوس PWM.";
Blockly.Msg["ACTUATORS_MOSFET_SETFREQUENCY_TITLE"] = "[MOSFET] تعيين التردد إلى %1 (Hz) على الدبوس %2";
...
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TITLE'] = '[مستشعر الحرارة بالأشعة تحت الحمراء MLX90621] درجة الحرارة (°C) النوع %1';
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'يعيد درجة الحرارة بالدرجات المئوية (°C) باستخدام مستشعر الأشعة تحت الحمراء MLX90621. أوصل المستشعر بمنفذ I2C.';
Blockly.Msg['SENSORS_MLX90621_INT_TYPE'] = 'عدد صحيح';
Blockly.Msg['SENSORS_MLX90621_FLOAT_TYPE'] = 'عشري';
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TITLE'] = '[مستشعر الحرارة بالأشعة تحت الحمراء MLX90621] درجة الحرارة (°C) %1';
...
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'يعيد درجة حرارة الجسم الأدنى أو الأعلى أو المتوسط بالدرجات المئوية (°C) باستخدام مستشعر الأشعة تحت الحمراء MLX90621. أوصل المستشعر بمنفذ I2C.';
