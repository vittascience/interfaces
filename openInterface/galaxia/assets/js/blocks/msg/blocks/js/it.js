...
Blockly.Msg['DISPLAY_GALAXIA_SET_LED_COLORS_PALETTE_TITLE'] = '[RGB LED] set LED to %1';
Blockly.Msg['DISPLAY_GALAXIA_SET_LED_COLORS_PALETTE_TOOLTIP'] = 'Allows you to adjust the color of the LED integrated in the Galaxia card.';
Blockly.Msg["DISPLAY_GALAXIA_LED_CONTROL_TITLE"] = "[RGB LED] set %1 intensity to %2";
Blockly.Msg["DISPLAY_GALAXIA_LED_CONTROL_TOOLTIP"] = "Adjusts the intensity of the red, green or blue for the LED integrated in the Galaxia card from 0 to 255.";
Blockly.Msg["DISPLAY_GALAXIA_LED_GET_VALUE_TITLE"] = "[RGB LED] %1 intensity";
Blockly.Msg["DISPLAY_GALAXIA_LED_GET_VALUE_TOOLTIP"] = "Returns a value between 0 and 255 corresponding to the intensity of red, blue or green currently transferred to the LED.";
// Display - Galaxia/Graphique
Blockly.Msg['DISPLAY_GALAXIA_SET_MODE_TITLE'] = 'imposta lo schermo in modalità %1';
Blockly.Msg['DISPLAY_GALAXIA_SET_MODE_TOOLTIP'] = 'Cambia la modalità dello schermo.';
Blockly.Msg['DISPLAY_GALAXIA_SET_MODE_CONSOLE'] = 'terminale';
Blockly.Msg['DISPLAY_GALAXIA_SET_MODE_PLOT'] = 'dati';
Blockly.Msg['DISPLAY_GALAXIA_SET_MODE_GRAPHICS'] = 'grafica';
Blockly.Msg['DISPLAY_GALAXIA_PLOT_ADD_POINT_TITLE'] = '[Dati] aggiungi il valore %1';
Blockly.Msg['DISPLAY_GALAXIA_PLOT_ADD_POINT_TOOLTIP'] = 'Aggiunge un punto al grafico.';
Blockly.Msg['DISPLAY_GALAXIA_PLOT_SET_Y_SCALE_TITLE'] = '[Dati] imposta la scala dell\'asse Y a min %1 max %2';
Blockly.Msg['DISPLAY_GALAXIA_PLOT_SET_Y_SCALE_TOOLTIP'] = 'Imposta la scala dell\'asse Y.';
Blockly.Msg['DISPLAY_GALAXIA_ANIMATE_FUNCTION_TITLE'] = '[Dati] ogni %1 secondo(i) calcola un nuovo valore';
Blockly.Msg['DISPLAY_GALAXIA_ANIMATE_FUNCTION_NEW_POINT'] = 'aggiungi il risultato %1 al grafico';
Blockly.Msg['DISPLAY_GALAXIA_ANIMATE_FUNCTION_TOOLTIP'] = 'Aggiunge un punto al grafico ogni x secondi.';
Blockly.Msg['DISPLAY_GALAXIA_RAW_PRINT_TITLE'] = '[Grafica] mostra il testo %1 a x %2 y %3';
Blockly.Msg['DISPLAY_GALAXIA_RAW_PRINT_TOOLTIP'] = 'Mostra del testo sullo schermo grafico.';
Blockly.Msg['DISPLAY_GALAXIA_RAW_TEXT_TITLE'] = '[Grafica] mostra il testo %1 a x %2 y %3 con il colore %4';
Blockly.Msg['DISPLAY_GALAXIA_RAW_RECT_TITLE'] = '[Grafica] mostra un rettangolo a x %1 y %2 larghezza %3 altezza %4 con il colore %5';
Blockly.Msg['DISPLAY_GALAXIA_RAW_RECT_TOOLTIP'] = 'Mostra un rettangolo sullo schermo grafico.';
Blockly.Msg['DISPLAY_GALAXIA_RAW_PRINT_IMG_TITLE'] = '[Grafica] mostra l\'immagine %1 a x %2 y %3';
Blockly.Msg['DISPLAY_GALAXIA_RAW_PRINT_IMG_TOOLTIP'] = 'Mostra un\'immagine sullo schermo grafico (devi prima caricare l\'immagine nella memoria della scheda Galaxia)';
...
Blockly.Msg['DISPLAY_OLED_DRAWICON_TOOLTIP'] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + 'Enable to display an icon from the Galaxia Image library, at position (x,y) on the grove OLED screen. Connect the OLED display on I2C port.';
// Display - Neopixel
...
Blockly.Msg['COMMUNICATION_RADIO_CONFIG_TITLE'] = '[Radio] set the channel %1';
Blockly.Msg['COMMUNICATION_RADIO_CONFIG_TOOLTIP'] = 'Allows you to configure the frequence channel (from 0 to 83).';
// Communication - log
Blockly.Msg['COMMUNICATION_LOG_DELETE_TITLE'] = '[Log] cancellare i log';
Blockly.Msg['COMMUNICATION_LOG_DELETE_TOOLTIP'] = 'Permette di cancellare i log dalla scheda Galaxia.';
Blockly.Msg['COMMUNICATION_LOG_SET_LABEL_TITLE'] = '[Log] aggiungere una nuova etichetta';
Blockly.Msg['COMMUNICATION_LOG_SET_LABEL_TOOLTIP'] = 'Permette di aggiungere un\'etichetta ai log della scheda Galaxia.';
Blockly.Msg['COMMUNICATION_LOG_ADDDATA_TITLE'] = '[Log] aggiungere dati a un\'etichetta';
Blockly.Msg['COMMUNICATION_LOG_ADDDATA_TOOLTIP'] = 'Permette di aggiungere un\'etichetta alla colonna dei dati del log. L\'etichetta può essere un testo o un numero. I dati possono essere un testo o un numero.';
Blockly.Msg['COMMUNICATION_LOG_DATA_TITLE'] = 'etichetta %1 dato %2';
Blockly.Msg['COMMUNICATION_LOG_DATA_TOOLTIP'] = 'Permette di aggiungere un\'etichetta alla colonna dei dati del log. L\'etichetta può essere un testo o un numero. I dati possono essere un testo o un numero.';
...
Blockly.Msg['COMMUNICATION_FS_SAVE_DATA_TITLE'] = '[Galaxia] save data %1 in file %2';
Blockly.Msg['COMMUNICATION_FS_SAVE_DATA_TOOLTIP'] = 'Allows you to save data to a text file in the Galaxia file system. If you use the same file name, the data will be appended to the end of the file. You can also press the + button to change the file extension.';
...
Blockly.Msg["COMMUNICATION_UART_INIT_TOOLTIP"] = "Allows you to set the serial connection of the Galaxia board to the UART port (1 or 0). Port 0 is reserved for REPL.";
Blockly.Msg["COMMUNICATION_UART_WRITE_TITLE"] = "[uart %1] write data %2";
Blockly.Msg["COMMUNICATION_UART_WRITE_TOOLTIP"] = "Allows writing data to UART port (1 or 0). By default the pins are as: UART 1 (tx=10, rx=9) and UART 0 (tx=1, rx=3) Otherwise, use the block 'Set serial connection to RX TX Baudrate...'.";
Blockly.Msg["COMMUNICATION_UART_READ_TITLE"] = "[uart %1] read data";
Blockly.Msg["COMMUNICATION_UART_READ_TOOLTIP"] = "Read data from UART port (1 or 0). By default the pins are as: UART 1 (tx=10, rx=9) and UART 0 (tx=1, rx=3).Otherwise, use the block 'Set serial connection to RX TX Baudrate...'.";
...
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Returns the size of the data available on the UART port (1 or 0). By default, the pins are as follows: UART 1 (tx=10, rx=9) and UART 0 (tx=1, rx=3). Otherwise, use the block \'Set serial connection to RX TX Baudrate ...\'.';
...
Blockly.Msg['ACTUATORS_MOTOR_SETPOWER_TOOLTIP'] = IMG_MODULE_MOTOR + Blockly.Tooltip.SEP + 'Enable to control DC motor power (from 0 to 8191) on digital pins. Warning, Galaxia has to be powered by external batterie in order to provide enough energy to DC motor.';
...
Blockly.Msg["DISPLAY_GALAXIA_IMAGE_VITTABOT_HEY"] = "Vittabot 'Ciao'";
Blockly.Msg["DISPLAY_GALAXIA_IMAGE_VITTABOT_HAPPY"] = "Vittabot felice";
Blockly.Msg["DISPLAY_GALAXIA_IMAGE_VITTABOT_ANGRY"] = "Vittabot arrabbiato";
...
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + 'Permette di ottenere l\'identificatore UID come stringa dal modulo Grove RFID 125 kHz se è disponibile sui pin digitali.\n\nI dati ricevuti dal modulo sono sotto forma di un array di byte. Per convertirli, usare il blocco "[RFID] convertire i dati ... in INT".\n\nAttenzione, questo modulo RFID funziona solo a 5V; usare ad esempio uno shield Bit:Maker per pilotarlo.';
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TITLE"] = "[RFID - 125kHz] convertire i dati %1 in %2";
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TOOLTIP"] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + "Permette di ottenere i dati ricevuti da un array di 'byte' sotto forma di hex, int o lista di interi.";
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nPer impostazione predefinita, i pin SPI 2 della scheda Thingz-Galaxia sono SCK: Pin(34) [P13], MISO: Pin(35) [P14] e MOSI: Pin(36) [P15].';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] ID del badge sul pin NSS %1';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_RC522 + Blockly.Tooltip.SEP + 'Permette di ottenere l\'identificatore UID come stringa dal modulo RFID SPI RC522 di Joy-It se è rilevato sui pin digitali.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
Blockly.Msg['ACTUATORS_KITRONIK_CONTROLMOTOR_TITLE'] = '[Kitronik Motors] controllare il motore %1 direzione %2 velocità %3';
Blockly.Msg['ACTUATORS_KITRONIK_CONTROLMOTOR_TOOLTIP'] = IMG_SHIELD_KITRONIK + Blockly.Tooltip.SEP + 'Consente di controllare MOTOR1, MOTOR2 o entrambi cambiando il verso (↻ : MARCIA AVANTI, ↺ : MARCIA INDIETRO) o la velocità (da 0 a 100 %) dello shield motore Kitronik per BBC:microbit. L\'alimentazione dello shield deve essere compresa tra 3V e 10V.';
Blockly.Msg['ACTUATORS_KITRONIK_STOPMOTOR_TITLE'] = '[Kitronik Motors] fermare il motore %1';
Blockly.Msg['ACTUATORS_KITRONIK_STOPMOTOR_TOOLTIP'] = IMG_SHIELD_KITRONIK + Blockly.Tooltip.SEP + 'Permette di fermare MOTOR1, MOTOR2 o entrambi dello shield motore Kitronik per BBC:microbit. L\'alimentazione dello shield deve essere compresa tra 3V e 10V. ';
Blockly.Msg['ACTUATORS_KITRONIK_MOTOR_BOTH'] = 'entrambi';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TITLE'] = '[Kitronik 16-Servos] controllare il servo %1 all\'angolo di %2 °';
Blockly.Msg['ACTUATORS_KITRONIK_SERVO_SETANGLE_TOOLTIP'] = IMG_MODULE_KITRONIK_SHIELD_16_SERVOS + Blockly.Tooltip.SEP + 'Permette di controllare l\'angolo di un servomotore (da 0 a 180) collegato allo shield Kitronik da 16 Servos. Attenzione, il montaggio deve essere alimentato da una batteria per fornire abbastanza corrente al servomotore.';
...
Blockly.Msg["ACTUATORS_MOSFET_SETPERCENTVALUE_TITLE"] = "[MOSFET] imposta la potenza su %1 (%) sul pin %2";
Blockly.Msg["ACTUATORS_MOSFET_SETPERCENTVALUE_TOOLTIP"] = IMG_MODULE_MOSFET + Blockly.Tooltip.SEP + "Permette di controllare la potenza in uscita del transistor MOSFET (da 0 a 100%) su un pin PWM.";
Blockly.Msg["ACTUATORS_MOSFET_SETFREQUENCY_TITLE"] = "[MOSFET] imposta la frequenza su %1 (Hz) sul pin %2";
Blockly.Msg["ACTUATORS_MOSFET_SETFREQUENCY_TOOLTIP"] = IMG_MODULE_MOSFET + Blockly.Tooltip.SEP + "Permette di impostare la frequenza di ciclo (Hz) del transistor MOSFET su un pin PWM.";
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TITLE'] = '[Sensore IR MLX90621] temperatura (°C) tipo %1';
Blockly.Msg['SENSORS_MLX90621_READTEMPERATURE_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'Restituisce la temperatura in gradi Celsius (°C) misurata dal sensore a infrarossi MLX90621. Collega il sensore a una porta I2C.';
Blockly.Msg['SENSORS_MLX90621_INT_TYPE'] = 'intero';
Blockly.Msg['SENSORS_MLX90621_FLOAT_TYPE'] = 'decimale';
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TITLE'] = '[Sensore IR MLX90621] temperatura (°C) %1';
...
Blockly.Msg['SENSORS_MLX90621_GETTEMPDATA_TOOLTIP'] = IMG_MODULE_MLX90621 + Blockly.Tooltip.SEP + 'Restituisce la temperatura dell\'oggetto (minima, massima o media) in gradi Celsius (°C) misurata con il sensore a infrarossi MLX90621. Collega il sensore a una porta I2C.';
