import '/openInterface/galaxia/assets/js/blocks/code2Blocks/ast_io.js'; // io blocks
import '/openInterface/galaxia/assets/js/blocks/code2Blocks/ast_display.js'; // display blocks
import '/openInterface/galaxia/assets/js/blocks/code2Blocks/ast_actuators.js'; // actuators blocks
import '/openInterface/galaxia/assets/js/blocks/code2Blocks/ast_sensors.js'; // sensors blocks
...
const LIB_IMPORT = {
    ...
    IMPORT_ESP32_LINKY: "from esp32_linky import Linky",
    IMPORT_ESP32_ROTARY: "from esp32_rotary import RotaryIRQ",
...
const EXCLUDED_COMMENTS = ['Neopixel on p', 'Buzzer on p', 'LED Module on p', 'Builtin LED on', 'Servo on p'] 
