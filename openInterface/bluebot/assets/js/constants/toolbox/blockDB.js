/**
 * Database of defaut blocks in Bluebot toolbox.
...
const TOOLBOXES_BLOCKS_CONTENT = {
    ...
    get: function () {
        return {
            ...
            "actuators_turnLeft": this.Set.field("ANGLE", 90),
            "actuators_turnRight": this.Set.field("ANGLE", 90),
