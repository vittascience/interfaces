...
Blockly.Msg['COMMUNICATION_SERIAL_WRITE_NUMBER_TITLE'] = 'write the number %1 to the console in %2 format';
Blockly.Msg['COMMUNICATION_SERIAL_WRITE_NUMBER_TOOLTIP'] = 'Allows you to display a number in the console in the chosen format (HEX: hexadecimal, DEC: decimal).';
