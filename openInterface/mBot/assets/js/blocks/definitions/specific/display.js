...
Blockly.Extensions.register("show_popup_leds_matrix", function () {
    ...
    this.getField('LEDS_MATRIX_BUTTON').clickHandler_ = (() => {
        ...
        if (!LedMatrixModalManager.isSet() && typeof Blockly.Wiki === 'undefined') {
            // init matrix
            LedMatrixModalManager.options = {
                suggestion_path: "/openInterface/mBot/assets/media/blocks_mbot_draw/dark_mode_mblocks_examples-",
                color: '#00b9ff',
                column_size: 16,
                line_size: 8,
                suggestions_data: {
                    '01': [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00],
                    '02': [0x00, 0x00, 0x3C, 0x62, 0x5E, 0x5E, 0x3C, 0x01, 0x01, 0x3C, 0x5E, 0x5E, 0x62, 0x3C, 0x00, 0x00],
                    '03': [0x00, 0x00, 0x00, 0x3C, 0x7E, 0x7E, 0x3C, 0x00, 0x00, 0x3C, 0x7E, 0x7E, 0x3C, 0x00, 0x00, 0x00],
                    '04': [0x00, 0x00, 0x00, 0x0C, 0x18, 0x18, 0x0C, 0x00, 0x00, 0x3C, 0x7E, 0x7E, 0x3C, 0x00, 0x00, 0x00],
                    '05': [0x00, 0x00, 0x00, 0x18, 0x30, 0x30, 0x18, 0x00, 0x00, 0x18, 0x30, 0x30, 0x18, 0x00, 0x00, 0x00],
                    '06': [0x00, 0x00, 0x00, 0x00, 0x38, 0x7C, 0x7E, 0x3F, 0x3F, 0x7E, 0x7C, 0x38, 0x00, 0x00, 0x00, 0x00],
                    '07': [0x00, 0x00, 0x04, 0x0E, 0x0E, 0xFC, 0x40, 0x20, 0x00, 0x02, 0x05, 0x05, 0x7E, 0x00, 0x00, 0x00],
                    '08': [0x00, 0x00, 0x0E, 0x18, 0xBE, 0x6D, 0x3D, 0x3C, 0x3C, 0x3D, 0x6D, 0xBE, 0x18, 0x0E, 0x00, 0x00],
                    '09': [0x10, 0x3C, 0x3E, 0x3E, 0x3E, 0x3E, 0x3C, 0x10, 0x10, 0x3C, 0x3E, 0x3E, 0x3E, 0x3E, 0x3C, 0x10],
                    '10': [0x00, 0xF8, 0x7C, 0x3E, 0x1E, 0x0E, 0x04, 0x00, 0x00, 0x04, 0x0E, 0x1E, 0x3E, 0x7C, 0xF8, 0x00],
                },
                suggestions_order: [
                    ['02', '04', '06', '08', '10'],
                    ['03', '05', '07', '09', '01']
