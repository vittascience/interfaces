/**
 * @fileoverview Math generators for mBot.
 */
...
Blockly.Arduino.math_number_property = function(block) {
    var number_to_check = Blockly.Arduino.valueToCode(block, 'NUMBER_TO_CHECK', Blockly.Arduino.ORDER_MULTIPLICATIVE) || '0';
    var dropdown_property = block.getFieldValue('PROPERTY');
    var code;
    if (dropdown_property == 'PRIME') {
      Blockly.Arduino.addFunction('mathIsPrime', FUNCTIONS_MBOT.DEF_MATH_IS_PRIME);
    ...
    switch (dropdown_property) {
      ...
      case 'NEGATIVE':
        ...
        break;
      case 'DIVISIBLE_BY':
        var divisor = Blockly.Arduino.valueToCode(block, 'DIVISOR', Blockly.Arduino.ORDER_MULTIPLICATIVE) || '0';
...
Blockly.Arduino.math_modulo = function(block) {
  var dividend = Blockly.Arduino.valueToCode(block, 'DIVIDEND', Blockly.Arduino.ORDER_MULTIPLICATIVE) || '0';
  var divisor = Blockly.Arduino.valueToCode(block, 'DIVISOR', Blockly.Arduino.ORDER_MULTIPLICATIVE) || '0';
