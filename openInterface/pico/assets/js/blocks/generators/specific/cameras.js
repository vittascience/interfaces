/**
 * @fileoverview Cameras generators for Raspberry Pi Pico.
 */

Blockly.Python.wio_get_class_data = function (block) {
    ...
    Blockly.Python.addInit('wio_i2c', 'wio = ' + Blockly.Python.Generators.I2C(pin));
...
Blockly.Python.wio_get_class_max_id = function (block) {
    Blockly.Python.addImport('machine_all', IMPORT_MACHINE_ALL);
    Blockly.Python.addImport('utime', IMPORT_UTIME);
    Blockly.Python.addFunction('wio_get_class_data', FUNCTIONS.DEF_WIO_GET_CLASS_DATA);
    const pin = block.getFieldValue("PIN");
