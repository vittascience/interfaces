...
Blockly.Msg["COMMUNICATION_RFID_CONVERTDATA_TOOLTIP"] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + "Allows you to obtain received data from an array of 'bytes' as a hex, int, or integer list.";
Blockly.Msg['COMMUNICATION_SPI_HELPER'] = '\nBy default, the SPI 0 pins on the Pico board are on SCK: Pin(18), MISO: Pin(16), and MOSI: Pin(19), and the SPI 1 pins are on SCK: Pin(10), MISO: Pin(8), and MOSI: Pin(11).'; 
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TITLE'] = '[RFID RC522] SPI %1 ID of the badge on the NSS pin %2';
Blockly.Msg['COMMUNICATION_MFRC522_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_RC522 + Blockly.Tooltip.SEP + 'Allows retrieval of the UID as a string of characters from the Joy-It RC522 SPI RFID module if it is detected on the digital pins.' + Blockly.Msg['COMMUNICATION_SPI_HELPER'];
Blockly.Msg['COMMUNICATION_GPS_INFO_TYPE'] = 'the frame type';
Blockly.Msg['COMMUNICATION_GPS_INFO_CLOCK'] = 'the time (h, m, s)';
Blockly.Msg['COMMUNICATION_GPS_INFO_LATITUDE'] = 'the latitude (°)';
Blockly.Msg['COMMUNICATION_GPS_INFO_LONGITUDE'] = 'the longitude (°)';
Blockly.Msg['COMMUNICATION_GPS_INFO_SATELLITE'] = 'the number of satellites used';
Blockly.Msg['COMMUNICATION_GPS_INFO_ALTITUDE'] = 'the altitude (m)';
Blockly.Msg['COMMUNICATION_GPS_INFO_ALL_FRAME'] = 'the entire frame';
Blockly.Msg['COMMUNICATION_GPS_GET_NMEA_TITLE'] = '[GPS] NMEA frames on UART bus %1';
Blockly.Msg['COMMUNICATION_GPS_GET_NMEA_TOOLTIP'] = IMG_MODULE_GPS + Blockly.Tooltip.SEP + 'Returns the list of NMEA frames read with the Grove SIM28 or Air530 GPS module on the RX/TX pins. The wires do not need to be reversed between the module pins and those indicated in the block. The reversal is done automatically in the Python code. By default, the pins are as follows: UART 1 (tx=4, rx=5) and UART 0 (tx=0, rx=1).';
Blockly.Msg['COMMUNICATION_GPS_GGA_GETINFORMATIONS_TITLE'] = '[GPS] get %1 on UART bus %2';
Blockly.Msg['COMMUNICATION_GPS_GGA_GETINFORMATIONS_TOOLTIP'] = IMG_MODULE_GPS + Blockly.Tooltip.SEP + 'Returns the selected data from (frame type, clock, latitude, longitude, altitude) analyzed from the NMEA frame (GNGGA or GPGGA) read with the Grove SIM28 or Air530 GPS module on the UART pins. By default, the pins are such as: UART 1 (tx=4, rx=5) and UART 0 (tx=0, rx=1). The wires do not need to be reversed between the module pins and those indicated in the block.';
...
Blockly.Msg['COMMUNICATION_UART_INIT_TOOLTIP'] = 'Allows you to set the serial connection of the Pico board to the UART port (1 or 0). Port 0 can be used but it is reserved also for REPL.';
...
// الكاميرا - Wio lite AI
Blockly.Msg['WIO_GET_DATA_TITLE'] = '[Wio lite] استرجاع جميع البيانات على المنفذ %1';
Blockly.Msg['WIO_GET_CLASS_DATA_BY_ID_TITLE'] = '[Wio lite] احتمال الفئة رقم %1 على المنفذ %2';
Blockly.Msg['WIO_GET_CLASS_MAX_ID_TITLE'] = '[Wio lite] معرف الفئة المكتشفة على المنفذ %1';
Blockly.Msg['WIO_GET_STATUS_TITLE'] = '[Wio lite] الحصول على %1 على المنفذ %2';
Blockly.Msg['ON_START_CORE0_TITLE'] = 'عند البدء';
Blockly.Msg['ON_START_CORE0_TOOLTIP'] = 'يسمح ببدء الملف التنفيذي الرئيسي على core0 من Raspberry Pi Pico.';
Blockly.Msg['FOREVER_CORE0_TITLE'] = 'تكرار إلى الأبد';
Blockly.Msg['PROCESS_FOREVER_CORE1_TITLE'] = '[core1] تكرار إلى الأبد';
Blockly.Msg['PROCESS_ON_START_CORE1_TITLE'] = '[core1] عند البدء';
Blockly.Msg['PROCESS_ON_START_CORE1_TOOLTIP'] = 'يسمح ببدء ملف تنفيذي ثانٍ على core1 من Raspberry Pi Pico.';
Blockly.Msg['PROCESS_EXIT_CORE1_TITLE'] = '[core1] إنهاء العملية';
Blockly.Msg['PROCESS_EXIT_CORE1_TOOLTIP'] = 'يسمح بإنهاء core1 من Raspberry Pi Pico.';
Blockly.Msg['PROCESS_GLOBAL_VAR_TITLE'] = 'تحويل %1 إلى متغير عالمي';
Blockly.Msg['PROCESS_GLOBAL_VAR_TOOLTIP'] = 'يسمح بتحويل متغير محلي إلى متغير عالمي حتى تتمكن العمليات من التواصل مع بعضها.';
Blockly.Msg['ROBOTS_KITRO_MOVE_TITLE'] = '[Kitronik] التحكم في الروبوت %1 السرعة %2 %';
Blockly.Msg['ROBOTS_KITRO_MOVE_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بالتحكم في اتجاه الروبوت Kitronik";
Blockly.Msg['ROBOTS_KITRO_MOVE_FORWARD'] = 'التقدم';
Blockly.Msg['ROBOTS_KITRO_MOVE_BACKWARD'] = 'التراجع';
Blockly.Msg['ROBOTS_KITRO_ROTATE_TITLE'] = '[Kitronik] تدوير الروبوت إلى %1 السرعة %2 %';
Blockly.Msg['ROBOTS_KITRO_ROTATE_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بتدوير الروبوت Kitronik إلى اليمين أو اليسار بسرعة تتراوح بين 70% و 100%";
Blockly.Msg['ROBOTS_KITRO_ROTATE_RIGHT'] = 'يمين';
Blockly.Msg['ROBOTS_KITRO_ROTATE_LEFT'] = 'يسار';
Blockly.Msg['ROBOTS_KITRO_STOP_TITLE'] = '[Kitronik] إيقاف الروبوت';
Blockly.Msg['ROBOTS_KITRO_STOP_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بإيقاف الروبوت Kitronik";
Blockly.Msg['ROBOTS_KITRO_CONTROL_MOTOR_TITLE'] = '[Kitronik] التحكم في المحرك %1 الاتجاه %2 السرعة %3 %';
Blockly.Msg['ROBOTS_KITRO_CONTROL_MOTOR_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بالتحكم في المحرك الأيمن أو الأيسر للروبوت Kitronik في الاتجاه (↻ : للأمام، ↺ : للخلف) والسرعة (من 70% إلى 100%) المطلوبة";
Blockly.Msg['ROBOTS_KITRO_MOTOR_RIGHT'] = 'أيمن';
Blockly.Msg['ROBOTS_KITRO_MOTOR_LEFT'] = 'يسار';
Blockly.Msg['ROBOTS_KITRO_SETANGLE_TITLE'] = '[Kitronik] تدوير الروبوت بمقدار %1 °';
Blockly.Msg['ROBOTS_KITRO_SETANGLE_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بالتحكم في اتجاه الروبوت (بالدرجات)";
Blockly.Msg['ROBOTS_KITRO_MOVE_ONE_SQUARE_FORWARD_TITLE'] = '[Kitronik] التقدم بمربع واحد';
Blockly.Msg['ROBOTS_KITRO_MOVE_ONE_SQUARE_FORWARD_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يدفع الروبوت Kitronik بمربع واحد";
Blockly.Msg['ROBOTS_KITRO_MOVE_ONE_SQUARE_BACKWARD_TITLE'] = '[Kitronik] التراجع بمربع واحد';
Blockly.Msg['ROBOTS_KITRO_MOVE_ONE_SQUARE_BACKWARD_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسحب الروبوت Kitronik بمربع واحد";
Blockly.Msg['ROBOTS_KITRO_ROTATE_LEFT_TITLE'] = '[Kitronik] التدوير إلى اليسار';
Blockly.Msg['ROBOTS_KITRO_ROTATE_LEFT_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يدور الروبوت Kitronik بمقدار 90° إلى اليسار";
Blockly.Msg['ROBOTS_KITRO_ROTATE_RIGHT_TITLE'] = '[Kitronik] التدوير إلى اليمين';
Blockly.Msg['ROBOTS_KITRO_ROTATE_RIGHT_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يدور الروبوت Kitronik بمقدار 90° إلى اليمين";
Blockly.Msg['ROBOTS_KITRO_ULTRASONICRANGER_TITLE'] = '[Kitronik] %1 على المستشعر %2';
Blockly.Msg['ROBOTS_KITRO_ULTRASONICRANGER_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يعيد المسافة (بالسنتيمتر) أو المدة (بالميكروثانية) للذهاب والعودة للموجة بين عقبة والروبوت Kitronik باستخدام المستشعر فوق الصوتي";
Blockly.Msg['ROBOTS_KITRO_ULTRASONIC_DISTANCE'] = 'المسافة (سم)';
Blockly.Msg['ROBOTS_KITRO_ULTRASONIC_DURATION'] = 'مدة الذهاب والعودة (ميكروثانية)';
Blockly.Msg['ROBOTS_KITRO_ULTRASONIC_SENSOR_FRONT'] = 'أمام';
Blockly.Msg['ROBOTS_KITRO_ULTRASONIC_SENSOR_BACK'] = 'خلف';
Blockly.Msg['ROBOTS_KITRO_READ_LINE_FINDER_TITLE'] = '[Kitronik] حالة مستشعر الخط %1';
Blockly.Msg['ROBOTS_KITRO_READ_LINE_FINDER_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بقراءة حالة مستشعر تتبع الخط الأيسر أو الأيمن للروبوت Kitronik. يعيد الكتلة 1 إذا كان المستشعر فوق الخط";
Blockly.Msg['ROBOTS_KITRO_LINE_RIGHT'] = 'يمين';
Blockly.Msg['ROBOTS_KITRO_LINE_LEFT'] = 'يسار';
Blockly.Msg['ROBOTS_KITRO_LINE_CENTER'] = 'وسط';
Blockly.Msg['ROBOTS_KITRO_CONTROL_LED_COLOR_TITLE'] = '[Kitronik] التحكم في LED RGB %1 %2';
Blockly.Msg['ROBOTS_KITRO_CONTROL_LED_COLOR_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بقراءة حالة مستشعر تتبع الخط الأيسر أو الأيمن للروبوت Kitronik. يعيد الكتلة 1 إذا كان المستشعر فوق الخط";
Blockly.Msg['ROBOTS_KITRO_TOP_LEFT'] = 'أمام يسار (0)';
Blockly.Msg['ROBOTS_KITRO_TOP_RIGHT'] = 'أمام يمين (1)';
Blockly.Msg['ROBOTS_KITRO_BOT_RIGHT'] = 'خلف يمين (2)';
Blockly.Msg['ROBOTS_KITRO_BOT_LEFT'] = 'خلف يسار (3)';
Blockly.Msg['ROBOTS_KITRO_CONTROL_RGB_LED_TITLE'] = '[Kitronik] التحكم في LED RGB %1 R %2 G %3 B %4';
Blockly.Msg['ROBOTS_KITRO_CONTROL_RGB_LED_TOOLTIP'] = IMG_ROBOT_KITRONIK_PICO + Blockly.Tooltip.SEP + "يسمح بقراءة حالة مستشعر تتبع الخط الأيسر أو الأيمن للروبوت Kitronik. يعيد الكتلة 1 إذا كان المستشعر فوق الخط";
Blockly.Msg['DISPLAY_LED_MATRIX_TITLE'] = '[مصفوفة LED] عرض %1 %2 على المنفذ %3';
...
Blockly.Msg['DISPLAY_LED_MATRIX_CLEAR_TITLE'] = '[مصفوفة LED] مسح المصفوفة على المنفذ %1';
Blockly.Msg['DISPLAY_LED_MATRIX_CLEAR_TOOLTIP'] = IMG_MODULE_LED_MATRIX_8_8 + Blockly.Tooltip.SEP + 'يطفئ جميع مصابيح LED في المصفوفة';
