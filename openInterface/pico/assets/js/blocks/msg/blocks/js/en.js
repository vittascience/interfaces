...
Blockly.Msg["DISPLAY_LED_MATRIX_TITLE"] = "[LED Matrix] display %1 %2 on port %3";
...
Blockly.Msg["DISPLAY_LED_MATRIX_CLEAR_TITLE"] = "[LED Matrix] clear the matrix on port %1";
...
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Returns the size of the data available on the UART port (1 or 0). By default, the pins are as follows: UART 1 (tx=4, rx=5) and UART 0 (tx=0, rx=1). Otherwise, use the block \'Set serial connection to RX TX Baudrate ...\'.';
