/**
 * Database of defaut blocks in Raspberry Pi Pico toolbox.
...
const TOOLBOXES_BLOCKS_CONTENT = {
    ...
    get: function () {
        return {
            // display - Pico BUILT-IN LED
            "display_controlPicoLed": this.Set.state(),
            "display_controlPicoWLed": this.Set.state(),
            // display - LCD
            ...
            // display - LED Bar
            "display_setLevelLedBar": this.Set.field("DCKI", "p18") + this.Set.number("VALUE", 3.14),
            "display_my9221_reverse": this.Set.field("DCKI", "p18") + this.Set.state(),
            // display - neopixel
            "display_defineNeopixel": this.Set.field("PIN", "p16"),
            ...
            "display_defineChainableRGBLed": this.Set.field("DIN", "p16"),
            "display_setColorChainableRGBLed": this.Set.field("DIN", "p16") + this.Set.number("LED") + this.Set.number("R", 255) + this.Set.number("G") + this.Set.number("B"),
            "display_setPaletteColorChainableRGBLed": this.Set.field("DIN", "p16") + this.Set.number("LED") + this.Set.colour_picker(),
            "display_setColorAllChainableRGBLed": this.Set.field("DIN", "p16") + this.Set.number("R", 255) + this.Set.number("G") + this.Set.number("B"),
            "display_setPaletteAllChainableRGBLed": this.Set.field("DIN", "p16") + this.Set.colour_picker(),
            "display_resetAllChainableRGBLed": this.Set.field("DIN", "p16"),
            // io - delay
            ...
            // io - external modules
            "io_getGroveButton": this.Set.field('PIN', "p16"),
            "io_getGroveSwitch": this.Set.field('PIN', "p16"),
            "io_getGroveTactile": this.Set.field('PIN', "p16"),
            "io_getGroveRotaryAngle": this.Set.field('PIN', "p27"),
            "io_getGroveSlidePotentiometer": this.Set.field('PIN', "p27"),
            "io_getGroveColoredButton": this.Set.field('PIN', "p16"),
            "io_setGroveColoredButton": this.Set.field('PIN', "p16") + this.Set.state(),
            "io_getKeypadNumber": this.Set.field("RX", "p4") + this.Set.field("TX", "p5"),
            ...
            "communication_StartBT": this.Set.text('NAME', "Pico_Vittascience"),
            "communication_SendBT": this.Set.text('DATA'),
            "communication_FizziqBT": this.Set.number('VALUE', 25),
            // communication - data logging
            "communication_writeOpenLogSd": this.Set.field("TX", "p4") + this.Set.field("RX", "p5")
            ...
            // communication - external bluetooth
            "communication_groveSerialBluetooth_setATCommand": this.Set.field("RX", "p4") + this.Set.field("TX", "p5") + this.Set.text("VALUE"),
            "communication_groveSerialBluetooth_getATCommand": this.Set.field("RX", "p4") + this.Set.field("TX", "p5"),
            "communication_sendSerialBluetoothData": this.Set.field("RX", "p4") + this.Set.field("TX", "p5") + this.Set.text("TEXT"),
            "communication_onSerialBluetoothDataReceived": this.Set.field("RX", "p4") + this.Set.field("TX", "p5"),
            "communication_hc05_sendBluetoothData": this.Set.field("RX", "p4") + this.Set.field("TX", "p5") + this.Set.text("DATA"),
            "communication_hc05_onBluetoothDataReceived": this.Set.field("RX", "p4") + this.Set.field("TX", "p5"),
            // communication - tracking modules
            "communication_mfrc522_getCardID": this.Set.field("NSS", "p17"),
            "communication_clockRTC_setHour": this.Set.number("HOUR", 8) + this.Set.number("MIN", 40) + this.Set.number("SEC", 10),
            // communication - uart
            "communication_serialInit": this.Set.field("RX", "p4") + this.Set.field("TX", "p5"),
            ...
            "network_configureAccessPoint": this.Set.text("ESSID", 'VittaAP') + this.Set.text("IP", '192.168.4.1'),
            // network - server
            ...
            //network - umail
            'network_umail_setup': this.Set.text("MAIL", 'pico@vittascience.com') + this.Set.text("PASSWORD", ''),
            'network_umail_to': this.Set.text("MAIL", 'xxx@mail.com') + this.Set.text("SUBJECT", 'Vittamail Pico'),
            'network_umail_write_sender': this.Set.text("NAME", 'Raspberry Pi Pico'),
            ...
            // sensors - gas
            "sensors_getO2gas": this.Set.field('PIN', "p26"),
            "sensors_SCD30_forcedCalibration": this.Set.number('DEFAULT', 420),
            // sensors - climate
            "sensors_getAirQualityValue": this.Set.field('PIN', "p26"),
            "sensors_getGroveMoisture": this.Set.field('PIN', "p26"),
            "sensors_getGroveTemperature": this.Set.field('PIN', "p26"),
            "sensors_getGroveHighTemperature": this.Set.field("A1", "p26"),
            "sensors_dhtReadData": this.Set.field('PIN', "p26"),
            "sensors_mpx5700ap_calibrate": this.Set.number("M", 1) + this.Set.number("B", 1),
            "sensors_getGroveWaterAmount": this.Set.field('PIN', "p16"),
            "sensors_getRainGauge": this.Set.field('PIN', "p16"),
            "sensors_getAnemometer": this.Set.field('PIN', "p16"),
            // sensors - sound & light
            "sensors_getGroveLight": this.Set.field('PIN', "p26"),
            "sensors_getUVindex": this.Set.field('PIN', "p26"),
            "sensors_getGroveSound": this.Set.field('PIN', "p26"),
            "sensors_getGroveUltrasonicRanger": this.Set.field('PIN', "p16"),
            "sensors_getGroveLineFinder": this.Set.field('PIN', "p16"),
            "sensors_getGroveTilt": this.Set.field('PIN', "p16"),
            "sensors_getGroveMotion": this.Set.field('PIN', "p16"),
            "sensors_getPiezoVibration": this.Set.field('PIN', "p16"),
            // actuators - motors
            ...
            // robots - kitronik
            "robots_moveKitro": this.Set.number('SPEED', 70),
            "robots_controlKitroMotors": this.Set.number('SPEED', 70),
            "robots_setKitroRotationAngle": this.Set.number('ANGLE', 90),
            "robots_controlKitroRGBLed": this.Set.number('R', 255) + this.Set.number('G', 255) + this.Set.number('B', 0),
            "robots_controlKitroColorLed": this.Set.field('LED', '0') + this.Set.colour_picker(),
            "robots_rotateKitro": this.Set.number('SPEED', 70),
