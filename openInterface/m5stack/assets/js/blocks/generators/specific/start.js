/**
 * @fileoverview Start generators for M5Stack.
 */

Blockly.Python.on_start = function (block) {
    Blockly.Python.addImport('m5stack_all', IMPORT_M5SATCK_ALL);
    Blockly.Python.addImport('m5ui_all', IMPORT_M5UI_ALL);
    Blockly.Python.addImport('uiflow_all', IMPORT_UIFLOW_ALL);
    Blockly.Python.addInit('init_lcdOrientation', "lcd.setRotation(3)");
