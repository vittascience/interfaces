/**
 * @fileoverview Sensors generators for M5stack.
 */
...
Blockly.Python.sensors_getO2gas = function (block) {
    ...
    Blockly.Python.addFunction('getAnalogMean', FUNCTIONS_M5STACK.DEF_GET_ANALOG_MEAN);
    Blockly.Python.addFunction('readO2', FUNCTIONS_M5STACK.DEF_O2SENSOR_READ);
...
Blockly.Python.sensors_DHT11ReadData = function (block) {
    ...
    Blockly.Python.addFunction('dht_getMeasure', FUNCTIONS_M5STACK.DEF_DHT_GET_MEASURE);
    switch (block.getFieldValue('DATA')) {
        case 'TEMP':
...
Blockly.Python.sensors_getGroveTemperature = function (block) {
    ...
    Blockly.Python.addFunction('getGroveTemperature', FUNCTIONS_M5STACK.DEF_GROVE_GET_TEMP);
    let code;
    switch (block.getFieldValue("UNIT")) {
        case "CELSIUS":
...
Blockly.Python.sensors_getGroveHighTemperature = function (block) {
    ...
    Blockly.Python.addImport('math', IMPORT_MATH);
    Blockly.Python.addConstant('thmc_table', FUNCTIONS_M5STACK.DEF_GROVE_HIGHTEMP_THMC_TABLE);
    Blockly.Python.addFunction('getAnalogMean', FUNCTIONS_M5STACK.DEF_GET_ANALOG_MEAN);
    Blockly.Python.addFunction('K_VtoT', FUNCTIONS_M5STACK.DEF_GROVE_HIGHTEMP_KVTOT);
    Blockly.Python.addFunction('getRoomTemp', FUNCTIONS_M5STACK.DEF_GROVE_HIGHTEMP_GET_ROOM_TEMP);
    Blockly.Python.addFunction('getThmcTemp', FUNCTIONS_M5STACK.DEF_GROVE_HIGHTEMP_GET_THMC_TEMP);
...
Blockly.Python.sensors_DS18B20_getTemperature = function (block) {
    ...
    Blockly.Python.addImport('utime', IMPORT_UTIME);
    Blockly.Python.addFunction('ds18b20_measure', FUNCTIONS_M5STACK.DEF_DS18B20_MEASURE);
...
Blockly.Python.sensors_getUVindex = function (block) {
    ...
    Blockly.Python.addImport('utime', IMPORT_UTIME);
    Blockly.Python.addFunction("getUVindex", FUNCTIONS_M5STACK.DEF_GROVE_GET_UV_INDEX);
...
Blockly.Python.sensors_getGroveUltrasonicRanger = function (block) {
    ...
    switch (block.getFieldValue("SENSOR")) {
        case "GROVE":
            const pin = block.getFieldValue("PIN");
            Blockly.Python.addFunction('grove_getUltrasonicData', FUNCTIONS_M5STACK.DEF_GROVE_ULTRASONIC);
        ...
        case "HC-SR04":
            ...
            Blockly.Python.addFunction('hcsr04_getUltrasonicData', FUNCTIONS_M5STACK.DEF_HCSR04_ULTRASONIC);
