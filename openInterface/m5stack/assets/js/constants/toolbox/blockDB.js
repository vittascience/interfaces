...
const TOOLBOXES_BLOCKS_CONTENT = {
    ...
    get: function () {
        return {
            /** m5stack default blocks */

            "screen_setBackgroundColorPalette": this.Set.colour_picker('#2e2e2e'),
            "screen_setBackgroundColorRGB": this.Set.number("R", 46) + this.Set.number("G", 46) + this.Set.number("B", 46),
            // screen - draw title
            "screen_M5Title_define": this.Set.text("ID", '0') + this.Set.text("TITLE", "{m5title}") + this.Set.number("POSITION", 148),
            "screen_M5Title_setFgColor": this.Set.text("ID", '0') + this.Set.colour_picker('#f0f0f0', "FGCOLOR"),
            "screen_M5Title_setFgColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("FGCOLOR", 240, 240, 240),
            "screen_M5Title_setBgColor": this.Set.text("ID", '0') + this.Set.colour_picker('#22b573', "BGCOLOR"),
            "screen_M5Title_setBgColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("BGCOLOR", 34, 181, 115),
            "screen_M5Title_setTitle": this.Set.text("ID", '0') + this.Set.text("TITLE", "{m5title}"),
            "screen_M5Title_controlDisplay": this.Set.text("ID", '0') + this.Set.state(),
            // screen - draw label
            "screen_M5TextBox_define": this.Set.text("ID", '0') + this.Set.text("TEXT", "{m5text}") + this.Set.number("X", 225) + this.Set.number("Y", 98),
            "screen_M5TextBox_setColor": this.Set.text("ID", '0') + this.Set.colour_picker('#22b573'),
            "screen_M5TextBox_setColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("COLOR", 34, 181, 115),
            "screen_M5TextBox_setPosition": this.Set.text("ID", '0') + this.Set.number("X", 225) + this.Set.number("Y", 98),
            "screen_M5TextBox_setFont": this.Set.text("ID", '0'),
            "screen_M5TextBox_setText": this.Set.text("ID", '0') + this.Set.text("TEXT", "{m5text}"),
            "screen_M5TextBox_setRotate": this.Set.text("ID", '0') + this.Set.number("ANGLE", 90),
            "screen_M5TextBox_controlDisplay": this.Set.text("ID", '0') + this.Set.state(),
            // screen - draw rectangle
            "screen_M5Rect_define": this.Set.text("ID", '0') + this.Set.number("X", 90) + this.Set.number("Y", 130),
            "screen_M5Rect_setSize": this.Set.text("ID", '0') + this.Set.number("WIDTH", 30) + this.Set.number("HEIGHT", 30),
            "screen_M5Rect_setBgColor": this.Set.text("ID", '0') + this.Set.colour_picker('#000', "FILL_COLOR"),
            "screen_M5Rect_setBgColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("FILL_COLOR", 0, 0, 0),
            "screen_M5Rect_setBorderColor": this.Set.text("ID", '0') + this.Set.colour_picker('#f0f0f0', "BORDER_COLOR"),
            "screen_M5Rect_setBorderColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("BORDER_COLOR", 240, 240, 240),
            "screen_M5Rect_setPosition": this.Set.text("ID", '0') + this.Set.number("X", 90) + this.Set.number("Y", 130),
            "screen_M5Rect_controlDisplay": this.Set.text("ID", '0') + this.Set.state(),
            // screen - draw circle
            "screen_M5Circle_define": this.Set.text("ID", '0') + this.Set.number("X", 132) + this.Set.number("Y", 118),
            "screen_M5Circle_setSize": this.Set.text("ID", '0') + this.Set.number("RADIUS", 15),
            "screen_M5Circle_setBgColor": this.Set.text("ID", '0') + this.Set.colour_picker('#fff4d0', "FILL_COLOR"),
            "screen_M5Circle_setBgColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("FILL_COLOR", 255, 244, 208),
            "screen_M5Circle_setBorderColor": this.Set.text("ID", '0') + this.Set.colour_picker('#22b573', "BORDER_COLOR"),
            "screen_M5Circle_setBorderColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("BORDER_COLOR", 34, 181, 115),
            "screen_M5Circle_setPosition": this.Set.text("ID", '0') + this.Set.number("X", 132) + this.Set.number("Y", 118),
            "screen_M5Circle_controlDisplay": this.Set.text("ID", '0') + this.Set.state(),
            // screen - draw triangle
            "screen_M5Triangle_define": this.Set.text("ID", '0') + this.Set.number("X1", 90) + this.Set.number("Y1", 160) + this.Set.number("X2", 60) + this.Set.number("Y2", 190) + this.Set.number("X3", 120) + this.Set.number("Y3", 190),
            "screen_M5Triangle_setSize": this.Set.text("ID", '0') + this.Set.number("X1", 90) + this.Set.number("Y1", 160) + this.Set.number("X2", 60) + this.Set.number("Y2", 190) + this.Set.number("X3", 120) + this.Set.number("Y3", 190),
            "screen_M5Triangle_setBgColor": this.Set.text("ID", '0') + this.Set.colour_picker('#000', "FILL_COLOR"),
            "screen_M5Triangle_setBgColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("FILL_COLOR", 0, 0, 0),
            "screen_M5Triangle_setBorderColor": this.Set.text("ID", '0') + this.Set.colour_picker('#f0f0f0', "BORDER_COLOR"),
            "screen_M5Triangle_setBorderColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("BORDER_COLOR", 240, 240, 240),
            "screen_M5Triangle_controlDisplay": this.Set.text("ID", '0') + this.Set.state(),
            // screen - draw line
            "screen_M5Line_define": this.Set.text("ID", '0') + this.Set.number("X1", 150) + this.Set.number("Y1", 116) + this.Set.number("X2", 220) + this.Set.number("Y2", 116),
            "screen_M5Line_setSize": this.Set.text("ID", '0') + this.Set.number("X1", 150) + this.Set.number("Y1", 116) + this.Set.number("X2", 220) + this.Set.number("Y2", 116),
            "screen_M5Line_setColor": this.Set.text("ID", '0') + this.Set.colour_picker('#f0f0f0'),
            "screen_M5Line_setColor-rgb": this.Set.text("ID", '0') + this.Set.colour_rgb("COLOR", 240, 240, 240),
            "screen_M5Line_controlDisplay": this.Set.text("ID", '0') + this.Set.state(),
            // io - time
            "io_pause": this.Set.number("TIME", 1),
            "io_waitUntil": "<value name='UNTIL'><block type='logic_compare'>" + this.Set.field("OP", "EQ") + this.Set.number("B", 1) + "</block></value>",            // io _ m5stack
            "io_m5stack_setCharge": this.Set.state(),
            // io - external modules
            "io_getGroveColoredButton": this.Set.field("PIN", "p5"),
            "io_setGroveColoredButton": this.Set.state(),
            "io_getGroveThumbJoystick": this.Set.field("PIN_Y", "p36"),
            // io - pins
            ...
            'communication_writeSd': this.Set.text('PATH', "/sd/data.txt") + "<value name='DATA'><block type='text_join'>"
                + this.Set.text("ADD0", '{data1}') + this.Set.text("ADD1", ';') + this.Set.text("ADD2", '{data2}')
                + "<mutation items='3'></mutation></block></value>",
            "communication_writeOpenLogSd": this.Set.field("RX", "p5") + "<value name='DATA'><block type='text_join'>"
                + this.Set.text("ADD0", '{data1}') + this.Set.text("ADD1", ';') + this.Set.text("ADD2", '{data2}')
                + "<mutation items='3'></mutation></block></value>",
            ...
            // communication - uart
            "communication_serialInit": this.Set.field("RX", "p5"),
            ...
            // network - wifi
            "network_connectStation": this.Set.text("SSID", "SSID") + this.Set.text("PASSWORD") + this.Set.text("IP", '192.168.1.10')
            ...
            //network - umail
            'network_umail_setup': this.Set.text("MAIL", 'm5stack@vittascience.com') + this.Set.text("PASSWORD", ''),
            'network_umail_to': this.Set.text("MAIL", 'xxx@mail.com') + this.Set.text("SUBJECT", 'Vittamail M5Stack'),
            'network_umail_write_sender': this.Set.text("NAME", 'M5Stack'),
            ...
            "display_setNumberGrove4Digit": this.Set.field("DIO", "p5") + this.Set.number("N", 1024),
            "display_setClockGrove4Digit": this.Set.field("DIO", "p5"),
            ...
            "display_defineChainableRGBLed": this.Set.field("DIN", "p5"),
            "display_setColorChainableRGBLed": this.Set.field("DIN", "p5") + this.Set.number("LED") + this.Set.number("R", 255) + this.Set.number("G") + this.Set.number("B"),
            "display_setPaletteColorChainableRGBLed": this.Set.field("DIN", "p5") + this.Set.number("LED") + this.Set.colour_picker(),
            "display_setColorAllChainableRGBLed": this.Set.field("DIN", "p5") + this.Set.number("R", 255) + this.Set.number("G") + this.Set.number("B"),
            "display_setPaletteAllChainableRGBLed": this.Set.field("DIN", "p5") + this.Set.colour_picker(),
            // sensors
            "sensors_getGroveHighTemperature": this.Set.field("A1", "p36"),
