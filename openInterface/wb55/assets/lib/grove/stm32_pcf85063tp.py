...
RTC_PCF85063TP_I2C_ADDR = const(0x51)
...
class RTC(object):
  def __init__(self, i2c, addr=RTC_PCF85063TP_I2C_ADDR):
    if i2c == None:
      raise ValueError("I2C object 'RTC PCF85063' needed as argument!")
    self._i2c = i2c
    i2cModules = self._i2c.scan()
    if addr not in i2cModules:
      error = "Unable to find module 'RTC PCF85063' at address " + str(hex(addr)) + ". Please check connections with the board.\n"
