...
const TOOLBOXES_BLOCKS_CONTENT = {
    ...
    get: function () {
        return {
            ...
            "display_setNumberGrove4Digit": this.Set.field("CLK", "'D2'") + this.Set.field("DIO", "'D3'") + this.Set.number("N", 1024),
            "display_setClockGrove4Digit": this.Set.field("CLK", "'D2'") + this.Set.field("DIO", "'D3'"),
            "display_setLevelLedBar": this.Set.field("DI", "'D2'") + this.Set.field("DCKI", "'D3'") + this.Set.number("VALUE", 3.14),
            "display_my9221_reverse": this.Set.field("DI", "'D2'") + this.Set.field("DCKI", "'D3'") + this.Set.state(),
            // display - neopixel
