// STM32 - stm32_chainableLED module

var $builtinmodule = function () {

    var stm32_chainableLED = {};

    stm32_chainableLED.__name__ = new Sk.builtin.str("stm32_chainableLED");
    ...
    stm32_chainableLED.P9813 = new Sk.misceval.buildClass(stm32_chainableLED, P9813, "P9813", []);

    return stm32_chainableLED;
};
