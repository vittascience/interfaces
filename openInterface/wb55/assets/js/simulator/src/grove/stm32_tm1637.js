// STM32 - stm32_tm1637 module

var $builtinmodule = function (name) {

    var stm32_tm1637 = {};

    stm32_tm1637.__name__ = new Sk.builtin.str('stm32_tm1637');
    ...
    stm32_tm1637.TM1637 = new Sk.misceval.buildClass(stm32_tm1637, function ($gbl, $loc) {
        ...
        TM1637__init__ = function (self, clk, dio, bright) {
            ...
            $("#tm1637_" + self.clk).find(".subtitle-module").html(self.clk + ' / ' + self.dio);
        };
        ...
        $loc.clock = new Sk.builtin.func(function (self, time) {
            let clock = "";
            const hours = time.v[0].v.toString();
            const minutes = time.v[1].v.toString();
            if (hours.length < 2)
                clock = '0' + hours;
            else
                clock = hours;
