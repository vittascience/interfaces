// STM32 - stm32_my9221 module

var $builtinmodule = function (name) {

    var stm32_my9221 = {};

    stm32_my9221.__name__ = new Sk.builtin.str('stm32_my9221');

    stm32_my9221.MY9221 = new Sk.misceval.buildClass(stm32_my9221, function ($gbl, $loc) {
        ...
        MY9221__init__ = function (self, di, dcki, reverse) {
            ...
            $("#ledBar_" + self.di).find(".subtitle-module").html(self.di + ' / ' + self.dcki);
            const htmlString = `
