...
function stm32_alphabot_v2_mod(stm32_alphabot_v2, import_modules) {
    ...
    var AlphaBot_v2 = function ($gbl, $loc) {

        const MAX_SPEED = 200;

        var AlphaBot_v2__init__ = function (self) {
            self.leftDir = 'forward';
            self.rightDir = 'forward';
            // TODO: SHOW ROBOT SIMULATOR
        ...
        var setMotorLeft = function (self, speed) {
        ...
        var setMotorRight = function (self, speed) {
        ...
        var moveForward = function (self, speed, duration_ms) {
        ...
        var moveBackward = function (self, speed, duration_ms) {
        ...
        var turnLeft = function (self, speed, duration_ms) {
            setMotorLeft(self, new Sk.builtin.int_(-speed.v));
            setMotorRight(self, speed);
            if (Sk.builtin.checkNone(duration_ms)) {
                return RobotSimulator.delayOnMovement(duration_ms.v);
        ...
        var turnRight = function (self, speed, duration_ms) {
            setMotorLeft(self, speed);
            setMotorRight(self, new Sk.builtin.int_(-speed.v));
            if (Sk.builtin.checkNone(duration_ms)) {
                return RobotSimulator.delayOnMovement(duration_ms.v);
        ...
        var TRSensors_calibrate = function (self) { };
        ...
        var TRSensors_readLine = function (self, sensor) {
            var sensor_values = [
        ...
        var readUltrasonicDistance = function (self, length, timeout_us) {
            let sum = 0;
            let len = 15;
            if (length !== undefined) {
                len = length.v;
