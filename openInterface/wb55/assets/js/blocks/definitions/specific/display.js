/**
 * @fileoverview Display blocks for STM32.
 */

Blockly.defineBlocksWithJsonArray([ // BEGIN JSON EXTRACT

    /* Start STM32 display blocks */

    // STM32 COLOR LED _ CONTROL STATE
    {
        "type": "display_stm32_controlColorLed",
        "message0": "%{BKY_DISPLAY_STM32_CONTROL_COLOR_LED_TITLE}",
        "args0": [{
        ...
        "tooltip": "%{BKY_DISPLAY_STM32_CONTROL_COLOR_LED_TOOLTIP}",
        "extensions": [
            "block_init_helpurl"
        ]
    },

    // STM32 COLOR LED _ TOGGLE STATE
    {
        "type": "display_stm32_toggleColorLed",
        "message0": "%{BKY_DISPLAY_STM32_TOGGLE_LED_STATE_TITLE}",
        "args0": [{
            "type": "field_grid_dropdown",
            "name": "LED",
            "options": [
        ...
        "nextStatement": null,
        "style": "display_blocks",
        "tooltip": "%{BKY_DISPLAY_STM32_TOGGLE_LED_STATE_TOOLTIP}",
        "extensions": [
            "block_init_helpurl"
        ]
    },
