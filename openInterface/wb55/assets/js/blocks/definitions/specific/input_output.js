/**
 * @fileoverview Input/Output blocks for STM32.
 */
...
Blockly.defineBlocksWithJsonArray([ // BEGIN JSON EXTRACT
    ...
    // BLOCK ON BUTTON PRESSED
    {
        ...
        "message0": "%{BKY_IO_STM32_ONSWITCHBUTTONPRESSED_TITLE}",
        "args0": [{
            "type": "field_grid_dropdown",
            "name": "SWITCH",
            "options": [
        ...
        "tooltip": "%{BKY_IO_STM32_ONSWITCHBUTTONPRESSED_TOOLTIP}",
    },

    // BLOCK READ SWITCH BUTTON
    {
        "type": "io_smt32_getSwitchState",
        "message0": "%{BKY_IO_STM32_GETSWITCHSTATE_TITLE}",
        "args0": [{
            "type": "field_grid_dropdown",
            "name": "SWITCH",
            "options": [
        ...
        "output": "Boolean",
        "tooltip": "%{BKY_IO_STM32_GETSWITCHSTATE_TOOLTIP}",
    },
