/**
 * @fileoverview Actuators generators for STM32.
 */
...
Blockly.Python.actuators_setServoAngle = function (block) {
    ...
    Blockly.Python.addFunction('setServoAngle', FUNCTIONS_WB55.DEF_SERVO_SET_ANGLE);
...
Blockly.Python.actuators_continuousServo_setSpeed = function (block) {
    ...
    const pwmName = "pwm_" + pinName;
    Blockly.Python.addImport('pyb', IMPORT_PYB);
    Blockly.Python.addFunction('setServoSpeed', FUNCTIONS_WB55.DEF_SERVO_SET_SPEED);
...
Blockly.Python.actuators_playMusicGroveBuzzer = function (block) {
    ...
    Blockly.Python.addFunction('pitch', FUNCTIONS_WB55.DEF_BUZZER_PITCH);
    switch (music) {
        case "CARRIBEAN_PIRATES":
            Blockly.Python.addFunction('BuzzerCarribeanPirates', FUNCTIONS_WB55.DEF_BUZZER_CARRIBEAN_PIRATES);
            return "BuzzerCarribeanPirates(" + pinName + ")" + NEWLINE;
        case "GAMME":
            Blockly.Python.addFunction('BuzzerGamme', FUNCTIONS_WB55.DEF_BUZZER_GAMME);
            return "BuzzerGamme(" + pinName + ")" + NEWLINE;
        case "SW":
            Blockly.Python.addFunction('BuzzerStarWars', FUNCTIONS_WB55.DEF_BUZZER_STAR_WARS);
            return "BuzzerStarWars(" + pinName + ")" + NEWLINE;
        case "R2D2":
            Blockly.Python.addFunction('BuzzerR2D2', FUNCTIONS_WB55.DEF_BUZZER_R2D2);
...
Blockly.Python.actuators_music_playNotes = function (block) {
    ...
    Blockly.Python.addImport('utime', IMPORT_UTIME);
    Blockly.Python.addFunction('pitch', FUNCTIONS_WB55.DEF_BUZZER_PITCH);
    Blockly.Python.addFunction('buzzer_playNotes', FUNCTIONS_WB55.DEF_BUZZER_PLAY_NOTES);
