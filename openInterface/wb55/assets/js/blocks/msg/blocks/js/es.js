...
// Display - STM32
Blockly.Msg['DISPLAY_STM32_CONTROL_COLOR_LED_TITLE'] = 'controla %1 LED al estado %2';
Blockly.Msg['DISPLAY_STM32_CONTROL_COLOR_LED_TOOLTIP'] = 'Controla el LED de color de la placa STM32';
Blockly.Msg['DISPLAY_STM32_TOGGLE_LED_STATE_TITLE'] = 'conmutar el estado de %1';
Blockly.Msg['DISPLAY_STM32_TOGGLE_LED_STATE_TOOLTIP'] = 'Conmutar el estado del LED de color de la placa STM32';
Blockly.Msg['LED_BLUE'] = 'LED1 (azul)';
Blockly.Msg['LED_GREEN'] = 'LED2 (verde)';
Blockly.Msg['LED_RED'] = 'LED3 (rojo)';
// Display - LCD
...
Blockly.Msg['DISPLAY_4DIGIT_SETCLOCK_TOOLTIP'] = IMG_MODULE_4DIGITDISPLAY + Blockly.Tooltip.SEP + 'Habilitar para mostrar el reloj en la pantalla de 4 dígitos de Grove (TM1637) en los pines digitales. Atención, obtener el reloj real sólo es posible si el STM32 permanece en modo de encendido';
...
Blockly.Msg['DISPLAY_MY9221_SET_LEVEL_TOOLTIP'] = IMG_MODULE_LED_BAR + Blockly.Tooltip.SEP + 'Habilitar para mostrar el nivel del valor de entrada en la pantalla de la barra de LEDs (MY9221) en los pines digitales';
...
Blockly.Msg['DISPLAY_NEOPIXEL_SETALLLEDCOLOR_TOOLTIP'] = IMG_MODULE_NEOPIXEL + Blockly.Tooltip.SEP + 'Permite controlar todos los LED del neopixel al valor de color elegido. Utilice P15 para ajustar el neopixel Alphabot';
...
Blockly.Msg['IO_STM32_GETSWITCHSTATE_TITLE'] = 'Lee el estado del interruptor %1';
Blockly.Msg['IO_STM32_GETSWITCHSTATE_TOOLTIP'] = 'Permite leer el valor digital integrado del interruptor de la placa STM32 (SW1, SW2, SW3)';
Blockly.Msg['IO_STM32_ONSWITCHBUTTONPRESSED_TITLE'] = 'en el botón del interruptor %1 %2 entonces';
Blockly.Msg['IO_STM32_ONSWITCHBUTTONPRESSED_TOOLTIP'] = 'Ejecuta las instrucciones leyendo el valor digital del interruptor integrado de la placa STM32 (SW1, SW2, SW3)';
Blockly.Msg['IO_STM32_PRESSED'] = 'pulsado';
Blockly.Msg['IO_STM32_RELEASED'] = 'liberado';
...
Blockly.Msg['COMMUNICATION_SERIAL_ONDATARECEIVED_TITLE then'] = 'sobre datos en serie recibidos en %1 entonces';
...
Blockly.Msg['COMMUNICATION_STM32_RTC_SETTIME_TOOLTIP'] = 'Permite inicializar la fecha con el módulo de reloj RTC integrado en STM32 para poder leer la fecha y la hora exactas mediante el bloque \'Leer módulo de reloj\'. Colocar en el bloque \'on start\'';
Blockly.Msg['COMMUNICATION_STM32_RTC_READTIME_TITLE'] = '[Reloj RTC] leído %1';
Blockly.Msg['COMMUNICATION_STM32_RTC_READTIME_TOOLTIP'] = 'Lea la fecha y la hora (elija en el menú desplegable) del módulo de reloj RTC integrado. Para obtener un resultado correcto, utilice primero los dos bloques \'Inicializar el módulo de reloj\'';
...
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SEND_TITLE'] = '[ST BLE Sensor] enviar datos de';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SEND_TOOLTIP'] = IMG_MODULE_BLE_SENSOR + Blockly.Tooltip.SEP + 'Este bloque permite escribir datos por bluetooth BLE integrado de STM32. Se puede utilizar con uno o más bloques en formato "Service" "Value".<br> Pasos para visualizar los datos: 1. Descargar la aplicación ST BLE Sensor. 2. Cargar el código en el STM32. 3. Al inicio de la ejecución, haga clic en "Conectar un dispositivo" en la aplicación. 4. "Haz clic en WBRR-MPY"';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_VALUE'] = 'Valor';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_TITLE'] = '[ST BLE Sensor] service %1';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_TOOLTIP'] = IMG_MODULE_BLE_SENSOR + Blockly.Tooltip.SEP + 'Este bloque debe utilizarse en el bloque "Enviar datos por servicio". Seleccione cualquier servicio de la aplicación y añada su valor. Nota: Puede utilizar cualquier servicio sólo una vez';
...
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_HUMIDITY'] = 'Humedad (%)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_PRESSURE'] = 'Presión (hPa o mBar)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_LUMINOSITY'] = 'Luminosidad (lux)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_ACCELEROMETER'] = 'Acelerómetro (mg.s-²)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_CO_SENSOR'] = 'Monóxido de carbono (CO) (ppm)';
Blockly.Msg['COMMUNICATION_BLE_SEND_DATA_TITLE'] = '[Bluetooth] enviar datos %1 ';
Blockly.Msg['COMMUNICATION_BLE_SEND_DATA_TOOLTIP'] = IMG_MODULE_BLE_SENSOR + Blockly.Tooltip.SEP + 'Enviar datos a través de Bluetooth';
...
// Communication - LoRa
Blockly.Msg['COMMUNICATION_LORA_INIT_TITLE'] = '[LoRa E5]  inicializa el módulo con la appEui %1 con la appKey : %2';
...
Blockly.Msg['COMMUNICATION_LORA_SEND_TITLE'] = '[LoRa E5] envía datos';
...
Blockly.Msg['COMMUNICATION_LORA_RECEIVE_TITLE'] = '[LoRa E5] Recibir un mensaje';
...
Blockly.Msg['SENSORS_MAGNETOSCOPE_INTEGRATED_LIS2MDL_TITLE'] = '[Magnetoscopio LIS2MDL] campo magnético siguiendo el eje %1';
...
Blockly.Msg['SENSORS_THERMOMETER_INTEGRATED_LPS22HH_TITLE'] = '[Termómetro LPS22HH] temperatura';
Blockly.Msg['SENSORS_THERMOMETER_INTEGRATED_LPS22HH_TOOLTIP'] = IMG_X_NUCLEO_IKS01A3 + Blockly.Tooltip.SEP + 'Devuelve la temperatura (en °C)';
// Sensors - Gas
...
Blockly.Msg['SENSORS_VL53L0X_GETRANGEMILLIMETERS_TITLE'] = '[Tiempo de vuelo] Valor de la distancia en %1';
...
Blockly.Msg['ACTUATORS_SERVO_SETANGLE_TOOLTIP'] = IMG_MODULE_SERVO + Blockly.Tooltip.SEP + 'Permite controlar el ángulo del servo (de 0 a 180) en los pines digitales. Atención, el STM32 debe ser alimentado por una batería externa para proporcionar suficiente energía al servomotor';
...
Blockly.Msg['ACTUATORS_MOTOR_SETPOWER_TOOLTIP'] = IMG_MODULE_MOTOR + Blockly.Tooltip.SEP + 'Permite controlar la potencia del motor de CC (de 0 a 100 %) en los pines digitales. Atención, el STM32 debe ser alimentado por una batería externa para proporcionar suficiente energía al motor de corriente continua';
...
// Actuators - MOSFET
Blockly.Msg['ACTUATORS_MOSFET_SETSTATE_TITLE'] = '[MOSFET] establece el estado a %1 en el pin %2';
...
Blockly.Msg['ROBOTS_ALPHABOT_RIGHT'] = 'derecho';
...
Blockly.Msg['ROBOTS_ALPHABOT_READOBSTACLEDETECTOR_TOOLTIP'] = IMG_MODULE_ALPHABOT + Blockly.Tooltip.SEP + 'Permite leer el estado de los detectores de obstáculos (sensores IR en LEDL y LEDR) del robot alfabeto. El bloque devuelve True si el sensor está frente al obstáculo';
...
Blockly.Msg['ROBOTS_ALPHABOT_REMOTECONTROL_ONCOMMANDRECEIVED_RECEIVED_THEN'] = 'recibido entonces';
Blockly.Msg['ROBOTS_ALPHABOT_REMOTECONTROL_ONCOMMANDRECEIVED_DETECTED_THEN'] = 'recibido por el mando a distancia negro básico NEC entonces';
Blockly.Msg['ROBOTS_ALPHABOT_REMOTECONTROL_ONCOMMANDRECEIVED_TOOLTIP'] = IMG_MODULE_BASIC_BLACK_REMOTE_IR_RECEIVER + Blockly.Tooltip.SEP + 'Permite ejecutar instrucciones sobre el comando recibido por transmisión IR desde el control remoto negro básico NEC';
Blockly.Msg['ROBOTS_ALPHABOT_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_DETECTED_THEN'] = 'recibido por el mando a distancia gris NEC <br>Car mp3<br> entonces';
Blockly.Msg['ROBOTS_ALPHABOT_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TOOLTIP'] = IMG_MODULE_CAR_MP3_GRAY_REMOTE_IR_RECEIVER + Blockly.Tooltip.SEP + 'Permite ejecutar instrucciones sobre el comando recibido por transmisión IR desde el mando a distancia gris NEC Car mp3';
