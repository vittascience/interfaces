/**
 * @fileoverview French messages for WB55. (FR)
 */
'use strict';
...
// Display - STM32
Blockly.Msg['DISPLAY_STM32_CONTROL_COLOR_LED_TITLE'] = 'contrôler la LED %1 état %2';
Blockly.Msg['DISPLAY_STM32_CONTROL_COLOR_LED_TOOLTIP'] = 'Contrôler l\'état des LED de couleur rouge, verte et bleue de la carte STM32.';
Blockly.Msg['DISPLAY_STM32_TOGGLE_LED_STATE_TITLE'] = 'inverser l\'état de la %1';
Blockly.Msg['DISPLAY_STM32_TOGGLE_LED_STATE_TOOLTIP'] = 'Inverser l\'état des LED de couleur de la carte STM32.';
Blockly.Msg['LED_BLUE'] = 'LED1 (bleue)';
Blockly.Msg['LED_GREEN'] = 'LED2 (verte)';
Blockly.Msg['LED_RED'] = 'LED3 (rouge)';
// Display - LCD
...
Blockly.Msg['DISPLAY_OLED_DRAWICON_TOOLTIP'] = IMG_MODULE_OLED + Blockly.Tooltip.SEP + 'Permet d\'afficher une icône de la librairie Image de STM32, à la position (x,y) sur l\'écran grove OLED. Brancher l\'afficheur sur un port I2C.';
...
Blockly.Msg['IO_STM32_GETSWITCHSTATE_TITLE'] = 'lire l\'état du bouton %1';
Blockly.Msg['IO_STM32_GETSWITCHSTATE_TOOLTIP'] = 'Permet de lire l\'état des boutons intégrés à la carte STM32 (SW1, SW2, SW3).';
Blockly.Msg['IO_STM32_ONSWITCHBUTTONPRESSED_TITLE'] = 'si le bouton %1 %2 alors';
Blockly.Msg['IO_STM32_ONSWITCHBUTTONPRESSED_TOOLTIP'] = 'Permet d\'exécuter des instructions selon l\'état des boutons intégrés à la carte STM32 (SW1, SW2, SW3).';
Blockly.Msg['IO_STM32_PRESSED'] = 'appuyé';
Blockly.Msg['IO_STM32_RELEASED'] = 'relâché';
...
Blockly.Msg['COMMUNICATION_UART_INIT_TOOLTIP'] = 'Initialiser la connexion série sur le port UART (1 ou 2). Par défaut, les broches sont telles que: UART 1 (tx=D10, rx=D11) et UART 2 (tx=D1, rx=D0).';
Blockly.Msg['COMMUNICATION_UART_WRITE_TITLE'] = '[uart] écrire la donnée %1 sur le bus %2';
Blockly.Msg['COMMUNICATION_UART_WRITE_TOOLTIP'] = 'Permet d\'écrire des données dans le port UART (1 ou 2). Par défaut, les broches sont telles que: UART 1 (tx=D10, rx=D11) et UART 2 (tx=D1, rx=D0).';
Blockly.Msg['COMMUNICATION_UART_READ_TITLE'] = '[uart] lire les données sur le bus %1';
Blockly.Msg['COMMUNICATION_UART_READ_TOOLTIP'] = 'Permet de lire des données depuis le port UART (1 ou 2). Par défaut, les broches sont telles que: UART 1 (tx=D10, rx=D11) et UART 2 (tx=D1, rx=D0).';
Blockly.Msg['COMMUNICATION_UART_READ_SIZE'] = 'taille des données';
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TITLE'] = '[uart] données disponibles sur le bus %1';
Blockly.Msg['COMMUNICATION_UART_DATA_AVAILABLE_TOOLTIP'] = 'Retourne la taille des données disponibles sur le port UART (1 ou 2). Par défaut, les broches sont telles que: UART 1 (tx=D10, rx=D11) et UART 2 (tx=D1, rx=D0).';
...
// Communication - STM32
Blockly.Msg['COMMUNICATION_STM32_RTC_SETTIME_TITLE'] = '[Horloge RTC] initialiser à %1 date %2  heure %3 minute %4 seconde %5';
Blockly.Msg['COMMUNICATION_STM32_RTC_SETTIME_TOOLTIP'] = 'Permet d\'initialiser le module horloge RTC intégré à la carte STM32, pour pouvoir lire la date et l\'heure précise avec le bloc \'Lire le module horloge\'. Placer dans le bloc \'Au démarrage\'.';
Blockly.Msg['COMMUNICATION_STM32_RTC_READTIME_TITLE'] = '[Horloge RTC] lire %1';
Blockly.Msg['COMMUNICATION_STM32_RTC_READTIME_TOOLTIP'] = 'Permet de lire la date et l\'heure du module horloge RTC intégré à la carte STM32. Pour avoir un résultat correct, utiliser au préalable les deux blocs \'Initialiser le module horloge\'.';
...
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SEND_TITLE'] = '[ST BLE Sensor] envoyer données dans l\'application';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SEND_TOOLTIP'] = IMG_MODULE_BLE_SENSOR + Blockly.Tooltip.SEP + 'Ce bloc permet d\'envoyer des mesures de capteurs à l\'application ST BLE Sensor grâce au bluetooth BLE intégré à la carte STM32. Il peut être utilisé avec un ou plusieurs blocs "Service" et "Valeur". Etapes pour visualiser les données: 1. Télécharger l\'application ST BLE Sensor. 2. Téléverser le code dans la carte STM32. 3. Lorsque le code est transféré, cliquer sur "Connect one Device" dans l\'application. 4. Si la carte est détectée, cliquer sur "WB55-MPY".';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_VALUE'] = 'Valeur';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_TITLE'] = '[ST BLE Sensor] service %1';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_TOOLTIP'] = IMG_MODULE_BLE_SENSOR + Blockly.Tooltip.SEP + 'Ce bloc est utilisé comme service dans le bloc "Envoyer données des services". Sélectionner un service, et ajouter la mesure. Note: Vous pouvez utiliser n\'importe quel service qu\'une seule fois par envoi de données.';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_FIRST_TEMPERATURE'] = 'Température 1 (°C)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_SECOND_TEMPERATURE'] = 'Température 2 (°C)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_HUMIDITY'] = 'Humidité (%)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_PRESSURE'] = 'Pression (hPa ou mBar)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_LUMINOSITY'] = 'Luminosité (lux)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_ACCELEROMETER'] = 'Acceléromètre (mg.s-²)';
Blockly.Msg['COMMUNICATION_BLE_STSENSORAPP_SERVICE_CO_SENSOR'] = 'Monoxyde de carbone (CO) (ppm)';
Blockly.Msg['COMMUNICATION_BLE_SEND_DATA_TITLE'] = '[Bluetooth] envoyer des données %1 ';
Blockly.Msg['COMMUNICATION_BLE_SEND_DATA_TOOLTIP'] = IMG_MODULE_BLE_SENSOR + Blockly.Tooltip.SEP + 'Envoyer des données via Bluetooth (BLE).';
Blockly.Msg['COMMUNICATION_BLE_READ_DATA_TITLE'] = '[Bluetooth] si message reçu dans %1 alors';
Blockly.Msg['COMMUNICATION_BLE_READ_DATA_TOOLTIP'] = IMG_MODULE_BLE_SENSOR + Blockly.Tooltip.SEP + 'Permet d\'exécuter des instructions si une donnée est reçue par Bluetooth (BLE).';
Blockly.Msg['COMMUNICATION_FIZZIQ_BT_TITLE'] = '[Bluetooth Fizziq App] envoyer %1 %2';
Blockly.Msg['COMMUNICATION_FIZZIQ_BT_TOOLTIP'] = IMG_MODULE_FIZZIQ + Blockly.Tooltip.SEP + 'Envoyer des données (Température, Humidité, etc) via Bluetooth à Fizziq App. Dans l\'onglet "Mesures" de Fizziq, cliquer sur "Capteurs externes", puis Connecter l\'App à l\'appareil nommé "WB55_Vittascience".';
Blockly.Msg['FIZZ_TEMP'] = 'Temperature';
Blockly.Msg['FIZZ_HUM'] = 'Humidite';
...
// Communication - LoRa
Blockly.Msg['COMMUNICATION_LORA_INIT_TITLE'] = '[LoRa E5] initialiser le module avec l\'appEui %1 avec l\'appKey %2';
...
Blockly.Msg['COMMUNICATION_LORA_SEND_TITLE'] = '[LoRa E5] envoyer des données';
...
Blockly.Msg['COMMUNICATION_LORA_RECEIVE_TITLE'] = '[LoRa E5] recevoir un message';
Blockly.Msg['COMMUNICATION_LORA_RECEIVE_TOOLTIP'] = IMG_MODULE_LORA + Blockly.Tooltip.SEP + 'Permet de recevoir des données via le module LoRa.';
...
Blockly.Msg['SENSORS_MAGNETOSCOPE_INTEGRATED_LIS2MDL_TITLE'] = '[Magnétoscope LIS2MDL] champ magnétique suivant %1';
...
Blockly.Msg['SENSORS_THERMOMETER_INTEGRATED_LPS22HH_TITLE'] = '[Thermomètre LPS22HH] température';
Blockly.Msg['SENSORS_THERMOMETER_INTEGRATED_LPS22HH_TOOLTIP'] = IMG_X_NUCLEO_IKS01A3 + Blockly.Tooltip.SEP + 'Renvoie la température (en °C).';
// Sensors - Gas
...
Blockly.Msg['ROBOTS_ALPHABOT_GO_TITLE'] = '[Alphabot] %1 à la vitesse %2 (%)';
