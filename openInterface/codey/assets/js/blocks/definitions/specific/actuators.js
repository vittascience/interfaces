/**
 * @fileoverview Actuators blocks for Codey.
 */
...
Blockly.defineBlocksWithJsonArray([ // BEGIN JSON EXTRACT
    // CODEY AUDIO - BLOCK PLAY MELODY
    {
        ...
        "message0": "%{BKY_ACTUATORS_AUDIO_PLAY_MELODY_TITLE}",
        "args0": [{
            "type": "field_dropdown",
            "name": "MELODY",
            "options": [
        ...
        "tooltip": "%{BKY_ACTUATORS_AUDIO_PLAY_MELODY_TOOLTIP}",
        "extensions": [
            "block_init_helpurl"
        ]
    },
    ...
    // CODEY AUDIO - BLOCK PLAY MELODY UNTIL DONE
    {
        ...
        "message0": "%{BKY_ACTUATORS_AUDIO_PLAY_MELODY_UNTIL_DONE_TITLE}",
        "args0": [{
            "type": "field_dropdown",
            "name": "MELODY",
            "options": [
        ...
        "nextStatement": null,
        "style": "actuators_blocks",
        "tooltip": "%{BKY_ACTUATORS_AUDIO_PLAY_MELODY_UNTIL_DONE_TOOLTIP}",
        "extensions": [
            "block_init_helpurl"
        ]
    },
    ...
    // CODEY AUDIO - BLOCK REST
    {
        ...
        "message0": "%{BKY_ACTUATORS_AUDIO_REST_TITLE}",
        "args0": [{
            "type": "input_value",
            "name": "DURATION",
            "check": "Number"
        ...
        "previousStatement": null,
        "nextStatement": null,
        "tooltip": "%{BKY_ACTUATORS_AUDIO_REST_TOOLTIP}",
        "style": "actuators_blocks",
        "extensions": [
            "block_init_helpurl"
        ]
    ...
    // CODEY AUDIO - BLOCK STOP SOUNDS
    {
        ...
        "message0": "%{BKY_ACTUATORS_AUDIO_STOP_SOUNDS_TITLE}",
        "previousStatement": null,
        "nextStatement": null,
        "tooltip": "%{BKY_ACTUATORS_AUDIO_STOP_SOUNDS_TOOLTIP}",
        "style": "actuators_blocks",
        "extensions": [
            "block_init_helpurl"
        ]
    ...
    // CODEY AUDIO - BLOCK SET VOLUME
    {
        ...
        "previousStatement": null,
        "nextStatement": null,
        "tooltip": "%{BKY_ACTUATORS_AUDIO_SET_VOLUME_TOOLTIP}",
        "style": "actuators_blocks",
        "extensions": [
            "block_init_helpurl",
            "block_buttons_plus_minus"
...
Blockly.Constants.Actuators.AUDIO_PLAY_NOTE_DURATION_MUTATOR_MIXIN =
    Blockly.Constants.Utils.addOptionMutatorMixin('duration', 'ACTUATORS_AUDIO_PLAY_NOTE_DURATION', 'input', 1, "(s)");
