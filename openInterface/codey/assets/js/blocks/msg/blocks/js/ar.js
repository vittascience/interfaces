...
// Actuators
Blockly.Msg['SPEAKER_PLAY_MELODY_TITLE'] = 'تشغيل الصوت %1';
Blockly.Msg['SPEAKER_PLAY_MELODY_TOOLTIP'] = 'يشغل لحنًا محددًا مسبقًا.';
Blockly.Msg['SPEAKER_PLAY_MELODY_UNTIL_DONE_TITLE'] = 'تشغيل الصوت %1 حتى النهاية';
Blockly.Msg['SPEAKER_PLAY_MELODY_UNTIL_DONE_TOOLTIP'] = 'يشغل اللحن وينتظر حتى ينتهي.';
Blockly.Msg['SPEAKER_PLAY_NOTE_TITLE'] = 'تشغيل النغمة %1';
Blockly.Msg['SPEAKER_PLAY_NOTE_TOOLTIP'] = 'يشغل نغمة موسيقية.';
Blockly.Msg['SPEAKER_PLAY_TONE_TITLE'] = 'تشغيل التردد %1 هرتز';
Blockly.Msg['SPEAKER_PLAY_TONE_TOOLTIP'] = 'يشغل صوتًا بتردد معين.';
Blockly.Msg['SPEAKER_REST_TITLE'] = 'توقف لمدة %1 زمن';
Blockly.Msg['SPEAKER_REST_TOOLTIP'] = 'يُدخل توقفًا مؤقتًا في الموسيقى.';
Blockly.Msg['SPEAKER_STOP_SOUNDS_TITLE'] = 'إيقاف جميع الأصوات';
Blockly.Msg['SPEAKER_STOP_SOUNDS_TOOLTIP'] = 'يوقف جميع الأصوات الحالية.';
Blockly.Msg['SPEAKER_SET_VOLUME_TITLE'] = 'ضبط مستوى الصوت إلى %1';
Blockly.Msg['SPEAKER_SET_VOLUME_TOOLTIP'] = 'يضبط مستوى الصوت.';
Blockly.Msg['SPEAKER_GET_VOLUME_TITLE'] = 'الحصول على مستوى الصوت';
Blockly.Msg['SPEAKER_GET_VOLUME_TOOLTIP'] = 'يعيد مستوى الصوت الحالي.';
Blockly.Msg['SPEAKER_SET_TEMPO_TITLE'] = 'ضبط الإيقاع إلى %1';
Blockly.Msg['SPEAKER_SET_TEMPO_TOOLTIP'] = 'يضبط الإيقاع للأصوات.';
Blockly.Msg['SPEAKER_GET_TEMPO_TITLE'] = 'الحصول على الإيقاع';
Blockly.Msg['SPEAKER_GET_TEMPO_TOOLTIP'] = 'يعيد الإيقاع الحالي.';
Blockly.Msg['SPEAKER_PLAY_TONE_DURATION'] = 'لمدة';
