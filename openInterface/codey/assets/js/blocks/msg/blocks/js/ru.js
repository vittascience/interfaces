...
Blockly.Msg['ACTUATORS_AUDIO_PLAY_MELODY_TITLE'] = "воспроизвести мелодию %1";
Blockly.Msg['ACTUATORS_AUDIO_PLAY_MELODY_TOOLTIP'] = "Воспроизводит предустановленную мелодию.";
Blockly.Msg['ACTUATORS_AUDIO_PLAY_MELODY_UNTIL_DONE_TITLE'] = "воспроизвести мелодию %1 до конца";
Blockly.Msg['ACTUATORS_AUDIO_PLAY_MELODY_UNTIL_DONE_TOOLTIP'] = "Воспроизводит предустановленную мелодию и ждёт окончания.";
Blockly.Msg['ACTUATORS_AUDIO_PLAY_NOTE_TITLE'] = "воспроизвести ноту %1";
Blockly.Msg['ACTUATORS_AUDIO_PLAY_NOTE_TOOLTIP'] = "Воспроизводит музыкальную ноту.";
Blockly.Msg['ACTUATORS_AUDIO_PLAY_TONE_TITLE'] = "воспроизвести частоту %1 Гц";
Blockly.Msg['ACTUATORS_AUDIO_PLAY_TONE_TOOLTIP'] = "Воспроизводит звук заданной частоты.";
Blockly.Msg['ACTUATORS_AUDIO_REST_TITLE'] = "пауза на %1 тактов";
Blockly.Msg['ACTUATORS_AUDIO_REST_TOOLTIP'] = "Делает паузу в музыке.";
Blockly.Msg['ACTUATORS_AUDIO_STOP_SOUNDS_TITLE'] = "остановить все звуки";
Blockly.Msg['ACTUATORS_AUDIO_STOP_SOUNDS_TOOLTIP'] = "Останавливает все текущие звуки.";
Blockly.Msg['ACTUATORS_AUDIO_SET_VOLUME_TITLE'] = "установить громкость %1";
Blockly.Msg['ACTUATORS_AUDIO_SET_VOLUME_TOOLTIP'] = "Устанавливает уровень громкости.";
Blockly.Msg['ACTUATORS_AUDIO_GET_VOLUME_TITLE'] = "получить громкость";
Blockly.Msg['ACTUATORS_AUDIO_GET_VOLUME_TOOLTIP'] = "Возвращает текущий уровень громкости.";
Blockly.Msg['ACTUATORS_AUDIO_SET_TEMPO_TITLE'] = "установить темп %1";
Blockly.Msg['ACTUATORS_AUDIO_SET_TEMPO_TOOLTIP'] = "Устанавливает темп воспроизведения.";
Blockly.Msg['ACTUATORS_AUDIO_GET_TEMPO_TITLE'] = "получить темп";
Blockly.Msg['ACTUATORS_AUDIO_GET_TEMPO_TOOLTIP'] = "Возвращает текущий темп.";
