...
// Actuators
Blockly.Msg['SPEAKER_PLAY_MELODY_TITLE'] = "play sound %1";
Blockly.Msg['SPEAKER_PLAY_MELODY_TOOLTIP'] = "Plays a predefined melody.";
Blockly.Msg['SPEAKER_PLAY_MELODY_UNTIL_DONE_TITLE'] = "play sound %1 until done";
Blockly.Msg['SPEAKER_PLAY_MELODY_UNTIL_DONE_TOOLTIP'] = "Plays a predefined melody and waits until it finishes.";
Blockly.Msg['SPEAKER_PLAY_NOTE_TITLE'] = "play note %1";
Blockly.Msg['SPEAKER_PLAY_NOTE_TOOLTIP'] = "Plays a musical note.";
Blockly.Msg['SPEAKER_PLAY_TONE_TITLE'] = "play tone %1 Hz";
Blockly.Msg['SPEAKER_PLAY_TONE_TOOLTIP'] = "Plays a tone of a specific frequency.";
Blockly.Msg['SPEAKER_REST_TITLE'] = "pause for %1 beat(s)";
Blockly.Msg['SPEAKER_REST_TOOLTIP'] = "Inserts a pause in the music.";
Blockly.Msg['SPEAKER_STOP_SOUNDS_TITLE'] = "stop all sounds";
Blockly.Msg['SPEAKER_STOP_SOUNDS_TOOLTIP'] = "Stops all currently playing sounds.";
Blockly.Msg['SPEAKER_SET_VOLUME_TITLE'] = "set volume to %1";
Blockly.Msg['SPEAKER_SET_VOLUME_TOOLTIP'] = "Sets the audio volume.";
Blockly.Msg['SPEAKER_GET_VOLUME_TITLE'] = "get volume";
Blockly.Msg['SPEAKER_GET_VOLUME_TOOLTIP'] = "Returns the current volume.";
Blockly.Msg['SPEAKER_SET_TEMPO_TITLE'] = "set tempo to %1";
Blockly.Msg['SPEAKER_SET_TEMPO_TOOLTIP'] = "Sets the tempo for the sounds.";
Blockly.Msg['SPEAKER_GET_TEMPO_TITLE'] = "get tempo";
Blockly.Msg['SPEAKER_GET_TEMPO_TOOLTIP'] = "Returns the current tempo.";
Blockly.Msg['SPEAKER_PLAY_TONE_DURATION'] = "for";
