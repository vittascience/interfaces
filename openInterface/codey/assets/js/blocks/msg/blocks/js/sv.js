...
Blockly.Msg['DISPLAY_SHOWRGB_TOOLTIP'] = 'Visar den angivna färgen på Codeys inbyggda LED i RGB-format (0 ~ 255).';
Blockly.Msg['DISPLAY_SETRED_TITLE'] = '[Inbyggd LED] röd intensitet %1';
Blockly.Msg['DISPLAY_SETRED_TOOLTIP'] = 'Ställer in den röda intensiteten på Codeys inbyggda LED (0 ~ 255).';
Blockly.Msg['DISPLAY_SETGREEN_TITLE'] = '[Inbyggd LED] grön intensitet %1';
Blockly.Msg['DISPLAY_SETGREEN_TOOLTIP'] = 'Ställer in den gröna intensiteten på Codeys inbyggda LED (0 ~ 255).';
Blockly.Msg['DISPLAY_SETBLUE_TITLE'] = '[Inbyggd LED] blå intensitet %1';
Blockly.Msg['DISPLAY_SETBLUE_TOOLTIP'] = 'Ställer in den blå intensiteten på Codeys inbyggda LED (0 ~ 255).';
Blockly.Msg['DISPLAY_OFF_TITLE'] = '[Inbyggd LED] stäng av';
Blockly.Msg['DISPLAY_OFF_TOOLTIP'] = 'Stänger av Codeys inbyggda LED.';
Blockly.Msg['DISPLAY_SHOW_TITLE'] = '[Matris] visa %1';
Blockly.Msg['DISPLAY_SHOW_TOOLTIP'] = 'Visar den angivna texten på Codeys LED-matris.';
Blockly.Msg['DISPLAY_SETPIXEL_TITLE'] = '[Matris] pixel X %1 Y %2 tillstånd %3';
Blockly.Msg['DISPLAY_SETPIXEL_TOOLTIP'] = 'Sätter pixelns tillstånd vid position X och Y på Codeys LED-matris.';
Blockly.Msg['DISPLAY_GETPIXEL_TITLE'] = '[Matris] pixelens tillstånd X %1 Y %2';
Blockly.Msg['DISPLAY_GETPIXEL_TOOLTIP'] = 'Returnerar pixelns tillstånd vid position X och Y på Codeys LED-matris.';
Blockly.Msg['DISPLAY_TOGGLEPIXEL_TITLE'] = '[Matris] växla pixel X %1 Y %2';
Blockly.Msg['DISPLAY_TOGGLEPIXEL_TOOLTIP'] = 'Växlar pixelns tillstånd vid position X och Y på Codeys LED-matris.';
...
Blockly.Msg['IO_WAIT_UNTIL_TOOLTIP'] = 'Stoppar körningen av koden tills villkoret är uppfyllt.';
...
Blockly.Msg['IO_ONBUTTONPRESSED_TOOLTIP'] = 'Kör instruktioner om knapp A, B eller C trycks.';
Blockly.Msg['IO_BUTTON_STATE_TITLE'] = 'knapp %1 tillstånd';
Blockly.Msg['IO_BUTTON_STATE_TOOLTIP'] = 'Returnerar tillståndet för knapp A, B eller C (sant/falskt).';
...
Blockly.Msg['COMMUNICATION_IRRECEIVE_TITLE'] = '[IR] ta emot infrarött';
Blockly.Msg['COMMUNICATION_IRRECEIVE_TOOLTIP'] = 'Returnerar strängen som tas emot av IR-mottagaren. Data som skickas av IR-sändaren måste sluta med \\n. För NEC-fjärrkontrollprotokollet, använd receive_remote_code().';
Blockly.Msg['COMMUNICATION_IRRECEIVEREMOTECODE_TITLE'] = '[IR] ta emot infrarött (NEC)';
...
Blockly.Msg['COMMUNICATION_IRSTARTLEARNING_TOOLTIP'] = 'Börjar lära in en infraröd signal. Endast kompatibelt med NEC-fjärrkontroller.';
Blockly.Msg['COMMUNICATION_IRSTOPLEARNING_TITLE'] = '[IR] stoppa inlärning';
Blockly.Msg['COMMUNICATION_IRSTOPLEARNING_TOOLTIP'] = 'Stoppar inlärning av en infraröd signal.';
Blockly.Msg['COMMUNICATION_IRSAVELEARNEDRESULT_TITLE'] = '[IR] spara inlärd signal på index %1';
Blockly.Msg['COMMUNICATION_IRSAVELEARNEDRESULT_TOOLTIP'] = 'Sparar den inlärda infraröda signalen i Codeys minne (index 0 till 15).';
Blockly.Msg['COMMUNICATION_IRSENDLEARNEDRESULT_TITLE'] = '[IR] skicka signal på index %1';
Blockly.Msg['COMMUNICATION_IRSENDLEARNEDRESULT_TOOLTIP'] = 'Skickar den inlärda infraröda signalen från Codeys minne.';
...
Blockly.Msg['SENSORS_PITCH'] = "nick";
...
Blockly.Msg['SENSORS_IS_SHAKED_TOOLTIP'] = "Returnerar sant om en skakning upptäcks.";
Blockly.Msg['SENSORS_GET_SHAKE_STRENGTH_TITLE'] = "skakningsintensitet";
Blockly.Msg['SENSORS_GET_SHAKE_STRENGTH_TOOLTIP'] = "Returnerar intensiteten på den senaste upptäckta skakningen.";
Blockly.Msg['SENSORS_GETPOSITION_TITLE'] = "%1?";
Blockly.Msg['SENSORS_IS_TILTED_LEFT'] = "lutat åt vänster";
Blockly.Msg['SENSORS_IS_TILTED_RIGHT'] = "lutat åt höger";
Blockly.Msg['SENSORS_IS_EARS_UP'] = "öronen upp";
Blockly.Msg['SENSORS_IS_EARS_DOWN'] = "öronen nedåt";
Blockly.Msg['SENSORS_IS_DISPLAY_UP'] = "skärmen uppåt";
Blockly.Msg['SENSORS_IS_DISPLAY_DOWN'] = "skärmen nedåt";
Blockly.Msg['SENSORS_IS_UPRIGHT'] = "upprätt";
Blockly.Msg['SENSORS_GETPOSITION_TOOLTIP'] = "Returnerar sant om enheten är i den angivna positionen.";
Blockly.Msg['SENSORS_GETACCELERATION_TITLE'] = "acceleration på %1";
Blockly.Msg['SENSORS_GETACCELERATION_TOOLTIP'] = "Returnerar accelerationsvärdet för vald axel eller den totala kraften.";
Blockly.Msg['SENSORS_GETGYROSCOPE_TITLE'] = "gyroskop på axel %1";
Blockly.Msg['SENSORS_GETGYROSCOPE_TOOLTIP'] = "Returnerar gyroskopvärdet för vald axel.";
Blockly.Msg['SENSORS_GET_LOUDNESS_TITLE'] = 'ljudnivå';
Blockly.Msg['SENSORS_GET_LOUDNESS_TOOLTIP'] = 'Returnerar ljudnivån (0–100).';
Blockly.Msg['SENSORS_GET_LIGHT_TITLE'] = 'ljussensorvärde';
Blockly.Msg['SENSORS_GET_LIGHT_TOOLTIP'] = 'Returnerar ljussensorns värde (0–100).';
...
Blockly.Msg['SPEAKER_PLAY_TONE_TOOLTIP'] = "Spelar en ton med en viss frekvens.";
Blockly.Msg['SPEAKER_REST_TITLE'] = "pausa i %1 slag";
Blockly.Msg['SPEAKER_REST_TOOLTIP'] = "Sätter in en paus i musiken.";
Blockly.Msg['SPEAKER_STOP_SOUNDS_TITLE'] = "stoppa alla ljud";
Blockly.Msg['SPEAKER_STOP_SOUNDS_TOOLTIP'] = "Stoppar alla pågående ljud.";
Blockly.Msg['SPEAKER_SET_VOLUME_TITLE'] = "sätt volymen till %1";
Blockly.Msg['SPEAKER_SET_VOLUME_TOOLTIP'] = "Ställer in ljudvolymen.";
Blockly.Msg['SPEAKER_GET_VOLUME_TITLE'] = "hämta volym";
Blockly.Msg['SPEAKER_GET_VOLUME_TOOLTIP'] = "Returnerar aktuell volym.";
Blockly.Msg['SPEAKER_SET_TEMPO_TITLE'] = "sätt tempot till %1";
Blockly.Msg['SPEAKER_SET_TEMPO_TOOLTIP'] = "Ställer in tempot för uppspelningen.";
Blockly.Msg['SPEAKER_GET_TEMPO_TITLE'] = "hämta tempo";
...
Blockly.Msg['ROBOTS_MOVE_TOOLTIP'] = 'Förflyttar Rocky-roboten i angiven riktning med angiven hastighet (+/- 100).';
...
Blockly.Msg['ROBOTS_DRIVE_TITLE'] = '[Rocky] vänster motor hastighet %1 höger motor hastighet %2';
Blockly.Msg['ROBOTS_DRIVE_TOOLTIP'] = 'Ställer in hastigheten för Rocky-robotens vänster- och högermotor (+/- 100).';
Blockly.Msg['ROBOTS_TURN_BY_DEGREE_TITLE'] = '[Rocky] %1 med %2 °';
Blockly.Msg['ROBOTS_TURN_BY_DEGREE_TOOLTIP'] = 'Vrider Rocky-roboten ett visst antal grader (+/- 360).';
Blockly.Msg['ROBOTS_SENSORS_GET_RGB_TITLE'] = '[Rocky] färgsensorns nivå för %1';
...
Blockly.Msg['ROBOTS_SENSORS_IS_COLOR_TOOLTIP'] = 'Returnerar sant om IR-färgsensorn upptäcker den angivna färgen (röd, grön, blå, gul, cyan, magenta, vit, svart).';
...
Blockly.Msg['ROBOTS_SENSORS_GET_LIGHT_TITLE'] = '[Rocky] ljussensorns nivå för %1';
Blockly.Msg['ROBOTS_SENSORS_AMBIENT'] = 'omgivningsljus';
Blockly.Msg['ROBOTS_SENSORS_REFLECTED'] = 'reflekterat ljus';
Blockly.Msg['ROBOTS_SENSORS_GREYNESS'] = 'gråhetsnivå';
Blockly.Msg['ROBOTS_SENSORS_GET_LIGHT_TOOLTIP'] = 'Returnerar IR-ljussensorns värde för vald typ (omgivningsljus, reflekterat ljus, gråhetsnivå).';
Blockly.Msg['ROBOTS_SENSORS_IS_OBSTACLE_AHEAD_TITLE'] = '[Rocky] hinder framför?';
Blockly.Msg['ROBOTS_SENSORS_IS_OBSTACLE_AHEAD_TOOLTIP'] = 'Returnerar sant om ett hinder upptäcks framför Rocky-roboten.';
