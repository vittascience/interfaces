...
const TOOLBOX_VITTASCIENCE_CONTENT = {
    ...
    "io": [
        ...
        {
            "label": "%{BKY_SUBCATEGORY_OTHER}",
            "blocks": [
                'io_potentiometer_get_value'
            ]
        }
    ],
    "communication": [
        {
            "blocks": [
                'communication_irReceive',
                'communication_irReceiveRemoteCode',
                'communication_irSend',
                'communication_irStartLearning',
                'communication_irStopLearning',
                'communication_irSaveLearnedResult',
                'communication_irSendLearnedResult',
                'communication_irLearn'
            ]
        }
    ],
    "sensors": [
        {
            "label": "%{BKY_SUBCATEGORY_MOTION}",
            "blocks": [
