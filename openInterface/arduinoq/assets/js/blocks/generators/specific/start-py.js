/**
 * @fileoverview Start python generators for Arduino Q.
 */

Blockly.Python.py_on_start = function (block) {
    Blockly.Python.addImport('license', "# SPDX-FileCopyrightText: Copyright (C) ARDUINO SRL (http://www.arduino.cc)\n# SPDX-License-Identifier: MPL-2.0\n\n");
...
Blockly.Python.py_forever = function (block) {
...
Blockly.Python.py_scratch_on_start = function () {
    Blockly.Python.addImport('license', "# SPDX-FileCopyrightText: Copyright (C) ARDUINO SRL (http://www.arduino.cc)\n# SPDX-License-Identifier: MPL-2.0\n\n");
    return ""; // DO NOT CHANGE
};

Blockly.Python.py_scratch_forever = function (block) {
    const prevBlock = block.previousConnection.targetBlock();
    const n = (prevBlock !== null && prevBlock.type === 'py_scratch_on_start' ? "" : NEWLINE);
    let statements = Blockly.Python.statementToCode(block, "DO");
    statements = Blockly.Python.addLoopTrap(statements, block.id) || Blockly.Python.PASS;
