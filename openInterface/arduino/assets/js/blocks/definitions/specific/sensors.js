/**
 * @fileoverview Sensors blocks for Arduino.
 */
...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
    ...
    // GROVE O2 GAS SENSOR _ READ CONCENTRATION/VOUT
    {
        ...
        "args0": [{
            ...
            "name": "DATA",
            "options": [
                ["%{BKY_SENSORS_O2_GAS_CONCENTRATION}", "1"],
                ["%{BKY_SENSORS_O2_GAS_VOUT}", "0"]
            ]
        }, {
            "type": "field_grid_dropdown",
            "name": "PIN",
    ...
    // MQ135 SENSOR _ READ CO2 JSON
    {
        ...
        "args0": [{
            ...
            "name": "DATA",
            "options": [
                ["%{BKY_SENSORS_MQ135_CONCENTRATION}", "CO2"],
                ["%{BKY_SENSORS_MQ135_RZERO_CALIBRATOR}", "R0"]
            ]
        }, {
            "type": "field_grid_dropdown",
            "name": "PIN",
    ...
    {
        "type": "sensors_onAirQualityIndexAs",
        "message0": "%{BKY_SENSORS_AIR_QUALITY_ONINDEXAS_TITLE}",
        "args0": [{
            "type": "field_grid_dropdown",
            "name": "INDEX",
            "options": [
                ["%{BKY_SENSORS_AIR_QUALITY_FA}", "FRESH_AIR"],
                ["%{BKY_SENSORS_AIR_QUALITY_LP}", "LOW_POLLUTION"],
                ["%{BKY_SENSORS_AIR_QUALITY_HP}", "HIGH_POLLUTION"],
                ["%{BKY_SENSORS_AIR_QUALITY_VHP}", "FORCE_SIGNAL"]
            ]
        }, {
            "type": "field_grid_dropdown",
            "name": "PIN",
    ...
    // GROVE DPS310 SENSOR _ READ DATA
    {
        "type": "sensors_getDps310Data",
        "message0": "%{BKY_SENSORS_DPS310_READDATA_TITLE}",
        "args0": [{
            "type": "field_grid_dropdown",
            "name": "DATA",
            "options": [
                ["%{BKY_SENSORS_DPS310_TEMPERATURE}", "TEMP"],
                ["%{BKY_SENSORS_DPS310_PRESSURE}", "PRESS"]]
        }],
        "output": "Decimal",
        "inputsInline": true,
        "style": "sensors_blocks",
        "tooltip": "%{BKY_SENSORS_DPS310_READDATA_TOOLTIP}",
        "extensions": [
            "block_init_helpurl"
        ],
        "mutator": "sensors_temperature_mutator"
    ...
    // GROVE BME680 SENSOR _ READ DATA
    {
        ...
        "args0": [{
            ...
            "name": "DATA",
            "options": [
                ["%{BKY_SENSORS_BME680_TEMPERATURE}", "TEMP"],
                ["%{BKY_SENSORS_BME680_PRESSURE}", "PRESS"],
                ["%{BKY_SENSORS_BME680_HUMIDITY}", "HUM"],
                ["%{BKY_SENSORS_BME680_GAS}", "GAS"]
            ]
        }],
        "output": "Decimal",
        "inputsInline": true,
    ...
    // GROVE WATER SENSOR I2C
    {
        "type": "sensors_getGroveWaterAmountI2C",
        "message0": "%{BKY_SENSORS_GETGROVEWATER_I2C_TITLE}",
        "output": "Number",
        "style": "sensors_blocks",
        "tooltip": "%{BKY_SENSORS_GETGROVEWATER_I2C_TOOLTIP}",
        "extensions": [
            "block_init_helpurl"
        ]
    },
    ...
    // GROVE I2C COLOR SENSOR _ ON COLOR DETECTED
    {
        "type": "sensors_colorSensor_onColorDetected",
        "message0": "%{BKY_SENSORS_GROVECOLOR_ONCOLORDETECTED_TITLE}",
        "args0": [{
            "type": "field_grid_dropdown",
            "name": "COLOR",
            "options": [
                ["%{BKY_COLOR_RED}", "RED"],
                ["%{BKY_COLOR_GREEN}", "GREEN"],
                ["%{BKY_COLOR_BLUE}", "BLUE"]
            ]
        }],
        "message1": "%1",
        ...
        "nextStatement": null,
        "style": "sensors_blocks",
        "tooltip": "%{BKY_SENSORS_GROVECOLOR_ONCOLORDETECTED_TOOLTIP}",
        "extensions": [
            "block_init_helpurl"
        ]
    },
    ...
    // GROVE PULSE SENSOR (BPM)
    {
        "type": "sensors_getPulseBpm",
        "message0": "%{BKY_SENSORS_GETPULSE_BPM_TITLE}",
        "args0": [{
            "type": "field_grid_dropdown",
            "name": "PIN",
            "options": Blockly.Constants.Pins.analog_read[Blockly.Constants.getSelectedBoard()]
