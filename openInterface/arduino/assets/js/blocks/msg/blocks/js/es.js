/**
 * @fileoverview Spanish messages for Arduino UNO R4. (ES)
 */
'use strict';
//COMMENT - Arduino
...
// Display - LED matrix
Blockly.Msg['DISPLAY_BUILTINMATRIX_DRAWBITMAPICON_TITLE'] = '[Matriz LED] mostrar dibujo %1 en la posición x %2 y %3 %4';
Blockly.Msg['DISPLAY_BUILTINMATRIX_DRAWBITMAPICON_TOOLTIP'] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + 'Permite mostrar el dibujo en la matriz de LEDs 12x8 del Arduino UNO R4 WIFI placa.';
Blockly.Msg['DISPLAY_BUILTINMATRIX_WITH_CLEAR'] = 'con limpieza';
Blockly.Msg['DISPLAY_BUILTINMATRIX_WITHOUT_CLEAR'] = 'sin limpieza';
Blockly.Msg['DISPLAY_BUILTINMATRIX_DRAWSTRING_TITLE'] = '[Matriz LED] desplácese por el texto %1 velocidad %2';
Blockly.Msg['DISPLAY_BUILTINMATRIX_DRAWSTRING_TOOLTIP'] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + 'Permite dibujar una cadena en la matriz de LEDs 12x8 del Arduino UNO R4 WIFI placa.';
Blockly.Msg['DISPLAY_BUILTINMATRIX_SHOWNUMBER_TITLE'] = '[Matriz LED] mostrar número %1';
Blockly.Msg['DISPLAY_BUILTINMATRIX_SHOWNUMBER_TOOLTIP'] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + 'Permite mostrar el número en la matriz de LEDs 12x8 del Arduino UNO R4 WIFI placa.';
Blockly.Msg["DISPLAY_BUILTINMATRIX_SETPIXEL_TITLE"] = "[Matriz LED] establecer el píxel x %1 y %2 en %3";
Blockly.Msg["DISPLAY_BUILTINMATRIX_SETPIXEL_TOOLTIP"] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + "Permite activar/desactivar un píxel en la matriz LED integrada de 12x8 del Arduino UNO R4 WIFI placa.";
Blockly.Msg["DISPLAY_BUILTINMATRIX_CLEARSCREEN_TITLE"] = "[Matriz LED] limpiar pantalla";
Blockly.Msg["DISPLAY_BUILTINMATRIX_CLEARSCREEN_TOOLTIP"] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + "Permite limpiar la pantalla de la matriz LED integrada de 12x8 del Arduino UNO R4 WIFI.";
// Display - Screens
...
Blockly.Msg['DISPLAY_OLED_ADDTEXT_TITLE'] = '[Ecran OLED %1] mostrar el texto %2 en la posición x %3 y %4';
...
Blockly.Msg['DISPLAY_OLED_DRAWICON_TITLE'] = '[Ecran OLED %1] mostrar el icono %2 en la posición x %3 y %4';
...
Blockly.Msg['DISPLAY_OLED_DRAWBITMAPLOGO_TITLE'] = '[Ecran OLED %1] mostrar logo %2';
...
Blockly.Msg['DISPLAY_OLED_CLEARSCREEN_TITLE'] = '[Ecran OLED %1] borrar pantalla';
...
Blockly.Msg['IO_GROVEKEYPAD_GETNUMBER_TITLE'] = '[Teclado numérico] número';
...
Blockly.Msg['IO_GROVEJOYSTICK_GETAXIS_TITLE'] = '[Módulo joystick] Valor de eje %1 en los pines X %2 Y %3';
...
Blockly.Msg['IO_GET_GROVE_ENCODER_VALUE_TITLE'] = '[Encoder rotatorio] valor en el pin D2';
Blockly.Msg['IO_GET_GROVE_ENCODER_VALUE_TOOLTIP'] = IMG_MODULE_ROTARY_ENCODER + Blockly.Tooltip.SEP + 'Devuelve el valor del encoder rotatorio Grove conectado al puerto D2 del shield Grove. Este es el único puerto Grove que admite la interrupción necesaria para el funcionamiento del encoder. Por lo tanto, no es posible conectarlo a otro puerto.';
...
Blockly.Msg['IO_GET_REVERSED_BUTTON_TITLE'] = '[Módulo de botón invertido] estado en el pin %1';
Blockly.Msg['IO_GET_REVERSED_BUTTON_TOOLTIP'] = 'Devuelve el valor del botón (0 o 1) en los pines digitales D0 a D13. Los botones NC (Normalmente Cerrados) permiten el paso de corriente cuando están en reposo.';
...
Blockly.Msg['IO_GROVEMP3_INIT_TITLE'] = '[Módulo MP3 %1] inicializar';
Blockly.Msg['IO_GROVEMP3_INIT_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Inicializa el módulo Grove MP3 v3.0 en los pines RX/TX';
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TITLE'] = '[Módulo MP3 %1] poner en reproducción/pausa';
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Permite poner en reproducción/pausa';
Blockly.Msg['IO_GROVEMP3_NEXT_TITLE'] = '[Módulo MP3 %1] pasar a la piste %2';
Blockly.Msg['IO_GROVEMP3_NEXT_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Va a la siguiente pista or la anterior.';
Blockly.Msg['IO_GROVEMP3_NEXT'] = 'siguiente';
Blockly.Msg['IO_GROVEMP3_PREVIOUS'] = 'anterior';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TITLE'] = '[Módulo MP3 %1] reproducir pista %2';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Te permite reproducir una pista proporcionando el nombre del archivo.';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TITLE'] = '[Módulo MP3 %1] reproducir la pista de la carpeta %2 índice %3';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Te permite reproducir una pista en una carpeta especificando su índice.';
Blockly.Msg['IO_GROVEMP3_GET_VOLUME_TITLE'] = '[Módulo MP3 %1] volumen actual';
Blockly.Msg['IO_GROVEMP3_GET_VOLUME_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Devuelve el nivel de volumen actual';
Blockly.Msg['IO_GROVEMP3_SET_VOLUME_TITLE'] = '[Módulo MP3 %1] establecer volumen %2';
Blockly.Msg['IO_GROVEMP3_SET_VOLUME_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Establece el nivel de volumen';
Blockly.Msg['IO_GROVEMP3_CHANGE_PLAYING_MODE_TITLE'] = '[Módulo MP3 %1] cambia el modo de reproducción a %2';
Blockly.Msg['IO_GROVEMP3_CHANGE_PLAYING_MODE_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Permite cambiar el modo de reproducción del reproductor MP3.';
Blockly.Msg['IO_GROVEMP3_MODE_CYCLE'] = "reproducir todas las pistas";
Blockly.Msg['IO_GROVEMP3_MODE_SINGLE_CYCLE'] = "reproducir una pista";
Blockly.Msg['IO_GROVEMP3_MODE_DIR_CYCLE'] = "reproducir una carpeta";
Blockly.Msg['IO_GROVEMP3_MODE_RANDOM'] = "en modo aleatorio";
Blockly.Msg['IO_GROVEMP3_MODE_SINGLE_SHOT'] = "solo una pista";
// Input/Output - Pins
...
Blockly.Msg["COMMUNICATION_OPENLOG_WRITE_TITLE"] = "[Openlog] escribir en la tarjeta baudrate %1";
Blockly.Msg['COMMUNICATION_OPENLOG_WRITE_TITLE_PINS'] = 'en pines RXI %1 TXO %2';
Blockly.Msg['COMMUNICATION_OPENLOG_WRITE_TITLE_DATA'] = 'Datos %1';
...
Blockly.Msg["COMMUNICATION_BLUETOOTH_SETTINGS_TITLE"] = "[Grove BT] establecer nombre %1 Modo %2 Código PIN %3";
Blockly.Msg["COMMUNICATION_BLUETOOTH_SETTINGS_TOOLTIP"] = IMG_MODULE_GROVE_BT + Blockly.Tooltip.SEP + "Habilitar la configuración de 3 parámetros (nombre, modo 'S' para esclavo o 'M' para maestro y código PIN) del módulo Bluetooth serie.";
...
Blockly.Msg['COMMUNICATION_BLUETOOTH_HELPER_R4'] = '\n.\nConexiones: Con la placa Arduino R4, RXD se conecta a TX (D1) y TXD se conecta a RX (D0). Esto corresponde al puerto UART de la shield Grove.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'] = '\n.\nNota: Para usar este bloque, el módulo debe estar en modo AT. Para ello, conecte el pin KEY del módulo al terminal 3V3 de Arduino con un cable Dupont, luego desconecte y vuelva a conectar la placa Arduino. El modo AT es visible cuando el LED del módulo HC05 parpadea aproximadamente cada segundo.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - cambiar el parámetro %1 a %2';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Permite cambiar los parámetros del módulo Bluetooth HC05 enviando un comando AT. Una vez modificado el parámetro, ya no es necesario volver a este modo, ya que está almacenado en la memoria del módulo.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - valor del parámetro %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Permite recuperar los valores de los parámetros del módulo Bluetooth HC05 enviando un comando AT.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TITLE'] = '[HC05 BT] Establecer la velocidad en baudios a %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Permite cambiar la velocidad de transmisión de datos con el módulo Bluetooth HC05. Por defecto, la velocidad en baudios del módulo es de 9600. Recuerde comprobar primero la velocidad en baudios en la memoria del módulo HC05 leyendo \'AT+UART?\' en modo AT. Si es necesario, cambie esta configuración enviando un comando AT+UART a "9600,0,0", por ejemplo.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'] = '\n.\nPara volver al modo de transmisión de datos, simplemente desconecte el pin KEY del terminal 3V3. El módulo empezará a parpadear rápidamente, lo que indica que está buscando un emparejamiento.'; Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TITLE'] = '[HC05 BT] Enviar mensaje %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Permite enviar datos a través del módulo Bluetooth HC05 en los pines digitales D0 a D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TITLE'] = '[HC05 BT] Si el mensaje se recibió en %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Le permite ejecutar instrucciones si los datos son recibidos por un módulo Bluetooth HC05 en los pines digitales D0 a D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - cambiar el parámetro %1 a %2';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Permite cambiar los parámetros del módulo Bluetooth HM10 enviando un comando AT. Una vez modificado el parámetro, ya no es necesario volver a este modo, ya que se almacena en la memoria del módulo.';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - valor del parámetro %1';
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Le permite recuperar el valor de los parámetros del módulo bluetooth HM10 enviando un comando AT.';
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_SENDDATA_TITLE"] = "[HM10 BT] enviar mensaje %1";
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_SENDDATA_TOOLTIP"] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + "Habilitar el envío de datos mediante el módulo Bluetooth serie HM10 en los pines digitales D0 a D13.";
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_ONDATARECEIVED_TITLE"] = "[HM10 BT] en el mensaje recibido en %1";
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_ONDATARECEIVED_TOOLTIP"] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + "Permite ejecutar instrucciones sobre los datos recibidos por el módulo Bluetooth serial HM10 en la variable 'HM10Data' en los pines digitales D0 a D13. De forma predeterminada, el nombre del módulo es MLT-BT05.";
...
Blockly.Msg['COMMUNICATION_GROVE_433MHZ_TRANSMITTER'] = '[Radio 315/433MHz] enviar en el pin %1 Mensaje %2';
...
Blockly.Msg['COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_TITLE'] = '[Control Remoto NEC] si se recibe el comando %1 entonces';
...
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TITLE'] = '[Lector RFID - 125kHz] ID de insignia';
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TOOLTIP'] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + 'Le permite recuperar el identificador UID en forma de una cadena de caracteres del módulo Grove RFID de 125 kHz si el uno está disponible en los pines digitales D0 a D13.Para verificar el identificador de una tarjeta y validarla o no, simplemente compárelo con el marco de cadena deseado.';
Blockly.Msg['COMMUNICATION_GPS_ONDATARECEIVED_TITLE'] = '[GPS] si se reciben datos en %1';
...
Blockly.Msg['SENSORS_MHZ19_GETDATA_TITLE'] = '[Sensor MH-Z19] %1';
...
Blockly.Msg['SENSORS_SUNLIGHT_GETDATA_TITLE'] = '[Sensor de luz SI1145] brillo %1';
Blockly.Msg['SENSORS_SUNLIGHT_GETDATA_TOOLTIP'] = IMG_MODULE_SI1145 + Blockly.Tooltip.SEP + 'Devuelve el índice de luz ultravioleta, el brillo visible (en luz) o infrarrojo (en lumen) gracias al sensor de luz solar Grove o al sensor GY1145.Conecte el sensor a un puerto I2C.';
...
Blockly.Msg['SENSORS_CAMERA_SNAPSHOT_TITLE'] = '[Cámara] tomar una foto';
Blockly.Msg['SENSORS_CAMERA_SNAPSHOT_SHIELD_TITLE'] = '[Shield SD] guarde la foto en el pin %1';
...
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TITLE'] = '[HC05 BT] enviar mensaje %1';
...
Blockly.Msg['SENSORS_BME280_GETDATA_TITLE'] = '[Sensor BME280 %1] %2';
Blockly.Msg['SENSORS_BME280_GETDATA_TOOLTIP'] = IMG_MODULE_BME280 + Blockly.Tooltip.SEP + 'Devuelve la temperatura ambiente en grados Celsius (°C) de -40 a 85 °C, Fahrenheit (°F) o Kelvin (K), la humedad (en %), la presión (en pascales) o la altitud (en m) usando el sensor BME280. Conectar el sensor a un puerto I2C.';
Blockly.Msg['ACTUATORS_SPDT_RELAY_CONTROL_STATE_TITLE'] = '[Módulo %1 Relé SPDT] controlar el relé %2 al estado %3';
Blockly.Msg['ACTUATORS_SPDT_RELAY_CONTROL_STATE_TOOLTIP'] = IMG_MODULE_MULTI_CHANNEL_RELAY + Blockly.Tooltip.SEP + 'Permite controlar el estado del relé (ALTO o BAJO). Por defecto, hemos configurado las conexiones de los dispositivos en "NO", es decir, normalmente abierto, lo que significa que el circuito está abierto. Si conectas el dispositivo en "NC", significa que estará encendido por defecto si el Arduino está desconectado. Para manejar el módulo en "NC", usa el bloque \'Definir la conexión del dispositivo...\'. Conectar el módulo a un puerto I2C.';
Blockly.Msg['ACTUATORS_SPDT_RELAY_DEFINE_NC_NO_TITLE'] = '[Módulo %1 Relé SPDT] definir el dispositivo %2 conectado a %3';
Blockly.Msg['ACTUATORS_SPDT_RELAY_DEFINE_NC_NO_TOOLTIP'] = IMG_MODULE_MULTI_CHANNEL_RELAY + Blockly.Tooltip.SEP + 'Permite configurar si los dispositivos están conectados en "NC" (normalmente cerrado) o "NO" (normalmente abierto). Conectar el módulo a un puerto I2C.';
Blockly.Msg['ACTUATORS_RELAY_CHANNEL_NO'] = 'NO (Normalmente abierto)';
Blockly.Msg['ACTUATORS_RELAY_CHANNEL_NC'] = 'NC (Normalmente cerrado)';
Blockly.Msg['IO_GROVEMP3_KT403A_PLAY_SONG_SPECIFY_TITLE'] = '[Módulo MP3 V2.0 ] reproducir la pista del directorio %1 índice %2';
Blockly.Msg['IO_GROVEMP3_KT403A_PLAY_SONG_SPECIFY_TOOLTIP'] = IMG_MODULE_MP3_V2 + Blockly.Tooltip.SEP + 'Permite reproducir una pista guardada en la tarjeta SD indicando el índice del directorio y el índice de la pista.';
Blockly.Msg['IO_DETACH_INTERRUPT_TITLE'] = 'desactivar el evento en el pin %1';
Blockly.Msg['IO_DETACH_INTERRUPT_TOOLTIP'] = 'Permite desactivar el evento en el pin D2 o D3.';
Blockly.Msg['IO_SETPINMODE_TITLE'] = 'aplicar el modo %1 al pin %2';
Blockly.Msg['IO_SETPINMODE_TOOLTIP'] = 'Permite aplicar el modo (INPUT, OUTPUT, INPUT_PULLUP) a un pin.';
Blockly.Msg['COMMUNICATION_SERIAL_WRITE_NUMBER_TITLE'] = 'escribir el número en la consola %1 con formato %2';
Blockly.Msg['COMMUNICATION_SERIAL_WRITE_NUMBER_TOOLTIP'] = 'Permite mostrar un número en la consola según el formato elegido (HEX: hexadecimal, DEC: decimal). Atención: no se pueden mostrar números de punto flotante en formato HEX.';
Blockly.Msg['COMMUNICATION_IR_SEND_NEC_REPEAT'] = 'repeticiones';
Blockly.Msg['COMMUNICATION_IR_SENDNECCOMMAND_TITLE'] = '[Emisor IR] enviar el comando NEC %1 dirección %2 en el pin %3';
Blockly.Msg['COMMUNICATION_IR_SENDNECCOMMAND_TOOLTIP'] = IMG_MODULE_IR_EMITTER + Blockly.Tooltip.SEP + 'Permite enviar un comando con una dirección determinada según el protocolo NEC por transmisión infrarroja con el módulo Emisor IR en los pines digitales.';
Blockly.Msg['COMMUNICATION_IR_SENDFRAME_TITLE'] = '[Emisor IR] enviar la trama %1 frecuencia %2 kHz en el pin %3';
Blockly.Msg['COMMUNICATION_IR_SENDFRAME_TOOLTIP'] = IMG_MODULE_IR_EMITTER + Blockly.Tooltip.SEP + 'Permite enviar una trama como un arreglo de enteros por transmisión infrarroja con el módulo Emisor IR en los pines digitales.';
Blockly.Msg['COMMUNICATION_IR_GET_PROTOCOL_PARAM_TITLE'] = '[Trama IR] obtener %1 de los datos infrarrojos';
Blockly.Msg['COMMUNICATION_IR_GET_PROTOCOL_PARAM_TOOLTIP'] = IMG_MODULE_IR_RECEIVER + Blockly.Tooltip.SEP + 'Permite obtener el comando o la dirección de los datos recibidos según el protocolo NEC o Sony SIRC. Este bloque debe usarse después de recibir datos infrarrojos con el bloque \'[Receptor IR] si dato recibido en el pin ...\'.';
Blockly.Msg['IR_RECEIVER_CMD'] = 'comando ';
Blockly.Msg['IR_RECEIVER_ADDR'] = 'dirección';
Blockly.Msg['COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TITLE'] = '[Control remoto NEC - gris] si se recibe el comando %1 entonces';
Blockly.Msg['COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TOOLTIP'] = IMG_MODULE_CAR_MP3_GRAY_REMOTE_IR_RECEIVER + Blockly.Tooltip.SEP + 'Permite ejecutar instrucciones si se recibe alguno de los comandos de un control remoto NEC por transmisión infrarroja. Usar este bloque con el receptor infrarrojo para que la transmisión funcione. El botón + permite añadir condiciones para otros botones.';
Blockly.Msg['SENSORS_MLX90614_READ_OBJECT_TEMPERATURE_TITLE'] = '[Sensor de temperatura IR] temperatura %1';
Blockly.Msg['SENSORS_MLX90614_READ_OBJECT_TEMPERATURE_TOOLTIP'] = IMG_MODULE_MLX90614 + Blockly.Tooltip.SEP + 'Devuelve la temperatura de un objeto en grados Celsius (°C) o Fahrenheit (°F) con el sensor infrarrojo MLX90614. Conectar el sensor a un puerto I2C.';
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TITLE'] = '[Sensor de ritmo cardíaco] bpm en el pin %1';
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TOOLTIP'] = IMG_MODULE_EAR_CLIP + Blockly.Tooltip.SEP + 'Devuelve el número de latidos por minuto (bpm) con el sensor cardíaco Grove.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TAKEMEASURE_TITLE'] = '[Sensor de pulso y oxígeno] tomar una medida';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TAKEMEASURE_TOOLTIP'] = IMG_MODULE_DFROBOT_MAX30102 + Blockly.Tooltip.SEP + 'Toma una medida de la frecuencia cardíaca y del nivel de oxígeno en la sangre con el sensor MAX30102 de DFRobot. Conectar el sensor a un puerto I2C.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_GETDATA_TITLE'] = '[Sensor de pulso y oxígeno] %1';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_GETDATA_TOOLTIP'] = IMG_MODULE_DFROBOT_MAX30102 + Blockly.Tooltip.SEP + 'Devuelve la frecuencia cardíaca (bpm) o el nivel de oxígeno en sangre (%) medidos por el sensor MAX30102 de DFRobot. Conectar el sensor a un puerto I2C.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_BPM'] = 'frecuencia cardíaca (bpm)';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_SPO2'] = 'nivel de oxígeno en la sangre (%)';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TEMP'] = 'temperatura (°C)';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TITLE'] = '[HuskyLens] activar el modo %1';
...
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_FACE_RECOGNITION'] = 'detección facial';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_TRACKING'] = 'seguimiento de objeto';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_RECOGNITION'] = 'detección de objetos';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_LINE_TRACKING'] = 'seguimiento de línea';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_COLOR_RECOGNITION'] = 'detección de color';
...
Blockly.Msg['CAMERAS_HUSKYLENS_SET_TEXT_TITLE'] = '[HuskyLens] mostrar el texto %1 en la posición (%2,%3)';
...
Blockly.Msg['CAMERAS_HUSKYLENS_CLEAR_SCREEN_TITLE'] = '[HuskyLens] borrar la pantalla';
Blockly.Msg['CAMERAS_HUSKYLENS_CLEAR_SCREEN_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Borra todo el texto mostrado en la pantalla de la cámara HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_LEARN_ID_TITLE'] = '[HuskyLens] aprender automáticamente el ID n°%1';
...
Blockly.Msg['CAMERAS_HUSKYLENS_FORGET_IDS_TITLE'] = '[HuskyLens] olvidar todos los IDs';
Blockly.Msg['CAMERAS_HUSKYLENS_FORGET_IDS_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Elimina todos los IDs registrados en la cámara HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_TITLE'] = '[HuskyLens] obtener los datos %1';
...
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TITLE'] = '[HuskyLens] asociar el nombre %1 al ID n°%2';
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permite asociar un nombre a un ID ya registrado (modo detección facial).';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TITLE'] = '[HuskyLens] obtener %1 de los bloques detectados';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permite obtener la información de detección de la cámara HuskyLens. Cada elemento identificado se almacena en un arreglo con la forma [x1, y1, ancho, alto, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ID'] = 'los IDs';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X'] = 'las coordenadas X';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y'] = 'las coordenadas Y';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X1'] = 'las coordenadas X (origen)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y1'] = 'las coordenadas Y (origen)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X2'] = 'las coordenadas X (destino)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y2'] = 'las coordenadas Y (destino)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_WIDTH'] = 'los anchos';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_HEIGHT'] = 'las alturas';
...
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_XY_TITLE'] = '[HuskyLens] obtener la %1 del bloque detectado';
...
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TITLE'] = '[HuskyLens] obtener %1 de las flechas detectadas';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permite obtener la información de detección de la cámara HuskyLens. Cada elemento identificado se almacena en un arreglo con la forma [x1, y1, x2, y2, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TITLE'] = '[HuskyLens] arreglo de datos %1 del ID n°%2';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Permite obtener los datos devueltos asociados al ID indicado con la cámara HuskyLens. Los datos recibidos están en un arreglo con la forma [x1, y1, ancho, alto, id].';
...
Blockly.Msg['CAMERAS_HUSKYLENS_CHECK_ID_TITLE'] = '[HuskyLens] %2 comprobar si el ID n.º%1 está detectado';
Blockly.Msg['CAMERAS_HUSKYLENS_CHECK_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Devuelve verdadero o falso si la cámara HuskyLens detecta el ID.';
...
Blockly.Msg['CAMERAS_HUSKYLENS_GET_LINE_DIRECTION_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'Detecta la dirección de la línea con la cámara HuskyLens.';
...
Blockly.Msg['CAMERAS_HUSKYLENS_LOAD_MODEL_TITLE'] = '[HuskyLens] cargar el modelo n.º%1';
...
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_ATBAUD_HELPER'] = '\n.\nPara cambiar la velocidad en baudios, usa el número correspondiente en la tabla siguiente. Tras enviar el comando, reinicia la placa Arduino pulsando el botón Reset para aplicar la nueva velocidad.\n';
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORRUN_TITLE"] = "[Controlador TB6612FNG] controlar motor de corriente continua canal %1 velocidad %2 dirección %3";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORRUN_TOOLTIP"] = "Permite controlar un motor de corriente continua conectado al canal A o B del controlador TB6612FNG.";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORBRAKE_TITLE"] = "[Controlador TB6612FNG] detener motor de corriente continua canal %1";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORBRAKE_TOOLTIP"] = "Permite frenar el motor de corriente continua conectado al canal A o B del controlador TB6612FNG.";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERRUN_TITLE"] = "[Controlador TB6612FNG] motor paso a paso modo %1 pasos %2 velocidad %3 (rpm)";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERRUN_TOOLTIP"] = "Permite controlar un motor paso a paso con el controlador TB6612FNG configurando modo, pasos y velocidad en rpm.";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERSTOP_TITLE"] = "[Controlador TB6612FNG] detener motor paso a paso";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERSTOP_TOOLTIP"] = "Permite detener el motor paso a paso controlado por el controlador TB6612FNG.";
