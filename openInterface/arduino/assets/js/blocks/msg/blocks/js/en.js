...
// Display - LED matrix
Blockly.Msg["DISPLAY_BUILTINMATRIX_DRAWBITMAPICON_TITLE"] = "[LED Matrix] show draw %1 at position x %2 y %3 %4";
Blockly.Msg["DISPLAY_BUILTINMATRIX_DRAWBITMAPICON_TOOLTIP"] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + "Lets you show drawing on the 12x8 built-in LED matrix of the Arduino UNO R4 WIFI.";
Blockly.Msg['DISPLAY_BUILTINMATRIX_WITH_CLEAR'] = 'with cleaning';
Blockly.Msg['DISPLAY_BUILTINMATRIX_WITHOUT_CLEAR'] = 'without cleaning';
Blockly.Msg["DISPLAY_BUILTINMATRIX_DRAWSTRING_TITLE"] = "[LED Matrix] scroll text %1 with speed %2 (%)";
Blockly.Msg["DISPLAY_BUILTINMATRIX_DRAWSTRING_TOOLTIP"] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + "Lets you draw string on the 12x8 built-in LED matrix of the Arduino UNO R4 WIFI.";
Blockly.Msg["DISPLAY_BUILTINMATRIX_SHOWNUMBER_TITLE"] = "[LED Matrix] show number %1";
Blockly.Msg["DISPLAY_BUILTINMATRIX_SHOWNUMBER_TOOLTIP"] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + "Lets you show number on the 12x8 built-in LED matrix of the Arduino UNO R4 WIFI.";
Blockly.Msg["DISPLAY_BUILTINMATRIX_SETPIXEL_TITLE"] = "[LED Matrix] set pixel x %1 y %2 to %3";
Blockly.Msg["DISPLAY_BUILTINMATRIX_SETPIXEL_TOOLTIP"] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + "Lets you set a pixel (ON/OFF) on the 12x8 built-in LED matrix of the Arduino UNO R4 WIFI.";
Blockly.Msg["DISPLAY_BUILTINMATRIX_CLEARSCREEN_TITLE"] = "[LED Matrix] clear screen";
Blockly.Msg["DISPLAY_BUILTINMATRIX_CLEARSCREEN_TOOLTIP"] = IMG_ARDUINO_UNO_R4_WIFI + Blockly.Tooltip.SEP + "Lets you clear screen of the 12x8 built-in LED matrix of the Arduino UNO R4 WIFI.";
// Display - Screens
...
Blockly.Msg["DISPLAY_OLED_ADDTEXT_TITLE"] = "[OLED display %1] show the text %2 at position x %3 y %4";
...
Blockly.Msg["DISPLAY_OLED_DRAWICON_TITLE"] = "[OLED display %1] draw icon %2 at position x %3 y %4";
...
Blockly.Msg["DISPLAY_OLED_DRAWBITMAPLOGO_TITLE"] = "[OLED display %1] draw logo %2";
...
Blockly.Msg["DISPLAY_OLED_CLEARSCREEN_TITLE"] = "[OLED display %1] clear screen";
...
Blockly.Msg["IO_GROVEKEYPAD_GETNUMBER_TITLE"] = "[Numeric Touch Keypad] get number";
...
Blockly.Msg['IO_GET_GROVE_ENCODER_VALUE_TOOLTIP'] = IMG_MODULE_ROTARY_ENCODER + Blockly.Tooltip.SEP + 'Returns the value of the Grove rotary encoder on port D2 of the Grove shield. This is the only Grove port that supports the required interrupt for the encoder to function. It is therefore not possible to connect it to another port.';
...
Blockly.Msg['IO_GET_REVERSED_BUTTON_TITLE'] = '[Reversed button module] state on pin %1';
Blockly.Msg['IO_GET_REVERSED_BUTTON_TOOLTIP'] = 'Returns the value of the button (0 or 1) on digital pins D0 to D13. Normally Closed (NC) buttons allow current to flow when at rest.';
...
Blockly.Msg["IO_GROVEMP3_INIT_TITLE"] = "[MP3 Module %1] initialize";
Blockly.Msg["IO_GROVEMP3_INIT_TOOLTIP"] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + "Initializes the Grove MP3 v3.0 module on RX/TX pins";
Blockly.Msg["IO_GROVEMP3_PLAY_PAUSE_TITLE"] = "[MP3 Module %1] set play/pause";
Blockly.Msg["IO_GROVEMP3_PLAY_PAUSE_TOOLTIP"] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + "Sets the play/pause state";
Blockly.Msg["IO_GROVEMP3_NEXT_TITLE"] = "[MP3 Module %1] go to %2 track";
Blockly.Msg["IO_GROVEMP3_NEXT_TOOLTIP"] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + "Goes to the next or previous track.";
Blockly.Msg['IO_GROVEMP3_NEXT'] = 'next';
Blockly.Msg['IO_GROVEMP3_PREVIOUS'] = 'previous';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TITLE'] = '[MP3 Module %1] play track %2';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Allows you to play a track by giving the file name. Please note, the .mp3 file name must be less than 8 characters.';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TITLE'] = '[MP3 Module %1] play the track from the folder %2 index %3';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Allows you to play a track in a folder by specifying its index.';
Blockly.Msg['IO_GROVEMP3_KT403A_PLAY_SONG_SPECIFY_TITLE'] = '[MP3 Module V2.0 ] play the track from directory %1 index %2';
Blockly.Msg['IO_GROVEMP3_KT403A_PLAY_SONG_SPECIFY_TOOLTIP'] = IMG_MODULE_MP3_V2 + Blockly.Tooltip.SEP + 'Allows you to play a track stored on the SD card by specifying the directory index and the track index.';
Blockly.Msg["IO_GROVEMP3_GET_VOLUME_TITLE"] = "[MP3 Module %1] current volume";
Blockly.Msg["IO_GROVEMP3_GET_VOLUME_TOOLTIP"] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + "Returns the current volume level.";
Blockly.Msg["IO_GROVEMP3_SET_VOLUME_TITLE"] = "[MP3 Module %1] set volume %2";
Blockly.Msg["IO_GROVEMP3_SET_VOLUME_TOOLTIP"] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + "Allows you to adjust the sound volume level (0-32).";
Blockly.Msg['IO_GROVEMP3_CHANGE_PLAYING_MODE_TITLE'] = '[MP3 Module %1] change the playing mode to %2';
Blockly.Msg['IO_GROVEMP3_CHANGE_PLAYING_MODE_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Allows you to change the MP3 player\'s mode.';
Blockly.Msg['IO_GROVEMP3_MODE_CYCLE'] = "loop through all tracks";
Blockly.Msg['IO_GROVEMP3_MODE_SINGLE_CYCLE'] = "loop through one track";
Blockly.Msg['IO_GROVEMP3_MODE_DIR_CYCLE'] = "loop through a folder";
Blockly.Msg['IO_GROVEMP3_MODE_RANDOM'] = "in random mode";
Blockly.Msg['IO_GROVEMP3_MODE_SINGLE_SHOT'] = "one track only";
// Input/Output - Pins
...
Blockly.Msg['IO_DETACH_INTERRUPT_TITLE'] = 'disable the event on pin %1';
Blockly.Msg['IO_DETACH_INTERRUPT_TOOLTIP'] = 'Disables the event on pin D2 or D3.';
Blockly.Msg['IO_SETPINMODE_TITLE'] = 'apply mode %1 to pin %2';
Blockly.Msg['IO_SETPINMODE_TOOLTIP'] = 'Apply the (INPUT, OUTPUT, INPUT_PULLUP) mode to a pin.';

// Communication - Common
Blockly.Msg['COMMUNICATION_RX_TX_PINS'] = 'on pins RX %1 TX %2';
Blockly.Msg['COMMUNICATION_THEN'] = 'then';
...
Blockly.Msg["COMMUNICATION_OPENLOG_WRITE_TITLE"] = "[Openlog] write on the SD card baudrate %1";
Blockly.Msg['COMMUNICATION_OPENLOG_WRITE_TITLE_PINS'] = 'on pins RXI %1 TXO %2';
Blockly.Msg['COMMUNICATION_OPENLOG_WRITE_TITLE_DATA'] = 'Datas %1';
...
Blockly.Msg["COMMUNICATION_BLUETOOTH_SETTINGS_TITLE"] = "[Grove BT] set name %1 mode %2 pin code %3";
...
Blockly.Msg["COMMUNICATION_GROVE_BLUETOOTH_SENDDATA_TOOLTIP"] = IMG_MODULE_GROVE_BT + Blockly.Tooltip.SEP + "Enable to send any data by serial bluetooth module on digital pins D0 up through D13.";
Blockly.Msg["COMMUNICATION_GROVE_BLUETOOTH_ONDATARECEIVED_TITLE"] = "[Grove BT] on message %1";
Blockly.Msg["COMMUNICATION_GROVE_BLUETOOTH_ONDATARECEIVED_TOOLTIP"] = IMG_MODULE_GROVE_BT + Blockly.Tooltip.SEP + "Allows you to execute instructions on data received by serial bluetooth module in the 'bluetoothData' variable on digital pins D0 up through D13.";
Blockly.Msg['COMMUNICATION_BLUETOOTH_HELPER_R4'] = '\n.\nConnections: With the Arduino R4 board, RXD connects to TX (D1) and TXD connects to RX (D0). This corresponds to the UART port on the Grove shield.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'] = '\n.\nPlease note: to use this block, the module must be in AT mode. To do this, connect the module\'s KEY pin to the Arduino\'s 3V3 terminal with a Dupont cable, then disconnect and reconnect the Arduino board. AT mode is visible when the LED on the HC05 module flashes approximately every second.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - change parameter %1 to %2';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Allows you to change the HC05 Bluetooth module\'s parameters by sending an AT command. Once the parameter has been changed, it is no longer necessary to return to this mode because it is stored in the module\'s memory.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - parameter value %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Allows you to retrieve the parameter values ​​of the HC05 Bluetooth module by sending an AT command.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TITLE'] = '[HC05 BT] set baudrate to %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Allows you to change the data transmission speed with the HC05 Bluetooth module. By default, the module\'s baudrate is 9600. Remember to first check the baudrate in the HC05 module\'s memory by reading \'AT+UART?\' in AT mode. If necessary, change this setting by sending an AT+UART command to "9600,0,0" for example.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'] = '\n.\nTo switch back to data transmission mode, simply disconnect the KEY pin from the 3V3 terminal. The module will then start flashing rapidly, indicating that it is searching for a pairing.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TITLE'] = '[HC05 BT] send message %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Allows you to send data via the HC05 Bluetooth module on digital pins D0 to D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TITLE'] = '[HC05 BT] if message received in %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HC05_BT + Blockly.Tooltip.SEP + 'Allows you to execute instructions if data is received by an HC05 Bluetooth module on digital pins D0 to D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - change parameter %1 to %2';
...
Blockly.Msg['COMMUNICATION_HM10_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HM10 BT] AT - value of parameter %1';
...
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_SENDDATA_TITLE"] = "[HM10 BT] send message %1";
...
Blockly.Msg["COMMUNICATION_HM10_BLUETOOTH_ONDATARECEIVED_TITLE"] = "[HM10 BT] on message received in %1";
...
Blockly.Msg["COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_TITLE"] = "[NEC remote control - black] if command received is %1 then";
Blockly.Msg["COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_TOOLTIP"] = IMG_MODULE_BASIC_BLACK_REMOTE_IR_RECEIVER + Blockly.Tooltip.SEP + "Allows you to execute instructions on command received by IR transmission. Use IR receiver block to enable IR transmission. The + button allows you to add conditions to the other buttons.";
Blockly.Msg['COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TITLE'] = '[NEC remote control - gray] if received command is %1 then';
Blockly.Msg['COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TOOLTIP'] = IMG_MODULE_CAR_MP3_GRAY_REMOTE_IR_RECEIVER + Blockly.Tooltip.SEP + 'Allows you to execute instructions if one of the commands is received from the NEC remote control via infrared transmission. Use the block with the infrared receiver to perform the transmission. The + button allows you to add conditions to the other buttons.';
...
Blockly.Msg["COMMUNICATION_RFID_GETSTRINGCARDID_TITLE"] = "[RFID reader - 125 kHz] UID card";
Blockly.Msg["COMMUNICATION_RFID_GETSTRINGCARDID_TOOLTIP"] = IMG_MODULE_RFID_125KHZ + Blockly.Tooltip.SEP + "Read the card UID of the Grove RFID module if it's available on digital pins D0 up to D13. In order to verify the UID card and validate it or not, it is enough simply to compare with the frame of type 'String' desired.";
Blockly.Msg["COMMUNICATION_GPS_ONDATARECEIVED_TITLE"] = "[GPS module] on data received in %1";
...
Blockly.Msg['SENSORS_MLX90614_READ_OBJECT_TEMPERATURE_TOOLTIP'] = IMG_MODULE_MLX90614 + Blockly.Tooltip.SEP + 'Returns the temperature of an object in degrees Celsius (°C) or Fahrenheit (°F) using the MLX90614 infrared sensor. Connect the sensor to an I2C port.';
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TITLE'] = '[Heart Rate Sensor] bpm on pin %1';
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TOOLTIP'] = IMG_MODULE_EAR_CLIP + Blockly.Tooltip.SEP + 'Returns the number of beats per minute (bpm) measured by the Grove heart rate sensor.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TAKEMEASURE_TITLE'] = '[Heart Rate & SpO2 Sensor] take measurement';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TAKEMEASURE_TOOLTIP'] = IMG_MODULE_DFROBOT_MAX30102 + Blockly.Tooltip.SEP + 'Initiates the measurement of heart rate and blood oxygen saturation (SpO2) using the DFRobot MAX30102 sensor. Wait for the measurement to complete before retrieving the values.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_GETDATA_TITLE'] = '[Heart Rate & SpO2 Sensor] %1';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_GETDATA_TOOLTIP'] = IMG_MODULE_DFROBOT_MAX30102 + Blockly.Tooltip.SEP + 'Returns the measured value from the DFRobot MAX30102 sensor based on user selection: heart rate (in bpm) or blood oxygen saturation (SpO2 in %).';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_BPM'] = 'heart rate (bpm)';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_SPO2'] = 'blood oxygen saturation (SpO2 %)';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TEMP'] = 'temperature (°C)';
// Sensors - Other
...
Blockly.Msg['ACTUATORS_SPDT_RELAY_CONTROL_STATE_TITLE'] = '[Module %1 SPDT Relay] control relay %2 to state %3';
Blockly.Msg['ACTUATORS_SPDT_RELAY_CONTROL_STATE_TOOLTIP'] = IMG_MODULE_MULTI_CHANNEL_RELAY + Blockly.Tooltip.SEP + 'Allows you to control the relay\'s value (HIGH or LOW). By default, we have set the device connections to "NO", meaning normally open, which means the circuit is broken. If you connect the device to "NC", it will be on by default if the Arduino is disconnected. To drive the module in "NC", use the \'Set Device Connection...\' block. Connect the module to an I2C port.';
Blockly.Msg['ACTUATORS_SPDT_RELAY_DEFINE_NC_NO_TITLE'] = '[Module %1 SPDT Relay] set appliance %2 plugged on %3';
Blockly.Msg['ACTUATORS_SPDT_RELAY_DEFINE_NC_NO_TOOLTIP'] = IMG_MODULE_MULTI_CHANNEL_RELAY + Blockly.Tooltip.SEP + 'Enables control of device connections to relays in "NC" (normally closed) or "NO" (normally open) mode. Connect the module to an I2C port.';
Blockly.Msg['ACTUATORS_RELAY_CHANNEL_NO'] = 'NO (Normally Open)';
Blockly.Msg['ACTUATORS_RELAY_CHANNEL_NC'] = 'NC (Normally Closed)';
...
Blockly.Msg['COMMUNICATION_IR_SEND_NEC_REPEAT'] = 'repetitions';
Blockly.Msg['COMMUNICATION_IR_SENDNECCOMMAND_TITLE'] = '[IR Emitter] send NEC command %1 address %2 on pin %3';
Blockly.Msg['COMMUNICATION_IR_SENDNECCOMMAND_TOOLTIP'] = IMG_MODULE_IR_EMITTER + Blockly.Tooltip.SEP + 'Sends a command with a specified address using the NEC protocol over infrared with the IR Emitter module on the digital pins.';
Blockly.Msg['COMMUNICATION_IR_SENDFRAME_TITLE'] = '[IR Emitter] send frame %1 frequency %2 kHz on pin %3';
Blockly.Msg['COMMUNICATION_IR_SENDFRAME_TOOLTIP'] = IMG_MODULE_IR_EMITTER + Blockly.Tooltip.SEP + 'Sends a frame as an array of integers via infrared with the IR Emitter module on the digital pins.';
Blockly.Msg['COMMUNICATION_IR_GET_PROTOCOL_PARAM_TITLE'] = '[IR Frame] get %1 from infrared data';
Blockly.Msg['COMMUNICATION_IR_GET_PROTOCOL_PARAM_TOOLTIP'] = IMG_MODULE_IR_RECEIVER + Blockly.Tooltip.SEP + 'Gets the command or address from data received using the NEC or Sony SIRC protocol. This block should be used after receiving infrared data with the block \'[IR Receiver] if data received on pin ...\'.';
Blockly.Msg['IR_RECEIVER_CMD'] = 'command ';
Blockly.Msg['IR_RECEIVER_ADDR'] = 'address';
