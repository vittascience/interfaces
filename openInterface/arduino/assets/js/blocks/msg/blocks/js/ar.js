...
Blockly.Msg['IO_GROVEMP3_INIT_TITLE'] = '[وحدة MP3 v3] تهيئة على مدخل RX %1 مخرج TX %2';
Blockly.Msg['IO_GROVEMP3_INIT_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'تهيئة وحدة Grove MP3 v3.0 على مدخل RX/TX';
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TITLE'] = '[وحدة MP3 v3] تشغيل/إيقاف التشغيل';
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'يتيح تشغيل/إيقاف التشغيل';
Blockly.Msg['IO_GROVEMP3_NEXT_TITLE'] = '[وحدة MP3 v3] التنقل إلى المقطوعة التالية';
Blockly.Msg['IO_GROVEMP3_NEXT_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'الانتقال إلى المقطوعة التالية';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TITLE'] = '[وحدة MP3 v3] تشغيل المسار %1';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'يسمح لك بتشغيل مسار عن طريق تقديم اسم الملف.';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TITLE'] = '[وحدة MP3 v3] تشغيل المسار من المجلد %1 الفهرس %2';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'يسمح لك بتشغيل مسار في مجلد معين من خلال تحديد الفهرس الخاص به.';
Blockly.Msg['IO_GROVEMP3_GET_VOLUME_TITLE'] = '[وحدة MP3 v3] مستوى الصوت الحالي';
Blockly.Msg['IO_GROVEMP3_GET_VOLUME_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'يُعيد مستوى الصوت الحالي';
Blockly.Msg['IO_GROVEMP3_SET_VOLUME_TITLE'] = '[وحدة MP3 v3] ضبط مستوى الصوت %1';
Blockly.Msg['IO_GROVEMP3_SET_VOLUME_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'يُضبط مستوى الصوت';
// Input/Output - Pins
