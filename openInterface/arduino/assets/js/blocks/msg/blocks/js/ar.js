...
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_SERIAL_BT + Blockly.Tooltip.SEP + 'Allows you to change the Grove Serial Bluetooth v3 module\'s parameters by sending an AT command. Once the parameter is changed, it is no longer necessary to return to this mode because it is stored in the module\'s memory.';
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[Grove BT] AT - parameter value %1';
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_SERIAL_BT + Blockly.Tooltip.SEP + 'Retrieves the Grove Serial Bluetooth v3 module parameter values ​​by sending an AT command.';
Blockly.Msg["COMMUNICATION_BLUETOOTH_SENDDATA_TITLE"] = "[Bluetooth] send message %1";
...
Blockly.Msg["COMMUNICATION_BLUETOOTH_ONDATARECEIVED_TITLE"] = "[Bluetooth] on message %1";
...
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Allows you to send data via the HC05 Bluetooth module on digital pins D0 to D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TITLE'] = '[HC05 BT] if message received in %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Allows you to execute instructions if data is received by an HC05 Bluetooth module on digital pins D0 to D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
...
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - تغيير الإعداد %3 إلى %4 على دبابيس RX %1 TX %2';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'يتيح تغيير إعدادات وحدة البلوتوث HC05 عبر إرسال أمر AT. بعد تغيير الإعداد، لا حاجة للعودة إلى هذا الوضع لأنه يُحفظ في ذاكرة الوحدة. انتبه، يجب أن تكون الوحدة في وضع AT. للقيام بذلك، وصل دبوس KEY للوحدة إلى منفذ 3V3 في الأردوينو بكابل دوبون، ثم افصل وأعد توصيل لوحة الأردوينو. يكون وضع AT ظاهرًا عندما تومض LED الوحدة HC05 تقريبًا كل ثانية.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - قيمة الإعداد %3 على دبابيس RX %1 TX %2';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'يتيح استرجاع قيمة إعدادات وحدة البلوتوث HC05 عبر إرسال أمر AT. انتبه، يجب أن تكون الوحدة في وضع AT. للقيام بذلك، وصل دبوس KEY للوحدة إلى منفذ 3V3 في الأردوينو بكابل دوبون، ثم افصل وأعد توصيل لوحة الأردوينو. يكون وضع AT ظاهرًا عندما تومض LED الوحدة HC05 تقريبًا كل ثانية.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TITLE'] = '[HC05 BT] تعيين سرعة البود إلى %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'يتيح تغيير سرعة نقل البيانات مع وحدة البلوتوث HC05. بشكل افتراضي، سرعة البود هي 9600. تأكد أولاً من سرعة البود المخزنة في وحدة HC05 عبر قراءة \'AT+UART?\' في وضع AT. إذا لزم الأمر، غيّر هذا الإعداد بإرسال أمر AT+UART إلى "19200,0,0" مثلاً.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TITLE'] = '[HC05 BT] إرسال على دبابيس RX %1 TX %2 الرسالة %3';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'يتيح إرسال بيانات عبر وحدة البلوتوث HC05 على الدبابيس الرقمية D0 إلى D13. للعودة إلى وضع نقل البيانات، فقط افصل دبوس KEY من منفذ 3V3. ستبدأ الوحدة بالوميض بسرعة، مما يعني أنها تبحث عن اقتران.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TITLE'] = '[HC05 BT] إذا استلمت رسالة على دبابيس RX %1 TX %2 في %3 إذن';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'يتيح تنفيذ تعليمات عند استلام بيانات من وحدة البلوتوث HC05 على الدبابيس الرقمية D0 إلى D13. للعودة إلى وضع نقل البيانات، فقط افصل دبوس KEY من منفذ 3V3. ستبدأ الوحدة بالوميض بسرعة، مما يعني أنها تبحث عن اقتران.';
