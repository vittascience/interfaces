/**
 * @fileoverview Arabic messages for Arduino. (AR)
 */
'use strict';
//COMMENT - Arduino
...
Blockly.Msg['DISPLAY_LCD_SETPALETTERGBCOLOR_TITLE'] = '[LCD] illuminate the LCD display in %2';
...
Blockly.Msg['DISPLAY_MY9221_SET_GREEN_TO_RED_TITLE'] = '[وحدة شريط LED] عرض مستوى %1 على المسامير DI %2 DCKI %3';
Blockly.Msg['DISPLAY_MY9221_RED_TO_GREEN'] = 'من الأحمر إلى الأخضر';
Blockly.Msg['DISPLAY_MY9221_GREEN_TO_RED'] = 'من الأخضر إلى الأحمر';
Blockly.Msg['DISPLAY_MY9221_SET_GREEN_TO_RED_TOOLTIP'] = IMG_MODULE_LED_BAR + Blockly.Tooltip.SEP + 'يتيح تغيير اتجاه مصابيح LED في وحدة شريط الرسم البياني Grove (MY9221)، من الأخضر إلى الأحمر أو من الأحمر إلى الأخضر.';
Blockly.Msg['DISPLAY_MY9221_SET_LED_TITLE'] = '[وحدة شريط LED] حالة LED رقم %1 %2 على المسامير DI %3 DCKI %4';
Blockly.Msg['DISPLAY_MY9221_SET_LED_TOOLTIP'] = IMG_MODULE_LED_BAR + Blockly.Tooltip.SEP + 'يتيح التحكم في كل مصباح LED في وحدة شريط الرسم البياني Grove (MY9221) على المسامير D0 إلى D13.';
...
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Allows you to play a track by giving the file name.';
...
Blockly.Msg["IO_GROVEMP3_SET_VOLUME_TOOLTIP"] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + "Sets the volume level.";
...
Blockly.Msg['IO_ATTACH_INTERRUPT_TITLE'] = 'on %1 detected on pin %2';
...
Blockly.Msg["COMMUNICATION_RFID_GETSTRINGCARDID_TITLE"] = "[RFID reader - 125kHz] UID card";
...
Blockly.Msg['SENSORS_SUNLIGHT_GETDATA_TITLE'] = '[Sunlight Sensor SI1145] get %1';
...
Blockly.Msg['SENSORS_GETPULSE_BPM_TITLE'] = '[حساس النبض] نبضات في الدقيقة %1';
Blockly.Msg['SENSORS_GETPULSE_BPM_TOOLTIP'] = IMG_MODULE_PULSE + Blockly.Tooltip.SEP + 'يعيد عدد النبضات في الدقيقة من المدخلات التناظرية A0 إلى A5.';
Blockly.Msg['SENSORS_VOLTAGE_DIVIDER_GETDATA_TITLE'] = '[مقسم الجهد] قسّم الجهد %1 على %2 على الدبوس %3';
...
Blockly.Msg['SENSORS_PRESSURE'] = 'الضغط (Pa)';
Blockly.Msg['SENSORS_ALTITUDE'] = 'الارتفاع (م)';
...
Blockly.Msg['SENSORS_BME280_GETDATA_TITLE'] = '[مستشعر BME280 %1] %2';
Blockly.Msg['SENSORS_BME280_GETDATA_TOOLTIP'] = IMG_MODULE_BME280 + Blockly.Tooltip.SEP + 'يعيد درجة الحرارة المحيطة بالدرجة المئوية (°C) من -40 إلى 85 °C، أو بالفهرنهايت (°F) أو بالكلفن (K)، والرطوبة (٪)، والضغط (بالباسكال) أو الارتفاع (م) باستخدام حساس BME280. وصل الحساس بمنفذ I2C.';
Blockly.Msg['ACTUATORS_SPDT_RELAY_CONTROL_STATE_TITLE'] = '[وحدة %1 مرحّل SPDT] ضبط المرحّل %2 على الحالة %3';
Blockly.Msg['ACTUATORS_SPDT_RELAY_CONTROL_STATE_TOOLTIP'] = IMG_MODULE_MULTI_CHANNEL_RELAY + Blockly.Tooltip.SEP + 'يتيح التحكم في حالة المرحّل (عالي أو منخفض). بشكل افتراضي تم ضبط توصيلات الأجهزة على "NO" (مفتوح عادةً)، وهذا يعني أن الدائرة مقطوعة. إذا وصّلت الجهاز إلى "NC" (مغلق عادةً)، فسيكون قيد التشغيل افتراضياً عندما يكون الأردوينو مفصولاً. للتحكم في الوحدة باستخدام وضع "NC"، استخدم البلوك \'تعيين توصيل الجهاز...\'. وصل الوحدة بمنفذ I2C.';
Blockly.Msg['ACTUATORS_SPDT_RELAY_DEFINE_NC_NO_TITLE'] = '[وحدة %1 مرحّل SPDT] تعيين الجهاز %2 على %3';
Blockly.Msg['ACTUATORS_SPDT_RELAY_DEFINE_NC_NO_TOOLTIP'] = IMG_MODULE_MULTI_CHANNEL_RELAY + Blockly.Tooltip.SEP + 'يتيح تحديد توصيل الأجهزة على المرحلات كـ "NC" (مغلق عادةً) أو "NO" (مفتوح عادةً). وصل الوحدة بمنفذ I2C.';
Blockly.Msg['ACTUATORS_RELAY_CHANNEL_NO'] = 'NO (مفتوح عادةً)';
Blockly.Msg['ACTUATORS_RELAY_CHANNEL_NC'] = 'NC (مغلق عادةً)';
Blockly.Msg['IO_GROVEMP3_KT403A_PLAY_SONG_SPECIFY_TITLE'] = '[Module MP3 V2.0 ] تشغيل المقطع من المجلد %1 الفهرس %2';
Blockly.Msg['IO_GROVEMP3_KT403A_PLAY_SONG_SPECIFY_TOOLTIP'] = IMG_MODULE_MP3_V2 + Blockly.Tooltip.SEP + 'يتيح تشغيل مقطع مخزّن على بطاقة SD بتحديد فهرس المجلد وفهرس المقطع.';
Blockly.Msg['IO_DETACH_INTERRUPT_TITLE'] = 'تعطيل الحدث على الدبوس %1';
Blockly.Msg['IO_DETACH_INTERRUPT_TOOLTIP'] = 'يتيح تعطيل الحدث على الدبوس D2 أو D3.';
Blockly.Msg['IO_SETPINMODE_TITLE'] = 'تطبيق الوضع %1 على الدبوس %2';
Blockly.Msg['IO_SETPINMODE_TOOLTIP'] = 'يتيح تطبيق الوضع (INPUT, OUTPUT, INPUT_PULLUP) على دبوس.';
Blockly.Msg['COMMUNICATION_SERIAL_WRITE_NUMBER_TITLE'] = 'طباعة العدد على المنفذ التسلسلي %1 بالصيغة %2';
Blockly.Msg['COMMUNICATION_SERIAL_WRITE_NUMBER_TOOLTIP'] = 'يتيح عرض عدد في المنفذ التسلسلي بالصيغة المختارة (HEX: سداسي عشري، DEC: عشري). ملاحظة: لا يمكن عرض الأعداد العشرية بصيغة HEX.';
Blockly.Msg['COMMUNICATION_IR_SEND_NEC_REPEAT'] = 'تكرارات';
Blockly.Msg['COMMUNICATION_IR_SENDNECCOMMAND_TITLE'] = '[مرسل IR] إرسال الأمر NEC %1 العنوان %2 على الدبوس %3';
Blockly.Msg['COMMUNICATION_IR_SENDNECCOMMAND_TOOLTIP'] = IMG_MODULE_IR_EMITTER + Blockly.Tooltip.SEP + 'يتيح إرسال أمر بعنوان محدد وفق بروتوكول NEC عبر الأشعة تحت الحمراء باستخدام وحدة الإرسال IR على المخارج الرقمية.';
Blockly.Msg['COMMUNICATION_IR_SENDFRAME_TITLE'] = '[مرسل IR] إرسال الإطار %1 بتردد %2 kHz على الدبوس %3';
Blockly.Msg['COMMUNICATION_IR_SENDFRAME_TOOLTIP'] = IMG_MODULE_IR_EMITTER + Blockly.Tooltip.SEP + 'يتيح إرسال إطار على شكل مصفوفة أعداد صحيحة عبر الأشعة تحت الحمراء باستخدام وحدة الإرسال IR على المخارج الرقمية.';
Blockly.Msg['COMMUNICATION_IR_GET_PROTOCOL_PARAM_TITLE'] = '[إطار IR] الحصول على %1 من بيانات الأشعة تحت الحمراء';
Blockly.Msg['COMMUNICATION_IR_GET_PROTOCOL_PARAM_TOOLTIP'] = IMG_MODULE_IR_RECEIVER + Blockly.Tooltip.SEP + 'يتيح الحصول على الأمر أو العنوان من البيانات المستقبلة وفق بروتوكول NEC أو Sony SIRC. يجب استخدام هذا البلوك بعد استقبال بيانات الأشعة تحت الحمراء مع البلوك \'[مستقبل IR] إذا تم استقبال بيانات على الدبوس ...\'.';
Blockly.Msg['IR_RECEIVER_CMD'] = 'الأمر ';
Blockly.Msg['IR_RECEIVER_ADDR'] = 'العنوان';
Blockly.Msg['COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TITLE'] = '[جهاز تحكم عن بعد NEC - رمادي] إذا تم استلام الأمر %1 إذًا';
Blockly.Msg['COMMUNICATION_REMOTECONTROL_ONCOMMANDRECEIVED_CAR_MP3_GRAY_TOOLTIP'] = IMG_MODULE_CAR_MP3_GRAY_REMOTE_IR_RECEIVER + Blockly.Tooltip.SEP + 'يتيح تنفيذ تعليمات عند استقبال أحد الأوامر من جهاز تحكم NEC عبر الأشعة تحت الحمراء. استخدم هذا البلوك مع مستقبل الأشعة تحت الحمراء لتشغيل الاستقبال. زر + يسمح بإضافة شروط لأزرار أخرى.';
Blockly.Msg['SENSORS_MLX90614_READ_OBJECT_TEMPERATURE_TITLE'] = '[مستشعر حرارة IR] درجة الحرارة %1';
Blockly.Msg['SENSORS_MLX90614_READ_OBJECT_TEMPERATURE_TOOLTIP'] = IMG_MODULE_MLX90614 + Blockly.Tooltip.SEP + 'يعيد درجة حرارة جسم بالدرجة المئوية (°C) أو بالفهرنهايت (°F) باستخدام مستشعر الأشعة تحت الحمراء MLX90614. وصل المستشعر بمنفذ I2C.';
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TITLE'] = '[مستشعر معدل ضربات القلب] نبضات في الدقيقة (bpm) على الدبوس %1';
Blockly.Msg['SENSORS_GET_EAR_CLIP_HEART_RATE_TOOLTIP'] = IMG_MODULE_EAR_CLIP + Blockly.Tooltip.SEP + 'يعيد عدد الضربات في الدقيقة (bpm) باستخدام مستشعر القلب من نوع Grove.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TAKEMEASURE_TITLE'] = '[مستشعر النبض وتشبع الأكسجين] إجراء قياس';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TAKEMEASURE_TOOLTIP'] = IMG_MODULE_DFROBOT_MAX30102 + Blockly.Tooltip.SEP + 'يجري قياسًا لمعدل ضربات القلب ومستوى الأكسجين في الدم باستخدام مستشعر MAX30102 من DFRobot. وصل المستشعر بمنفذ I2C.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_GETDATA_TITLE'] = '[مستشعر النبض وتشبع الأكسجين] %1';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_GETDATA_TOOLTIP'] = IMG_MODULE_DFROBOT_MAX30102 + Blockly.Tooltip.SEP + 'يعيد معدل ضربات القلب (bpm) أو مستوى تشبع الأكسجين في الدم (%) المقاس بواسطة مستشعر MAX30102 من DFRobot. وصل المستشعر بمنفذ I2C.';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_BPM'] = 'معدل ضربات القلب (bpm)';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_SPO2'] = 'نسبة تشبع الأكسجين في الدم (%)';
Blockly.Msg['SENSORS_DFROBOT_MAX30102_TEMP'] = 'درجة الحرارة (°C)';
...
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_FACE_RECOGNITION'] = 'كشف الوجوه';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_TRACKING'] = 'تتبع الأجسام';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_RECOGNITION'] = 'كشف الأجسام';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_LINE_TRACKING'] = 'تتبع الخط';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_COLOR_RECOGNITION'] = 'كشف اللون';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_TAG_RECOGNITION'] = 'كشف AprilTag';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_MODE_OBJECT_CLASSIFICATION'] = 'تصنيف الأجسام';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_TEXT_TITLE'] = '[HuskyLens] عرض النص %1 في الموضع (%2,%3)';
Blockly.Msg['CAMERAS_HUSKYLENS_SET_TEXT_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يعرض نصًا عند الموضع (x,y) على شاشة كاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_CLEAR_SCREEN_TITLE'] = '[HuskyLens] مسح الشاشة';
Blockly.Msg['CAMERAS_HUSKYLENS_CLEAR_SCREEN_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يمسح كل النص المعروض على شاشة كاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_LEARN_ID_TITLE'] = '[HuskyLens] تعلّم المعرّف رقم %1 تلقائيًا';
Blockly.Msg['CAMERAS_HUSKYLENS_LEARN_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يتيح تعلم التعرف تلقائيًا على معرّف باستخدام كاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_FORGET_IDS_TITLE'] = '[HuskyLens] مسح كل المعرّفات';
Blockly.Msg['CAMERAS_HUSKYLENS_FORGET_IDS_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يمسح كل المعرّفات المسجلة في كاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_TITLE'] = '[HuskyLens] استرجاع البيانات %1';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يتيح الحصول على البيانات التي ترجعها كاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS'] = 'كتل';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS'] = 'أسهم';
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TITLE'] = '[HuskyLens] ربط الاسم %1 بالمعرّف رقم %2';
Blockly.Msg['CAMERAS_HUSKYLENS_CUSTOM_NAME_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يتيح ربط اسم بمعرّف مسجل مسبقًا (وضع كشف الوجوه).';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TITLE'] = '[HuskyLens] الحصول على %1 من الكتل المكتشفة';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يتيح الحصول على معلومات الكشف من كاميرا HuskyLens. كل عنصر معرف يخزن في مصفوفة بالشكل [x1, y1, العرض, الارتفاع, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ID'] = 'المعرفات';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X'] = 'إحداثيات X';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y'] = 'إحداثيات Y';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X1'] = 'إحداثيات X (الأصل)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y1'] = 'إحداثيات Y (الأصل)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_X2'] = 'إحداثيات X (النهاية)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_Y2'] = 'إحداثيات Y (النهاية)';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_WIDTH'] = 'العروض';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_HEIGHT'] = 'الارتفاعات';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ALL'] = 'كل البيانات';
...
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_XY_TITLE'] = '[HuskyLens] الحصول على %1 للكتلة المكتشفة';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_BLOCKS_XY_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يتيح الحصول على الإحداثيات X أو Y للكتلة المكتشفة بواسطة كاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TITLE'] = '[HuskyLens] الحصول على %1 من الأسهم المكتشفة';
Blockly.Msg['CAMERAS_HUSKYLENS_REQUEST_ARROWS_DATA_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يتيح الحصول على معلومات الكشف من كاميرا HuskyLens. كل عنصر معرف يُخزّن في مصفوفة بالشكل [x1, y1, x2, y2, id].';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_DATA_BY_ID_TITLE'] = '[HuskyLens] مصفوفة بيانات %1 للمعرّف رقم %2';
...
Blockly.Msg['CAMERAS_HUSKYLENS_CHECK_ID_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يعيد صحيحًا أو خطأً إذا كان المعرف مكتشفًا بواسطة كاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_GET_LINE_DIRECTION_TITLE'] = '[HuskyLens] إذا كان الخط ذو المعرف رقم %1 %2';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_STRAIGHT'] = 'مستقيمة';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_LEFT'] = 'تتجه لليسار';
Blockly.Msg['CAMERAS_HUSKYLENS_LINE_RIGHT'] = 'تتجه لليمين';
...
Blockly.Msg['CAMERAS_HUSKYLENS_SAVE_MODEL_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يحفظ النموذج على بطاقة SD الخاصة بكاميرا HuskyLens.';
Blockly.Msg['CAMERAS_HUSKYLENS_LOAD_MODEL_TITLE'] = '[HuskyLens] تحميل النموذج رقم %1';
Blockly.Msg['CAMERAS_HUSKYLENS_LOAD_MODEL_TOOLTIP'] = IMG_HUSKYLENS + Blockly.Tooltip.SEP + 'يحمل النموذج من بطاقة SD الخاصة بكاميرا HuskyLens.';
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_ATBAUD_HELPER'] = '\n.\nلتغيير معدل البود، استخدم الرقم المقابل في الجدول التالي. بعد إرسال الأمر، أعد تشغيل لوحة الأردوينو بالضغط على زر Reset لتطبيق معدل البود الجديد.\n';
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORRUN_TITLE"] = "[TB6612FNG Driver] تحكم بمحرك DC على القناة %1 السرعة %2 والاتجاه %3";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORRUN_TOOLTIP"] = "يتيح التحكم بمحرك DC المتصل على القناة A أو B من مشغّل TB6612FNG.";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORBRAKE_TITLE"] = "[TB6612FNG Motor Driver] إيقاف محرك DC على القناة %1";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_DCMOTORBRAKE_TOOLTIP"] = "يتيح فرملة محرك DC المتصل على القناة A أو B من مشغّل TB6612FNG.";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERRUN_TITLE"] = "[TB6612FNG Motor Driver] محرك خطوة وضع %1 خطوات %2 سرعة %3 (دورة/دقيقة)";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERRUN_TOOLTIP"] = "يتيح التحكم بمحرك خطوة عبر مشغّل TB6612FNG بتعيين الوضع وعدد الخطوات والسرعة (دورة/دقيقة).";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERSTOP_TITLE"] = "[TB6612FNG Motor Driver] إيقاف محرك الخطوة";
Blockly.Msg["ACTUATORS_TB6612FNG_MOTOR_DRIVER_STEPPERSTOP_TOOLTIP"] = "يتيح إيقاف محرك الخطوة المشغّل بواسطة TB6612FNG.";
