/**
 * @fileoverview Italian messages for Arduino UNO R4. (IT)
 */
'use strict';
//COMMENT - Arduino
...
Blockly.Msg['IO_GET_REVERSED_BUTTON_TOOLTIP'] = 'Restituisce il valore del pulsante (0 o 1) sui pin digitali da D0 a D13. I pulsanti NC (Normalmente Chiusi) lasciano passare la corrente quando sono a riposo.';
...
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TITLE'] = '[Modulo MP3 %1] impostare play/pausa';
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TOOLTIP'] = IMG_MODULE_MP3_V3 + Blockly.Tooltip.SEP + 'Imposta lo stato di play/pausa';
...
Blockly.Msg['COMMUNICATION_BLUETOOTH_SETTINGS_TITLE'] = "[Bluetooth] imposta nome %1 modalità %2 codice pin %3";
Blockly.Msg['COMMUNICATION_BLUETOOTH_SETTINGS_TOOLTIP'] = IMG_MODULE_SERIAL_BT + Blockly.Tooltip.SEP + "Abilita l'impostazione di 3 parametri (nome, modalità 'S' per slave o 'M' per master e codice pin) del modulo Bluetooth seriale.";
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[Grove BT] AT - modifica il parametro %1 in %2';
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_SERIAL_BT + Blockly.Tooltip.SEP + 'Consente di modificare i parametri del modulo Grove Serial Bluetooth v3 inviando un comando AT. Una volta modificato il parametro, non è più necessario tornare a questa modalità perché viene memorizzato nella memoria del modulo.';
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[Grove BT] AT - valore del parametro %1';
Blockly.Msg['COMMUNICATION_GROVE_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_SERIAL_BT + Blockly.Tooltip.SEP + 'Recupera i valori dei parametri del modulo Grove Serial Bluetooth v3 inviando un comando AT.';
Blockly.Msg['COMMUNICATION_BLUETOOTH_SENDDATA_TITLE'] = "[Bluetooth] invia messaggio %1";
Blockly.Msg['COMMUNICATION_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_SERIAL_BT + Blockly.Tooltip.SEP + "Abilita l'invio di dati tramite modulo Bluetooth seriale sui pin digitali da D0 a D13.";
Blockly.Msg['COMMUNICATION_BLUETOOTH_ONDATARECEIVED_TITLE'] = "[Bluetooth] sul messaggio %1";
Blockly.Msg['COMMUNICATION_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_SERIAL_BT + Blockly.Tooltip.SEP + "Consente di eseguire istruzioni sui dati ricevuti dal modulo Bluetooth seriale nella variabile 'bluetoothData' sui pin digitali da D0 a D13.";
...
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di modificare i parametri del modulo Bluetooth HC05 inviando un comando AT. Una volta modificato il parametro, non è più necessario tornare a questa modalità perché è memorizzato nella memoria del modulo.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - valore parametro %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di recuperare i valori dei parametri del modulo Bluetooth HC05 inviando un comando AT.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_KEY_HELPER'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TITLE'] = '[HC05 BT] imposta la velocità in baud a %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di modificare la velocità di trasmissione dati con il modulo Bluetooth HC05. Per impostazione predefinita, il baudrate del modulo è 9600. Ricordarsi di controllare prima il baudrate nella memoria del modulo HC05 leggendo \'AT+UART?\' in modalità AT. Se necessario, modificare questa impostazione inviando un comando AT+UART a "9600,0,0", ad esempio.';
...
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di inviare dati tramite il modulo Bluetooth HC05 sui pin digitali da D0 a D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TITLE'] = '[HC05 BT] se il messaggio è stato ricevuto in %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di eseguire istruzioni se i dati vengono ricevuti da un modulo Bluetooth HC05 sui pin digitali da D0 a D13.' + Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_TRANSMISSION_MODE'];
...
Blockly.Msg['COMMUNICATION_RFID_GETSTRINGCARDID_TITLE'] = '[RFID reader] UID card';
...
Blockly.Msg['SENSORS_GETPULSE_BPM_TITLE'] = '[Sensore di polso] battiti al minuto %1';
...
Blockly.Msg['SENSORS_VOLTAGE_DIVIDER_GETDATA_TITLE'] = '[Divisore di tensione] dividi la tensione %1 per %2 sul pin %3';
...
// IA Sensores
Blockly.Msg['VITTAIA_LOAD_LOCAL_MODEL_TITLE'] = 'carica modello locale';
Blockly.Msg['VITTAIA_LOAD_LOCAL_MODEL_TOOLTIP'] = 'Permette di caricare un modello IA memorizzato localmente dal browser web.';
Blockly.Msg['VITTAIA_LOAD_CLOUD_MODEL_TITLE'] = 'caricare il modello dall\'URL %1';
Blockly.Msg['VITTAIA_LOAD_CLOUD_MODEL_TOOLTIP'] = 'Consente di caricare un modello IA memorizzato nel cloud.';
Blockly.Msg['VITTAIA_MAKE_PREDICTION_TITLE'] = 'Predizione dai dati dei sensori';
Blockly.Msg['VITTAIA_MAKE_PREDICTION_TIME_WINDOW'] = 'finestra';
Blockly.Msg['VITTAIA_MAKE_PREDICTION_TOOLTIP'] = 'Consente di eseguire una previsione da un sensore. Regolare la finestra temporale se necessario.';
Blockly.Msg['VITTAIA_SENSOR_ACC'] = 'accelerometro';
Blockly.Msg['VITTAIA_DETECT_CLASS_TITLE'] = 'se la classe %1 %2 è rilevata allora';
...
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - cambia il parametro %3 in %4 sui pin RX %1 TX %2';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di modificare i parametri del modulo bluetooth HC05 inviando un comando AT. Una volta cambiato il parametro, non è più necessario tornare in questa modalità perché viene memorizzato nel modulo. Attenzione, il modulo deve essere in modalità AT. Per attivarla, collega il pin KEY del modulo al 3V3 di Arduino con un cavo dupont, poi scollega e ricollega la scheda Arduino. La modalità AT è indicata dal lampeggio del LED circa ogni secondo sul modulo HC05.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TITLE'] = '[HC05 BT] AT - valore del parametro %3 sui pin RX %1 TX %2';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_GET_AT_COMMAND_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di leggere il valore dei parametri del modulo bluetooth HC05 inviando un comando AT. Attenzione, il modulo deve essere in modalità AT. Per attivarla, collega il pin KEY del modulo al 3V3 di Arduino con un cavo dupont, poi scollega e ricollega la scheda Arduino. La modalità AT è indicata dal lampeggio del LED circa ogni secondo sul modulo HC05.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TITLE'] = '[HC05 BT] imposta il baudrate a %1';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_CHANGEBAUDRATE_TOOLTIP'] = IMG_MODULE_HC05 + Blockly.Tooltip.SEP + 'Consente di cambiare la velocità di trasmissione dati del modulo bluetooth HC05. Di default, il baudrate è 9600. Verifica prima il baudrate memorizzato nel modulo HC05 leggendo \'AT+UART?\' in modalità AT. Se necessario, modifica questo parametro inviando un comando AT+UART, ad esempio "19200,0,0".';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TITLE'] = '[HC05 BT] invia sul pin RX %1 TX %2 il messaggio %3';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_SENDDATA_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Consente di inviare dati tramite il modulo bluetooth HC05 sui pin digitali D0 a D13. Per tornare alla modalità trasmissione dati, scollega semplicemente il pin KEY dal 3V3. Il modulo inizierà a lampeggiare rapidamente, segnalando che sta cercando un accoppiamento.';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TITLE'] = '[HC05 BT] se ricevi un messaggio sui pin RX %1 TX %2 in %3 allora';
Blockly.Msg['COMMUNICATION_HC05_BLUETOOTH_ONDATARECEIVED_TOOLTIP'] = IMG_MODULE_HM10_BT + Blockly.Tooltip.SEP + 'Consente di eseguire istruzioni quando un dato viene ricevuto da un modulo bluetooth HC05 sui pin digitali D0 a D13. Per tornare alla modalità trasmissione dati, scollega semplicemente il pin KEY dal 3V3. Il modulo inizierà a lampeggiare rapidamente, segnalando che sta cercando un accoppiamento.';
Blockly.Msg['COMMUNICATION_OPENLOG_WRITE_TITLE_PINS'] = 'Blockly.Msg[\'COMMUNICATION_OPENLOG_WRITE_TITLE_PINS\'] = \'sui pin RXI %1 TXO %2\';';
