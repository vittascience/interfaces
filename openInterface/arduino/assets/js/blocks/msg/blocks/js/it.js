...
Blockly.Msg['IO_GROVEMP3_INIT_TITLE'] = '[Modulo MP3 v3] inizializza su pin RX %1 TX %2';
Blockly.Msg['IO_GROVEMP3_INIT_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'Inizializza il modulo Grove MP3 v3.0 sui pin RX/TX';
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TITLE'] = '[Modulo MP3 v3] impostare play/pausa';
Blockly.Msg['IO_GROVEMP3_PLAY_PAUSE_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'Imposta lo stato di play/pausa';
Blockly.Msg['IO_GROVEMP3_NEXT_TITLE'] = '[Modulo MP3 v3] passa al brano successivo';
Blockly.Msg['IO_GROVEMP3_NEXT_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'Passa al brano successivo';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TITLE'] = '[Modulo MP3 v3] riproduci traccia %1';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_SONG_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'Ti consente di riprodurre una traccia fornendo il nome del file.';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TITLE'] = '[Modulo MP3 v3] riproduci traccia dalla cartella %1 indice %2';
Blockly.Msg['IO_GROVEMP3_PLAY_SD_DIRECTORY_SONG_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'Ti consente di riprodurre una traccia in una cartella specificandone l\'indice.';
Blockly.Msg['IO_GROVEMP3_GET_VOLUME_TITLE'] = '[Modulo MP3 v3] volume corrente';
Blockly.Msg['IO_GROVEMP3_GET_VOLUME_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'Restituisce il livello di volume corrente';
Blockly.Msg['IO_GROVEMP3_SET_VOLUME_TITLE'] = '[Modulo MP3 v3] imposta volume %1';
Blockly.Msg['IO_GROVEMP3_SET_VOLUME_TOOLTIP'] = IMG_MODULE_MP3 + Blockly.Tooltip.SEP + 'Imposta il livello di volume';
// Input/Output - Pins
