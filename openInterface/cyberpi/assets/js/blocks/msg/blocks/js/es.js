...
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TITLE'] = '[mBot2] %1 de %2 %3 velocidad %4 (RPM)';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_CM'] = 'cm';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_INCHS'] = 'pulgadas';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Permite que mBot2 avance o retroceda cierta distancia (en cm o pulgadas) a velocidad (de 0 a 207 RPM).';
Blockly.Msg['ROBOTS_MBOT2_TURN_TITLE'] = '[mBot2] gira %1 de %2 (°) velocidad %3 (RPM)';
Blockly.Msg['ROBOTS_MBOT2_TURN_RIGHT'] = 'derecha';
Blockly.Msg['ROBOTS_MBOT2_TURN_LEFT'] = 'izquierda';
Blockly.Msg['ROBOTS_MBOT2_TURN_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Le permite girar a la izquierda o a la derecha en un cierto ángulo (en °) a velocidad (de 0 a 207 RPM) con el robot mBot2.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_MODE_GREEN'] = 'verde'; Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_MODE_CYAN'] = 'cian';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_MODE_BLUE'] = 'azul';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_MODE_PURPLE'] = 'morado';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_MODE_BLACK'] = 'negro';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_MODE_CUSTOM'] = 'predefinido';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DETECTION_IS_TITLE'] = '[Sensor RGB cuádruple. %1] estado de detección es %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DETECTION_IS_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Devuelve \'Verdadero\' si el estado de detección de los 4 sensores bajo el robot (L2, L1, R1, R2) está marcado; devuelve \'Falso\' en caso contrario. El valor 1 corresponde al fondo (generalmente blanco) y 0 a la línea (generalmente negra). Es posible conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado para el robot mBot2 es 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TITLE'] = '[Sensor RGB cuádruple. %1] estados de detección';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Devuelve el estado de los 4 sensores bajo el robot (L2, L1, R1, R2) de 0 a 15. El valor 1 corresponde al fondo (generalmente blanco) y 0 a la línea (generalmente negra). Se pueden conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado para el robot mBot2 es 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TITLE'] = '[Sensor RGB cuádruple. %1] La sonda %2 detecta %3';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Devuelve \'Verdadero\' si la sonda seleccionada (L2, L1, R1, R2) detecta la línea o el color seleccionado; de lo contrario, \'Falso\'. Se pueden conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado para el robot mBot2 es 1.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_R'] = 'nivel de rojo';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_G'] = 'nivel de verde';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_B'] = 'nivel de azul';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_GRAY_LEVEL'] = 'nivel de gris';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_LIGHT'] = 'intensidad de la luz';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_OFFSET_TRACK_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Devuelve la desviación del robot respecto a la línea de -100 a 100 mm. Un valor negativo indica una desviación hacia la izquierda. Por el contrario, un valor positivo indica una desviación hacia la derecha. Se pueden conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado del robot mBot2 es 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DEFINE_COLOR_TITLE'] = '[Sensor RGB cuádruple %1] establece el color en %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DEFINE_COLOR_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Permite configurar el color de las luces del sensor RGB cuádruple en rojo, verde o azul. Se pueden conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado del robot mBot2 es 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_SET_COLOR_LIST_TITLE'] = 'El [sensor RGB cuádruple %1] controla los LED en %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_SET_COLOR_LIST_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Permite configurar el color de las luces del sensor RGB cuádruple eligiendo un color de la lista. Se pueden conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado para el robot mBot2 es 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_CLOSE_LED_TITLE'] = 'El [sensor RGB cuádruple %1] apaga los LED';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_CLOSE_LED_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Apaga los LED del sensor RGB cuádruple. Se pueden conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado para el robot mBot2 es 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TITLE'] = '[Sensor RGB cuádruple %1] Luz bajo la sonda %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Permite recuperar el brillo (de 0 a 100%) del sensor RGB cuádruple bajo la sonda seleccionada [L2, L1, R1, R2]. Se pueden conectar hasta 8 sensores RGB cuádruples en paralelo. Utilice el parámetro (1-8) para seleccionar el sensor. El sensor predeterminado para el robot mBot2 es 1.';
// Red - Wi-Fi
...
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TITLE'] = '[Pantalla] borrar la pantalla';
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TOOLTIP'] = 'Permite borrar la pantalla de la placa CyberPi.';
