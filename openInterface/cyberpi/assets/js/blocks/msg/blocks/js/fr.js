...
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TITLE'] = '[Ecran] effacer l\'écran';
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TOOLTIP'] = 'Permet d\'effacer l\'écran de la carte CyberPi.';
// Display - Linechart
...
Blockly.Msg['IO_WRITEPWMPIN_TOOLTIP'] = 'Permet d\'appliquer un signal PWM avec une fréquence fixée à 5kHz et en changeant le cycle de 0 à 1023. La valeur 512 correspondra à 50% du cycle, donc environ 1.66V.';
...
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TITLE'] = '[mBot2] %1 de %2 %3 vitesse %4 (tr/min)';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_CM'] = 'cm';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_INCHS'] = 'pouce.s';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Permet d\'avancer ou de reculer d\'une certaine distance (en cm ou en pouce) à la vitesse désirée (de 0 à 207 tr/min) avec le robot mBot2.';
Blockly.Msg['ROBOTS_MBOT2_TURN_TITLE'] = '[mBot2] pivoter vers la %1 de %2 (°) vitesse %3 (tr/min)';
Blockly.Msg['ROBOTS_MBOT2_TURN_RIGHT'] = 'droite';
Blockly.Msg['ROBOTS_MBOT2_TURN_LEFT'] = 'gauche';
Blockly.Msg['ROBOTS_MBOT2_TURN_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Permet de pivoter à gauche ou à droite d\'un certain angle (en °) à la vitesse désirée (de 0 à 207 tr/min) avec le robot mBot2.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DETECTION_IS_TITLE'] = '[Capteur RGB quad. %1] états de détection est %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DETECTION_IS_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Retournes \'True\' si l\'état de détection des 4 capteurs sous le robot (L2, L1, R1, R2) est vérifié, retourne \'False\' sinon. La valeur 1 correspond à l\'arrière-plan (souvent blanc) et 0 correspond à la ligne (souvent noire).\nIl est possible de brancher en parallèle jusqu\'à 8 capteurs RGB quadruple. Utiliser le paramètre (1-8) pour sélectionner le capteur. Le capteur par défaut du robot mBot2 est le 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TITLE'] = '[Capteur RGB quad. %1] états de détection';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Retournes l\'état des 4 capteurs sous le robot (L2, L1, R1, R2) de 0 à 15. La valeur 1 correspond à l\'arrière-plan (souvent blanc) et 0 correspond à la ligne (souvent noire). \nIl est possible de brancher en parallèle jusqu\'à 8 capteurs RGB quadruple. utiliser le paramètre (1-8) pour sélectionner le capteur. Le capteur par défaut du robot mBot2 est le 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TITLE'] = '[Capteur RGB quad. %1] la sonde %2 détecte %3';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Retournes \'True\' si la sonde choisie (L2, L1, R1, R2]) détecte la ligne ou la couleur sélectionnée, sinon \'False\'.\nIl est possible de brancher en parallèle jusqu\'à 8 capteurs RGB quadruple. Utiliser le paramètre (1-8) pour sélectionner le capteur. Le capteur par défaut du robot mBot2 est le 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_PROBE_DATA_TITLE'] = '[Capteur RGB quad. %1] %2 mesuré.e avec la sonde %3';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_PROBE_DATA_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Retournes \'True\' si la sonde choisie (L2, L1, R1, R2) détecte la ligne ou la couleur sélectionnée, sinon \'False\'.\nIl est possible de brancher en parallèle jusqu\'à 8 capteurs RGB quadruple. Utiliser le paramètre (1-8) pour sélectionner le capteur. Le capteur par défaut du robot mBot2 est le 1.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_COLOR_HEX'] = 'couleur (hex)';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TITLE'] = '[Capteur RGB quad. %1] luminosité sous la sonde %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Permet de récupérer la luminosité (de 0 à 100 %) du capteur RGB quadruple sous la sonde choisie [L2, L1, R1, R2]. \n\nIl est possible de brancher en parallèle jusqu\'à 8 capteurs RGB quadruple. Utiliser le paramètre (1-8) pour sélectionner le capteur. Le capteur par défaut du robot mBot2 est le 1.';
// Network - WiFi
