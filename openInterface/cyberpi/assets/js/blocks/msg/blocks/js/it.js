...
Blockly.Msg['IO_WRITEPWMPIN_TOOLTIP'] = 'Abilita l\'applicazione del segnale PWM con frequenza fissa di 5kHz. Puoi cambiare il valore da 0 a 1023. 512 sarà il 50% del duty cycle, circa 1.66V.';
...
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TITLE'] = '[mBot2] %1 di %2 %3 velocità %4 (RPM)';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_CM'] = 'cm';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_INCHS'] = 'pollici';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Consente a mBot2 di spostarsi avanti o indietro di una certa distanza (in cm o pollici) a velocità (da 0 a 207 giri/min).';
Blockly.Msg['ROBOTS_MBOT2_TURN_TITLE'] = '[mBot2] gira %1 di %2 (°) velocità %3 (RPM)';
Blockly.Msg['ROBOTS_MBOT2_TURN_RIGHT'] = 'destra';
Blockly.Msg['ROBOTS_MBOT2_TURN_LEFT'] = 'sinistra';
Blockly.Msg['ROBOTS_MBOT2_TURN_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Ti permette di girare a sinistra oa destra di un certo angolo (in °) a velocità (da 0 a 207 giri/min) con il robot mBot2.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DETECTION_IS_TITLE'] = '[Sensore RGB Quad. %1] lo stato di rilevamento è %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DETECTION_IS_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Restituisce \'True\' se lo stato di rilevamento dei 4 sensori sotto il robot (L2, L1, R1, R2) è verificato, altrimenti restituisce \'False\'. Il valore 1 corrisponde allo sfondo (spesso bianco) e 0 corrisponde alla linea (spesso nera). È possibile collegare fino a 8 sensori RGB quadrupli in parallelo. Utilizzare il parametro (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TITLE'] = '[Sensore RGB quadruplo. %1] stati di rilevamento';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Restituisce lo stato dei 4 sensori sotto il robot (L2, L1, R1, R2) da 0 a 15. Il valore 1 corrisponde allo sfondo (spesso bianco) e 0 corrisponde alla linea (spesso nera). È possibile collegare in parallelo fino a 8 sensori RGB quadrupli. Utilizzare il parametro (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TITLE'] = '[Sensore RGB quadruplo. %1] La sonda %2 rileva %3';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Restituisce \'True\' se la sonda selezionata (L2, L1, R1, R2) rileva la linea o il colore selezionato, altrimenti \'False\'. È possibile collegare in parallelo fino a 8 sensori RGB quad. Utilizzare i parametri (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_PROBE_DATA_TITLE'] = '[Sensore RGB quad %1] %2 misurato con la sonda %3';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_PROBE_DATA_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Restituisce \'True\' se la sonda scelta (L2, L1, R1, R2) rileva la linea o il colore selezionato, altrimenti \'False\'. È possibile collegare in parallelo fino a 8 sensori RGB quad. Utilizzare il parametro (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_GRAY_LEVEL'] = 'livello grigio';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_LIGHT'] = 'intensità luminosa';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_COLOR'] = 'colore';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DATA_COLOR_HEX'] = 'colore (esadecimale)';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_OFFSET_TRACK_TITLE'] = '[Sensore quad RGB. %1] deviazione dalla linea';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_OFFSET_TRACK_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Restituisce la deviazione del robot dalla linea da -100 a 100 mm. Un valore negativo indica una deviazione verso sinistra. Al contrario, un valore positivo indica una deviazione verso destra. È possibile collegare in parallelo fino a 8 sensori quad RGB. Utilizzare i parametri (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DEFINE_COLOR_TITLE'] = '[Sensore RGB quadruplo %1] imposta il colore su %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DEFINE_COLOR_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Consente di impostare il colore delle luci del sensore RGB quadruplo su rosso, verde o blu. È possibile collegare in parallelo fino a 8 sensori RGB quadrupli. Utilizzare i parametri (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_SET_COLOR_LIST_TITLE'] = '[Il sensore RGB quadruplo %1] controlla i LED a %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_SET_COLOR_LIST_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Consente di impostare il colore delle luci del sensore RGB quadruplo scegliendo un colore dall\'elenco. È possibile collegare in parallelo fino a 8 sensori RGB quadrupli. Utilizzare i parametri (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_CLOSE_LED_TITLE'] = '[Sensore RGB quadruplo %1] Spegni i LED';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_CLOSE_LED_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Spegne i LED del sensore RGB quadruplo. È possibile collegare in parallelo fino a 8 sensori RGB quadrupli. Utilizzare i parametri (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TITLE'] = '[Sensore RGB quadruplo %1] Luce sotto la sonda %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Consente di recuperare la luminosità (da 0 a 100%) del sensore RGB quad sotto la sonda scelta [L2, L1, R1, R2]. È possibile collegare in parallelo fino a 8 sensori RGB quad. Utilizzare i parametri (1-8) per selezionare il sensore. Il sensore predefinito per il robot mBot2 è 1.';// Rete: Wi-Fi
...
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TITLE'] = '[Schermo] cancella lo schermo';
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TOOLTIP'] = 'Consente di cancellare lo schermo della scheda CyberPi.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Restituisce la luminosità (da 0 a 100%) del sensore RGB quadruplo sotto la sonda selezionata [L2, L1, R1, R2]. \n\nÈ possibile collegare in parallelo fino a 8 sensori RGB quadrupli. Usa il parametro (1-8) per selezionare il sensore. Il sensore predefinito del robot mBot2 è 1.';
