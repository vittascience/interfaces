/**
 * @fileoverview Arabic messages for CyberPi. (AR)
 * Not translated yet.
 */
...
Blockly.Msg['IO_WRITEPWMPIN_TOOLTIP'] = 'Allows to apply a PWM signal with a fixed frequency of 5kHz and changing the cycle from 0 to 1023. The value 512 will correspond to 50% of the cycle, therefore approximately 1.66V.';
...
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TITLE'] = '[mBot2] %1 of %2 %3 speed %4 (RPM)';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_CM'] = 'cm';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_INCHS'] = 'inch.s';
Blockly.Msg['ROBOTS_MBOT2_MOVE_BY_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Allows mBot2 to move forward or backward a certain distance (in cm or inch) at speed (from 0 to 207 RPM).';
Blockly.Msg['ROBOTS_MBOT2_TURN_TITLE'] = '[mBot2] turn %1 of %2 (°) speed %3 (RPM)';
Blockly.Msg['ROBOTS_MBOT2_TURN_RIGHT'] = 'right';
Blockly.Msg['ROBOTS_MBOT2_TURN_LEFT'] = 'left';
Blockly.Msg['ROBOTS_MBOT2_TURN_TOOLTIP'] = IMG_ROBOT_MBOT2 + Blockly.Tooltip.SEP + 'Allows you to turn left or right by a certain angle (in °) at speed (from 0 to 207 RPM) with the mBot2 robot.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DETECTION_IS_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Returns \'True\' if the detection state of the 4 sensors under the robot (L2, L1, R1, R2) is checked, returns \'False\' otherwise. The value 1 corresponds to the background (often white) and 0 corresponds to the line (often black). It is possible to connect up to 8 quad RGB sensors in parallel. Use the parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TITLE'] = '[Quad RGB sensor. %1] detection states';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_DETECTION_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Returns the state of the 4 sensors under the robot (L2, L1, R1, R2) from 0 to 15. The value 1 corresponds to the background (often white) and 0 corresponds to the line (often black). Up to 8 quad RGB sensors can be connected in parallel. Use the parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TITLE'] = '[Quad RGB sensor. %1] probe %2 detects %3';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_IS_COLOR_DETECTED_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Returns \'True\' if the selected probe (L2, L1, R1, R2) detects the selected line or color, otherwise \'False\'. Up to 8 quad RGB sensors can be connected in parallel. Use parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_PROBE_DATA_TITLE'] = '[Quad RGB sensor %1] %2 measured with probe %3';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_PROBE_DATA_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Returns \'True\' if the chosen probe (L2, L1, R1, R2) detects the selected line or color, otherwise \'False\'. Up to 8 quad RGB sensors can be connected in parallel. Use parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
...
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_OFFSET_TRACK_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Returns the robot\'s deviation from the line from -100 to 100 mm. A negative value means a deviation to the left. Conversely, a positive value means a deviation to the right. Up to 8 quad RGB sensors can be connected in parallel. Use parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DEFINE_COLOR_TITLE'] = '[Quad RGB sensor %1] set the color to %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_DEFINE_COLOR_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Allows you to set the color of the quad RGB sensor lights to red, green, or blue. Up to 8 quad RGB sensors can be connected in parallel. Use parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_SET_COLOR_LIST_TITLE'] = '[Quad RGB sensor %1] controls the LEDs at %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_SET_COLOR_LIST_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Allows you to set the color of the quad RGB sensor lights by choosing a color from the list. Up to 8 quad RGB sensors can be connected in parallel. Use parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_CLOSE_LED_TITLE'] = '[Quad RGB Sensor %1] Turn off LEDs';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_CLOSE_LED_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Turns off the LEDs of the quad RGB sensor. Up to 8 quad RGB sensors can be connected in parallel. Use parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TITLE'] = '[Quad RGB Sensor %1] Light under probe %2';
Blockly.Msg['MBUILD_SENSORS_QUAD_RGB_GET_LIGHT_TOOLTIP'] = IMG_MBUILD_SENSORS_QUAD_RGB_SENSOR + Blockly.Tooltip.SEP + 'Allows you to retrieve the brightness (from 0 to 100%) of the quad RGB sensor under the chosen probe [L2, L1, R1, R2]. Up to 8 quad RGB sensors can be connected in parallel. Use parameter (1-8) to select the sensor. The default sensor for the mBot2 robot is 1.';
// Network - Wi-Fi
...
Blockly.Msg['CYBERPI_WIFI_BROADCAST_SET_TOOLTIP'] = 'Allows you to send a message containing a value on a WiFi network. All CyberPi boards connected to a network must use the same communication channel. Without connection to the router, CyberPi boards use the same channel by default and can thus communicate with each other on the LAN; When the CyberPi card is connected to a router, its channel depends on the router setting, which may be different from the default channel, and therefore it may fail to communicate with another CyberPi card that is not connected to the router. Therefore, to ensure good communication, if you are using a router, connect all CyberPi boards to the same local network.';
...
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TITLE'] = "[الشاشة] مسح الشاشة";
Blockly.Msg['CYBERPI_DISPLAY_CLEAR_TOOLTIP'] = "يمكّن من مسح شاشة لوحة CyberPi.";
