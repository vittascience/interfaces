...
Blockly.Msg['SENSE_HAT_IMU_GET_ORIENTATION_RADIANS_TITLE'] = '[Sense HAT] get orientation in radians (pitch, roll, yaw)';
Blockly.Msg['SENSE_HAT_IMU_GET_ORIENTATION_RADIANS_TOOLTIP'] = IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + 'Obtains the orientation in radians (pitch, roll, yaw) from the Sense HAT.';
