...
Blockly.Msg['NETWORK_GET_PI_NAME_TITLE'] = '[raspberry] اسم المضيف %1';
Blockly.Msg['NETWORK_GET_PI_NAME_TOOLTIP'] = 'يسمح باسترداد اسم المضيف ل Raspberry Pi.';
Blockly.Msg['SENSE_HAT_GET_TEMPERATURE_TITLE'] = '[Sense HAT] درجة الحرارة في %1';
Blockly.Msg['SENSE_HAT_GET_TEMPERATURE_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يرجع درجة الحرارة بالدرجات المئوية (°C) أو الفهرنهايت (°F) أو كلفن (K) من مستشعر درجة الحرارة في Sense HAT.';
Blockly.Msg['SENSE_HAT_GET_HUMIDITY_TITLE'] = '[Sense HAT] الرطوبة';
Blockly.Msg['SENSE_HAT_GET_HUMIDITY_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يرجع الرطوبة (بالنسبة المئوية) من مستشعر الرطوبة في Sense HAT.';
Blockly.Msg['SENSE_HAT_GET_TEMPERATURE_FROM_TITLE'] = '[Sense HAT] درجة الحرارة في %1 من المستشعر %2';
Blockly.Msg['SENSE_HAT_GET_TEMPERATURE_FROM_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + "يرجع درجة الحرارة بالدرجات المئوية (°C) أو الفهرنهايت (°F) أو كلفن (K) مع مستشعر الرطوبة أو الضغط في Sense HAT.';
Blockly.Msg['SENSE_HAT_GET_TEMPERATURE_HUMIDITY'] = 'الرطوبة';
Blockly.Msg['SENSE_HAT_GET_TEMPERATURE_PRESSURE'] = 'الضغط';
Blockly.Msg['SENSE_HAT_GET_PRESSURE_TITLE'] = '[Sense HAT] الضغط في %1';
Blockly.Msg['SENSE_HAT_GET_PRESSURE_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يرجع الضغط (بالميليبار) من مستشعر الضغط في Sense HAT.';
Blockly.Msg['SENSE_HAT_DISPLAY_SET_PIXEL_TITLE'] = '[Sense HAT] تعيين البكسل في x %1 و y %2، R %3 V %4 B %5';
Blockly.Msg['SENSE_HAT_DISPLAY_SET_PIXEL_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بتعيين لون بكسل في Sense HAT بلون RGB.';
Blockly.Msg['SENSE_HAT_DISPLAY_SET_PIXEL_PALETTE_TITLE'] = '[Sense HAT] تعيين البكسل في x %1 y %2 مع اللون %3';
Blockly.Msg['SENSE_HAT_DISPLAY_SET_PIXEL_PALETTE_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بتعيين لون بكسل في Sense HAT بلون من اللوحة.';
Blockly.Msg['SENSE_HAT_DISPLAY_SET_PIXELS_IMAGE_TITLE'] = '[Sense HAT] تعيين الصورة %1 مع %2 على خلفية %3';
Blockly.Msg['SENSE_HAT_DISPLAY_SET_PIXELS_IMAGE_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بتعيين صورة على مصفوفة LED في Sense HAT بلون RGB.';
Blockly.Msg['SENSE_HAT_DISPLAY_GET_PIXEL_TITLE'] = '[Sense HAT] لون البكسل في x %1 و y %2';
Blockly.Msg['SENSE_HAT_DISPLAY_GET_PIXEL_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح باسترداد لون بكسل في Sense HAT.';
Blockly.Msg['SENSE_HAT_DISPLAY_GET_PIXELS_TITLE'] = '[Sense HAT] استرداد ألوان البكسلات';
Blockly.Msg['SENSE_HAT_DISPLAY_GET_PIXELS_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح باسترداد ألوان البكسلات في Sense HAT.';
Blockly.Msg['SENSE_HAT_DISPLAY_CLEAR_TITLE'] = '[Sense HAT] مسح العرض';
Blockly.Msg['SENSE_HAT_DISPLAY_CLEAR_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بمسح عرض LED في Sense HAT.';
Blockly.Msg['SENSE_HAT_DISPLAY_CLEAR_WITH_COLOR_TITLE'] = '[Sense HAT] مسح العرض مع اللون %1';
Blockly.Msg['SENSE_HAT_DISPLAY_CLEAR_WITH_COLOR_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بمسح عرض LED في Sense HAT بلون RGB.';
Blockly.Msg['SENSE_HAT_DISAPLY_SHOW_LEDS_TITLE'] = '[Sense HAT] عرض الصورة مع اللون %1';
Blockly.Msg['SENSE_HAT_DISAPLY_SHOW_LEDS_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بعرض الصورة على مصفوفة LED في Sense HAT.';
Blockly.Msg['SENSE_HAT_DISPLAY_SHOW_MESSAGE_TITLE'] = '[Sense HAT] عرض الرسالة %1 مع السرعة %2 اللون %3 والخلفية %4';
Blockly.Msg['SENSE_HAT_DISPLAY_SHOW_MESSAGE_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بعرض رسالة على مصفوفة LED في Sense HAT بلون RGB.';
Blockly.Msg['SENSE_HAT_DISPLAY_SHOW_LETTER_TITLE'] = '[Sense HAT] عرض الحرف %1 مع اللون %2 على خلفية %3';
Blockly.Msg['SENSE_HAT_DISPLAY_SHOW_LETTER_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بعرض حرف على مصفوفة LED في Sense HAT بلون RGB.';
Blockly.Msg['SENSE_HAT_WAIT_FOR_EVENT_TITLE'] = '[Sense HAT] الانتظار لحدث عصا التحكم';
Blockly.Msg['SENSE_HAT_WAIT_FOR_EVENT_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بالانتظار لحدث على Sense HAT.';
Blockly.Msg['SENSE_HAT_GET_EVENT_ACTION_DIRECTION_TITLE'] = '[Sense HAT] الحصول على %1 من حدث عصا التحكم';
Blockly.Msg['SENSE_HAT_GET_EVENT_ACTION_DIRECTION_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + "يسمح بالحصول على الاتجاه أو الإجراء من حدث عصا التحكم.';
Blockly.Msg['SENSE_HAT_GET_EVENT_DIRECTION'] = 'الاتجاه';
Blockly.Msg['SENSE_HAT_GET_EVENT_ACTION'] = 'الإجراء';
Blockly.Msg['SENSE_HAT_GET_EVENT_JOYSTICK_TITLE'] = '[Sense HAT] الحصول على مصفوفة من أحداث عصا التحكم.';
Blockly.Msg['SENSE_HAT_GET_EVENT_JOYSTICK_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + "يسمح بالحصول على مصفوفة تحتوي على قائمة أحداث عصا التحكم.';
Blockly.Msg['SENSE_HAT_SET_IMU_CONFIG_TITLE'] = '[Sense HAT] %1 الجيروسكوب %2 %3 التسارع %4 %5 البوصلة';
Blockly.Msg['SENSE_HAT_SET_IMU_CONFIG_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بتكوين مستشعرات IMU (وحدة القياس بالقصور الذاتي) في Sense HAT.';
Blockly.Msg['SENSE_HAT_SET_IMU_CONFIG_ON'] = 'تفعيل';
Blockly.Msg['SENSE_HAT_SET_IMU_CONFIG_OFF'] = 'تعطيل';
Blockly.Msg['SENSE_HAT_IMU_GET_ORIENTATION_TITLE'] = '[Sense HAT] الاتجاه في %1 (x، y، z)';
Blockly.Msg['SENSE_HAT_IMU_GET_ORIENTATION_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + \'يسمح بالحصول على الاتجاه بالراديان (الانحدار، التدحرج، الانحراف) في Sense HAT.';
...
Blockly.Msg['SENSE_HAT_IMU_GET_COMPASS_TOOLTIP'] = 'IMG_MODULE_SENSE_HAT + Blockly.Tooltip.SEP + "يسمح بالحصول على اتجاه البوصلة في Sense HAT.';
Blockly.Msg['SENSORS_RPI_CAMERA_TAKE_PICTURE_TITLE'] = '[Raspberry Pi Camera] التقاط صورة';
Blockly.Msg['SENSORS_RPI_CAMERA_TAKE_PICTURE_TOOLTIP'] = 'IMG_MODULE_PI_CAMERA + Blockly.Tooltip.SEP + \'يسمح بالتقاط صورة باستخدام كاميرا Raspberry Pi.';
Blockly.Msg['SENSORS_RPI_CAMERA_TAKE_VIDEO_TITLE'] = '[Raspberry Pi Camera] تسجيل فيديو لمدة %1 ثانية';
Blockly.Msg['SENSORS_RPI_CAMERA_TAKE_VIDEO_TOOLTIP'] = 'IMG_MODULE_PI_CAMERA + Blockly.Tooltip.SEP + \'يسمح بتسجيل فيديو باستخدام كاميرا Raspberry Pi.';
