...
Blockly.Msg["TI_SYSTEM_WAIT_KEY_TOOLTIP"] = "Waits for a key to be pressed on the TI-83 calculator and returns the numerical value of the key.";
...
Blockly.Msg["MICROBIT_MUSIC_PLAYFREQUENCY_TITLE"] = "[Buzzer/Speaker] play frequency %1 during %2 (ms)";
Blockly.Msg["MICROBIT_MUSIC_PLAYFREQUENCY_TOOLTIP"] = "Enable to play integer frequency on built-in micro:bit speaker.";
Blockly.Msg["MICROBIT_MUSIC_SETTEMPO_TITLE"] = "[Buzzer/Speaker] set ticks %1 and tempo %2";
Blockly.Msg["MICROBIT_MUSIC_SETTEMPO_TOOLTIP"] = "Enable to set ticks music and beats per minute.";
Blockly.Msg["MICROBIT_MUSIC_SETVOLUME_TITLE"] = "[Buzzer/Speaker] set volume to %1";
...
Blockly.Msg['MICROBIT_NEOPIXEL_COLOR_TITLE'] = '[Neopixel - Color] set LED to R %1 G %2 B %3 on pin %4';
Blockly.Msg['MICROBIT_NEOPIXEL_COLOR_TOOLTIP'] = IMG_MODULE_NEOPIXEL + Blockly.Tooltip.SEP + "Allows setting the color of a Neopixel RGB LED using the Color class";
