...
Blockly.Msg['IO_INITCHRONOMETER_TITLE'] = '[time] remettre le chronomètre à 0';
...
Blockly.Msg['DEVICES_GROVE_GETULTRASONIC_TOOLTIP'] = IMG_MODULE_ULTRASONIC + Blockly.Tooltip.SEP + 'Renvoie la distance (en cm) mesurée grâce au capteur grove à ultrasons sur les broches digitales. Attention, si le capteur est un modèle grove, TRIG et ECHO sont sur la même broche SIG.';
...
Blockly.Msg['DEVICES_GROVE_SETLED_TITLE'] = '[LED] contrôler la LED à %1 sur la broche  %2';
