...
var $builtinmodule = function (name) {
    ...
    mod.__name__ = new Sk.builtin.str('potentio');
	
	mod.potentiometer = new Sk.misceval.buildClass(mod, function($gbl, $loc) {
		...
		$loc.measurement = new Sk.builtin.func(function (self) {
			self.measure = $("#potentiometer_" + self.pinId + "_value").html()
