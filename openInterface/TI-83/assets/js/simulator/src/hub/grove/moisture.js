// Innovator Hub - moisture module

var $builtinmodule = function (name) {
	
	var mod = {};

    mod.__name__ = new Sk.builtin.str('moisture');
	
	mod.moisture = new Sk.misceval.buildClass(mod, function($gbl, $loc) {
		...
		var js__init__ = function (self, pin) {
			if (pin !== undefined) {
                ...
                Simulator.Mosaic.specific.ti.showError("Il manque l'argument 'pin' à la fonction moisture()", "function takes 2 positional arguments but 1 were given.", 'TypeError');
			}
		};
		...
		$loc.measurement = new Sk.builtin.func(function (self) {
			self.measure = $("#groveMoisture_" + self.pinName + "_value").html()
