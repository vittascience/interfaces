// Innovator Hub - sound module

var $builtinmodule = function (name) {

    var sound = {};

    sound.__name__ = new Sk.builtin.str('sound');

    sound.tone = new Sk.builtin.func(function (frequency, duration, tempo) {
        const module = Simulator.getModuleByKey('ih-buzzer');
    ...
    sound.note = new Sk.builtin.func(function () {
        throw new Sk.builtin.NotImplementedError("sound.note() is not yet implemented");
    });
