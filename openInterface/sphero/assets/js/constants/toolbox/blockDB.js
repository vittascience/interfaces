/**
 * Database of defaut blocks in Sphero toolbox.
...
const TOOLBOXES_BLOCKS_CONTENT = {
    ...
    get: function () {
        return {
            /** Sphero default blocks */

            // display
            'display_set_main_LED_RGB': this.Set.number("R", 0) + this.Set.number("G", 255) + this.Set.number("B", 0),
            'display_set_main_LED_RGB_palette': this.Set.colour_picker('#22b573', "COLOUR"),
            'display_set_main_LED_RGB_fade': this.Set.colour_picker('#ffffff', "FROM") + this.Set.colour_picker('#22b573', "TO") + this.Set.number("TIME", 2),
            'display_set_main_LED_RGB_blink': this.Set.colour_picker('#22b573', "COLOUR") + this.Set.number("TIME", 1) + this.Set.number("COUNTER", 5),
            'display_set_back_LED_intensity': this.Set.number("INTENSITY", 255),
            // io - time
            ...
            // actuators
            "actuators_set_motors": this.Set.number("SPEED", 125),
            "actuators_set_motors_with_timeout": this.Set.number("SPEED", 125) +  this.Set.number("TIMEOUT", 1),
            "actuators_set_heading": this.Set.number("HEADING", 0),
            "actuators_set_motors_with_heading": this.Set.number("SPEED", 125) +  this.Set.number("HEADING", 0),
            "actuators_rotate": this.Set.number("SPEED", 125),
            "actuators_rotate_with_timeout": this.Set.number("SPEED", 125) +  this.Set.number("TIMEOUT", 1),
            "actuators_set_motor": this.Set.number("SPEED", 125),
