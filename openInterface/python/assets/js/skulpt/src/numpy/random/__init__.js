...
var $builtinmodule = function(name) {
    ...
    var randomState_c = function($gbl, $loc) {
        ...
        */
        ...
        var js_tomaxint = function(self, size) {
            throw new Sk.builtin.NotImplementedError('RandomState.tomaxint');
        ...
        */
        ...
        var js_bytes = function(self, length) {
            throw new Sk.builtin.NotImplementedError('RandomState.bytes');
        };
        $loc.bytes = new Sk.builtin.func(js_bytes);

        var js_choice = function(self, length) {
            throw new Sk.builtin.NotImplementedError('RandomState.choice');
        };
        $loc.choice = new Sk.builtin.func(js_choice);

        var js_uniform = function(self, length) {
            throw new Sk.builtin.NotImplementedError('RandomState.uniform');
        };
    ...
    mod[CLASS_RANDOMSTATE] = new Sk.misceval.buildClass(mod, randomState_c,
      CLASS_RANDOMSTATE, []);
