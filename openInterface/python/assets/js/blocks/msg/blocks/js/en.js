...
Blockly.Msg['VITTAIA_MAKE_PREDICTIONS_FROM_URL_TITLE'] = '%1 start detection on the image URL %2';
Blockly.Msg['VITTAIA_MAKE_PREDICTIONS_FROM_URL_TOOLTIP'] = 'Performs model predictions for the image downloaded from a URL. A prediction has two elements: the class and the confidence level.';
