describe('adding non point data works', function () {
	...
	it('Removes polygons from vittamap when removed', function () {
	...
	describe('hasLayer', function () {
		...
		it('returns true before adding to vittamap', function() {
			group = new L.MarkerClusterGroup();
		...
		it('returns true after adding to vittamap after adding polygon', function () {
			group = new L.MarkerClusterGroup();
		...
		it('returns true after adding to vittamap before adding polygon', function () {
			group = new L.MarkerClusterGroup();
	...
	describe('removeLayer', function() {
		...
		it('removes before adding to vittamap', function () {
			group = new L.MarkerClusterGroup();
		...
		it('removes after adding to vittamap after adding polygon', function () {
			group = new L.MarkerClusterGroup();
		...
		it('removes after adding to vittamap before adding polygon', function () {
			group = new L.MarkerClusterGroup();
