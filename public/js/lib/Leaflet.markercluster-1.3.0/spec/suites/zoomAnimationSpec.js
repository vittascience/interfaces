describe('zoomAnimation', function () {
	...
	it('adds the visible marker to the vittamap when zooming in', function () {
	...
	it('adds the visible marker to the vittamap when jumping around', function () {
		...
		//Now the second one should be visible on the vittamap
		expect(marker2._icon).to.not.be(undefined);
		expect(marker2._icon).to.not.be(null);
	});

	it('adds the visible markers to the vittamap, but not parent clusters when jumping around', function () {
	...
	it('removes clicked clusters on the edge of a mobile screen', function () {
		...
		// Finally make sure that the cluster has been removed from vittamap.
	...
	describe('zoomToShowLayer', function () {
		...
		it('zoom to single marker inside vittamap view', function () {
			group = new L.MarkerClusterGroup();
			...
			//Marker should be visible, vittamap center and zoom level should stay the same, callback called once
			expect(marker._icon).to.not.be(undefined);
			expect(marker._icon).to.not.be(null);
		...
		it('pan vittamap to single marker outside vittamap view', function () {
			group = new L.MarkerClusterGroup();
			...
			//Marker should be visible, vittamap center should be equal to marker center,
		...
		it('change view and zoom to marker in cluster inside vittamap view', function () {
			group = new L.MarkerClusterGroup();
		...
		it('change view and zoom to marker in cluster outside vittamap view', function () {
			group = new L.MarkerClusterGroup();
