describe('spiderfy', function () {
	...
	it('Spiderfies at current zoom if all child markers are still within a single cluster at vittamap maxZoom', function () {
	...
	it('removes all markers and spider legs when group is removed from vittamap', function () {
