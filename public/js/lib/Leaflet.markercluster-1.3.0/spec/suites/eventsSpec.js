describe('events', function() {
	 ...
	 *
	 * But refrain from re-creating div and vittamap every time. Re-use those objects.
	 */
	...
	describe('after being added, removed, re-added from the vittamap', function() {
		...
		it('does not break vittamap events', function () {
			var callback = sinon.spy();
		...
		//layeradd
		it('fires layeradd when markers are added while not on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layeradd when vectors are added while not on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layeradd when markers are added while on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layeradd when vectors are added while on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layeradd when markers are added using addLayers while on the vittamap with chunked loading', function() {
			var callback = sinon.spy();
		...
		it('fires layeradd when vectors are added using addLayers while on the vittamap with chunked loading', function() {
			var callback = sinon.spy();
		...
		//layerremove
		it('fires layerremove when a marker is removed while not on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layerremove when a vector is removed while not on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layerremove when a marker is removed while on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layerremove when a vector is removed while on the vittamap', function() {
			var callback = sinon.spy();
		...
		it('fires layerremove when a marker is removed using removeLayers while on the vittamap with chunked loading', function() {
			var callback = sinon.spy();
		...
		it('fires layerremove when a vector is removed using removeLayers while on the vittamap with chunked loading', function() {
			var callback = sinon.spy();
		...
		it('fires layerremove when a marker is removed using removeLayers while not on the vittamap with chunked loading', function() {
			var callback = sinon.spy();
		...
		it('fires layerremove when a vector is removed using removeLayers while not on the vittamap with chunked loading', function() {
			var callback = sinon.spy();
