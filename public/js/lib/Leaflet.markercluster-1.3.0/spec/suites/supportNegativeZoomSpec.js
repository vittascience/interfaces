describe('things behave correctly with negative minZoom', function () {
	...
	it('shows a single marker added to the group before the group is added to the vittamap', function () {
	...
	it('shows a single marker added to the group after the group is added to the vittamap', function () {
