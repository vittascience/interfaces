describe('Option removeOutsideVisibleBounds', function () {
	...
	// Add all markers once to vittamap then remove them immediately so that their icon is null (instead of undefined).
	...
	it('leaves all objects on vittamap when set to false', function () {
	...
	// The actual vittamap view should be '-1.0986328125,84.92929204957956,1.0986328125,85.11983467698401'
	...
	function moveMarkersAndMapToMaxLat(latLngs, isSouth) {
		...
		map.fitBounds([
			[isSouth ? -86 : 85, -1],
			[isSouth ? -85 : 86, 1] // The actual vittamap view longitude span will be wider. '-1.0986328125,84.92929204957956,1.0986328125,85.11983467698401'
		]);
	}
