describe('support for Circle elements', function () {
	...
	it('appears when added to the group before the group is added to the vittamap', function () {
	...
	it('appears when added to the group after the group is added to the vittamap', function () {
	...
	it('appears animated when added to the group after the group is added to the vittamap', function () {
