describe('removeLayer', function () {
	...
	it('removes a layer that was added to it (before being on the vittamap) that is shown in a cluster', function () {
	...
	it('removes a layer that was added to it (after being on the vittamap) that is shown in a cluster', function () {
	...
	it('removes a layer that was added to it (before being on the vittamap) that is individually', function () {
	...
	it('removes a layer (with animation) that was added to it (after being on the vittamap) that is shown in a cluster', function () {
	...
	it('removes the layers that are in the given LayerGroup when not on the vittamap', function () {
