describe('addLayer adding a single marker', function () {
	...
	it('appears (using animations) when added after the group is added to the vittamap', function () {
	...
	it('does not appear when too far away when added before the group is added to the vittamap', function () {
	...
	it('does not appear when too far away when added after the group is added to the vittamap', function () {
