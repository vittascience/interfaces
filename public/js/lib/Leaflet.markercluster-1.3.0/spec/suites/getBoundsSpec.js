describe('getBounds', function() {
	...
	describe('polygon layer', function() {
		it('returns the correct bounds before adding to the vittamap', function() {
		...
		it('returns the correct bounds after adding to the vittamap after adding polygon', function() {
			var group = new L.MarkerClusterGroup();
			var polygon = new L.Polygon([[1.5, 1.5], [2.0, 1.5], [2.0, 2.0], [1.5, 2.0]]);
		...
		it('returns the correct bounds after adding to the vittamap before adding polygon', function() {
			var group = new L.MarkerClusterGroup();
			var polygon = new L.Polygon([[1.5, 1.5], [2.0, 1.5], [2.0, 2.0], [1.5, 2.0]]);
	...
	describe('marker layers', function () {
		...
		it('returns the correct bounds after adding to the vittamap after adding markers', function () {
			var group = new L.MarkerClusterGroup();
			var marker = new L.Marker([1.5, 1.5]);
			var marker2 = new L.Marker([1.0, 5.0]);
			var marker3 = new L.Marker([6.0, 2.0]);
		...
		it('returns the correct bounds after adding to the vittamap before adding markers', function () {
			var group = new L.MarkerClusterGroup();
			var marker = new L.Marker([1.5, 1.5]);
			var marker2 = new L.Marker([1.0, 5.0]);
			var marker3 = new L.Marker([6.0, 2.0]);
	...
	describe('marker and polygon layers', function() {
		...
		it('returns the correct bounds after adding to the vittamap', function () {
			var group = new L.MarkerClusterGroup();
			var marker = new L.Marker([6.0, 3.0]);
			var polygon = new L.Polygon([[1.5, 1.5], [2.0, 1.5], [2.0, 2.0], [1.5, 2.0]]);
