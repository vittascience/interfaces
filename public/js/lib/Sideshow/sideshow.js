  ...
  (function (name, module) {
    ...
    var strings = {
      availableWizards: {
        ...
        "fr": "<i class=\"fas fa-graduation-cap\"></i> Tutoriels Disponibles"
      },
      relatedWizards: {
        "en": "Related Wizards",
        "pt-br": "Tutoriais Relacionados",
        "es": "Tutoriales Relacionados",
        "fr": "<i class=\"fas fa-graduation-cap\"></i> Tutoriels Similaires"
      },
      noAvailableWizards: {
        "en": "There's no tutorials available.",
        "pt-br": "Não há tutoriais disponíveis para esta tela.",
        "es": "No hay tutoriales disponibles.",
        "fr": "<i class=\"fas fa-graduation-cap\"></i> Il n'y a pas de tutoriels disponibles"
      },
      close: {
        "en": "Close",
        "pt-br": "Fechar",
    ...
    WizardMenu.setTitle = function (title) {
      this.$el.find(".sideshow-wizard-menu-title").html(title);
    };
